...
public class NewListManagement {
	...
	//public static final String ListManagementSubsection = "//*[@id=\"MainContent_rptListTypes_lnkLstType_";
	//public static final String ListManagementSubsection = "//table[@class='FilterTable toggleElement-Parent']//td[2]//a[contains(text(),'Market Segment')]";
	public static final String ListManagementSubsection = "//table[@class='FilterTable toggleElement-Parent']//td[2]//a[contains(text(),";
}
