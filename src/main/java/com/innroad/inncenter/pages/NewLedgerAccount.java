...
public class NewLedgerAccount {
	...
	public static final String LedgeAccount_AccountType = "MainContent_drpAccountType";
	public static final String ListOfAllPaymentMethods = "//tr[@class='dgHeader']//following-sibling::tr[contains(@class, 'dgItem')]//input[1]/..//following-sibling::td[1]";
}
