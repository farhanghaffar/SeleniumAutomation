...
public class Elements_TapeChart {
	...
	@FindBy(xpath = NewTapeChart.errorMessage)
	public WebElement errorMessage;
	
	@FindBy(xpath = OR.ReservationUpdate_PopupRoomClass)
	public WebElement ReservationUpdate_PopupRoomClass;

	@FindBy(xpath = OR.ReservationUpdate_PopupOkButton)
	public WebElement ReservationUpdate_PopupOkButton;

	
	@FindBy(xpath = OR.UnassignedListGuestNames)
	public WebElement UnassignedListGuestNames;

	@FindBy(xpath = NewTapeChart.ruleName)
	public WebElement ruleName;

	@FindBy(xpath = NewTapeChart.ruleDescription)
	public WebElement ruleDescription;
	
	@FindBy(xpath = NewTapeChart.ruleBrokenCancelIcon)
	public WebElement ruleBrokenCancelIcon;
	
	@FindBy(xpath = NewTapeChart.ruleBrokenPopupTapeChart)
	public WebElement ruleBrokenPopupTapeChart;
	
	@FindBy(xpath = NewTapeChart.tapeChartSearch_OverrideAmount)
	public WebElement tapeChartSearch_OverrideAmount;
	
	@FindBy(xpath = NewTapeChart.unassignedReservationNameList)
	public List<WebElement> unassignedReservationNameList;
