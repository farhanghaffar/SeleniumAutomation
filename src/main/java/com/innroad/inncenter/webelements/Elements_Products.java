...
public class Elements_Products {
	...
	@FindBy(xpath = OR_Products.BUNDLES_TAB)
	public WebElement bundlesTab;

	@FindBy(xpath = OR_Products.CREATE_BUNDLE)
	public WebElement createBundleButton;

	@FindBy(xpath = OR_Products.BUNDLE_DISPLAY_NAME)
	public WebElement bundleDisplayName;

	@FindBy(xpath = OR_Products.SELL_ON_NBE_CHECKBOX)
	public WebElement sellOnBECheckbox;

	@FindBy(xpath = OR_Products.ASSOCIATE_ROOMCLASS)
	public WebElement associateRoomClasses;

	@FindBy(xpath = OR_Products.BUNDLE_DESCRIPTION)
	public WebElement bundleDescription;

	@FindBy(xpath = OR_Products.PRODUCTS_PRICING)
	public WebElement prodcutsAndPricing;
	
	@FindBy(xpath = OR_Products.SAVE_BUTTON)
