...
public class WebElements_TaskList {
	...
	@FindBy(xpath = OR.taskDueOn)
	public WebElement taskDueOn;
	
	@FindBy(xpath = OR.taskDueOnDate)
	public WebElement taskDueOnDate;
	...
	@FindBy(xpath = OR.bulkStatusChange_CloseButton)
	public WebElement bulkStatusChange_CloseButton;
	
	@FindBy(xpath = OR_TaskList.toDo)
	public WebElement toDo;
	
	@FindBy(xpath = OR_TaskList.inspection)
	public WebElement inspection;
	
	@FindBy(xpath = OR_TaskList.done)
	public WebElement done;
	
	@FindBy(xpath = OR_TaskList.all)
	public WebElement all;
	
	@FindBy(xpath = OR_TaskList.taskreportToDo)
	public WebElement taskreportToDo;
	
	@FindBy(xpath = OR_TaskList.taskreportInspection)
	public WebElement taskreportInspection;
	
	@FindBy(xpath = OR_TaskList.taskreportDone)
	public WebElement taskreportDone;
	
	@FindBy(xpath = OR_TaskList.taskreportAll)
	public WebElement taskreportAll;
	
	@FindBy(xpath = OR_TaskList.tasklistHeader)
	public WebElement tasklistHeader;
	
	@FindBy(xpath = OR_TaskList.taskreportAll)
	public List<WebElement> taskreportAllList;
	
	@FindBy(xpath = OR_TaskList.allBar)
	public WebElement allBar;
	
	@FindBy(xpath = OR.TaskPopupAdd_CloseButton)
	public WebElement TaskPopupAdd_CloseButton;
	
	@FindBy(xpath = OR.filterClearAllLink)
	public WebElement filterClearAllLink;
	
	@FindBy(xpath = OR.taskMessage)
	public WebElement taskMessage;
	
	@FindBy(xpath = OR.noTaskMessage)
	public WebElement noTaskMessage;
}
