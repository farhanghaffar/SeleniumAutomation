...
public class Elements_Roles {
	...
	@FindBy(xpath = OR_Admin.checkboxSelectAll)
	...
	@FindBy(xpath = OR_Admin.checkboxEntityAll)
	public WebElement checkboxEntityAll;
	...
	@FindBy(xpath = OR_Admin.roleName)
	public WebElement roleName;
	
	@FindBy(xpath = OR_Admin.roleDescription)
	public WebElement roleDescription;
	
	@FindBy(xpath = OR_Admin.roleClear)
	public WebElement roleClear;
	
	@FindBy(xpath = OR_Admin.roleDeleteButton)
	public WebElement roleDeleteButton;
	
	@FindBy(xpath = OR_Admin.roleStatusDropDownBox)
	public WebElement roleStatusDropDownBox;
	
	@FindBy(xpath = OR_Admin.roleHelpIcon)
	public WebElement roleHelpIcon;
	
	@FindBy(xpath = OR_Admin.roleSpinerLoading)
	public WebElement roleSpinerLoading;
}
