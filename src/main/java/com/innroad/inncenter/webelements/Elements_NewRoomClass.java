...
public class Elements_NewRoomClass {
	...
	@FindBy(xpath = OR.RoomClassPagesfixed)
	public List<WebElement> RoomClassPagesfixed;
	...
	@FindBy(xpath = NewRoomClass.SaveChanges)
	public WebElement SaveChanges;
	
	@FindBy(xpath = NewRoomClass.ClickVrboTab)
	public WebElement ClickVrboTab;
	
	@FindBy(xpath = NewRoomClass.GetRatePlanVrbo)
	public WebElement getRatePlanVrbo;
	
	@FindBy(xpath = NewRoomClass.VRBO_HEADLINES)
	public WebElement VRBO_HEADLINES;	
}
