...
public class Elements_Admin {
	...
	@FindBy(xpath = OR_Admin.saveClientDetails)
	public WebElement saveClientDetails;

	@FindBy(id = OR_Admin.selectWeekDay)
	public WebElement selectWeekDay;
	
	@FindBy(xpath = OR_Admin.ClickPhoneMask)
	public WebElement clickPhoneMask;
	
	@FindBy(xpath = OR.GetAdminName)
