...
public class Elements_RoomMaintenance {
	...
	public static Logger app_logs = Logger.getLogger("devpinoyLogger");
		...
		@FindBy(xpath=OR_GuestServices.RoomMaintenance_StartDates)
		public WebElement RoomMaintenance_StartDates;
		
		@FindBy(xpath=OR_GuestServices.RoomMaintenance_EndDates)
		public WebElement RoomMaintenance_EndDates;
		
		@FindBy(xpath=OR_GuestServices.RoomMaintenance_StartDatesClear)
		public WebElement RoomMaintenance_StartDatesClear;
		
		@FindBy(xpath=OR_GuestServices.RoomMaintenance_EndDatesClear)
		public WebElement RoomMaintenance_EndDatesClear;
		
		@FindBy(xpath=OR_GuestServices.RoomMaintenance_Message)
		public WebElement RoomMaintenance_Message;
