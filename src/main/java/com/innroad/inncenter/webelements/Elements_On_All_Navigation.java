...
public class Elements_On_All_Navigation {
	...
	@FindBy(xpath = OR.Guest_HistoryIcons)
	public WebElement Guest_HistoryIcons;

	@FindBy(xpath = OR.Guest_History1)
	public WebElement Guest_History1;
	...
	@FindBy(id = OR.Accounts_NavIcons)
	public WebElement Accounts_NavIcons;
	...
	@FindBy(xpath = OR.Guest_Services_4)
	public WebElement Guest_Services_4;
	
	@FindBy(xpath = OR.Guest_Services_5)
	public WebElement Guest_Services_5;
	
	@FindBy(xpath = OR.Loading)
	public WebElement Loading;
	
	@FindBy(xpath = OR.Guest_Services_6)
	public WebElement Guest_Services_6;
	...
	@FindBy(xpath = OR.Setup2)
	public WebElement Setup2;
	
	@FindBy(xpath = OR.setup)
	public WebElement setup;

	@FindBy(xpath = OR.setupIcons)
	public WebElement setupIcons;
	
	@FindBy(xpath = OR.setupIconsAfterRateGrid)
	public WebElement setupIconsAfterRateGrid;
	
	@FindBy(xpath = OR.setupIconsAfterRoomMaintenance)
	public WebElement setupIconsAfterRoomMaintenance;
	...
	@FindBy(xpath = OR.Ledger_Accounts2)
	public WebElement Ledger_Accounts2;
	...
	@FindBy(xpath = OR.List_Management_From_Properties_Tab)
	public WebElement List_Management_From_Properties_Tab;
	...
	@FindBy(xpath = OR.Admin2)
	public WebElement Admin2;
	
	@FindBy(xpath = OR.Admin3)
	...
	@FindBy(xpath = OR.GDPR)
	public WebElement GDPR;

	@FindBy(xpath = OR.Night_audit)
	public WebElement Night_audit;

	@FindBy(xpath = OR.Night_audit2)
	public WebElement Night_audit2;

	@FindBy(xpath = OR.Night_audit3)
	public WebElement Night_audit3;
	...
	@FindBy(xpath = OR.Reservation_BackwardfromPolicy)
	public WebElement Reservation_BackwardfromPolicy;
	...
	@FindBy(xpath = OR.getDefaultProperty)
	public WebElement getDefaultProperty;
...
/*	@FindBy(xpath = OR.SetupFromrateGrid)
	...
	@FindBy(xpath = OR.productBundlesV2)
	public WebElement productBundlesV2;
	...
	@FindBy(xpath = OR.InventoryFromRoomClass)
	public WebElement InventoryFromRoomClass;
	
	@FindBy(id = OR_PackageRatePlan.ProductAndBundle)
	public WebElement ProductAndBundle;

	@FindBy(xpath  = OR_PackageRatePlan.SearchProduct)
	public WebElement SearchProduct;

	

	@FindBy(xpath = OR.inventoryToSetup)
	public WebElement inventoryToSetup;
	
	@FindBy(xpath = OR.Reports_2)
	public WebElement Reports_2;
	
	@FindBy(xpath = OR.NavInventoryFromListMgmt)
	public WebElement navInventoryFromListMgmt;
	
	@FindBy(xpath = OR.PropertyDetails)
	public WebElement propertyDetails;

	
	@FindBy(xpath = OR.TaxesAndFeesTab)
	public WebElement TaxesAndFeesTab;
	
	@FindBy(xpath = OR.VrboTab)
	public WebElement VrboTab;
	
	@FindBy(xpath = OR.VrboSetupTab)
	public WebElement VrboSetupTab;
	
	@FindBy(xpath = OR.taxesAndFeesTabAfterRoomClass)
	public WebElement taxesAndFeesTabAfterRoomClass;
	
	@FindBy(xpath = OR.AccountToRes)
	public WebElement accountToRes;

	@FindBy(xpath = OR.Reservation4)
	public WebElement reservation4;
	@FindBy(xpath = OR.ClickAirbnbTab)
	public WebElement airbnbTab;
	
	@FindBy(xpath = OR.ClickPropertyDropdownOnAirbnbTab)
	public WebElement clickPropertyDropdownOnAirbnbTab;
		
	@FindBy(xpath = OR.GetAirbnbRatePlan)
	public WebElement getAirbnbRatePlan;
	
	@FindBy(xpath = OR.Inventory_Backward_Admin1)
	public WebElement Inventory_Backward_Admin1;
	
	@FindBy(xpath = OR.PropertyLink)
	public WebElement PropertyLink;
	
	@FindBy(id = OR.ReservationBackwardFromProperty)
	public WebElement ReservationBackwardFromProperty;
}
