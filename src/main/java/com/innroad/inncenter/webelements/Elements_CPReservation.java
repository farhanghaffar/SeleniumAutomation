...
public class Elements_CPReservation {
	...
	@FindBy(xpath = OR_Reservation.SaveButtonAfterEditGuestInfo)
	public WebElement SaveButtonAfterEditGuestInfo;
	...
	@FindBy(xpath = OR_Reservation.CP_NewReservation_Account_V2)
	public WebElement CP_NewReservation_Account_V2;
	
	@FindBy(xpath = OR_Reservation.CP_NewReservation_Account_V2Delete)
	public WebElement CP_NewReservation_Account_V2Delete;
	...
	@FindBy(xpath = OR_Reservation.CP_NewReservation_SplitRoom)
	public WebElement CP_NewReservation_SplitRoom;

	@FindBy(xpath = OR_Reservation.CP_NewReservation_AddMoreGuestInfo)
	public WebElement CP_NewReservation_AddMoreGuestInfo;
	
	@FindBy(xpath = OR_Reservation.CP_NewReservation_AddMoreGuestInfo2)
	public WebElement CP_NewReservation_AddMoreGuestInfo2;
	...
	@FindBy(xpath = OR_Reservation.CheckIn_GuestRegistrationReportToggle)
	public WebElement CheckIn_GuestRegistrationReportToggle;
	@FindBy(xpath = OR_Reservation.CheckOut_GuestRegistrationReportToggle)
	public WebElement CheckOut_GuestRegistrationReportToggle;
	...
	@FindBy(xpath = OR_Reservation.CP_Reservation_Confirm_Button)
	public WebElement CP_Reservation_Confirm_Button;
	...
	@FindBy(xpath = OR_Reservation.CP_Reservation_ConfirmCheckOutPayment_Button)
	public WebElement CP_Reservation_ConfirmCheckOutPayment_Button;
	
	@FindBy(xpath = OR_Reservation.CP_Reservation_ConfirmCheckInPayment_Button_2)
	public WebElement CP_Reservation_ConfirmCheckInPayment_Button_2;
	...
	@FindBy(xpath = OR_Reservation.closeButtonCheckin)
	public WebElement closeButtonCheckin;
	...
	@FindBy(xpath = OR_Reservation.StayInfo_Editbutton2)
	public WebElement StayInfo_Editbutton2;
	...
	@FindBy(xpath = OR_Reservation.COPY_CP_GuestInfo_LastName1)
	public WebElement COPY_CP_GuestInfo_LastName1;
	...
	public WebElement COPY_CP_MailingInfo_Code;
	...
	@FindBy(xpath = OR_Reservation.CancelReservation_Successful)
	public WebElement CancelReservation_Successful;
	...
	@FindBy(xpath = OR_Reservation.RoomWhileChangeDatesPopupYesButton)
	public WebElement RoomWhileChangeDatesPopupYesButton;
	...
	@FindBy(xpath = OR_Reservation.SpinerLoading1)
	public WebElement SpinerLoading1;
	...
	/*
	 * @FindBy(xpath = OR_Reservation.propertyDetailsCode) public WebElement
	 * propertyDetailsCode;
	 */
	...
	@FindBy(xpath = OR_Reservation.noShowPolicyDropdownInDetailsTab)
	public WebElement noShowPolicyDropdownInDetailsTab;

	@FindBy(xpath = OR_Reservation.closeNoShowPolicyExpand)
	public WebElement closeNoShowPolicyExpand;

	/*
	 * @FindBy(xpath = OR_Reservation.folioBalance) public WebElement folioBalance;
	 */
	...
	@FindBy(xpath = OR_Reservation.decryptLink1)
	public WebElement decryptLink1;

	@FindBy(xpath = OR_Reservation.ccNumberInput)
	public WebElement ccNumberInput;
	
	@FindBy(xpath = OR_Reservation.ccNumberInput1)
	public WebElement ccNumberInput1;
	...
	@FindBy(xpath = OR_Reservation.EDITBUTTON)
	...
	@FindBy(xpath = OR_Reservation.StartDate)
	public List<WebElement> StartDate;

	@FindBy(xpath = OR_Reservation.RateDisplayName)
	public List<WebElement> RateDisplayName;

	@FindBy(xpath = OR_Reservation.RatesValue)
	public List<WebElement> RatePerInterval;

	@FindBy(xpath = OR_Reservation.closeReservationSearch)
	public WebElement closeReservationSearch;

	@FindBy(xpath = OR_Reservation.RoomChargesInTripSummary)
	public WebElement RoomChargesInTripSummary;

	@FindBy(xpath = OR_Reservation.ClickOnEditReservationIcon)
	public WebElement ClickOnEditReservationIcon;

	@FindBy(xpath = OR_Reservation.NoShowClosePopupButton)
	public WebElement NoShowClosePopupButton;
	
	@FindBy(xpath = OR_Reservation.NoShowSuccess_CloseButton_U)
	public WebElement NoShowSuccess_ClosePopupButton_U;
	
		
	@FindBy(xpath = OR_Reservation.NoShowSuccess_CloseButton)
	public WebElement NoShowSuccess_CloseButton;
	
	@FindBy(xpath = OR_Reservation.CHECKINCLOSEBUTTON)
	public WebElement CHECKINCLOSEBUTTON;	
	
	@FindBy(xpath = OR_Reservation.ClickSelectFirstRoomClass)
	public WebElement clickSelectFirstRoomClass;
	@FindBy(xpath = OR_Reservation.reservationTab)
	public WebElement reservationTab;

	@FindBy(id = OR_Reservation.reservationTab_2)
	public WebElement reservationTab_2;

	@FindBy(xpath = OR_Reservation.recordFoundLabel)
	public WebElement recordFoundLabel;

	@FindBy(xpath = OR_Reservation.recordFound)
	public WebElement recordFound;

	@FindBy(xpath = OR_Reservation.selectItemsPerPage)
	public WebElement selectItemsPerPage;

	@FindBy(xpath = OR_Reservation.reservationList)
	public List<WebElement> reservationList;

	@FindBy(xpath = OR_Reservation.roomNumber)
	public WebElement roomNumber;

	@FindBy(xpath = OR_Reservation.StayInfoThreeDots)
	public List<WebElement> StayInfoThreeDots;

	@FindBy(xpath = OR_Reservation.confirmCheckin)
	public WebElement confirmCheckin;

	@FindBy(xpath = OR_Reservation.proceedToCheckinPayment)
	public WebElement proceedToCheckinPayment;

	@FindBy(xpath = OR_Reservation.confirmDirtyRoomCheckin)
	public WebElement confirmDirtyRoomCheckin;

	@FindBy(xpath = OR_Reservation.closeSuccesPopup)
	public WebElement closeSuccesPopup;

	@FindBy(xpath = OR_Reservation.EnterFindGuestProfile)
	public WebElement enterFindGuestProfile;

	@FindBy(xpath = OR_Reservation.ResultGuestHistory)
	public WebElement resultGuestHistory;

	@FindBy(xpath = OR_Reservation.OverBookingConfirmation)
	public WebElement overBookingConfirmation;

	@FindBy(xpath = OR_Reservation.GuestHistoryConfirmationPopup)
	public WebElement guestHistoryConfirmationPopup;
	
	@FindBy(xpath = OR_Reservation.GetPaymentMethod)
	public WebElement getPaymentMethod;
	
	@FindBy(xpath = OR_Reservation.GetCardNumber)
	public WebElement getCardNumber;
	
	@FindBy(xpath = OR_Reservation.GetNameOnCard)
	public WebElement getNameOnCard;
	
	@FindBy(xpath = OR_Reservation.GetExpiryDate)
	public WebElement getExpiryDate;
	
	@FindBy(xpath = OR_Reservation.ClickDecriptor)
	public WebElement clickDecriptor;
	
	@FindBy(xpath = OR_Reservation.GetGuestFirstName)
	public WebElement getGuestFirstName;
	
	@FindBy(xpath = OR_Reservation.GetguestLastName)
	public WebElement getguestLastName;
	
	@FindBy(xpath = OR_Reservation.GetContactFirstName)
	public WebElement getContactFirstName;
	
	@FindBy(xpath = OR_Reservation.GetContactLastName)
	public WebElement getContactLastName;
	
	@FindBy(xpath = OR_Reservation.GetguestEmail)
	public WebElement getguestEmail;
	
	@FindBy(xpath = OR_Reservation.GetPhone)
	public WebElement getPhone;
	
	@FindBy(xpath = OR_Reservation.GetAlternamePhone)
	public WebElement getAlternamePhone;
	
	@FindBy(xpath = OR_Reservation.SameAsMailingAddr)
	public WebElement sameAsMailingAddr;
	
	@FindBy(xpath = OR_Reservation.BillingLastname)
	public WebElement billingLastname;
	
	@FindBy(xpath = OR_Reservation.BiliingFirstName)
	public WebElement biliingFirstName;
	
	@FindBy(xpath = OR_Reservation.SameAsmailing)
	public WebElement sameAsmailing;
	
	@FindBy(xpath = OR_Reservation.BillingSalutation)
	public WebElement billingSalutation;
	
	@FindBy(xpath = OR_Reservation.BillingFirstName)
	public WebElement billingFirstName;
	
	@FindBy(xpath = OR_Reservation.BillingLastName)
	public WebElement billingLastName;
	
	@FindBy(xpath = OR_Reservation.BillingAddress1)
	public WebElement billingAddress1;
	
	@FindBy(xpath = OR_Reservation.BillingAddress2)
	public WebElement billingAddress2;
	
	@FindBy(xpath = OR_Reservation.BillingAddress3)
	public WebElement billingAddress3;
	
	@FindBy(xpath = OR_Reservation.BillingCity)
	public WebElement billingCity;

	@FindBy(xpath = OR_Reservation.CP_NewReservation_CheckoutTextBox)
	public WebElement CP_NewReservation_CheckoutTextBox;
	
	@FindBy(xpath = OR_Reservation.GetAutosuggestName)
	public WebElement getAutosuggestName;
	
	@FindBy(xpath = OR_Reservation.GetBillingPostalCode)
	public WebElement getBillingPostalCode;
	
	@FindBy(xpath = OR_Reservation.ClickEditGuestInFo)
	public WebElement clickEditGuestInFo;
	
	@FindBy(xpath = OR_Reservation.SaveGuestInfo)
	public WebElement saveGuestInfo;
	
	@FindBy(xpath = OR_Reservation.UpdateGuestProfile)
	public WebElement updateGuestProfile;
	@FindBy(xpath = OR_Reservation.selectedProperty)
	public WebElement selectedProperty;

	@FindBy(xpath = OR_Reservation.selectedProperty1)
	public WebElement selectedProperty1;
	
	@FindBy(xpath = OR_Reservation.closeCheckinSuccessPopup)
	public WebElement closeCheckinSuccessPopup;

	@FindBy(xpath = OR_Reservation.paymentDetailsNotes)
	public WebElement paymentDetailsNotes;

	@FindBy(name = OR_Reservation.authorizationType)
	public WebElement authorizationType;

	@FindBy(xpath = OR_Reservation.processPayment)
	public WebElement processPayment;

	@FindBy(xpath = OR_Reservation.continuePayment)
	public WebElement continuePayment;
	
	@FindBy(xpath = OR_Reservation.continuePaymentButton)
	public WebElement continuePaymentButton;

	@FindBy(xpath = OR_Reservation.voidPayment)
	public WebElement voidPayment;
	
	@FindBy(xpath = OR_Reservation.paginationAvailable)
	public WebElement paginationAvailable;

	@FindBy(xpath = OR_Reservation.paginationRightIcon)
	public WebElement paginationRightIcon;
	
	@FindBy(xpath = OR_Reservation.restrictionAndPolicy)
	public WebElement restrictionAndPolicy;

	@FindBy(xpath = OR_Reservation.RemoveGuestProfile)
	public WebElement removeGuestProfile;
	
	@FindBy(xpath = OR_Reservation.ClickRemovePopupYes)
	public WebElement clickRemovePopupYes;
	
	@FindBy(xpath = OR_Reservation.UnneccesaryLog)
	public WebElement unneccesaryLog;
	
	@FindBy(xpath = OR_Reservation.PaymentRequiredBorder)
	public WebElement paymentRequiredBorder;
	
	@FindBy(xpath = OR_Reservation.GetBillingSalutation)
	public WebElement getBillingSalutation;
	
	@FindBy(xpath = OR_Reservation.GetBillingCountry)
	public WebElement getBillingCountry;
	
	@FindBy(xpath = OR_Reservation.GetBillingState)
	public WebElement getBillingState;
	
	@FindBy(xpath = OR.GetPostalCode)
	public WebElement getPostalCode;
	
	@FindBy(xpath = OR_Reservation.GetHistoryAccoutResTabName)
	public WebElement getHistoryAccoutResTabName;
	
	@FindBy(xpath = OR_Reservation.CheckInClosePopupButton)
	public WebElement CheckInClosePopupButton;


	@FindBy(xpath = OR.noRateCombinationMessage)
	public WebElement noRateCombinationMessage;
	
	@FindBy(xpath = OR.closeStayInfo)
	public WebElement closeStayInfo;
	
	@FindBy(xpath = OR.closeMrbStayInfo)
	public WebElement closeMrbStayInfo;
	
	@FindBy(xpath = OR.noRoomClassAvailable)
	public WebElement noRoomClassAvailable;
	
	@FindBy(xpath = OR_Reservation.calendarIcon)
	public WebElement calendarIcon;
	
	@FindBy(xpath = OR_Reservation.calendarHeading)
	public WebElement calendarHeading;

	@FindBy(xpath = OR_Reservation.calendarPreviousIcon)
	public WebElement calendarPreviousIcon;
	
	@FindBy(xpath = OR_Reservation.calendarNextIcon)
	public WebElement calendarNextIcon;

	@FindBy(xpath = OR_Reservation.noRecordFound)
	public WebElement NoRecordFound;

	@FindBy(xpath = OR_Reservation.NoShowProcess)
	public WebElement NoShowProcess;

	@FindBy(xpath = OR_Reservation.goTopIcon)
	public WebElement goTopIcon;

	@FindBy(xpath = OR_Reservation.goTopIcon2)
	public WebElement goTopIcon2;

	@FindBy(xpath = OR_Reservation.innroadLogo)
	public WebElement innroadLogo;
	
	@FindBy(xpath = OR_Reservation.ngExclamationMark)
	public WebElement ngExclamationMark;

	@FindBy(xpath = OR_Reservation.ngExclamationMarkB)
	public WebElement ngExclamationMarkB;

	@FindBy(xpath = OR_Reservation.noShow_CloseButton)
	public WebElement noShow_CloseButton;
	
	@FindBy(xpath = OR_Reservation.cancel_CloseButton)
	public WebElement cancel_CloseButton;
	
	@FindBy(xpath = OR_Reservation.checkout_CloseButton)
	public WebElement checkout_CloseButton;
	
	@FindBy(xpath = OR_Reservation.checkIn_CloseButton)
	public WebElement checkIn_CloseButton;
	
	@FindBy(xpath = OR_Reservation.noShowCloseButtonWithoutPayment)
	public WebElement noShowCloseButtonWithoutPayment;
	
	@FindBy(xpath = OR_Reservation.ClickVoidButton)
	public WebElement clickVoidButton;
	
	@FindBy(xpath = OR_Reservation.EnterNote)
	public WebElement EnterNote;
	
	@FindBy(xpath = OR_Reservation.ClickVoidButtonOnNotePopup)
	public WebElement clickVoidButtonOnNotePopup;
	
	@FindBy(xpath = OR_Reservation.ClickSaveButtonUnderFolioTab)
	public WebElement clickSaveButtonUnderFolioTab;
	
	@FindBy(xpath = OR_Reservation.CP_Reservation_ExtCnf)
	public WebElement CP_Reservation_ExtCnf;


	@FindBy(xpath = OR_Reservation.ClickProcessButtonOnBulkActions)
	public WebElement clickProcessButtonOnBulkActions;

	@FindBy(xpath = OR_Reservation.roomSearchError)
	public WebElement roomSearchError;
	
	@FindBy(xpath = OR_Reservation.bookQuote)
	public WebElement bookQuote;

	@FindBy(xpath = OR_Reservation.confirmBooking)
	public WebElement confirmBooking;

	@FindBy(xpath = OR_Reservation.closeBookingSuccessfullPopup)
	public WebElement closeBookingSuccessfullPopup;


	@FindBy(xpath = OR_Reservation.transactionDeclinedErrorMessage)
	public WebElement transactionDeclinedErrorMessage;
	
	@FindBy(xpath = OR_Reservation.closeTakePaymentPopup)
	public WebElement closeTakePaymentPopup;
	
	@FindBy(xpath = OR_Reservation.CP_NewReservation_PencilIcon_PaymentMethod)
	public WebElement CP_NewReservation_PencilIcon_PaymentMethod;

	@FindBy(xpath = OR_Reservation.CP_NewReservation_Save_PaymentMethod)
	public WebElement CP_NewReservation_Save_PaymentMethod;

	@FindBy(xpath = OR_Reservation.checkOutPaymentPayButton)
	public WebElement checkOutPaymentPayButton;

	@FindBy(xpath = OR_Reservation.CheckoutSuccessfulClose)
	public WebElement checkoutSuccessfulClose;

	@FindBy(xpath = OR_Reservation.ProceedToPaymentButton2)
	public WebElement ProceedToPaymentButton2;

	@FindBy(xpath = OR_Reservation.noShowConfirmPopupConfirmButton)
	public WebElement noShowConfirmPopupConfirmButton;

	@FindBy(xpath = OR_Reservation.noShowSuccessPopupClose2)
	public WebElement noShowSuccessPopupClose2;

	@FindBy(xpath = OR_Reservation.stayInfoChangeDetails2)
	public WebElement stayInfoChangeDetails2;

	@FindBy(xpath = OR_Reservation.stayInfoChangeDetails3)
	public WebElement stayInfoChangeDetails3;
	
	@FindBy(xpath = OR.cancelSecondaryRoom)
	public WebElement cancelSecondaryRoom;
	
	@FindBy(xpath = OR_Reservation.selectedPropertys)
	public WebElement selectedPropertys;
	
	@FindBy(xpath = OR_Reservation.selectedPropertysAfterGS)
	public WebElement selectedPropertysAfterGS;

	@FindBy(xpath = OR_Reservation.ClickContactSalutation)
	public WebElement clickContactSalutation;
	
	@FindBy(xpath = OR_Reservation.EnterPhoneCode)
	public WebElement enterPhoneCode;
	
	
	@FindBy(xpath = OR_Reservation.ClickYesVrboPopup)
	public WebElement clickYesVrboPopup;
	
	@FindBy(xpath = OR_Reservation.GetFee)
	public WebElement getFee;

	@FindBy(xpath = OR_Reservation.payButton)
	public WebElement payButton;
	
	@FindBy(xpath = OR_Reservation.selectedPropertyss)
	public WebElement selectedPropertyss;
	
	@FindBy(xpath = OR_Reservation.CloseCancellationSuccessfull)
	public WebElement closeCancellationSuccessfull;
	
	@FindBy(xpath = OR_Reservation.EnterExternalConfirmation)
	public WebElement enterExternalConfirmation;
	
	@FindBy(xpath = OR_Reservation.GetContactTitle)
	public WebElement getContactTitle;
	
	@FindBy(xpath = OR_Reservation.GetTravelAccount)
	public WebElement getTravelAccount;

	@FindBy(xpath = OR_Reservation.RollBacktPopupYesButton2)
	public WebElement RollBacktPopupYesButton2;
	
	@FindBy(xpath = OR_Reservation.rollBacktPopupYesButtonForMRB)
	public WebElement rollBacktPopupYesButtonForMRB;
	
	@FindBy(xpath = OR_Reservation.BulkCancelReason)
	public WebElement bulkCancelReason;

	@FindBy(xpath = OR_Reservation.CloseBulNoShowPopup)
	public WebElement closeBulNoShowPopup;

	@FindBy(xpath = OR_Reservation.longStayCheckBox)
	public WebElement longStayCheckBox;
	
	@FindBy(xpath = OR_Reservation.GetPaymentMethodName)
	public WebElement getPaymentMethodName;
	
	@FindBy(xpath = OR_Reservation.ClickProcessButtonOnPayMentPopup)
	public WebElement clickProcessButtonOnPayMentPopup;
	
	@FindBy(xpath = OR_Reservation.AddNotesWhileCancelPayment)
	public WebElement addNotesWhileCancelPayment;
	
	@FindBy(xpath = OR_Reservation.ClickContinueButton)
	public WebElement clickContinueButton;
	
	
	@FindBy(xpath = OR_Reservation.PaymentPopup)
	public WebElement paymentPopup;
	
	@FindBy(xpath = OR_Reservation.EnterlineItemDate)
	public WebElement enterlineItemDate;

	@FindBy(xpath = OR_Reservation.getRateName)
	public WebElement getRateName;
	
	@FindBy(xpath = OR_Reservation.DATE_RATE_DETAIL_RES_V2)
	public List<WebElement> DATE_RATE_DETAIL_RES_V2;

	@FindBy(xpath = OR_Reservation.RATEPLAN_NAME_RATE_DETAIL_RES_V2)
	public List<WebElement> RATEPLAN_NAME_RATE_DETAIL_RES_V2;

	@FindBy(xpath = OR_Reservation.RATEVALUE_RATE_DETAIL_RES_V2)
	public List<WebElement> RATEVALUE_RATE_DETAIL_RES_V2;
	
	@FindBy(xpath = OR_Reservation.rules)
	public WebElement rules;

	@FindBy(xpath = OR_Reservation.ruleName)
	public WebElement ruleName;

	@FindBy(xpath = OR_Reservation.rulesNoButton)
	public WebElement rulesNoButton;
	
	@FindBy(xpath = OR_Reservation.areYouSureMsg)
	public WebElement areYouSureMsg;
	
	@FindBy(xpath = OR_Reservation.splitResError)
	public WebElement splitResError;
	
	@FindBy(xpath = OR_Reservation.removeMultiRoomSearchIcon)
	public List<WebElement> removeMultiRoomSearchIcon;
	
	@FindBy(xpath = OR_Reservation.updateBy)
	public WebElement updateBy;
	
	@FindBy(xpath = OR_Reservation.getNotesUpdatedOn)
	public WebElement getNotesUpdatedOn;
	
	@FindBy(xpath = OR_Reservation.assignRoomNumber)
	public WebElement assignRoomNumber;

	@FindBy(xpath = OR_Reservation.CP_NewReservation_ACCOUNT)
	public WebElement CP_NewReservation_ACCOUNT;

	@FindBy(xpath = OR_Reservation.EditGuestInfoIcon)
	public WebElement EditGuestInfoIcon;

	@FindBy(xpath = OR_Reservation.CP_NewReservation_SOURCE)
	public WebElement CP_NewReservation_SOURCE;
	
	@FindBy(xpath = OR_Reservation.CP_NewReservation_Status)
	public WebElement CP_NewReservation_Status;

	
	@FindBy(xpath = OR_Reservation.CPCheckoutClose)
	public WebElement CPCheckoutClose;

	@FindBy(xpath = OR_Reservation.getRuleName)
	public WebElement getRuleName;
	
	@FindBy(xpath = OR_Reservation.OkButton)
	public WebElement OkButton;

	@FindBy(xpath = OR_Reservation.getpaymentMethodsList)
	public List<WebElement> getpaymentMethodsList;
	
	@FindBy(xpath = OR_Reservation.takePaymentButton2)
	public WebElement takePaymentButton2;
	
	@FindBy(xpath = OR_Reservation.reservationNumberInAdvanceSearch)
	public List<WebElement> reservationNumberInAdvanceSearch;
	
	@FindBy(xpath = OR.reset_Button)
	public WebElement reset_Button;
	
	@FindBy(xpath = OR.check_Box)
	public WebElement check_Box;
	
	@FindBy(xpath = OR.totalAmountOnStayInfoPage)
	public WebElement totalAmountOnStayInfoPage;
	
	@FindBy(xpath = OR_Reservation.paymentType)
	public WebElement paymentType;
	
	@FindBy(xpath = OR_Reservation.expiryDate)
	public WebElement expiryDate;
	
	@FindBy(xpath = OR_Reservation.setExemptAnywayButton)
	public WebElement setExemptAnywayButton;

	@FindBy(xpath = OR_Reservation.ROOMLOCK)
	public WebElement RoomLock;
	
	@FindBy(xpath = OR_Reservation.ROOMLOCKMSG)
	public WebElement ROOMLOCKMSG;
	
	@FindBy(xpath = OR_Reservation.StayInfo_EditBtnDisable)
	public WebElement StayInfo_EditBtnDisable;
	
	@FindBy(xpath = OR_Reservation.PaymentLineItem)
	public WebElement PaymentLineItem;

	@FindBy(xpath = OR_Reservation.ROOMUNLOCK)
	public WebElement RoomUnLock;
	
	@FindBy(xpath = OR_Reservation.closeGuestProfile)
	public WebElement closeGuestProfile;

	@FindBy(xpath = OR_Reservation.GetTripChargesInTripSummaryBeforeCreateReservation)
	public WebElement GetTripChargesInTripSummaryBeforeCreateReservation;

	@FindBy(xpath = OR.TakePaymentFromReservationDetailButton)
	public WebElement TakePaymentFromReservationDetailButton;


	@FindBy(xpath = OR_Reservation.reservationV2Loading)
	public WebElement reservationV2Loading;
	@FindBy(xpath = OR_Reservation.marketingInfoEdit)
	public WebElement marketingInfoEdit;
	@FindBy(xpath = OR_Reservation.marketingInfoSave)
	public WebElement marketingInfoSave;
	

	@FindBy(xpath = OR_Reservation.takePaymentButton)
	public WebElement takePaymentButton;
	
	@FindBy(xpath = OR_Reservation.takepaymentPayButton)
	public WebElement takepaymentPayButton;

	@FindBy(xpath = OR_Reservation.EnterCheckinDate1)
	public WebElement EnterCheckinDate1;

	@FindBy(xpath = OR_Reservation.EnterCheckout1)
	public WebElement EnterCheckout1;
	
	@FindBy(xpath = OR_Reservation.CP_NewReservation_Adults1)
	public WebElement CP_NewReservation_Adults1;

	@FindBy(xpath = OR_Reservation.CP_NewReservation_Children1)
	public WebElement CP_NewReservation_Children1;

	@FindBy(xpath = OR_Reservation.CP_NewReservation_Rateplan1)
	public WebElement CP_NewReservation_Rateplan1;
	
	@FindBy(xpath = OR_Reservation.CP_NewReservation_FindRooms1)
	public WebElement CP_NewReservation_FindRooms1;
	
	@FindBy(xpath = OR_Reservation.COPY_OF_SPLITRESERVATION)
	public WebElement COPY_OF_SPLITRESERVATION;
	

	@FindBy(xpath = OR_Reservation.CP_NewReservation_Referral1)
	public WebElement CP_NewReservation_Referral1;
	
	@FindBy(xpath = OR_Reservation.PromoCodeInStayInfo)
	public WebElement PromoCodeInStayInfo;
	

	@FindBy(xpath = OR_Reservation.COPY_CP_NewReservation_TaskNotCopy1)
	public WebElement COPY_CP_NewReservation_TaskNotCopy1;

	@FindBy(xpath = OR_Reservation.EDITReservation)
	public WebElement EDITReservation;
	
	@FindBy(xpath = OR_Reservation.EDITReservation)
	public WebElement CheckOutGuestRegirstrationReportToggle;

	@FindBy(xpath = OR_Reservation.CP_NewReservation_TravelAgent_V2)
	public WebElement CP_NewReservation_TravelAgent_V2;

	@FindBy(xpath = OR_Reservation.CP_NewReservation_Search)
	public WebElement CP_NewReservation_Search;
	
	@FindBy(xpath = OR_Reservation.CP_NewReservation_TravelAgentDelete_V2)
	public WebElement CP_NewReservation_TravelAgentDelete_V2;
	
	@FindBy(xpath = OR_Reservation.EDIT_TASK)
	public WebElement EDIT_TASK;
	

	@FindBy(xpath = OR_Reservation.DELETE_TASK)
