...
public class Elements_Reservation {
    ...
    @FindBy(xpath = OR_Reservation.ReservationCurrentStatusForAll)
    public WebElement ReservationCurrentStatusForAll;
	...
	@FindBy(xpath = OR_Reservation.checkInPrimaryGuest)
	    public WebElement checkInPrimaryGuest;
	 @FindBy(xpath = OR_Reservation.checkInSecondaryGuest)
	    public WebElement checkInSecondaryGuest;
	 @FindBy(xpath = OR_Reservation.CheckOutPrimaryGuest)
	    public WebElement CheckOutPrimaryGuest;
...
//	public WebElement RoomOverBookingPopUp;
	...
	@FindBy(xpath = OR.reservationStatusField)
	public List<WebElement> reservationStatusField;
	 
	@FindBy(xpath = OR_Reservation.RollbackReservationPopupMessage)
	public WebElement RollbackReservationPopupMessage;
	
	@FindBy(xpath = OR_Reservation.RollbackReservationPopupYesButton)
	public WebElement RollbackReservationPopupYesButton;
 
	@FindBy(xpath = OR_Reservation.CheckOutSecondaryGuest)
    public WebElement CheckOutSecondaryGuest;
	
	@FindBy(xpath = OR_Reservation.confirmButton)
	public WebElement confirmButton;
	
	@FindBy(xpath = OR_Reservation.swipeButtonInCheckInPopup)
	public WebElement swipeButtonInCheckInPopup;
	
	@FindBy(xpath = OR_Reservation.cardNumberInCheckInPopup)
	public WebElement cardNumberInCheckInPopup;
	
	@FindBy(xpath = OR_Reservation.authorizeInCheckInPopup)
	public WebElement authorizeInCheckInPopup;
	
	@FindBy(xpath = OR_Reservation.authorizeInCheckInPopup2)
	public WebElement authorizeInCheckInPopup2;
	...
	@FindBy(xpath = OR_Reservation.ProceedToNoShowPaymentButton)
	public WebElement ProceedToNoShowPaymentButton;
