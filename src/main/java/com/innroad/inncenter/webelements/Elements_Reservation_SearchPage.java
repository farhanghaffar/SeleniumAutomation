...
public class Elements_Reservation_SearchPage {
	...
	@FindBy(xpath = OR.enterCancellationReason1)
	...
	// Bulk No Show
	@FindBy(xpath = OR.selectNoShow_U)
	public WebElement selectNoShow_U;
	...
	@FindBy(xpath = OR_Reservation.clientDropDown)
	public WebElement clientDropDown;

	@FindBy(xpath = OR_Reservation.statusDropDown)
	public WebElement statusDropDown;

	@FindBy(xpath = OR_Reservation.bookFrom)
	public WebElement bookFrom;

	@FindBy(xpath = OR_Reservation.bookTo)
	public WebElement bookTo;

	@FindBy(xpath = OR_Reservation.ratePlanDropDown)
	public WebElement ratePlanDropDown;

	@FindBy(xpath = OR_Reservation.roomClassDropDown)
	public WebElement roomClassDropDown;

	@FindBy(xpath = OR_Reservation.roomNumberDropDown)
	public WebElement roomNumberDropDown;

	@FindBy(xpath = OR_Reservation.taxExamptDropDown)
	public WebElement taxExamptDropDown;

	@FindBy(xpath = OR_Reservation.sourceDropDown)
	public WebElement sourceDropDown;

	@FindBy(xpath = OR_Reservation.marketingSegmentDropDown)
	public WebElement marketingSegmentDropDown;

	@FindBy(xpath = OR_Reservation.referralDropDown)
	public WebElement referralDropDown;

	@FindBy(xpath = OR_Reservation.promoCode)
	public WebElement promoCode;

	@FindBy(xpath = OR_Reservation.cardNumber)
	public WebElement cardNumber;

	@FindBy(xpath = OR_Reservation.accountName)
	public WebElement accountName;

	@FindBy(xpath = OR.BulkPopupguestName)
	public WebElement BulkPopupGuestName_U;

	@FindBy(xpath = OR.BulkPopupAmonut)
	public WebElement BulkPopupAmount_U;

	@FindBy(xpath = OR.BulkPopupguestRservationNumber)
	public WebElement BulkPopupReservationNumber_U;

	@FindBy(xpath = OR.BulkPopupClose)
	public WebElement CancelReservationStatus;

	@FindBy(xpath = OR_Reservation.ADVANCE_SEARCH_MARKET_SEGMENT)
	public WebElement ADVANCE_SEARCH_MARKET_SEGMENT;

	@FindBy(xpath = OR_Reservation.ADVANCE_SEARCH_SOURCE)
	public WebElement ADVANCE_SEARCH_SOURCE;

	@FindBy(xpath = OR_Reservation.ADVANCE_SEARCH_REFERRAL)
	public WebElement ADVANCE_SEARCH_REFERRAL;

	@FindBy(xpath = OR_Reservation.ADVANCE_SEARCH_STATUS)
	public WebElement ADVANCE_SEARCH_STATUS;

	@FindBy(xpath = OR_Reservation.ADVANCE_SEARCH_RESERVATION)
	public WebElement ADVANCE_SEARCH_RESERVATION;

	@FindBy(xpath = OR_Reservation.ADVANCE_SEARCH_RATE_PLAN)
	public WebElement ADVANCE_SEARCH_RATE_PLAN;

	@FindBy(xpath = OR_Reservation.ADVANCE_SEARCH_PROMO_CODE)
	public WebElement ADVANCE_SEARCH_PROMO_CODE;

	@FindBy(xpath = OR_Reservation.ADVANCE_SEARCH_ROOM_CLASS)
	public WebElement ADVANCE_SEARCH_ROOM_CLASS;

	@FindBy(xpath = OR_Reservation.ADVANCE_SEARCH_ROOM_NUMBER)
	public WebElement ADVANCE_SEARCH_ROOM_NUMBER;

	@FindBy(xpath = OR_Reservation.ADVANCE_SEARCH_CREDIT_CARD)
	public WebElement ADVANCE_SEARCH_CREDIT_CARD;

	@FindBy(xpath = OR_Reservation.ADVANCE_SEARCH_GUEST_NAME)
	public WebElement ADVANCE_SEARCH_GUEST_NAME;

	@FindBy(xpath = OR_Reservation.ADVANCE_SEARCH_EMAIL)
	public WebElement ADVANCE_SEARCH_EMAIL;

	@FindBy(xpath = OR_Reservation.ADVANCE_SEARCH_PHONE)
	public WebElement ADVANCE_SEARCH_PHONE;

	@FindBy(xpath = OR_Reservation.ADVANCE_SEARCH_COUNTRY)
	public WebElement ADVANCE_SEARCH_COUNTRY;

	@FindBy(xpath = OR_Reservation.ADVANCE_SEARCH_STATE)
	public WebElement ADVANCE_SEARCH_STATE;
}
