...
public class OR_Admin {
	...
	public static final String selectWeekDay = "MainContent_drpStartDayOfWeek";
	...
	public static final String checkboxSelectAll = "(//*[contains(@data-bind,'selectAllWithIndeterminateCol')])[1]";
	...
	public static final String checkboxEntityAll = "(//input[contains(@data-bind,'selectAllWithIndeterminateCol')])[1]";
	...
	public static final String roleName = "//input[@placeholder='Role Name']";
	public static final String roleDescription = "//input[@placeholder = 'Role Description']";
	public static final String roleClear = "//button[contains(@data-bind,'clearText')]";
	public static final String roleDeleteButton = "//button[.='Delete']";
	public static final String roleStatusDropDownBox = "//select[contains(@data-bind ,'StatusName')]";
	public static final String roleHelpIcon = "//div[(@class ='tools')]/i";
    ...
    public static final String saveClientDetails = "//input[@value='Save']";
    public static final String ClickPhoneMask = "//input[@name='ctl00$MainContent$chkAutoMaskPhoneNumber']";
	public static final String UserTab = "ucNavSecondary_rptrNavMain_lbtnNavMainItem_1";
	public static final String SearchButton = "//button[text()='Search']";
	
	public static final String roleSpinerLoading = "(//div[(@Class='modules_loading')])[2]";
