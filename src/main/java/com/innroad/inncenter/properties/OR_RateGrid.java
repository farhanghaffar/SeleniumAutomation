...
public class OR_RateGrid{
	...
	public static final String ratePlanNamesExpanIcon="//span[contains(@class,'ir-plus pr-5')]";
	public static final String ratePlanNamesCollapseIcon="//span[contains(@class,'ir-minus pr-5')]";
	...
	public static final String ratePlanDesc="//div[@class='rate-plan-description']";
	...
	public static final String blankBestAvailableRates="//div[contains(@class,'RegularRate')and contains(text(),'--')]/following-sibling::div[@class='RuleIndication']";
	public static final String OverRideBestAvailableRates="//div[contains(@class,'has-changes')]";
	public static final String rateCrossIcon="//span[@class='ir-crossMark sm danger']";
	public static final String differentSource="//div[@class='legend-item' and contains(text(),'Sources have different prices')]";
	public static final String squarBox="//div[contains(@id,'tooltip')]";
	public static final String availabilityBoxColor="//span[contains(text(),'Availability')]/following-sibling::div";
	public static final String ratePlanSavedMessage="//div[contains(text(),'Rate Plan saved successfully')]";
	public static final String availibilityLabel="//div[contains(@class,'availability-row')]";
	public static final String ClickOnRightArrowOfDate = "(//span[@class='right-arrow'])[1]";
	public static final String defaltRatePlan = "//button[@role='switch']";

	public static final String REMOVE_OVERRIDE_BUTTON = "//button[contains(@class,'Override')]//b[text()='Remove Override']";
