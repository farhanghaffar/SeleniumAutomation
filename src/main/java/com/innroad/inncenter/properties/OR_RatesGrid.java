...
public class OR_RatesGrid {
	...
	public static final String roomClassLevelRatePerNight = "//label[text()='Room Rate']//input[@class='rulesPopupControls']";
	public static final String roomClassLevelExtraAdult = "//label[text()='Extra Ad']//input[@class='rulesPopupControls']";
	public static final String roomClassLevelExtraChild = "//label[text()='Extra Ch']//input[@class='rulesPopupControls']";
	public static final String roomClassLevelRateSaveButton = "//span[@class='ir-checkMark sm success']/..";
	
	public static final String conditionsDescription="//div[@class='rate-plan-description']/following-sibling::div";
	public static final String rateSuccessMsg = "//div[@class='Toastify__toast-body' and text()='Rate saved successfully']";
	public static final String rateExAdExChPopup="//div[@class='popover-inner']";
	public static final String ruleSuccessMsgCloseIcon = "//div[@class='Toastify__toast-container Toastify__toast-container--top-right']";
	public static final String ruleSuccessMsg = "//div[@class='Toastify__toast-body']";

	public static final String roomClassLevelRateCloseButton = "//span[@class='ir-crossMark sm danger']/..";
	public static final String UPDATE_RATE_NEWRATE_NIGHTLYRATES = "//input[@name='newRate']";
	public static final String UPDATE_RATE_NEWRATE_ADDITIONALADULTS = "//input[@name='additionalAdult']";
	public static final String UPDATE_RATE_NEWRATE_ADDITIONALCHILDS = "//input[@name='additionalChild']";
	 public static final String bulkUpdateEnterNewRateRadioBtn = "//div[text()='Enter new rate']/../..//input[@name='updatePlanOption']";
	 ...
	 public static final String CALENDAR_TAB = "//div[text()='Calendar']";
	    ...
	    public static final String GetBaseFromSourcePopup = "//input[@name='rateVal']";
	    public static final String GetAdultFromSourcePopup = "//input[@name='extraAdult']";
	    public static final String GetChildFromSourcePopup = "//input[@name='extraChild']";
	    public static final String assignPoliciesByRoomClass="(//span[contains(text(),'Assign Policies by room class')]/..//button)[1]";
