...
public class OR_Products {
	...
	public static final String ADD_PRODUCT_CATEGORY = "(//div[@class='ant-select-selector'])[1]";
	...
	public static final String ADD_PRODUCT_COST_PER_ONE = "(//div[@class='ant-select-selector'])[2]";
	public static final String ADD_PRODUCT_COST_PER_TWO = "(//div[@class='ant-select-selector'])[3]//span";
	...
	public static final String POP_UP_ADD_PRODUCT_BUTTON = "//button[@class='ant-btn ant-btn-success btn wide font-N mb-20 inrd-button']";
	...
	//Bundles
	public static final String BUNDLES_TAB="//div[text()='Bundles']";
	public static final String CREATE_BUNDLE="//button[text()='Create bundle']";
	public static final String BUNDLE_DISPLAY_NAME="//span[@class='inrd-input line']//input";
	public static final String SELL_ON_NBE_CHECKBOX="//span[text()='Sell on booking engine?']";
	public static final String ASSOCIATE_ROOMCLASS="//span[@class='ant-select-selection-placeholder']/../..";
	public static final String BUNDLE_DESCRIPTION="//LABEL[@class='inrd-textarea-label']/..//textarea";
	public static final String PRODUCTS_PRICING="//a[text()='Products & Pricing']";
	public static final String SAVE_BUTTON="//button[contains(@class,'ant-btn-success')]";
	public static final String BUNDLE_TOASTER_MSG="//div[@class='Toastify__toast-body']";
}