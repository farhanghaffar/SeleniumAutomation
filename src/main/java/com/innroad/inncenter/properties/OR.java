...
public class OR {
	...
	public static final String getDefaultProperty = "//div[@class='property-selector']//span[1]";
	...
	public static final String RoomClassPagesfixed = "//ul[contains(@class,'pagination')]//li//a[not(contains(@class,'nt-pagination-item-link'))]";
	...
	public static final String searchButton = "(//button[contains(@data-bind,'GoAdvanced')])[1]";
	...
	public static final String Tape_Chart_1 = "//a[@data-id='#tapeChart']";
	...
	public static final String Guest_HistoryIcons ="(//span[.='Guest History'])[2]";
	public static final String Guest_History = "//span[.='Guest History']";
	public static final String Guest_History1 = "//li[@class='guest-history open']";
	public static final String Guest_HistoryIcon = "//a[@data-id='#guestHistory']";
	...
	public static final String Accounts_NavIcons = "//a[@data-id='fncMenuAccounts']";
	...
	public static final String Guest_Services_4 = "//a[.='Guest Services']";
	public static final String Guest_Services_5 = "(//span[.='Guest Services'])[2]";
	public static final String Guest_Services_6 = "(//a[@href='/GuestServices'])[2]";
	public static final String Loading = "//div[contains(text(),'loading..')]";
	...
	public static final String Setup2 = "//*[@data-id='fncMenuSetup']";
	...
	public static final String inventoryToSetup = "//li[@id='head_setup']//a";

	public static final String setupIcons = "//a[@href='/Menu.aspx?tab=fncMenuSetup']";
	public static final String setupIconsAfterRateGrid = "//a[@href='/menu.aspx?tab=fncMenuSetup']";
	public static final String setupIconsAfterRoomMaintenance = "(//a[@href='Menu.aspx?tab=fncMenuSetup'])[2]";

	public static final String Setup_Grid = "//*[@id='tdTitle']/font";
	public static final String Propeties = "//a[.='Properties']";
	public static final String Propety_Grid = "//*[@id='tdTitle']/font[text()='Properties']";
	...
	public static final String Taxes = "(//a[.='Taxes'])[1]|//*[@id='ucNavSecondary_rptrNavMain_lbtnNavMainItem_2']";
	public static final String Taxes1 = "(//span[.='Taxes'])[2]|//*[@id='MainContent_rptrMenu_lbtnMenuItem_2']";
	public static final String Taxes_Grid = "//*[@id='tdTitle']/font";
//	public static final String Ledger_Accounts = "//a[text()='Ledger Accounts']";
	...
	public static final String List_Management = "//ul[@class='sec_nav']//li/a[text()='List Management']";
	...
	public static final String List_Management_From_Properties_Tab = "//ul[@class='sec_nav']//li/a[text()='List Management']";
	public static final String Admin = "//*[.='Admin']";
	public static final String AdminIcon = "(//i[contains(@class,'nav-admin')])[2]";

	public static final String Client_info = "(//a[.='Client Info'])[1]";
	public static final String Client_info1 = "(//span[.='Client Info'])[2]";
	public static final String Client_info_grid = "//*[@id='tdTitle']/font";
	public static final String Users = "(//a[.='Users'])[1]";
	...
	public static final String Night_audit2 = "(//span[.='Night Audit'])[2]";
	public static final String Night_audit3 = "//a[.='Night Audit']";
	public static final String GDPR = "(//span[.='GDPR'])[2]";
	...
	public static final String Reports = "(//span[text()='Reports'])[2]";
	public static final String Reports1 = "(//a[text()='Reports'])[2]";
	...
	public static final String Reservation_InsideTipIcon = "//span[@class='notificationIcon']";
	public static final String Reservation_InsideTipDescription = "//div[@class='notificationDescription']";
	public static final String Reservation_InsideTipClose = "//span[@class='notificationClose']";
	public static final String Reservation_InsideTipHyperLink = "//a[contains(@data-bind,'NotificationMessageLinkLabel')]";
	...
	public static final String Reservation_BackwardfromPolicy = "(//span[contains(text(),'Reservations')])[3]";
	...
	public static final String AllNight = "MainContent_rdAllNight";
	public static final String AfterlimitMeet = "MainContent_rdAfterLimit";
	...
	public static final String Account_save = "//button[contains(@data-bind,'AccountSave') and text()='Save']";
	...
	public static final String Verify_Notes_Popup = "(//div[@id='NotesDetailPopup']//h4[.='Note Details'])[2]";// div[@class='modal-scrollable']//div[@id='NotesDetailPopup']//h4[.='Note
																												// Details']";
	public static final String Acc_Note_Enter_sub = "(//h4[text()='Note Details']/../..//input[contains(@data-bind,'Subject') and @placeholder='Subject'])[2]";// div[@class='modal-scrollable']//div[@id='NotesDetailPopup']//input[contains(@data-bind,'value:
																																								// Subject')]";
	public static final String Acc_Note_Enter_Details = "(//div[@id='NotesDetailPopup']//textarea[contains(@data-bind,'value: NoteDetails')])[2]";// div[@class='modal-scrollable']//div[@id='NotesDetailPopup']//textarea[contains(@data-bind,'value:
																																					// NoteDetails')]";
	public static final String Acc_Note_Select_Note_Type = "(//div[@id='NotesDetailPopup']//select[contains(@data-bind,'options: $parent.NoteTypes')])[2]";// div[@class='modal-scrollable']//div[@id='NotesDetailPopup']//select[contains(@data-bind,'options:
																																							// $parent.NoteTypes')]";
	...
	public static final String Acc_Note_Save = "(//div[@id='NotesDetailPopup']//button[.='Save'])[2]";// div[@class='modal-scrollable']//div[@id='NotesDetailPopup']//button[.='Save']";
	...
	public static final String BasicGuestName = "//input[contains(@data-bind,'BasicGuestName')]";
	...
	public static final String Account_BeginningBalance = "//label[text()='Beginning Balance: ']//parent::div/span[@class='pamt']/span";
	public static final String Account_Payments = "//label[text()='Payments: ']//parent::div/span[@class='pamt']/span";
	public static final String Account_NewCharges = "//label[text()='New Charges: ']//parent::div/span[@class='pamt']/span";
	public static final String Account_Taxes = "//label[text()='Taxes']//parent::div/span[contains(@class,'pamt')]/span";
	public static final String Account_AdvanceDepositBalance = "//span[text()='Advance Deposit Balance']//parent::a//following-sibling::span[contains(@class,'pamt')]/span";
	...
	//public static final String Void = "//button[@class='btn blue' and text()='Void']";
	public static final String Void = "//button[contains(@data-bind,'fnVoidFolioItems')]";
	...
	// public static final String Check_Reservation = "//tbody[@data-bind='foreach:
	// ReservationList']//div[@class='checker']";
	public static final String Check_Reservation = "(//div[contains(@data-bind,'SelectAllReservations ')])[1]/input";
	...
	public static final String advanced = "(//button[text()='Advanced'])[2]";
	...
	public static final String enterCancellationReason1 = "(//textarea[@placeholder='Cancellation reason'])[last()]";
	...
	public static final String processButton = "//h4[contains(@data-bind,'BulkActionTitle')]/parent::*/..//button[text()='Process']";
	public static final String bulkCancellationMessage = "//h4[.='Bulk Cancel Completed']";
	public static final String VoidRoomChargesxpath = "(//input[@data-bind = 'enable: BulkVoidChargesEnable() === 1, checked: BulkVoidCharges'])";
    public static final String PostCancellationFee = "(//input[@data-bind = 'enable: (BulkVoidCharges() && BulkPostFeesEnable() === 1), checked: BulkPostFees'])";
	...
	public static final String BulkPopupguestName = "(//span[@ data-bind = 'attr: { title: GuestName }, text: GuestName'])[2]";
	public static final String BulkPopupAmonut = "(//span[@ data-bind = 'attr: { value: Amount }, text: Amount'])[2]";
	public static final String BulkPopupguestRservationNumber = "(//span[@ data-bind = 'text: ConfirmationNumber'])[3]";
	public static final String basicSearchcancelledReservation = "";
	public static final String CancelReservationStatus = "//span[@ data-bind= 'text: StatusName.replace(' ', '-')']";
	...
	public static final String selectNoShow_U = "(//span[.='No Show'])[3]";
	...
	// public static final String Verify_Payment_Details_poup = "//span[.='Payment
	// Details']";
	...
	public static final String selectCategory = "//td//select[contains(@data-bind,'options: LedgerAccountItems')]";
	public static final String enterAmount = "//td[@class='lineitem-amount']//input[contains(@data-bind,'value: Amount')]";
	public static final String enterDescription = "//input[contains(@data-bind,'value: LedgerAccountDescription')]";
	...
	//public static final String Policy_Save = ".//*[@id='bpjscontainer_22']//button[text()='Save']|//button[text()='Save']";


/*
	public static final String Policy_Save = ".//*[@id='bpjscontainer_22']//button[text()='Save']";
*/
	public static final String Policy_Save_2 = "//button[text()='Save']";
	public static final String Policy_Save = "//button[text()='Save']";
	public static final String Policy_Close_Btn = "//*[@id='bpjscontainer_17']//li[contains(@class,'new-policy')]//i";
	public static final String Policy_Close_Btn2 = "(//*[@id='bpjscontainer_17']//li[contains(@class,'new-policy')]//i)[2]";
	...
	public static final String Click_Tapechart_RatePlan = "//div[@id='divReservationTapeChart']//button[@title='BookingEngine']";
	public static final String ReservationUpdate_Popup = "//div[@id='ReservationUpdate']";
	public static final String ReservationUpdate_PopupRoomClass = "//div[contains(@data-bind,'RoomClassChanged') and @class='datetext']";
	public static final String ReservationUpdate_PopupOkButton = "//div[@id='ReservationUpdate']//div[contains(@class,'modal-footer')]//button[text()='OK']";
	...
	public static final String Verify_Reservation_Page = "//div[@id='ReservationSearch']";
	...
	public static final String Click_Quote_Block = ".//*[@id='MainContent_btnQuote']";
	...
	public static final String GeneratedReservationNumber = "//*[@id='roomingListSummary_DIV']//tr[2]//td[1]";
	...
	public static final String VoidRC_Chkbox_In_Popup = "//label[text()='Void Room Charges']/preceding-sibling::input|//span[text()='Void Room Charges']";
	...
	public static final String closeReservation = "(//i[contains(@data-bind,'click: $parent.closeTab')])[5]";
	public static final String guestHistoryAccountNo = "(//span[contains(@data-bind,'text: AccountNoToDisplay')])[1]";
	public static final String enterAccountFName = "(//input[contains(@data-bind,'value: Account.AccountFirstName')])[1]";
	...
	public static final String clickSearchButton = "(//button[contains(@data-bind,'click: GetAccountsList')])[2]";
	public static final String clickSearchButton1 = "(//button[contains(@data-bind,'click: GetAccountsList')])[1]";

	public static final String clickSearchButtons = "//button[contains(@data-bind,'click: GetAccountsList')]";
	public static final String selectGuestHistoryAccount = "(//input[contains(@data-bind,'checked: DeleteAccount')])[1]";
	public static final String enterGAccountLastName = "(//input[contains(@data-bind,'value: Account.AccountLastName')])[1]";
	...
	public static final String roomClassAbbreviation = "//ul[@class='verticalRoomName'][1]//li//a";
	...
	public static final String Click_newRule_Btn = "//button[contains(@data-bind,'click: createNewRule')]";
	...
	public static final String Click_saveButton = "//button[contains(@data-bind,'click: saveRuleDetail')]";
	...
	public static final String DepositOverrideToggle = "(//span[@title = 'Override Deposit Due']//..//..//following-sibling::span[contains(@class,'ir-switchIcon')])[2]";

	// Document Upload
	public static final String DocumentUploadButton = "//button[contains(text(),'UPLOAD')]";
	public static final String DocumentInputFeild = "//input[@data-bind='event:{ change: fileUploaded }, value: uploadedFile']";
	public static final String DocumentProcessedUploadButton = "//h4[contains(text(),'Upload Document')]//..//..//button[contains(text(),'Upload')]";

	// Document Delete
	public static final String DocumentDeleteButton = "//button[contains(text(),'DELETE')]";
	public static final String DocumentProcessedDeleteButton = "//h4[contains(text(),'Delete Document')]//..//..//following-sibling::button[contains(text(),'Confirm')]";

	//Toast
	public static final String ToastHeading = "//div[@class='toast-title']";
	...
	public static final String SelectAllLineitems = "(//input[contains(@data-bind,'click: selectAllLineItems')])[2]";
	...
	public static final String ApplyRoutingButton = "(//button[text()='Apply Routing'])[2]";// (//button[contains(@data-bind,'click:
																						// fnApplyRouting')])[1]";
	...
	public static final String AddButton = "//button[contains(text(),'Add Line Item')]";
	...
	public static final String CommitButton = "//button[contains(text(),'Commit')]|//button[contains(@data-bind,'ReservationDetail.fnCommit')]";
	...
	public static final String PayButton2 = "(//button[text() = 'Pay'])[last()]";
	...
	// public static final String ClickToday =
	// "//table/tfoot/tr[1]/th[@class='today']";
	public static final String ClickToday = "(//div[@class='datepicker-days']//table//following::tfoot//th[text()='Today'])[1]";
	...
	public static final String Click_NewFolio_ = "//i[contains(@data-bind,'CreateNewFolio')]";
	...
	public static final String Account_Folio_FolioOptions = "//a[text()='Folio Options']";
	...
	public static final String CloseNewUserTab = "(//i[contains(@data-bind,'click: $parent.closeTab')])[5]";
	...
	public static final String TaskPopupAdd_CloseButton = "//div[@id='addTaskModal']//button[@class='close closeBtn']";
	public static final String bulkStatusChange_CloseButton = "//div[@id='bulk-status-modal']//button[@class='close closeBtn']/span";
	...
	// Rates Grid ratee popup old version
	public static final String ratePopupFrame = "//iframe[@id='frmWaitHost']";
	public static final String ratePopupBaseAmount = "//input[@name = 'ctl00$MainContent$txtAmount']";
	public static final String ratePopupExtraAdults = "//input[@name = 'ctl00$MainContent$txtMaxAdults']";
	public static final String ratePopupExtraChild = "//input[@name = 'ctl00$MainContent$txtMaxPersons']";
	public static final String ratePopupCancel = "//input[@name='ctl00$MainContent$btnCancel']";
	// Groups
	...
	// public static final String Reservation_ACCNO =
	// "//a[contains(@data-bind,'Accountname')]";
	...
	public static final String Reservation_Menu_FromTax = "//i[@class='nav-sprite nav-reservation nav_icon']";
	...
	public static final String AdvanceSearchClose = "//button[contains(@data-bind,'GoBasicLink')]";
	// Netsale
	...
	public static final String AddLineItemButton = "//button[contains(@data-bind,'fnAddFolioItem')]";
	...
	public static final String paymentSubmitButton = "//a[contains(@data-bind,'IsPaymentFormValid')]";
	public static final String paymentSubmitButton2 = "//span[contains(@data-bind,'text: PaymentProcessButtonText()')]";
	...
	// public static final String TaskLIst_StatusDropDownBoxFilterOption =
	// "//div[@id='bulk-status-modal']//button/span[@class='filter-option
	// pull-left']";
	public static final String TaskLIst_StatusDropDownBoxFilterOption = "//button[@data-toggle='dropdown']";
	...
	//public static final String taskDueOn = "addTaskDateIcon";
	public static final String taskDueOn = "//i[@id='addTaskDateIcon']";
	public static final String taskDueOnDate = "//input[@name='singledate']";
	...
	public static final String ADVANCE_SEARCH_WITH_RESERVATION_NUMBER = "//input[contains(@data-bind,'AdvReservationNumber')]";
	...
	/*public static final String guestAccountFirstName = "(//input[contains(@data-bind,'value: AccountFirstName')])[3]";
	public static final String guestAccountLastName = "(//input[contains(@data-bind,'value: AccountLastName')])[2]";*/
	...
	public static final String cancelButton = "(//span[contains(@data-bind,'UpdatedDate')]/../../div/button[contains(text(),'Cancel')])[2]";
	public static final String cancelButton1 = "(//span[contains(@data-bind,'UpdatedDate')]/../../div/button[contains(text(),'Cancel')])[1]";
	...
	public static final String guestHistoryAccountPage = "//div[contains(text(),'Account Details')]";
	...
	//public static final String NIGHTLY_RATE_PLAN = "//a[normalize-space()='Nightly rate plan']";
	...
	// public static final String SetupFromrateGrid =
	// "//a[@data-id='fncMenuSetup']";
	...
	public static final String roomClassRoomHousekeepingZoneFieldV2 = "//div[@id='rooms[0].housekeepingZoneId']/div/div/div";
	public static final String roomClassRoomTabV2 = "//div[@role='tab' and text()='Rooms']";
	public static final String roomClassRoomPhysicalRoomsTitleV2 = "//h1[contains(@class,'PhysicalRooms')]";

	// public static final String roomClassPublishConfirmedDailogV2 =
	// "//div[@id='rcDialogTitle0']";
	public static final String roomClassPublishConfirmedDailogV2 = "//div[@class='ant-modal-title']";
	public static final String roomClassPublishConfirmedDailogOKButtonV2 = "//button/span[.='OK']/..";

	public static final String roomClassCreatedToaster = "//div[contains(text(),'Successfully Created Room Class')]"; // Successfully
	// Updated
	// Room
	// Class:
	// test33444
	public static final String roomClassUpdatedToaster = "//div[contains(text(),'Successfully Updated Room Class')]"; // Successfully
	// Created
	// Room
	// Class:
	// test33444
	...
	public static final String productBundlesV2="//a[@data-id='fncProductsAndBundlesList']";
	...
	//public static final String setUPV2 = "//*[contains(@href,'Menu.aspx?tab=fncMenuSetup')]";
	public static final String setUPV2 = "//li[@id='head_setup']//a[@href='Menu.aspx?tab=fncMenuSetup'][normalize-space()='Setup']";
	...
	// public static final String roomClassPagination = "//ul[contains(@class,
	// 'RoomClasses_tablePagination')]";
	public static final String roomClassPaginationList = "//ul[contains(@class, 'RoomClasses_tablePagination')]/li";
	public static final String roomClassStatusList = "//label[text()='STATUS']/../following-sibling::div"; // "//span[text()='STATUS:']/..//div/div";
	...
	// public static final String RoomOverBookingPopUp =
	// "//*[@id='RoomOverBookingPopUp']";
	public static final String enterFirstName = "(//input[contains(@data-bind,'value: Account.AccountName')])[1]";
	// Account NO
	public static final String account_No = "//input[@id='MainContent_txtAccountNo']";

	public static final String groupClearStartDate = "//img[@alt='Clear Start date']";

	public static final String accountSaved = "//div[text()='Account Saved']";
	public static final String getAccountOnDetailsPage = "(//input[@placeholder='Account Number'])[2]";
	public static final String clickClearOnGuestHistory = "(//button[text()='Clear'])[4]";
	public static final String accountDetailsLastName = "(//input[@placeholder='Last Name'])[3]";
	public static final String ClickAddNoteButton = "//a[@data-bind='click: addAccountNotes']";
	public static final String NoteSubject = "(//label[text()='Subject:']/following-sibling::div/input[@placeholder='Subject'])[3]";
	public static final String Notedetails = "(//label[text()='Details:']/following-sibling::div/textarea[@placeholder='Details'])[2]";
	public static final String NoteType = "(//label[text()='Notes Type:']/following::div[1]/select[@class='form-control'])[2]";
	public static final String ClickSaveNote = "(//button[@data-bind='click: saveDetail, visible: !isSaving()'])[2]";

	// public static final String InventoryFromRoomClass =
	// "//a[@data-id='fncMenuInventory']";
	// verify Billing
	public static final String GetBillingFirstName = "//div[@data-bind='css: ValidationCss(Account.BillingAddress.FirstName)']/input";
	public static final String GetBillingLastName = "//div[@data-bind='css: ValidationCss(Account.BillingAddress.LastName)']/input";

	public static final String InventoryFromRoomClass = "//a[@data-id='fncMenuInventory']";
	// verify Billing
	// public static final String GetBillingFirstName = "//div[@data-bind='css:
	// ValidationCss(Account.BillingAddress.FirstName)']/input";
	// public static final String GetBillingLastName = "//div[@data-bind='css:
	// ValidationCss(Account.BillingAddress.LastName)']/input";

	public static final String GetBillingEmail = "//div[@data-bind='css: ValidationCss(Account.BillingAddress.Email)']/input";
	public static final String GetBillingPhone = "//input[@data-bind='disable: (Account.UseMailingInfo() || isSaving()), value: Account.BillingAddress.PhoneNumber']";
	public static final String GetBillingCountry = "(//label[text()='Country:'])[3]/following::select[1]";
	public static final String GetBillingState = "//div[@data-bind='with: SetCountryAndStateBilling, css: ValidationCss(Account.BillingAddress.TerritoryId)']/select";
	public static final String GetBillingCity = "//div[@data-bind='css: ValidationCss(Account.BillingAddress.City)']/input";
	public static final String GetBillingPostal = "//div[@data-bind='css: ValidationCss(Account.BillingAddress.PostalCode)']/input";
	public static final String GetBillingAddress1 = "//div[@data-bind='css: ValidationCss(Account.BillingAddress.MailingAddress1)']/input";
	public static final String GetBilligAddress2 = "//input[@data-bind='disable: (Account.UseMailingInfo() || isSaving()), value: Account.BillingAddress.MailingAddress2']";
	public static final String GetBillingAddress3 = "//input[@data-bind='disable: (Account.UseMailingInfo() || isSaving()), value: Account.BillingAddress.MailingAddress3']";
	// ---------
	public static final String ClickCombine = "(//span[text()='Combine']/../input)[1]";
	public static final String ClickCombine1 = "(//span[text()='Combine']/../input)[2]";
	public static final String SearchReservation = "(//input[@data-bind='textInput: BasicConfirmationNumber'])[1]";
	public static final String SearchReservation1 = "(//input[@data-bind='textInput: BasicConfirmationNumber'])[2]";
	public static final String ClickSearch = "(//button[@value='Search' and @id='Button2'])[3]/span[1]";
	public static final String ClickReset = "//button[contains(@data-bind,'$data.Reset')]";
	public static final String RoomCount = "//span[@data-bind='text: Rooms']";
	public static final String ReservationCount = "//span[@data-bind='text: Reservations']";
	public static final String GetUpdatedOn = "//th[contains(text(),'Updated On')]/following::tbody/tr/td/span[@data-bind='text: $root.getContextTime(DateUpdate())']";
	public static final String SelectBullingSalutation = "//select[contains(@data-bind,'disable:(Account.UseMailingInfo() || isSaving()), value:Account.BillingAddress.Salutation')]";
	public static final String SelectSalutation = "(//select[contains(@data-bind,'value: Account.MailingAddress.Salutation, enable: !isSaving()')])[1]";
	public static final String GuestHistorySelected = "//li[@class='guest-history here active open']";

	public static final String GetAddress1 = "//div[@data-bind='css: ValidationCss(Account.MailingAddress.MailingAddress1)']/input";
	public static final String GetAddress2 = "//input[@data-bind='value: Account.MailingAddress.MailingAddress2, enable: !isSaving()']";
	public static final String GetAddress3 = "//input[@data-bind='value: Account.MailingAddress.MailingAddress3, enable: !isSaving()']";
	public static final String GetCity = "//div[@data-bind='css: ValidationCss(Account.MailingAddress.City)']/input";
	public static final String GetPostalCode = "//div[@data-bind='css: ValidationCss(Account.MailingAddress.PostalCode)']/input";
	public static final String GetState = "//div[@data-bind='with: SetCountryAndState, css: ValidationCss(Account.MailingAddress.TerritoryId)']/select";
	public static final String GetCountry = "(//label[text()='Country:'])[2]/following::select[1]";

	public static final String GetAccountFirstName = "//input[@data-bind='value: Account.AccountFirstName']";
	public static final String GetAccountLastname = "//input[@data-bind='value: Account.AccountLastName']";
	public static final String GetGuestFirstName = "//div[@data-bind='css: ValidationCss(Account.MailingAddress.FirstName)']/input";
	public static final String GetGuestLastName = "//div[@data-bind='css: ValidationCss(Account.MailingAddress.LastName)']/input";
	public static final String GetEmail = "//div[@data-bind='css: ValidationCss(Account.MailingAddress.Email)']/input";
	public static final String GetPhone = "//input[@data-bind='value: Account.MailingAddress.PhoneNumber, enable: !isSaving()']";
	public static final String GetAlternatePhone = "//div[@data-bind='css: ValidationCss(Account.MailingAddress.AltPhoneNumber)']/input";

	// Verify payment fields
	public static final String GetPaymentMethod = "(//label[contains(text(),'Bill Type: ')]/following::select)[1]";
	public static final String GetCardNumber = "//input[@placeholder='Billing Account Number']";
	public static final String GetExpDate = "//input[@placeholder='Exp Date']";
	public static final String ClickDescriptor = "(//i[@class='inncenter-icons-collection decrypt'])[4]";
	public static final String UseMailingAddressCheck = "(//div[text()='Billing Information']/following::div//input[@type='checkbox'])[1]";

	/*
	 * public static final String setUP = "(//span[text()='Setup'])[2]"; public
	 * static final String roomClasses
	 * ="//ul[@class='sec_nav']//li/a[text()='Room Classes']"; public static final
	 * String createnewRoomClass
	 * ="//button[@class='ant-btn ant-btn-primary' and span ='New Room Class']";
	 * public static final String newRoomLabel ="//h1[text()='New Room']"; public
	 * static final String detailsLabel="(//div[text()='Details'])[1]"; public
	 * static final String
	 * roomClassNamev2="//input[@id ='name' and @class='ant-input']"; public static
	 * final String
	 * roomClassABv2="//input[@id ='abbreviation' and @class='ant-input']"; public
	 * static final String sortOrderv2="//input[@id ='sortOrder']"; public static
	 * final String maxAdultv2="//input[@id ='maxAdults']"; public static final
	 * String maxPersonv2="//input[@id ='maxPersons']"; public static final String
	 * smokingPolicyv2="//div[@id ='isSmokingAllowed']//span//i"; public static
	 * final String editDescription ="//button[@title ='Edit Description']"; public
	 * static final String detailsv2 = "//div[@class='jodit_wysiwyg']"; public
	 * static final String donev2="//button/span[.='Done']/.."; public static final
	 * String roomsv2="//div[text()='Rooms']"; public static final String
	 * roomsquantityv2=
	 * "//div[@class='ant-input-number-input-wrap']//input[@placeholder='Placeholder']";
	 * public static final String roomquantityButtonv2
	 * ="//div[@class='ant-col-1']//button[@type ='button']"; public static final
	 * String roomNamev2
	 * ="//input[@class='ant-input PhysicalRooms_roomName_L5kZX']"; public static
	 * final String stationIdv2 ="//input[@id='rooms[0].stationId']"; public static
	 * final String sortOrder ="//input[@id='rooms[0].sortOrder']"; public static
	 * final String houseKeepingZonev2=
	 * "(//div[@id='rooms[0].housekeepingZoneId']/div/div/following::span/i)[1]";
	 * public static final String doneButtonv2 ="//button/span[.='Done']/.."; public
	 * static final String publishv2 ="//button[.='PUBLISH']"; public static final
	 * String roomClassPublishConfirmedV2 = "//div[@id='rcDialogTitle0']"; public
	 * static final String roomClassPublishConfirmedOKButtonV2 =
	 * "//div[text()='Publish Confirmed']/../..//button"; public static final String
	 * roomClassPagination =
	 * "//ul[contains(@class, 'RoomClasses_tablePagination')]"; public static final
	 * String noRoomClassesFound =
	 * "//div[contains(text(),'No Room Classes Found')]"; public static final String
	 * roomClassRecordsFound = "//p[contains(text(),'Record(s) found')]"; public
	 * static final String roomClassAlphabetFilter =
	 * "//div[contains(@class,'RoomClasses_alphabetFilter')]"; public static final
	 * String roomClassPageStatusDropdown =
	 * "(//span[.='STATUS:']//following::div[@aria-autocomplete='list'])[1]"; public
	 * static final String roomClassItemsPerPageDropdown =
	 * "//div[text()='Items Per Page']//following::div[@aria-autocomplete='list']//div[@title]"
	 * ;
	 * 
	 * public static final String roomClassTable = "//table//tbody/tr"; //public
	 * static final String roomClassPagination =
	 * "//ul[contains(@class, 'RoomClasses_tablePagination')]"; public static final
	 * String roomClassPaginationList =
	 * "//ul[contains(@class, 'RoomClasses_tablePagination')]/li"; public static
	 * final String roomClassStatusList = "//span[text()='STATUS:']/..//div/div";
	 * public static final String StayInfo_AccountName =
	 * "//guest-info//a/span[contains(@data-bind,'account')]"; public static final
	 * String StayInfo_GroupCheckBox = "//*[@id='groupEnab']";
	 */

	// public static final String RoomOverBookingPopUp =
	// "//*[@id='RoomOverBookingPopUp']";

	public static final String RoomStatus_Reports_RoomListReport = "//div[@class='table-responsive']//table//tbody//tr//td[1]";

	// verify Marketing info

	public static final String GetMarketing = "//div[@data-bind='css: ValidationCss(Account.MarketSegmentValue)']/select";
	public static final String GetReferral = "//div[@data-bind='css: ValidationCss(Account.ReferralValue)']/select";

	public static final String EnterBillingFirstName = "//div[@data-bind='css: ValidationCss(Account.BillingAddress.FirstName)']/input";
	public static final String EnterBillingLastName = "//div[@data-bind='css: ValidationCss(Account.BillingAddress.LastName)']/input";
	public static final String ClickPrintIcon = "(//a[contains(@data-bind,'click: Print')])[2]";

	public static final String ClickExport = "(//div[text()='Export'])[3]";
	public static final String ResTab = "//li[contains(@data-bind,'css: SelectedTab() === ')]/a[contains(text(),'Reservations')]";
	public static final String ClickPrintIcons = "(//a[contains(@data-bind,'click: Print')])[2]";
	public static final String SelectCurrentDated_PeriodLock = "//input[@id ='MainContent_dgCurrentNightAuditList_ActuCurrentChkBoxAll']/..";
	public static final String SelectPriorDated_PeriodLock = "//input[@id='MainContent_btnPriorDatedItems']";
	public static final String SelectPriorDatedClick_PeriodLock = "//input[@id='MainContent_dgNightAuditList_ActuChkBoxAll']";
	public static final String folio_Tab = "//a[text()='Folio(s)']";
	public static final String SelectVoidDated_PeriodLock = "//input[@id ='MainContent_btnVoidItems']";

	public static final String dailyTransactions = "//a[text()='Daily Transactions']";
	public static final String priorItems = "MainContent_btnPriorDatedItems";
	public static final String currentItems = "MainContent_btnCurrentDatedItems";
	public static final String voidItems = "MainContent_btnVoidItems";
	public static final String noRecordFoundMessage = "MainContent_lblErrorMessage";
	public static final String postButton = "MainContent_btnPost";
	public static final String periodStatus = "//a[text()='Period Status']";
	public static final String totalPriorItemsFound = "MainContent_lblRecordCountPrior";
	public static final String periodLockMsg = "//td[text()='The following periods will be locked and no further postings will be allowed:']";
	public static final String lockButton = "//*[@id='btnLock']";
	public static final String lockPeriodFrame = "dialog-body0";
	public static final String checkAllCurrentItems = "MainContent_dgCurrentNightAuditList_ActuCurrentChkBoxAll";
	public static final String checkAllPriorItems = "MainContent_dgNightAuditList_ActuChkBoxAll";
	public static final String checkAllVoidItems = "MainContent_dgVoidedItems_chkVoidedSelectAll";
	public static final String noRateCombinationMessage = "//div[starts-with(text(), 'No rate combination')]";
	public static final String closeStayInfo = "//span[@data-bind='click: roomSearch.close']";
	public static final String noRoomClassAvailable = "//*[starts-with(text(), 'Room Classes are not available for the search criteria.')]";
	public static final String SelectVoidDateClick_PeriodLock = "//input[@id ='MainContent_dgVoidedItems_chkVoidedSelectAll']";
	public static final String checkout_ClosePopupButton = "//button[@data-bind='click: checkOutDetail.closeModal']";
	public static final String currentDateDataTable_PeriodLock = "//table[@id='MainContent_dgCurrentNightAuditList']/tbody/tr";

	public static final String closeMrbStayInfo = "//span[@data-bind='click: close']";
	public static final String roomClassSection = "//div[contains(@data-bind, 'roomSearch.roomClasses')]";
	public static final String Reports_2 = "(//span[text()='Reports'])[2]";
	public static final String NavInventoryFromListMgmt = "//*[@class='nav-sprite nav-inventory nav_icon']";

	// NightAudit
	public static final String PeriodStatusButton = "//a[@id='ucNavSecondary_rptrNavMain_lbtnNavMainItem_0']";
	public static final String checkoutButton = "//button[text()='Check Out']";
	public static final String proceedtocheckoutpayment = "(//h4[text()='Check Out']/../..//button)[2]";
	public static final String selectPaymentMethod_Checkout = "//label[text()='PAYMENT METHOD']/preceding-sibling::div/button";
	public static final String selectCardNumber_Checkout = "(//input[@placeholder='Credit Card Number'])[2]";
	public static final String selectCardHolderName_Checkout = "(//input[@placeholder='Name On Card'])[3]";
	public static final String selectExpiryDate_Checkout = "(//input[@placeholder='Expiry Date'])[2]";
	public static final String proceedToExternalPayment_Checkout = "//span[text()=' Log as External Payment']/..";
	public static final String payNow_Checkout = "//button[contains(@data-bind,'PaymentFormattedAmountMask')]";
	public static final String paymentMethod_Checkout = "//label[text()='PAYMENT METHOD']/preceding-sibling::div//ul/li//span[contains(text(),'Amex')]";

	// Room Class V2
	public static final String expandNewRoomClassStatus = "//div[@id='status']/div";
	public static final String selectedStatusOfNewRoomClass = "//div[@id='status']/div//div[contains(@class,'selected-value')]";

	public static final String RoomStatusReportHeader = "//label[contains(@class,'taskTitle')]/i";
	public static final String RoomStatusReportHeaderDate = "//label[contains(@class,'taskTitle')]/i/following-sibling::span";
	public static final String ReportDirty = "//li[contains(@class,'dirty')]";
	public static final String ReportInspection = "//li[contains(@class,'inspection')]";
	public static final String ReportClean = "//li[contains(@class,'clean')]";
	public static final String ReportOutOfOrder = "//li[contains(@class,'out-of-order')]";
	public static final String ReportAll = "//li[contains(@class,'all')]";
	public static final String ReportRoomHeader = "//table[contains(@class,'gs-table')]//tr/th[(text()='Room')]";
	public static final String ReportRoomClassHeader = "//table[contains(@class,'gs-table')]//tr/th[(text()='Room Class')]";
	public static final String ReportZoneHeader = "//table[contains(@class,'gs-table')]//tr/th[(text()='Zone')]";
	public static final String ReportConditionHeader = "//table[contains(@class,'gs-table')]//tr/th[(text()='Condition')]";
	public static final String ReportOccupancyHeader = "//table[contains(@class,'gs-table')]//tr/th[(text()='Occupancy')]";
	public static final String ReportDepartureDateHeader = "//table[contains(@class,'gs-table')]//tr/th[(text()='Departure Date')]";
	public static final String ReportArrivalDueDateHeader = "//table[contains(@class,'gs-table')]//tr/th[(text()='Arrival Due')]";
	public static final String ReportTaskDateHeader = "//table[contains(@class,'gs-table')]//tr/th[(text()='Task(s)')]";
	public static final String Reportcontant = "//table/tbody/tr";
	public static final String ReportcontantData = "//table[contains(@class,'gs-table')]//tbody//tr/td";

	public static final String ReportDirtyCount = "//li[contains(@class,'dirty')]//span[@class='gs-statsValue']";
	public static final String ReportInspectionCount = "//li[contains(@class,'inspection')]//span[@class='gs-statsValue']";
	public static final String ReportCleanCount = "//li[contains(@class,'clean')]//span[@class='gs-statsValue']";
	public static final String ReportOutOfOrderCount = "//li[contains(@class,'out-of-order')]//span[@class='gs-statsValue']";
	public static final String ReportALLCount = "//li[contains(@class,'all')]//span[@class='gs-statsValue']";
	public static final String ReportPrintIcon = "//a[contains(text(),'Print')]";
	public static final String NoResult = "//h2[@class='tasksNotFoundText']";

	public static final String filterClearAllLink = "//a[contains(text(),'Clear All')]";

	public static final String taskMessage = "//div[contains(text(),'All of the fields below are required')]";
	public static final String noTaskMessage = "//tr[@class='noTask']/td";
	public static final String rateGridBulkUpdateUpdateButton = "//button[text()='Update']";

	public static final String rateGridBulkUpdateStartDate = "(//input[@placeholder='MM/DD/YYYY'])[1]";
	public static final String rateGridBulkUpdateEndDate = "(//input[@placeholder='MM/DD/YYYY'])[2]";

	/*
	 * public static final String filterClearAllLink =
	 * "//a[contains(text(),'Clear All')]";
	 * 
	 * public static final String taskMessage =
	 * "//div[contains(text(),'All of the fields below are required')]"; public
	 * static final String noTaskMessage = "//tr[@class='noTask']/td";
	 */

	public static final String NewRoomText = "//h1[text()='New Room']";
	public static final String TaxDetailText = "//font[text()='Tax Item Details']";
	public static final String PropertyDetails = "//font[text()='Property Details']";
	public static final String PropertyListPage = "//font[text()='Properties']";
	public static final String PropertyOptionsText = "(//td[contains(text(),'Reservations:')])[1]";

	public static final String reservationBalance = "(//div[contains(@data-bind, 'value: balance')])[1]";
	public static final String closeIframe = "//a[@id='dialog-close0']";
	public static final String printIcon = "//input[@id='MainContent_imgPrintResList']";
	public static final String editBlock = "//*[@id='btnEditBlock']";
	public static final String errorMessage = "//span[@id='MainContent_lblErrorMessage']//li";
	public static final String cancel = "//input[@id='MainContent_btnCancelEditBlock']";
	public static final String weekDay = "//table[@class='datepicker-table-condensed table-condensed']//th[@class='dow']";
	public static final String houseKeeping = "MainContent_rptrMenuRight_lblHouseKeepingTextRight_0";
	public static final String houseKeepingSetNow = "MainContent_rptrMenuRight_btnSetRoomNowDirtyRight_0";
	public static final String longStay = "MainContent_rptrMenuRight_lblLongStayTextRight_1";
	public static final String longStaySetNow = "MainContent_rptrMenuRight_btnSetLongStayRight_1";
	public static final String aduitDateLabel = "//td[text()='Audit Date:']";

	public static final String buttonDistribute = "//button[text()='Distribute']";
	public static final String txtAmountDistribute = "(//input[contains(@data-bind,'AmountChanged')])";
	public static final String txtAmountDistribute2 = "(//input[contains(@data-bind,'AmountChanged')])[2]";
	public static final String buttonAddDistribute = "(//button[text()='Add' and contains(@class,'btn-add-process-payment')])";
	public static final String buttonAddDistribute2 = "(//button[text()='Add' and contains(@class,'btn-add-process-payment')])[2]";
	public static final String buttonContinuetDistribute = "(//button[text()='Continue' and contains(@class,'btn-payment-continue')])";
	public static final String buttonContinuetDistribute2 = "(//button[text()='Continue' and contains(@class,'btn-payment-continue')])[2]";
	public static final String selectPaymentMethodDistribute = "(//select[contains(@class,'payment-method-dropdown')])";
	public static final String selectPaymentMethodDistribute2 = "(//select[contains(@class,'payment-method-dropdown')])[2]";

	public static final String TaxesAndFeesTab="//a[@data-id='/setup/taxes']";
	public static final String taxesAndFeesTabAfterRoomClass="//a[@href='/setup/taxes']";


	//public static final String TotalItemOnTaxesAndFeePage = "//tbody[@class='ant-table-tbody']/tr";
	public static final String TotalItemOnTaxesAndFeePage = "//tbody[@class='ant-table-tbody']/tr/td[contains(text(),'No item found')]";
	public static final String TotalItemOnTaxesSize = "//tbody[@class='ant-table-tbody']/tr";
	public static final String MakeInactive = "(//span[@class='ant-checkbox ant-checkbox-checked']/input[@class='ant-checkbox-input'])[1]";
	public static final String MakeActive =  "(//span[@class='ant-checkbox']/input[@class='ant-checkbox-input'])[1]";

	public static final String BackLink = "//a[@class='BackLink']";

	public static final String ClickConfirm = "//button[@class='ant-btn btn inrd-button ant-btn-success']";
	public static final String ClickConfirm1 = "//button[@class='ant-btn ant-btn-success btn inrd-button']";
	public static final String TaxPageSetupTitle = "//h2[text()='Taxes & Fees']";
	public static final String VrboSetupTab = "//a[.='Vrbo Setup']";
	public static final String VrboTab="//a[@data-id='/setup/vrbo']";

	public static final String roomClassIdFieldV2 = "//label[text()='ROOM CLASS ID']//following-sibling::div";

	public static final String AccountToRes = "//*[@class='nav-sprite nav-reservation nav_icon']";

	public static final String clickPropertySelect = "//div[contains(text(),'Click Me')]";
	public static final String editPropertySelect = "(//span[@role='presentation'])[2]/b";
	public static final String inputPropertySelect = "//input[contains(@id,'s2id_autogen3_search')]";
	public static final String clickPropertyName = "(//div[contains(@id,'select2-result')])[1]";

	public static final String threeDotsMRB = "//span[contains(@class,'custom-icon-more')]";
	public static final String cancelSecondaryRoom = "//ul//li[contains(text(),'Cancel')]";
	// public static final String EmailSetOnPropertyPage =
	// "//input[@name='ctl00$MainContent$txtMailing_email']";
	public static final String ReplyToManualCustomRadio = "(//input[@name='ctl00$MainContent$groupMailFrom'])[2]";
	public static final String ReplyToManualCustomEmailSet = "(//input[@name='ctl00$MainContent$groupMailFrom'])[2]/following::input[@id='MainContent_txtMailFrom']";
	public static final String ReplyToscheduledCustomRadio = "//input[@name='ctl00$MainContent$ChkMailfrom']";
	public static final String ReplyToscheduledCustomEmailSet = "//input[@name='ctl00$MainContent$ChkMailfrom']/following::input[@name='ctl00$MainContent$txtschfrom']";
	// public static final String functionConfirmationLetterCheckBox =
	// "//input[@id='dgFunctionsList_chkSelectFunction_1']";
	public static final String CCOnAllMailRadio = "//input[@name='ctl00$MainContent$ChkMailCC']";
	public static final String CConAllMailSet = "//input[@name='ctl00$MainContent$ChkMailCC']/following::input[@name='ctl00$MainContent$txtccMail']";

	public static final String EmailSetOnPropertyPage = "//input[@name='ctl00$MainContent$txtMailing_email']";
	public static final String Reservation4 = "//i[@class='nav-sprite nav-reservation nav_icon']";
	public static final String CreateNewTaxButton = "//span[text()='Create']//parent::button";
	public static final String taxLink = "//a[text()='Tax']";

	// Create Tax
	public static final String newTaxItem_Title = "//h2[text()='Item details']";
	// Item Name
	public static final String taxItemName = "//label[text()='Tax name']//following-sibling::input";
	// Display Name
	public static final String taxDispalyName = "//label[contains(text(),'Display name')]//following-sibling::input";
	// Tax Status
	public static final String taxStatus = "//select[@id='MainContent_drpActive']";
	// Description
	public static final String taxDescription = "//label[contains(text(),'Description')]//following-sibling::textarea";
	// Tax Value
	public static final String taxValue = "//input[@id='MainContent_txtTaxItemValue']";
	// Tax exempt
	public static final String excludeTaxExempt = "//span[text()='Exclude when tax exempt']//../span/input";
	// VAT
	public static final String calculateasVAT = "//span[text()='VAT']//../span/input";
	// Tax Pick one
	public static final String taxPickOne = "//label[contains(text(),'Flat/Percent') or contains(text(),'Tax Type')]//../div";
	public static final String selectPercentage = "//*[@role='listbox']/..//div[contains(text(),'percentage') or contains(text(),'Percentage')]";

	// Tax select All
	public static final String taxSelectAllLedgerAccounts = "//label[text()='Ledger Account']//../div/div/span";
	public static final String addLedgerAccountsLink = "//button[text()='Add ledger accounts']";
	public static final String selectLedgerAccounts = "//label[text()='Select ledger account(s)']//../div/div";
	public static final String selectLedgerAccountPopUp = "//div[@class='ant-modal-content']";
	public static final String addLedgerAccountButton = "//span[text()='Add']//parent::button";
	public static final String saveTaxButton = "//span[text()=' Save ']//parent::button";
	public static final String percentageAmount = "//label[text()='Amount ']//../span/div/div[2]/input";
	public static final String USDAmount = "//label[text()='Amount ']//../span/label/div/div[2]/input";
	public static final String textAndFeesHeader = "//h2[text()='Taxes & Fees']";
	public static final String GetAllAvailableTaxes = "//table/tbody/tr";
	public static final String deleteTaxButton = "//span[text()='Delete']//parent::button";
	public static final String taxRestrictionButton = "//h2[contains(text(),' Restrict this ')]/button";

	// Add room classes in tax creation
	public static final String selectRoomClasses = "//label[text()='Select room class']//..//div[@class='ant-select-selection__placeholder' and text()='--Select--']";
	public static final String addRoomClassDialogue = "//div[@id='rcDialogTitle1']";
	public static final String addRoomClassesButton = "//button[text()='Add room classes']/i";
	public static final String addRoomClassButton = "//div[text()='Add room class']//..//../div[@class='ant-modal-footer']/div/div/button";

	// Add rate Plans in tax creation
	public static final String selectRatePlans = "//label[text()='Select rate plan(s)']//..//div[@class='ant-select-selection__placeholder' and text()='--Select--']";
	public static final String addRatePlanDialogue = "//div[@id='rcDialogTitle2']";
	public static final String addRatePlanButton = "//button[text()='Add rate plans']/i";
	public static final String addRatePlnButton = "//div[text()='Add rate plan']//..//../div[@class='ant-modal-footer']/div/div/button";

	// Add source in tax creation
	public static final String selectSource = "//label[text()='Select source(s)']//..//div[@class='ant-select-selection__placeholder' and text()='--Select--']";
	public static final String addSourceDialogue = "//div[@id='rcDialogTitle0']";
	public static final String addSourceButton = "//button[text()='Add source']/i";

	public static final String ClickAirbnbTab = "//a[@data-id='/setup/airbnb']";
//	public static final String AirbnbTab = "//a[.='Airbnb Setup']";
	public static final String AirbnbTab = "//h1[contains(@class,'AirbnbSetup_title')]";
	public static final String ClickPropertyDropdownOnAirbnbTab = "//span[text()='Autorates']/ancestor::div/i";
	public static final String GetAirbnbRatePlan = "//div[@class='ant-select-selection-selected-value']";
	public static final String Account_Folios1 = "(//div[@class='AccountDetail']//a[.='Folio'])[2]";
	public static final String Account_Folios2 = "(//div[@class='AccountDetail']//a[.='Folio'])[1]";
	public static final String GetAdminName = "//tr[@class='dgItem']/td/a";

	public static final String verifyLineItemPostStatus="//i[@class='inncenter-icons-collection transactionstatus-icon2']";

	public static final String tax_ddl = "//span[@class='ant-select-selection-search']/input[@class='ant-select-selection-search-input']";
	// public static final String
	// selectPercentCty="//ul[contains(@class,'ant-select-dropdown-menu')]//li[text()='Percentage
	// per charge']";
	...
	// public static final String
	// selectPercentCtyFee="//ul[contains(@class,'ant-select-dropdown-menu')]//li[text()='percentage']";
	// public static final String SelectPerStayFee =
	// "//ul[contains(@class,'ant-select-dropdown-menu')]//li[text()='per stay']";
	...
	/*
	 * public static final String
	 * addRoomClass="//h2[text()='Room class']/..//div//i"; public static final
	 * String addRatePlan="//h2[text()='Rate plan']/..//div//i"; public static final
	 * String addSource="//h2[text()='Source']/..//div//i";
	 */
...
// public static final String addSource="//button[text()='Add source']";
	...
	public static final String addSource = "//div[text()='Add source']//..//../div[@class='ant-modal-footer']/div/div/button";

	public static final String Admin2 = "(//*[.='Admin'])[2]";
	public static final String Admin3="//ul[contains(@class,'nav_des')]//a[text()='Admin']";
	public static final String Ledger_Accounts2 = "//a[.='Ledger Accounts']";
	public static final String deleteBlock = "MainContent_btnDeleteBlock";
	public static final String Click_Continue_Block_Night_2 = ".//*[@id='btnOBContinue']";

	public static final String taxFilterIcon = "//button[contains(@class,'inrd-button')]/div[@class='icon-filter']";
	public static final String taxFilterStatus = "//span[@class='ant-select-selection-item']";

	public static final String UnassignedListGuestNames = "//div[contains(@data-bind,'css: isRoomAssigned')]//span[contains(@data-bind,'GuestName')]";


	public static final String GiftCertificateRedeemed = "//label[.='Redeemed: ']//following-sibling::span[@class='pamt']";
	public static final String reservationStatusField="(//*[contains(@data-bind,'foreach: { data: ResStatuses, as:')])[1]//li//span[1]";
	public static final String changeProperty="//div[@class='select2-container propertyByClient']//span[@role='presentation']";


	public static final String mailingInfoSalutation = "(//select[contains(@data-bind,'SaluationId')])[2]";
	public static final String phoneCountryCode = "//input[contains(@data-bind , 'MailingAddress.PhoneCountryCode')]";
	public static final String alternatePhoneCountryCode = "//input[contains(@data-bind , 'MailingAddress.AltPhoneCountryCode')]";
	public static final String phoneExtention = "//input[contains(@data-bind , 'MailingAddress.PhoneExtn')]";
	public static final String alternatePhoneExtention = "//input[contains(@data-bind , 'MailingAddress.AltPhoneExtn')]";
	public static final String faxCountryCode = "//input[contains(@data-bind , 'MailingAddress.FaxCountryCode')]";
	public static final String faxExtention = "//input[contains(@data-bind , 'MailingAddress.FaxExtn')]";
	public static final String billingInfoSaluation = "(//select[contains(@data-bind,'SaluationId')])[3]";
	public static final String billingPhoneCountryCode = "//input[contains(@data-bind , 'BillingAddress.PhoneCountryCode')]";
	public static final String billingPhoneNumber = "//input[contains(@data-bind , 'BillingAddress.PhoneNumber')]";
	public static final String billingPhoneExtention = "//input[contains(@data-bind , 'BillingAddress.PhoneExtn')]";
	public static final String billingAlternatePhoneCountryCode = "//input[contains(@data-bind , 'BillingAddress.AltPhoneCountryCode')]";
	public static final String billingAlternatePhoneNumber = "//input[contains(@data-bind , 'BillingAddress.AltPhoneNumber')]";
	public static final String billingAlternatePhoneExtention = "//input[contains(@data-bind , 'BillingAddress.AltPhoneExtn')]";
	public static final String billingAddressLine1 = "//input[contains(@data-bind , 'BillingAddress.MailingAddress1')]";
	public static final String billingAddressLine2 = "//input[contains(@data-bind , 'BillingAddress.MailingAddress2')]";
	public static final String billingAddressLine3 = "//input[contains(@data-bind , 'BillingAddress.MailingAddress3')]";
	public static final String billingPropertyDropdown = "//select[contains(@data-bind , 'Account.PropertyId')]";
	public static final String billingTypeDropdown = "//select[contains(@data-bind , 'BillingTypeId')]";
	public static final String billingFaxCountryCode = "//input[contains(@data-bind , 'BillingAddress.FaxCountryCode')]";
	public static final String billingFaxNumber = "//input[contains(@data-bind , 'BillingAddress.FaxNumber')]";
	public static final String billingFaxExtention = "//input[contains(@data-bind , 'BillingAddress.FaxExtn')]";
	public static final String billingEmail = "//input[contains(@data-bind , 'BillingAddress.Email')]";
	public static final String billingCity = "//input[contains(@data-bind , 'BillingAddress.City')]";
	public static final String billingPostalCode = "//input[contains(@data-bind , 'BillingAddress.PostalCode')]";
	public static final String billingStateDropdown = "//select[contains(@data-bind , 'BillingAddress.TerritoryId')]";
	public static final String billingCountryDropdown = "//select[contains(@data-bind , 'SetCountryAndStateBilling')]";
	public static final String accountPage_Save_Btn = "//button[contains(@data-bind,'click: SaveOnlyAfterCheckingPickedReservationCount')]";
	public static final String account_Since = "//input[contains(@placeholder,'Account Since')]";
	public static final String market_Segment = "//select[contains(@data-bind,'Account.MarketSegmentValue')]";
	public static final String reset_Button = "//button[contains(@data-bind,'EnableResetButton')]";
	public static final String check_Box = "//input[contains(@data-bind,'checkItem')]";
	public static final String click_Season = "(//a[.='Seasons'])[1]";
	public static final String rule_reset_Button = "//button[contains(@data-bind,'click: resetRuleDetail')]";
	public static final String policy_reset_Button = "//button[contains(@data-bind,'click: resetDetail')]";
	
	public static final String policy_property_name = "//label[contains(@data-bind,'value: PropertyName')]";
	public static final String policy_status = "//select[contains(@data-bind,'value: PolicyStatusId')]";



	// Propert Options
	public static final String PropertyOperationsText = "(//td[contains(text(),'Operations:')])[1]";
	public static final String PropertyCheckInOutText = "(//td[contains(text(),'Check In/Out Process:')])[1]";
	public static final String PropertyBookingEngineText = "(//td[contains(text(),'Booking Engine:')])[1]";
	public static final String PropertySystemText = "(//td[contains(text(),'System:')])[1]";
	public static final String PropertyCancelledReservationText = "(//td[contains(text(),'Cancelled Reservations:')])[1]";
	public static final String PropertyInventryManagementText = "(//td[contains(text(),'Inventory Management:')])[1]";

	public static final String AuthorizationIcon = "//tbody//td[@class='text-center lineitems-changestatus']";
	public static final String TakePaymentFromReservationDetailButton = "(//button[text()='TAKE PAYMENT'])[1]";
	public static final String totalAmountOnStayInfoPage = "//span[text()='TOTAL']//following-sibling::span";
	
	public static final String accounttab="//input[@id='MainContent_btnAccount']";
	public static final String addNotInGrp="//input[@id='MainContent_UcNotes_btnAdd']";
	public static final String Inventory_Backward_Admin1 = "//a[@data-id='fncMenuAdmin']";
	public static final String feeLink = "//a[text()='Fee']";
	public static final String feeName = "//label[text()='Fee name']//following-sibling::input";

	public static final String perNightOrStay = "//span[@title='per night']";
//	public static final String perNightOrStay = "(//span[@class='ant-select-arrow'])[3]";
	public static final String PropertyLink = "(//a[text()='Properties'])[2]";
	public static final String ReservationBackwardFromProperty = "head_reservations";
	public static final String NewReservationButtonInRV2 = "//a[@data-bind='click: NewReservation']";

	public static final String saveFolio = "(//div[contains(@data-bind , 'tabSelected() ===')]//button[text()='Save'])[last()]";
	public static final String requiredMarketSegment = "//input[@id='MainContent_chkMarketSegment']";
	public static final String requiredReferrals = "//input[@id='MainContent_chkReferrals']";
	
	public static final String verify_Search_Loading_Gird = "//tbody[contains(@data-bind,'ShowReservationGrid')]";
	public static final String Properties_interface = "//input[@id='MainContent_btnInterfaceOption']";
	public static final String paymentSuccessFullPopupClose2 = "//h4[contains(text(),'Successful')]//following::button[text()='Continue']";
