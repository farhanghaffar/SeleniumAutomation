...
public class OR_GuestServices {
	...
	public static final String RoomStatusTab = "//a[.='Room Status']";
	 ...
	 public static final String RoomStatusZone = "//room-card-list/div/h2";
	 public static final String RoomMaintenance_StartDates = "//input[@id='MainContent_txtDateStart']/following-sibling::img[@name='cal_img']";
	 public static final String RoomMaintenance_EndDates = "//input[@id='MainContent_txtDateEnd']/following-sibling::img[@name='cal_img']";
	 public static final String RoomMaintenance_StartDatesClear = "//input[@id='MainContent_txtDateStart']/following-sibling::img[@name='img_eraser']";
	 public static final String RoomMaintenance_EndDatesClear = "//input[@id='MainContent_txtDateEnd']/following-sibling::img[@name='img_eraser']";
	 public static final String RoomMaintenance_Message = "//span[@id='MainContent_lblErrorMessage']";
	 public static final String GSSelectAll = "//span[contains(text(),'Select All')]/input";
	 public static final String GSDSelectAll = "//span[contains(text(),'Deselect All')]/input";
	 public static final String allRoomTileChecked = "//span[contains(@class,'checked')]";
