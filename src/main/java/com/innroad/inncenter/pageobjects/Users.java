...
public class Users {
	...
	public void selectUser(WebDriver driver, ArrayList<String> test_steps, String user) {
		String locator = String.format("//a[translate(text(), 'ABCDEFGHIJKLMNOPQRSTUVWXYZ', 'abcdefghijklmnopqrstuvwxyz')= '%s']", user.toLowerCase());
	...
	public boolean isShowFooterEnabled(WebDriver driver, ArrayList<String> test_steps) {
		String locator = "//span[text()='Show Footer']/parent::td/following-sibling::td/select";
		Wait.WaitForElement(driver, locator);
		Wait.waitForElementToBeVisibile(By.xpath(locator), driver);
		Wait.waitForElementToBeClickable(By.xpath(locator), driver);
		...
		return (((String) js.executeScript("return arguments[0].value", element)).trim()).equalsIgnoreCase("yes");
	}
	...
	public boolean isShowLegendEnabled(WebDriver driver, ArrayList<String> test_steps) {
		String locator = "//span[text()='Show Legend']/parent::td/following-sibling::td/select";
		Wait.WaitForElement(driver, locator);
		Wait.waitForElementToBeVisibile(By.xpath(locator), driver);
		Wait.waitForElementToBeClickable(By.xpath(locator), driver);
	...
	public boolean isShowRulesEnabled(WebDriver driver, ArrayList<String> test_steps) {
		String locator = "//span[text()='Show Rules']/parent::td/following-sibling::td/select";
		Wait.WaitForElement(driver, locator);
		Wait.waitForElementToBeVisibile(By.xpath(locator), driver);
		Wait.waitForElementToBeClickable(By.xpath(locator), driver);
	...
	public boolean isShowRoomClassDataEnabled(WebDriver driver, ArrayList<String> test_steps) {
		String locator = "//span[text()='Show Room Class Data']/parent::td/following-sibling::td/select";
		Wait.WaitForElement(driver, locator);
		Wait.waitForElementToBeVisibile(By.xpath(locator), driver);
		Wait.waitForElementToBeClickable(By.xpath(locator), driver);
	...
	public boolean isGroupByRoomClassEnabled(WebDriver driver, ArrayList<String> test_steps) {
		String locator = "//span[text()='Group By Room Class']/parent::td/following-sibling::td/select";
		Wait.WaitForElement(driver, locator);
		Wait.waitForElementToBeVisibile(By.xpath(locator), driver);
		Wait.waitForElementToBeClickable(By.xpath(locator), driver);
	...
	public boolean isShowRoomConditionEnabled(WebDriver driver, ArrayList<String> test_steps) {
		String locator = "//span[text()='Show Room Condition']/parent::td/following-sibling::td/select";
		Wait.WaitForElement(driver, locator);
		Wait.waitForElementToBeVisibile(By.xpath(locator), driver);
		Wait.waitForElementToBeClickable(By.xpath(locator), driver);
