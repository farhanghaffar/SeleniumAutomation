...
public class Reservation {
	...
	//ByAbuBkr
	public void VerifyTapeChartRules(WebDriver driver) {
		driver.findElement(By.xpath("//*[@id=\"bpjscontainer_17\"]/div/ul/li[2]/a/span[3]")).click();
...
*/
	...
	public ArrayList<String> VerifyFolioLineDescription(WebDriver driver, String LineDescription,
			String lineNo) {
		ArrayList<String> test_steps = new ArrayList<>();
		String linDes = "(//td[@class='lineitem-description']/a)[" + lineNo + "]";

		Wait.explicit_wait_visibilityof_webelement_120(driver.findElement(By.xpath(linDes)), driver);
		assertEquals(driver.findElement(By.xpath(linDes)).getText(), LineDescription, "Failed Line Description Not Matched");
		test_steps.add("Successfully verified LineDescription : " + LineDescription);
		reservationLogger.info("Successfully verified LineDescription : " + LineDescription);
		return test_steps;
	}
...
*/
	...
	public ArrayList<String> ClickEditStayInfoAfterLock(WebDriver driver, ArrayList<String> test_steps,String expectedRoomLockMsg)
			throws InterruptedException, ParseException {
		...
		reservationLogger.info("Click Stay Info Edit button");
		test_steps.add("Click Stay Info Edit button");
		Wait.WaitForElement(driver, OR_Reservation.ROOMLOCKMSG);
		//Wait.waitForElementToBeClickable(By.xpath(OR_Reservation.ROOMLOCKMSG), driver);
		// Wait.explicit_wait_visibilityof_webelement(element.StayInfo_ChangeDetails,
		// driver);
		String roomLockMsg=driver.findElement(By.xpath("//p[contains(text(),'Please note that this guest has requested not to have their room changed.')]")).getText();
		
		assertEquals(roomLockMsg, expectedRoomLockMsg,
				"Failed : Message  missmatched");
		reservationLogger.info("Verified Notes Subject :" + expectedRoomLockMsg);
	
		test_steps.add("Verified Notes Subject :" + expectedRoomLockMsg);
		String yesButton="//p[contains(text(),'Please note that this guest has requested not to have their room changed.')]/../following-sibling::div//button[contains(text(),'Yes')]";
