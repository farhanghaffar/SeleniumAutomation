...
public class Account implements IAccount {
	...
	public void AccountDetails(WebDriver driver, String AccountType, String AccountName) throws InterruptedException {
		...
		Assert.assertEquals(AccountType, selectedOption,"Failed: AccountType Mismatched");
	...
	public void addLineitem1(WebDriver driver, String propertyName, String SelectCategory, String Amount,
		...
		try {
          Wait.WaitForElement(driver, "//div[@class='AccountDetail']//td[@class='lineitem-amount']//input[contains(@data-bind,'value: Amount')]");
	...
	public String getGiftCertNumber(WebDriver driver, ArrayList<String> test_steps) {
		Elements_Accounts CreateAccountlineitem = new Elements_Accounts(driver);
		String GetID = CreateAccountlineitem.Get_Gift_ID.getAttribute("value");
		accountsLogger.info("GetID :" + GetID);
		String GetSplitid[] = GetID.split("#");
	...
	public void Commit(WebDriver driver) {
		Elements_Accounts CreateAccountlineitem = new Elements_Accounts(driver);
		Wait.waitForElementToBeClickable(By.xpath(OR.Click_Commit), driver);
...
//		}
	...
	public String CreateNewUnitItem(WebDriver driver, String ItemName, String DisplayName, String Description,
			String ItemValue, String unitType, String Category, String SelectTax) throws InterruptedException {
		...
		Account.Item_Value.sendKeys(ItemValue);
		Account.PercentCheckbox.click();
		if (unitType.equalsIgnoreCase("Owner Revenue")) {
			driver.findElement(By.xpath("//label[contains(text(),'Owner Revenue')]//preceding-sibling::input")).click();
		}
		Wait.explicit_wait_visibilityof_webelement_150(Account.SelectItem_Catagory, driver);
		new Select(Account.SelectItem_Catagory).selectByVisibleText(Category);
		JavascriptExecutor jse = (JavascriptExecutor) driver;
		jse.executeScript("arguments[0].scrollIntoView();", Account.Item_Associate_Button);
	...
	public Double GetEndingBalance(WebDriver driver, ArrayList<String> test_steps) throws InterruptedException {
		Elements_Accounts Account = new Elements_Accounts(driver);
		Utility.ScrollToElement(Account.Account_EndingBalance, driver);
		String Balance = Account.Account_EndingBalance.getText();
		System.out.print(Balance);
		Double EndingBalance = Double.parseDouble(Balance.split(" ")[1]);
		System.out.print(EndingBalance);
		return EndingBalance;
	}
	
	public Double getBeginningBalance(WebDriver driver, ArrayList<String> test_steps) throws InterruptedException {
		Elements_Accounts Account = new Elements_Accounts(driver);
		Utility.ScrollToElement(Account.Account_BeginningBalance, driver);
		String Balance = Account.Account_BeginningBalance.getText();
		System.out.print(Balance);
		Double BeginningBalance = Double.parseDouble(Balance.split(" ")[1]);
		System.out.print(BeginningBalance);
		return BeginningBalance;
	}
	
	public Double getPayments(WebDriver driver, ArrayList<String> test_steps) throws InterruptedException {
		Elements_Accounts Account = new Elements_Accounts(driver);
		Utility.ScrollToElement(Account.Account_Payments, driver);
		String Balance = Account.Account_Payments.getText();
		System.out.print(Balance);
		Double Payments = Double.parseDouble(Balance.split(" ")[1]);
		System.out.print(Payments);
		return Payments;
	}
	
	public Double getNewCharges(WebDriver driver, ArrayList<String> test_steps) throws InterruptedException {
		Elements_Accounts Account = new Elements_Accounts(driver);
		Utility.ScrollToElement(Account.Account_NewCharges, driver);
		String Balance = Account.Account_NewCharges.getText();
		System.out.print(Balance);
		Double NewCharges = Double.parseDouble(Balance.split(" ")[1]);
		System.out.print(NewCharges);
		return NewCharges;
	}
	
	public Double getTaxes(WebDriver driver, ArrayList<String> test_steps) throws InterruptedException {
		Elements_Accounts Account = new Elements_Accounts(driver);
		Utility.ScrollToElement(Account.Account_Taxes, driver);
		String Balance = Account.Account_Taxes.getText();
		System.out.print(Balance);
		Double Taxes = Double.parseDouble(Balance.split(" ")[1]);
		System.out.print(Taxes);
		return Taxes;
	}
	
	public Double getAdvanceDepositBalance(WebDriver driver, ArrayList<String> test_steps) throws InterruptedException {
		Elements_Accounts Account = new Elements_Accounts(driver);
		Utility.ScrollToElement(Account.Account_AdvanceDepositBalance, driver);
		String Balance = Account.Account_AdvanceDepositBalance.getText();
		System.out.print(Balance);
		Double AdvanceDepositBalance = Double.parseDouble(Balance.split(" ")[1]);
		System.out.print(AdvanceDepositBalance);
		return AdvanceDepositBalance;
	}
	...
	public void click_reservationTab(WebDriver driver, ArrayList<String> test_steps) {
		Elements_Accounts CreateAccount = new Elements_Accounts(driver);
		String res = "//div[@class='AccountDetail']//a[.='Reservations']";
		Wait.WaitForElement(driver, res);
		try {
		driver.findElement(By.xpath(res)).click();
		}catch (Exception e) {
			Utility.clickThroughJavaScript(driver, driver.findElement(By.xpath(res)));
		}
		test_steps.add("Click on reservation tab in account");
	}
	public void clickreservationTab(WebDriver driver, ArrayList<String> test_steps) {
		Elements_Accounts CreateAccount = new Elements_Accounts(driver);
		
		Wait.WaitForElement(driver, OR.ResTab);
		CreateAccount.resTab.click();
		test_steps.add("Click on reservation tab in account");
	}
	...
	public void clickOnPrintIcon(WebDriver driver, ArrayList<String>test_steps) throws InterruptedException, IOException {
		...
		Wait.WaitForElement(driver, OR.ClickPrintIcons);
		Wait.waitForElementToBeVisibile(By.xpath(OR.ClickPrintIcons), driver);
		Wait.waitForElementToBeClickable(By.xpath(OR.ClickPrintIcons), driver);
		CreateAccount.ClickPrintIcons.click();
	...
	public void verify_reservationNotInAccpountResewrvation(WebDriver driver, ArrayList<String> test_steps,
			String reservation) {
		String search = "(//button[@id='Button2'])[3]";
		Wait.WaitForElement(driver, search);
		driver.findElement(By.xpath(search)).click();
		...
		if(driver.findElement(By.xpath(res)).isDisplayed()) {
			...
			test_steps.add("Reservation not found in account reservation tab");
		}
	...
	public void associateRooms(WebDriver driver, ArrayList<String> test_steps, String roomclass)
		...
		String property = "//h4[text()='Room Picker']/../..//label[contains(text(),'Property:')]/following-sibling::div/select";
	...
	public void associateRooms(WebDriver driver, ArrayList<String> test_steps, String roomclass, String roomNumber)
			throws InterruptedException {
		String associate = "//button[contains(text(),'Associate Rooms')]";
		Wait.WaitForElement(driver, associate);
		driver.findElement(By.xpath(associate)).click();
...
//		test_steps.add("selected room class : " + roomclass);
		...
		//String input = "//input[@data-bind='checked: select, disable: Associated']";
		String input = "//span[contains(text(),'"+roomclass+"')]//parent::td//following-sibling::td/span[text()='"+roomNumber+"']//ancestor::tr//input";
...
//				Wait.WaitForElement(driver, input);
				...
				WebElement nextButton = driver.findElement(By.xpath("//i[contains(@class,'double-right')]/parent::a"));
				Utility.ScrollToElement(nextButton, driver);
				nextButton.click();
			}
		}
	...
	public ArrayList<String> ageingPaymentAdvanceDeposit_Pay(WebDriver driver, ExtentTest test1, String AccountType,
		...
		if (PaymentType.equalsIgnoreCase("MC")) {
			...
			Wait.WaitForElement(driver, OR.Verify_MC_Grid);
			Wait.WaitForElement(driver, OR.Click_Account_Pay_Continue);
			Wait.explicit_wait_visibilityof_webelement_350(AccountPayment.Click_Account_Pay_Continue, driver);
			AccountPayment.Click_Account_Pay_Continue.click();
		...
		Wait.wait3Second();
		AccountPayment.Deposit_Auto_apply.get(1).click();
		test_steps.add("Clicking on Auto Apply");
		accountsLogger.info("Clicking on Auto Apply");

		Wait.wait3Second();
		AccountPayment.Deposit_Auto_applyAdd.get(1).click();
		test_steps.add("Clicking on Add");
		accountsLogger.info("Clicking on Add");

		Wait.wait3Second();
		AccountPayment.Deposit_Auto_applyContinue.get(1).click();
		test_steps.add("Clicking on Continue");
		accountsLogger.info("Clicking on Continue");
	...
	public void ClickFolio(WebDriver driver) throws InterruptedException {
		...
		ClickFolio.Account_Folio.click();	
		Wait.waitForElementToBeVisibile(By.xpath("//div[contains(text(),'Line Items')]"), driver);
	...
	public ArrayList<String> Accounts_AccountStatement(WebDriver driver, ArrayList<String> steps)
		...
		Wait.waitForElementToBeClickable(By.xpath(NewAccount.Accounts_AccountStatement_Confirm), driver);
		//account.Accounts_AccountStatement_Confirm.click();
		Utility.clickThroughJavaScript(driver, account.Accounts_AccountStatement_Confirm);
		...
		try {
			...
			try {
				Utility.clickThroughAction(driver, account.Accounts_AccountStatement_Confirm);
				Wait.wait2Second();
				driver.switchTo().alert().accept();
				steps.add("Accept Alert");
				accountsLogger.info("Accept Alert");
	...
	public ArrayList<String> selectPropertyFromAccount(WebDriver driver, String selectProperty)
		...
		Utility.ScrollToElement(accountElement.selectPropertyFromAccount, driver);
		try {
			new Select(accountElement.selectPropertyFromAccount).selectByVisibleText(selectProperty);
			
		}catch(Exception e) {
			new Select(accountElement.selectPropertyFromAccount).selectByIndex(1);;			
		}
...
//		Wait.waitForElementToBeVisibile(By.xpath(NewAccount.folioOptionsLabel), driver);
	...
	public void searchForAnAccount(WebDriver driver, ArrayList<String> test_steps, String accountType, String accountName)
		...
		Wait.WaitForElement(driver, OR.Enter_AccountName_On_SearchPage);
		...
		if (Utility.validateString(accountType)) {
			...
			accountsLogger.info("Account type is not provided to select");
		}
	...
	*/
	...
	public void createNewAccount(WebDriver driver, ArrayList<String> test_steps, String accountType,
			...
			String phonenumber, String alternativeNumber, String address1, String address2, String address3, String email,
			String city, String state, String postalcode) throws Exception {
		test_steps.add("============== Creating a new Account ==============");
	...
	public boolean unitOwnersItemsAvailability(WebDriver driver, ArrayList<String> test_steps) throws InterruptedException {
	...
	public ArrayList<String> getAssociatedUnitOwnerItemsListAndValue(WebDriver driver,String itemName, String category, ArrayList<String> test_steps) throws InterruptedException {
		...
		String strUnitItemsRows = "//table[contains(@id,'UnitOwnerItemsList')]/tbody/tr";
		String strFirstUnitOwnerItem = "//table[contains(@id,'UnitOwnerItemsList')]/tbody/tr[2]/td[1]/a";
		...
		if (unitItemsRows.size()>2) {
			...
			accountsLogger.info("Clicked on first Unit Owner item");
			...
			CreateNewUnitItem(driver, itemName, "", "", "10", "Owner Revenue", category, "Room Charge");
			items.add("10");
			items.add("Room Charge");
		}

		return items;
	}
	
	public HashMap<String, String> getAssociatedUnitOwnerItemsList(WebDriver driver,String itemName, String category, ArrayList<String> test_steps) throws InterruptedException {
		...
		if (unitItemsRows.size()>2) {
			...
			accountsLogger.info("Clicked on first Unit Owner item");
			List<WebElement> AssociatedItems = driver.findElements(By.xpath(strAssocitedItems));
			items.put("value", driver.findElement(By.xpath(value)).getAttribute("value"));

			for (int i = 1; i < AssociatedItems.size(); i++) {
				List<WebElement> cells = AssociatedItems.get(i).findElements(By.tagName("td"));
				itemsAssociated = itemsAssociated + "|" + cells.get(0).getText();
			}
			items.put("ledgerItems", itemsAssociated);
			
			if (driver.findElement(By.xpath("//label[contains(text(),'Owner Revenue')]//preceding-sibling::input")).isSelected()) {
				items.put("unitType", "Owner Revenue");
			}else if (driver.findElement(By.xpath("//label[contains(text(),'Owner Expense')]//preceding-sibling::input")).isSelected()) {
				items.put("unitType", "Owner Expense");
			}

		}else {
			CreateNewUnitItem(driver, itemName, "", "", "10", "Owner Revenue", category, "Room Charge");
			items.put("value", "10");
			items.put("ledgerItems", "Room Charge");
			items.put("unitType", "Owner Revenue");
	...
	public String  createAccount(WebDriver driver, ArrayList<String> test_steps, ExtentTest test, String accountType, String accountName, String firstName,
	...
	public Double postedFirstLineItemAndGetAmount(WebDriver driver, ArrayList<String> test_steps) {
		...
		try {
			driver.findElement(By.xpath("(//td[contains(@class,'changestatus')])[1]/i")).click();
			Save(driver);
			folio.includeTaxinLIneItemCheckbox(driver, true);
			String amount = driver.findElement(By.xpath("(//table[contains(@class,'table-foliogrid')]//tr/td[11]/span)[1]")).getText();
			outBoundAmount = Double.parseDouble(amount.split(" ")[1]);
		}catch(Exception e) {
			test_steps.add(e.toString());
			accountsLogger.info(e.toString());
		}
		accountsLogger.info("OutBound amount: "+outBoundAmount);
		return outBoundAmount;
	}
	
	public void postedLineItem(WebDriver driver, String category, ArrayList<String> test_steps) {
		String lineItem = "//span[text()='"+category+"']/../..//td[contains(@class,'changestatus')]/i";
		try {
	...
	public ArrayList<String> deleteAllAccount(WebDriver driver, String accountName, ArrayList<String> test_steps)
			throws InterruptedException {

		boolean accountFoundMessage = false;
		Elements_Accounts CreateAccount = new Elements_Accounts(driver);
		String path="//div[contains(@data-bind,'NoOfRecordsPerPage')]//ul[contains(@class, 'pagination')]//li[not(contains(@class,'disabled'))]/a";
		...
		if(isExist) {
 			...
 			accountFoundMessage = true;
			Utility.app_logs.info("Record Found");
 			}
		
		
			if(accountFoundMessage) {
				//Get Total matching records displayed text
				String rightIconDisabled="(//div[contains(@data-bind,'NoOfRecordsPerPage')]//ul[contains(@class, 'pagination')]//li[(contains(@class,'disabled'))]/a/i[contains(@class,'right')])[2]";
				String pathOfRightArrow="(//div[contains(@data-bind,'NoOfRecordsPerPage')]//ul[contains(@class, 'pagination')]//li[not(contains(@class,'disabled'))]/a/i)[2]";				
				boolean isRightEnabled=Utility.isElementPresent(driver, By.xpath(pathOfRightArrow));
				boolean tillRightDisabled=false;
				if(isRightEnabled) {
				do {
					String path1="//a[contains(@data-bind,'AccountName')and contains(text(),'"+accountName+"')]/parent::*/parent::*//td//input";
					List<WebElement> listOFElement=driver.findElements(By.xpath(path1));
					
					for(int i=0;i<listOFElement.size();i++) {
						Utility.ScrollToElement(listOFElement.get(i), driver);
					...
					test_steps.add(Toast_Message);
					accountsLogger.info(Toast_Message);
					Utility.ScrollToElement(driver.findElement(By.xpath(pathOfRightArrow)), driver);
					driver.findElement(By.xpath(pathOfRightArrow)).click();
					accountsLogger.info("Click on Right Arrow");
					tillRightDisabled=Utility.isElementPresent(driver, By.xpath(rightIconDisabled));
				}while(!tillRightDisabled);
				}else {
					String path1="//a[contains(@data-bind,'AccountName')and contains(text(),'"+accountName+"')]/parent::*/parent::*//td//input";
					List<WebElement> listOFElement=driver.findElements(By.xpath(path1));
			...
			{
				test_steps.add("No Account Found");
				accountsLogger.info("No Account Found");
			}
			return test_steps;
			}

	public void distributeAmountUnitOwners(WebDriver driver, String amount) {		
		Elements_Accounts account = new Elements_Accounts(driver);
		
		account.buttonDistribute.click();
		accountsLogger.info("Clicked on Distribute");
		try {
			Wait.WaitForElement(driver, OR.txtAmountDistribute);
			Wait.waitForElementToBeVisibile(By.xpath(OR.txtAmountDistribute2), driver, 2);
			account.txtAmountDistribute2.clear();
			account.txtAmountDistribute2.sendKeys(amount);
			accountsLogger.info("Enter amount "+amount);
		}catch (Exception e) {
			Wait.WaitForElement(driver, OR.txtAmountDistribute);
			account.txtAmountDistribute.clear();
			account.txtAmountDistribute.sendKeys(amount);
			accountsLogger.info("Enter amount "+amount);
		}
		try {
			Wait.explicit_wait_visibilityof_webelement_3(account.selectPaymentMethodDistribute2, driver);
			new Select(account.selectPaymentMethodDistribute2).selectByVisibleText("Check");
		}catch (Exception e) {
			new Select(account.selectPaymentMethodDistribute).selectByVisibleText("Check");
		}		
		accountsLogger.info("Selected Payment method as Check");
		try {
			Wait.explicit_wait_visibilityof_webelement_3(account.buttonAddDistribute2, driver);
			account.buttonAddDistribute2.click();
		}catch (Exception e) {
			account.buttonAddDistribute.click();
		}
		accountsLogger.info("Clicked on Add button");
		try {
			Wait.WaitForElement(driver, OR.buttonContinuetDistribute);
			Wait.explicit_wait_visibilityof_webelement_3(account.buttonContinuetDistribute2, driver);
			account.buttonContinuetDistribute2.click();
		}catch (Exception e) {
			account.buttonContinuetDistribute.click();
		}
		accountsLogger.info("Clicked on Continue button");
	}

	public void navigateFolios(WebDriver driver) throws InterruptedException {
		Elements_Accounts ClickFolio = new Elements_Accounts(driver);

		try {
			Wait.waitForElementToBeVisibile(By.xpath(OR.Account_Folios1), driver);
			ClickFolio.account_Folios1.click();
			// Wait.explicit_wait_visibilityof_webelement(ClickFolio.Account_Folio_FolioOptions,
			// driver);
		} catch (Exception e) {
			Wait.waitForElementToBeVisibile(By.xpath(OR.Account_Folios2), driver);
			ClickFolio.account_Folios2.click();
	...
	public String getGiftCerificateRedeedmedAmount(WebDriver driver) {
		Elements_Accounts account = new Elements_Accounts(driver);
		Wait.WaitForElement(driver, OR.GiftCertificateRedeemed);
		String amount = account.GiftCertificateRedeemed.getText();
		accountsLogger.info("Gift Certificate Redeemed amount: "+amount);
		return amount;
	}
	
	public void makePayment(WebDriver driver, String PaymentType, String CardName, String CCNumber, String CCExpiry,
			String CCVCode, String Authorizationtype, String ChangeAmount, String ChangeAmountValue)
			throws InterruptedException {
		Elements_Accounts AccountPayment = new Elements_Accounts(driver);
		JavascriptExecutor jse = (JavascriptExecutor) driver;
		...
		if (PaymentType.equalsIgnoreCase("MC") || PaymentType.equalsIgnoreCase("Visa") || PaymentType.equalsIgnoreCase("Amex") || 
			...
			try {
				Wait.explicit_wait_visibilityof_webelement_3(AccountPayment.Apply_Advance_Deposite, driver);
				// Wait.explicit_wait_xpath(OR.Apply_Advance_Deposite);
				AccountPayment.Click_Continue_Adv_Deposite.click();
			}catch (Exception e) {
		...
		Wait.waitForElementToBeClickable(By.xpath(OR.Click_Account_Pay_Continue), driver);
		AccountPayment.Click_Account_Pay_Continue.click();
		Wait.explicit_wait_visibilityof_webelement(AccountPayment.Get_Line_item_Account, driver);
	}
	public void createNewAccountWithTaxExempt(WebDriver driver, ArrayList<String> test_steps, String accountType,
			String accountName, String marketSegment, String referral, String accountFirstName, String accountLastName,
			String phonenumber, String alternativeNumber, String address1, String address2, String address3, String email,
			String city, String state, String postalcode,String TaxExemptID) throws Exception {
		clickOnNewAccountButton(driver, test_steps, accountType);
		enterAccountDetails(driver, test_steps, accountType, accountName, "");
		if (Utility.validateString(marketSegment) || Utility.validateString(referral)) {
			enterAccountAttributes(driver, marketSegment, referral);
		...
		String taxExempt="//label[text()='Tax Exempt:']/following-sibling::input";
		Wait.WaitForElement(driver, taxExempt);
		driver.findElement(By.xpath(taxExempt)).click();
		Wait.wait2Second();
		
		String taxExemptId="//label[text()='Tax ExemptID:']/following-sibling::div/input";
		Wait.WaitForElement(driver, taxExemptId);
		driver.findElement(By.xpath(taxExemptId)).sendKeys(TaxExemptID);
		
		test_steps.add("Tax exempt is enable in account and entered tax exempt id as : "+TaxExemptID);
		accountsLogger.info("Tax exempt is enable in account and entered tax exempt id as : "+TaxExemptID);
	...
	public void outboundAdvancedDepositForLineItem(WebDriver driver, String category, ArrayList<String> test_steps) throws Exception {
		Elements_Accounts account = new Elements_Accounts(driver);
		String advancedDepositBalance = "//span[text()='Advance Deposit Balance']";
		String checkbox = "//span[text()='Payment Details']/../../../../..//span[text()='"+category+"']/../../td/input";
		try {
			...
			Wait.wait5Second();
			Wait.waitForElementToBeVisibile(By.xpath(OR.Select_Account_paymethod), driver, 20);
			...
			account.Click_AddPayment_Account.click();
			Wait.wait5Second();
			Wait.waitForElementToBeClickable(By.xpath(OR.Click_Account_Pay_Continue), driver);
			account.Click_Account_Pay_Continue.click();
			Wait.explicit_wait_visibilityof_webelement(account.Get_Line_item_Account, driver);
			Save(driver);
		}catch (Exception e) {
			accountsLogger.info(e.toString());
		}
	}
	public void VerifyAccountNameAndType(WebDriver driver, String AccountType,ArrayList<String> testSteps) throws InterruptedException {
		Wait.wait2Second();
		Elements_Accounts CreateAccount = new Elements_Accounts(driver);
		Wait.WaitForElement(driver, OR.Verify_Account_Type);
		Wait.explicit_wait_visibilityof_webelement_150(CreateAccount.Verify_Account_Type, driver);
		String selectedOption = new Select(CreateAccount.Verify_Account_Type).getFirstSelectedOption().getText();
		Assert.assertEquals(AccountType, selectedOption);
		testSteps.add("Verified account type is "+AccountType.toLowerCase());
		String value=CreateAccount.Enter_Account_Name.getText();
		assertEquals(value, "","Account name is not empty");
		testSteps.add("Verified account name is empty");
		
	}

	public void ClickOnNewAccountButton(WebDriver driver, ArrayList<String> testSteps) {
		String NewAccountButtonxpath = "//button[contains(text(),'New Account')]";
		Wait.WaitForElement(driver, NewAccountButtonxpath);
		Wait.waitForElementToBeClickable(By.xpath(NewAccountButtonxpath), driver);
		driver.findElement(By.xpath(NewAccountButtonxpath)).click();

	}
	
	public void associateAnyRooms(WebDriver driver, ArrayList<String> test_steps, String roomclass)
			throws InterruptedException {
		String associate = "//button[contains(text(),'Associate Rooms')]";
		Wait.WaitForElement(driver, associate);
		driver.findElement(By.xpath(associate)).click();
		...
		String roomclassname = "//label[contains(text(),'Room Class:')]/following-sibling::div/select";
		Wait.WaitForElement(driver, roomclassname);
		new Select(driver.findElement(By.xpath(roomclassname))).selectByVisibleText(roomclass);
		test_steps.add("selected room class : " + roomclass);
	...
	//Added By Riddhi - Method get HA(House Account) Account Number
	public String getHAAccountNumber(WebDriver driver, ExtentTest test1, String AccountName) throws InterruptedException {
	...
	public String getGCNumberFromFolio(WebDriver driver)
	{
		Elements_Accounts CreateAccountlineitem = new Elements_Accounts(driver);				
		String gcNumber = CreateAccountlineitem.gcNumber.getText();
		accountsLogger.info("GetID :" + gcNumber);
		String GetSplitid[] = gcNumber.split("#");
		accountsLogger.info("Gift Certificate Number:" + GetSplitid[1]);
		return GetSplitid[1];
	}
	public void clickOnGCFolioAddButton(WebDriver driver, ArrayList<String> test_steps)
	{
		Elements_Accounts accEle = new Elements_Accounts(driver);
	}
	//Added By Riddhi - Make Payment in House Account Folio
			...
			String PostalCode, String AuthCode) throws InterruptedException 
	{
		...
		elements_All_Payments.HouseAccoutn_Enter_Amount.sendKeys(Keys.TAB);
		...
		Save(driver);
		// Verify payment		
		String amount = Utility.convertDecimalFormat(Amount);
		amount = "$" + amount + "";		
		oldFolioObj.Verify_LineItem(driver, PaymentType, Amount, "");		
	}
}
