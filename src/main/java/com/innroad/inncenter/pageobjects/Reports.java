...
public class Reports implements IReports {
	...
	public ArrayList<String> VerifyCityLedger(WebDriver driver, String LedgerType, ArrayList<String> test_steps)
	...
	public ArrayList<String> BalanceLedgerReport(WebDriver driver, ArrayList<String> test_steps)
			throws InterruptedException {
		Elements_Reports elements_Reports = new Elements_Reports(driver);
	...
	public ArrayList<String> BalanceLedgerGoButton(WebDriver driver, ArrayList<String> test_steps)
			throws InterruptedException {
	...
	public ArrayList<String> BalanceLedgeWithShiftReport(WebDriver driver, ArrayList<String> test_steps)
			throws InterruptedException {
	...
	public ArrayList<String> BalanceLedgeWithDepartmentReport(WebDriver driver, ArrayList<String> test_steps)
			throws InterruptedException {
	...
	public ArrayList<String> LedgerBalance_DepartmentReportUnderSummary(WebDriver driver, ArrayList<String> test_steps)
			throws InterruptedException {
	...
	public ArrayList<String> LedgerBalance_Dates(WebDriver driver, ArrayList<String> test_steps)
			throws InterruptedException {
	...
	public ArrayList<String> LedgerBalance_DepartmentReportUnderDetail(WebDriver driver, ArrayList<String> test_steps)
			throws InterruptedException {
	...
	public ArrayList<String> BalanceLedgeWithShift_DetailsReport(WebDriver driver, ArrayList<String> test_steps)
			throws InterruptedException {
	...
	public ArrayList<String> BalanceLedgeWithDepartment_DetailsReport(WebDriver driver, ArrayList<String> test_steps)
			throws InterruptedException {
	...
	public ArrayList<String> SelectMarchantDate(WebDriver driver, ArrayList<String> test_steps)
			throws InterruptedException {
		Elements_Reports elements_Reports = new Elements_Reports(driver);
		...
		if (ActiveDate.equals("1")) {
			...
			/*
			 * int currentDate = Integer.parseInt(ActiveDate); currentDate = currentDate -
			 * 1; String SelectDate = String.valueOf(currentDate);
			 * driver.findElement(By.xpath("(//td[.='" + SelectDate + "'])[1]")).click();
			 */
			elements_Reports.FirstOfTheMonth.click();
		}
	...
	public ArrayList<String> MerchantGoButton(WebDriver driver, ArrayList<String> test_steps)
			throws InterruptedException {
	...
	public ArrayList<String> DailyFlashReport(WebDriver driver, ArrayList<String> test_steps)
			throws InterruptedException {
	...
	public ArrayList<String> ManagementTransferReport(WebDriver driver, ArrayList<String> test_steps)
			throws InterruptedException {
	...
	public ArrayList<String> BreakoutTaxExempt_Revenue(WebDriver driver, ArrayList<String> test_steps)
			throws InterruptedException {
	...
	public ArrayList<String> DailyFlashGoButton(WebDriver driver, ArrayList<String> test_steps)
			throws InterruptedException {
	...
	public ArrayList<String> SelectRoomForecast_FromDate(WebDriver driver, ArrayList<String> test_steps)
			throws InterruptedException {
		Elements_Reports elements_Reports = new Elements_Reports(driver);
	...
	public ArrayList<String> SelectRoomForecast_ToDate(WebDriver driver, ArrayList<String> test_steps)
			throws InterruptedException {
		Elements_Reports elements_Reports = new Elements_Reports(driver);
	...
	public ArrayList<String> RoomForecastGoButton(WebDriver driver, ArrayList<String> test_steps)
			throws InterruptedException {
	...
	public ArrayList<String> SelectNetSales_FromDate(WebDriver driver, ArrayList<String> test_steps)
			throws InterruptedException {
	...
	public ArrayList<String> GenerateAdvanceDepositeReport(WebDriver driver, ArrayList<String> test_steps,
			String reportType, String DetailLevel) throws InterruptedException {
		Elements_Reports elements_Reports = new Elements_Reports(driver);
	...
	public ArrayList<String> AdvanceDepositGoButton(WebDriver driver, ArrayList<String> test_steps)
			throws InterruptedException {
	...
	public ArrayList<String> AccountBalanceGoButton(WebDriver driver, ArrayList<String> test_steps)
			throws InterruptedException {
	...
	public String verifyGuestStatementReport(WebDriver driver, ArrayList<String> test_steps)
			throws InterruptedException {
	...
	public File selectDate(WebDriver driver, ArrayList test_steps, String date, ArrayList Revenue,
			ArrayList Revenuetype, ArrayList amount, ArrayList MTD, ArrayList YTD, ArrayList daypay, ArrayList monthpay,
		...
		try {
			...
			/*
			 * outer : while(i<20){ label=driver.findElement(By.xpath(monthYear)).getText();
			 * if(label.equalsIgnoreCase(month)){ Wait.WaitForElement(driver, dateTest);
			...
			// break outer;
			/*
			 * }else{ Wait.wait2Second(); Wait.WaitForElement(driver,
			 * OR.Repoprts_DailyFlash_Calender_Right);
	...
	public void verifyInnroadLogo(File file, ArrayList test_steps) throws Exception {
		...
		for (Page p : pdf.getPages()) {
			...
			for (Image img : p.getImages()) {
				FileOutputStream out = new FileOutputStream(new File(outputDir,
						String.format("%s-%s.%s", p.getPageNumber(), i, img.dataFormat().name().toLowerCase())));
				out.write(img.data());
				out.close();
				i++;
			}
		...
		BufferedImage biB = ImageIO
				.read(new File(System.getProperty("user.dir") + "/externalFiles/downloadFiles/0-0.png"));
		...
		if (sizeA == sizeB) {
			...
			test_steps.add("Innroad logo validated sucessfully " + "<img src='" + System.getProperty("user.dir")
...
//	
	public ArrayList<String> verfiyInnroadLogo() throws IOException {
		...
		for (Page p : pdf.getPages()) {
			...
			System.out.printf("Found %s images on page %s", p.getImages().size(), p.getPageNumber());
			System.out.println();
			// test_steps.add(String.format("Found %s images on page %s",
			// p.getImages().size(), p.getPageNumber()));
...
//				+ "\\externalFiles\\downloadFiles\\0-0.png' hight=" + 50 + " width =" + 50 + "/>");
	...
	public ArrayList<String> verfiyInnroadLogo(String fileName) throws IOException, InterruptedException {
		...
		File file = new File(System.getProperty("user.dir") + File.separator + "externalFiles" + File.separator
				+ "downloadFiles" + File.separator + fileName);
		...
		for (String img : ImgList) {
			File loadImage = new File(
					System.getProperty("user.dir") + "/externalFiles/downloadFiles/" + folderName + "/" + img);
...
//				+ "\\externalFiles\\downloadFiles\\0-0.png' hight=" + 50 + " width =" + 50 + "/>");
	...
	public void Report_Verify_ReportContent(WebDriver driver, String reportContent, String compareData,
	...
	public ArrayList<String> breakoutTaxExemptRevenue(WebDriver driver, ArrayList<String> test_steps)
			throws InterruptedException {
	 ...
	 * ################
	 * 
	 * ' Method Name: <verifyFlashReportLayout> ' Description: <Verify the content
	 * of flash report> ' Input parameters: <WebDriver driver, String qaProperty,
	 * String dailyFlashReport, String yTD, String mTD> ' Return value:
	 ...
	 * ################
	 */
	public ArrayList<String> verifyFlashReportLayout(WebDriver driver, String qaProperty, String dailyFlashReport,
			String yTD, String mTD) throws InterruptedException {
		Elements_Reports reports = new Elements_Reports(driver);
	 ...
	 * ################
	 * 
	 * ' Method Name: <selectDate> ' Description: <Select today date in daily flash
	 * report> ' Input parameters: < 'WebDriver' separated parameters type> ' Return
	 * value: <ArrayList> ' Created By: <Jamal Nasir> ' Created On: <04/28/2020>
	 * 
	 * #############################################################################
	 * #############################################################################
	 * ################
	 ...
	 * ################
	 * 
	 * ' Method Name: <selectNetSalesFromDate> ' Description: <Select From date> '
	 * Input parameters: <WebDriver driver, String checkInDate> ' Return value:
	 ...
	 * ################
	 * 
	 * ' Method Name: <selectNetSalesToDate> ' Description: <Select To date> ' Input
	 * parameters: <WebDriver driver, String checkOutDate> ' Return value:
	 * <ArrayList> ' Created By: <Jamal Nasir> ' Created On: <05/06/2020>
	 * 
	 * #############################################################################
	 * #############################################################################
	 * ################
	 */
	public ArrayList<String> selectNetSalesToDate(WebDriver driver, String checkOutDate) throws InterruptedException {
		Elements_Reports elementsReports = new Elements_Reports(driver);
		ArrayList<String> test_steps = new ArrayList<>();
			...
			if (headerText.equalsIgnoreCase(monthYear)) {
				...
				for (int k = 1; k <= size; k++) {
					...
					if (!classText.contains("old")) {
						driver.findElement(By.xpath(date)).click();
						Wait.wait2Second();
						assertTrue(!elementsReports.NetSalesStayonToDate.getAttribute("value").isEmpty(),
	 ...
	 * ################
	 * 
	 * ' Method Name: <VerifyNetSalesReport> ' Description: <Verify Content Of
	 * NetSales Report> ' Input parameters: <WebDriver driver, String
	 * NetSalesReport, String GroupBy, String qaProperty, String StayFromDate,
	 * String StayToDate, String JSRoomClass, String RoomClass, int
	 * numberOfReservation> ' Return value: <ArrayList> ' Created By: <Jamal Nasir>
	 ...
	 * ################
	 */
	public ArrayList<String> verifyNetSalesReport(WebDriver driver, String netSalesReport, String groupBy,
			String qaProperty, String stayFromDate, String stayToDate, String jsRoomClass, String roomClass,
			int numberOfReservation) throws InterruptedException {
		Elements_Reports reports = new Elements_Reports(driver);
		ArrayList<String> test_steps = new ArrayList<>();
		File theNewestFile = null;
		File getFile = null;
							...
							if (!map.containsKey(weekConsumedDesc)) {
								...
								if (line.contains(String.valueOf(numberOfReservation))) {
									if (!map.containsKey(String.valueOf(numberOfReservation))) {
										System.out.print(line.toString());
										test_steps.add(
												"Verified NetSales report grouped by week consumed has total three reservations");
										reportLogger.info(
												"Verified NetSales report grouped by week consumed has total three reservations");
						...
						if (line.contains(jsRoomClass)) {
							if (!map.containsKey(jsRoomClass)) {
								...
								if (line.contains(jsRoomClassRes)) {
									...
									reportLogger
											.info("Verified room class (" + jsRoomClass + ") have two reservations");
	 ...
	 * ################
	 * 
	 * ' Method Name: <netSalesGroupBy> ' Description: <Select groupBy option> '
	 * Input parameters: <WebDriver driver, String groupBy> ' Return value:
	 * <ArrayList<String>> ' Created By: <Jamal Nasir> ' Created On: <05/06/2020>
	 * 
	 * #############################################################################
	 * #############################################################################
	 ...
	 * ################
	 * 
	 * ' Method Name: <verifyGuestsReport> ' Description: <This method will verify
	 * content of GuestReports WithTaxBreakdown> ' Input parameters: <WebDriver
	 * driver, String reportHeading, String incidentalName, String description,
	 * String amount, String reservationNumber,String roomClassName, String
	 * roomClassDescription,String roomNumber,String folioTaxes, String
	 * folioRoomCharges, String paymentMethod> ' Return value: <ArrayList<String>> '
	...
	public ArrayList<String> verifyGuestsReport(WebDriver driver, String reportHeading, String incidentalName,
			String description, String amount, String reservationNumber, String roomClassName,
			String roomClassDescription, String roomNumber, String folioTaxes, String folioRoomCharges,
			String paymentMethod) throws InterruptedException {
		File theNewestFile = null;
		File getFile = null;
		ArrayList<String> test_steps = new ArrayList<>();
		String verifyIncidentalAmount = incidentalName + " " + description + " " + roomClassName + " : " + roomNumber
				+ " $ -" + amount;
		...
		String verifyRoomClass = "Room Charge " + roomClassDescription + " " + roomClassName + " : " + roomNumber
				+ " $ " + folioTaxes + " $ " + totalRoomCharges;
						...
						for (String line : lines) {
							...
							if (line.contains(reservationNumber)) {
								if (!map.containsKey(reservationNumber)) {
									...
									reportLogger
											.info("Verified reservation number(" + reservationNumber + ") in report");
							...
							if (line.contains(verifyIncidentalAmount)) {
								if (!map.containsKey(verifyIncidentalAmount)) {
									if (!map.containsKey(verifyIncidentalAmount)) {
										test_steps.add("Verified that void line item(" + incidentalName + ") amount("
												+ amount + ") has negative sign(-) in report");
										reportLogger.info("Verified that void line item(" + incidentalName + ") amount("
												+ amount + ") has negative sign(-) in report");
							...
							if (line.contains(verifyRoomClass)) {
								if (!map.containsKey(verifyRoomClass)) {
									test_steps.add("Verified RoomClass(" + roomClassName + "), room charges amount("
											+ folioRoomCharges + ") and  tax(" + folioTaxes + ")  in report");
									reportLogger.info("Verified RoomClass(" + roomClassName + "), room charges amount("
											+ folioRoomCharges + ") and  tax(" + folioTaxes + ")  in report");
	 ...
	 * ################
	 * 
	 * ' Method Name: <SelectLedgerBalanceFromDate> ' Description: <This method will
	 * select from date in ledger balance report> ' Input parameters: <WebDriver
	 * driver, String fromDate> ' Return value: <ArrayList<String>> ' Created By:
	 ...
	 * ################
	 * 
	 * ' Method Name: <SelectLedgerBalanceToDate> ' Description: <This method will
	 * select from date in ledger balance report> ' Input parameters: <WebDriver
	 * driver, String toDate> ' Return value: <ArrayList<String>> ' Created By:
	 * <Jamal Nasir> ' Created On: <05/18/2020>
	 * 
	 * #############################################################################
	 * #############################################################################
	 * ################
	 */
	public ArrayList<String> SelectLedgerBalanceToDate(WebDriver driver, String toDate) throws InterruptedException {
		Elements_Reports elementsReports = new Elements_Reports(driver);
		ArrayList<String> test_steps = new ArrayList<>();
	 ...
	 * ################
	 * 
	 * ' Method Name: <clickCheckBoxIncidentals> ' Description: <This method will
	 * click Incidentals in ledger balance report> ' Input parameters: <WebDriver
	 ...
	 * ################
	 */
	public ArrayList<String> clickAllIncidentalsSelectCheckBox(WebDriver driver) throws InterruptedException {
		Elements_Reports elementsReports = new Elements_Reports(driver);
		ArrayList<String> test_steps = new ArrayList<>();
	 ...
	 * ################
	 * 
	 * ' Method Name: <selectGroupBy> ' Description: <This method will select group
	 * by options in ledger balance report> ' Input parameters: <WebDriver driver> '
	 ...
	 * ################
	 */
	public ArrayList<String> selectGroupBy(WebDriver driver, String Category) throws InterruptedException {
		ArrayList<String> test_steps = new ArrayList<>();
	 ...
	 * ################
	 * 
	 * ' Method Name: <clickIncidentalsCheckBoxes> ' Description: <This method will
	 * select specific check box in ledger balance report> ' Input parameters:
	 * <WebDriver driver, String incidentalName> ' Return value: <ArrayList<String>>
	 ...
	 * ################
	 * 
	 * ' Method Name: <clickItemStatus> ' Description: <This method will select
	 * specific check box for ItemStatus in ledger balance report> ' Input
	 * parameters: <WebDriver driver, String status> ' Return value:
	 * <ArrayList<String>> ' Created By: <Jamal Nasir> ' Created On: <05/18/2020>
	 * 
	 * #############################################################################
	 * #############################################################################
	 * ################
	...
	public ArrayList<String> clickItemStatus(WebDriver driver, String status) throws InterruptedException {
		ArrayList<String> test_steps = new ArrayList<>();
	 ...
	 * ################
	 * 
	 * ' Method Name: <verifyLegderBalanceReport> ' Description: <This method will
	 * verify ledger balance report content> ' Input parameters: <WebDriver driver,
	 * String incidentalName, String incidentalName2, String firstRoomNumber, String
	 * secondRoomNumber> ' Return value: <ArrayList<String>> ' Created By: <Jamal
	...
	public ArrayList<String> verifyLegderBalanceReport(WebDriver driver, String incidentalName, String incidentalName2,
			String incidentalName3, String firstRoomNumber, String secondRoomNumber) throws InterruptedException {
		File theNewestFile = null;
		File getFile = null;
		Elements_Reports reports = new Elements_Reports(driver);
		ArrayList<String> test_steps = new ArrayList<>();
					...
					for (String line : lines) {
							...
							if (!map.containsKey(incidentalName)) {
								if (line.contains(firstRoomNumber)) {
									if (!map.containsKey(firstRoomNumber)) {
										test_steps.add("Verified that item description (" + incidentalName
												+ ") exist in report");
										reportLogger.info("Verified that item description (" + incidentalName
												+ ") exist in report");
										map.put(incidentalName, 1);
										test_steps.add("Verified that item description (" + incidentalName
												+ ") is displayed along with Room number (" + firstRoomNumber + ") ");
										reportLogger.info("Verified that item description (" + incidentalName
												+ ") is displayed along with Room number (" + firstRoomNumber + ") ");
						...
						if (line.contains(incidentalName2)) {
							if (!map.containsKey(incidentalName2)) {
								if (line.contains(firstRoomNumber)) {
									test_steps.add(
											"Verified that item description (" + incidentalName2 + ") exist in report");
									reportLogger.info(
											"Verified that item description (" + incidentalName2 + ") exist in report");
									map.put(incidentalName2, 1);
									test_steps.add("Verified that item description (" + incidentalName2
											+ ") is displayed along with Room number (" + firstRoomNumber + ")");
									reportLogger.info("Verified that item description (" + incidentalName2
											+ ") is displayed along with Room number (" + firstRoomNumber + ")");
						...
						if (line.contains(incidentalName3)) {
							if (!map.containsKey(incidentalName3)) {
								if (line.contains(secondRoomNumber)) {
									test_steps.add(
											"Verified that item description (" + incidentalName3 + ") exist in report");
									reportLogger.info(
											"Verified that item description (" + incidentalName3 + ") exist in report");
									map.put(incidentalName3, 1);
									test_steps.add("Verified that item description (" + incidentalName3
											+ ") is displayed along with Room number (" + secondRoomNumber + ")");
									reportLogger.info("Verified that item description (" + incidentalName3
											+ ") is displayed along with Room number (" + secondRoomNumber + ")");
	 ...
	 * ################
	 * 
	 * ' Method Name: <navigateAccountBalance> ' Description: <This method will
	 * navigate to Account Balance tab> ' Input parameters: <WebDriver> ' Return
	 ...
	 * ################
	 * 
	 * ' Method Name: <selectLedgerType> ' Description: <This method will select
	 * ledger type> ' Input parameters: <WebDriver , String> ' Return value: <void>
	 ...
	 * ################
	 * 
	 * ' Method Name: <selectAccountTypeCheckBox> ' Description: <This method will
	 * select the label's checkBox based on the 'checked' parameter> ' Input
	 * parameters: <WebDriver, String, boolean> ' Return value: <ArrayList<String>>
	 * ' Created By: <Adhnan Ghaffar> ' Created On: <06/02/2020>
	 * 
	 * #############################################################################
	 * #############################################################################
	 ...
	 * ################
	 * 
	 * ' Method Name: <printReportData> ' Description: <This method will download
	 * the report and print it on console> ' Input parameters: <WebDriver> ' Return
	 * value: <void> ' Created By: <Adhnan Ghaffar> ' Created On: <02/06/2020>
	 * 
	 * #############################################################################
	 * #############################################################################
	 * ################
	...
	public File verifyGuestStement(WebDriver driver, String fileName, ArrayList<String> documentfields,
			String ContentFields, ArrayList<String> test_steps) throws InterruptedException {

		File theNewestFile = null;
		File getFile = null;
		/*
		 * String line1
		 * =checkInDate+" "+category+" "+description+" "+validateRoomwithRoomNumber1+" "
		 * +" $ "+" "+tax+" "+" $"+" "+amount; String
		 * line2=checkOutDate+" "+category+" "+description+" "
		 * +validateRoomwithRoomNumber1+" "+" $ "+" "+tax+" "+" $"+" "+amount;
		 */
		getFile = new File(System.getProperty("user.dir") + File.separator + "externalFiles" + File.separator
				+ "downloadFiles" + File.separator + fileName);
	...
	public void verifyGuestStatementReportGenerated(WebDriver driver, ArrayList<String> test_steps)
			throws InterruptedException {
	 ...
	 * ########################
	 *
	 * ' Method Name: getLineHavingData ' Description: This method will return line
	 * String having data in it . ' Input parameters: (driver, String[], String) '
	 * Return value: String ' Created By: Adhnan Ghaffar ' Created On: <07/14/2020>
	 * #########################################################################
	 * #########################################################################
	 * ########################
	 */
	public String getLineHavingData(WebDriver driver, String[] lines, String data) throws InterruptedException {
	 ...
	 * ################
	 * 
	 * ' Method Name: <selectDailyFlashSpecificDate> ' Description: <Select any
	 * specificdate from the current month or from future> ' Input parameters: <
	 * 'WebDriver' separated parameters type> ' Return value: <ArrayList> ' Created
	 * By: <Adhnan Ghaffar> ' Created On: <07/21/2020>
	 * 
	 * #############################################################################
	 * #############################################################################
	 * ################
	 ...
	 * ################
	 */
	public void selectAnyDateFromCalender(WebDriver driver, ArrayList<String> test_steps, String startDate,
	...
	public void verifyReportContent(WebDriver driver, String[] reportContent, Map<String, String> contentFields,
			ArrayList<String> test_steps) {
		Object[] contentField = contentFields.keySet().toArray();

		try {
			for (Object contentpassed : contentField) {
                boolean matched = false;
				String val = contentFields.get(contentpassed).toString().trim();
				for (String rpContent : reportContent) {

					if (rpContent.trim().contains(val)) {
						test_steps
								.add("Verify content found in report: " + contentFields.get(contentpassed).toString());
						//found[i] = rpContent.trim();
						matched = true;
...
test_steps.add("FAIL - One or more content failed to match" + "<br>"
							+ "<a href='https://innroad.atlassian.net/browse/NG-11639'>"
							+ "Click here to open JIRA: NG-11639</a>"
	 ...
	 * ################
	 * 
	 * ' Method Name: <verifyNightAuditReport> ' Description: <Verify the currency label
	 * in night audit report> ' Input parameters: <WebDriver driver, String currencyLabel,>
	 ...
	 * ################
	 */
	public ArrayList<String> verifyNightAuditReport(WebDriver driver, String currencyLabel) throws InterruptedException {
		Elements_Reports reports = new Elements_Reports(driver);
		ArrayList<String> test_steps = new ArrayList<>();
		File theNewestFile = null;
		File getFile = null;
		...
		reportLogger.info("getCurrency : " + getCurrency);
		...
		try {
			...
			String iframe1 = "//iframe[@id='dialog-body0']";
			Wait.WaitForElement(driver, iframe1);
			Wait.waitForElementToBeVisibile(By.xpath(iframe1), driver);
			driver.switchTo().frame("dialog-body0");
			reportLogger.info("Switched to iframe1");

			String iframe = "//iframe[@id='ifrmAccountStatement']";
			Wait.WaitForElement(driver, iframe);
			Wait.waitForElementToBeVisibile(By.xpath(iframe), driver);			
			driver.switchTo().frame("ifrmAccountStatement");
			reportLogger.info("Switched to iframe2");
			...
			try {
				...
				if (!document.isEncrypted()) {
					...
					for (String line : lines) {
						...
						if (line.contains(getCurrency)) {
							if (!map.containsKey(getCurrency)) {
								test_steps.add("Verified " + getCurrency + " in Night Audit Report");
								reportLogger.info("Verified " + getCurrency + " in Night Audit Report");
								map.put(getCurrency, 1);
							}
						}
					}
					document.close();
