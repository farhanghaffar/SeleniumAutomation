...
public class ChangeCountryStateInRoomingListAndVerifyForGroup extends TestCore {
	...
	public void verifyCountryInRoomingList_GroupAcc(String url, String clientcode, String username, String password,
			...
			String State3) throws InterruptedException, IOException, ParseException {
		...
		try {
			...
			getTest_Steps.clear();
			getTest_Steps = group.verifyRoomingListSummaryInfo(driver, BlockName, "Reserved", "50");
			test_steps.addAll(getTest_Steps);
	...
	public Object[][] getData() {
		...
		return Utility.getData("ChangeCountryStateInRoomingList", excel);
	}
