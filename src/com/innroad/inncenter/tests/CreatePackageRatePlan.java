...
public class CreatePackageRatePlan extends TestCore {
	...
	@Test
	public void createPackageRatePlan() throws InterruptedException, IOException, ParseException {
		...
		String extraRoomClassesInSeason = "#3 - Twin Beds";
		...
		String seasonRuleSpecificRoomClasses= null;
		...
		test_name = "CreatePackageRatePlan";
	...
	//			login.login(driver, envURL, "autorates", "autouser", "Auto@123");
		...
		try {
			...
			testSteps.add("=================== GET FIRST PRODUCT DEFAULT PRICE AND CALCULATION METHOD ======================");
			app_logs.info("=================== GET FIRST PRODUCT DEFAULT PRICE AND CALCULATION METHOD ======================");
		...
		try {
			...
			nightlyRate.createSeasons(driver, testSteps, seasonStartDate, seasonEndDate, seasonName, isMonDay,
					...
					roomClassesName, seasonRuleType, seasonRuleMinStayValue, isSeasonRuleOnMonday,
