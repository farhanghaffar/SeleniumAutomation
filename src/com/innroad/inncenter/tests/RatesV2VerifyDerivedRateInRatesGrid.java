...
public class RatesV2VerifyDerivedRateInRatesGrid extends TestCore {
	...
	public void ratesV2VerifyDerivedRateInRatesGrid(String clientName, String delim, String parentRatePlanType,
			String parentRatePlanName, String parentRateFolioName, String parentRateDescription,
			String intervalRatePlanIntervalValue, String isDefaultProRateChecked, String packageRateType,
			String packageratePlanProduct, String packageRatePlanPerRateIncrementType1,
			String packageRatePlanPerRateIncrementType2, String packageRatePlanProductAmount, String channels,
			String roomClassNames,  String isRatePlanRistrictionReq, String ristrictionType,
			String isMinStay, String minNights, String isMaxStay, String maxNights, String isMoreThanDaysReq,
			String moreThanDaysCount, String isWithInDaysReq,  String withInDaysCount, String promoCode,String isPolicesReq, String policyTypes,
			String policyNames, String parentSeasonName, String isSundayCheck, String isMondayCheck,
			String isTuesdayCheck, String isWednesdayCheck, String isThursdayCheck, String isFridayCheck,
			String isSaturdayCheck, String isAdditionalChargesForChildrenAdults, String parentMaxAdults,
			String parentMaxPersons, String parentAdditionalAdultsPerNight, String parentAdditionalChildPerNight,
			String parentIsAddRoomClassInSeason, String roomClassesBaseAmount, String additionalAdult,
			String additionalChild, String seasonDuration, String seasonRules, String seasonRuleMinStayValue,
			String derivedRatePlan, String derivedRatePlanFolioDisplayName, String derivedRatePlanDescription,
			String percentValue, String currencyValue, String istakenRulesFromParentRateplan, String seasonType,
			String customStartDate, String customEndDate, String overrideDerivedRateValue, String overrideBaseRateValue,
			String bulkUpdateDerivedRateValue, String bulkUpdateBaseRateValue,
			String bulkUpdateDerivedRateMinimumStayValue, String overrideDerivedRateMinimumStayValue,
			String bulkUpdateBaseRateMinimumStayValue, String overrideBaseRateMinimumStayValue,
			String isTotalOccupancyOn, String totalOccupancyType, String totalOccupancyValue, String isMinimumStayOn,
			String isCheckInToggle, String isBulkNoCheckIn, String isCheckOutToggle, String isBulkNoCheckOut)
		...
		app_logs.info("startDateForCustomDateRange : " + customStartDate);
		app_logs.info("endDateForCustomDateRange : " + customEndDate);
		String[] startDateArray = customStartDate.split(Utility.DELIM);
		app_logs.info(startDateArray[0]);
		String startDate = startDateArray[0];
		app_logs.info("Start date : " + customStartDate);

		String[] endDateArray = customEndDate.split(Utility.DELIM);
		app_logs.info(endDateArray[endDateArray.length - 1]);
		String endDate = endDateArray[endDateArray.length - 1];
		app_logs.info("End date : " + customEndDate);
...
/*
		...
		try {
			...
			if (policies.verifyListOfPoliciesExist(driver, tempPolicyNames, policyNames) == null) {
...
*/
		...
		try {
			...
			app_logs.info("Excel Sheet Date : " + customStartDate);

			if (Utility.compareDates(startDate, todayDate, dateFormat) > 0) {
...
>>>>>>> MavenDockerIntegration
		...
		try {
			...
			getTestSteps = derivedRate.createDerivedRatePlan(driver, "Derived rate plan",
					...
					Boolean.parseBoolean(istakenRulesFromParentRateplan), seasonType, customStartDate, customEndDate, dateFormat,
		...
		try {
			...
			getTestSteps = derivedRate.createDerivedRatePlan(driver, "Derived rate plan",
					...
					seasonType, customStartDate, customEndDate, dateFormat, channels, "All", seasonDuration, timeZone);
			testSteps.addAll(getTestSteps);
	...
	public Object[][] getData() {
		...
		return Utility.getData("VerifyDeriveRateFromNightlyRate", excel);
	}
