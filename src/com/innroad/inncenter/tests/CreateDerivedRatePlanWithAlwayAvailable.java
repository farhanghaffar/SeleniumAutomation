...
public class CreateDerivedRatePlanWithAlwayAvailable extends TestCore {
	...
	public static String RatePlanName = "DerivedRatePlan" + Utility.generateRandomString();
	public static String FolioDisplayName= "FolioRatePlan" + Utility.generateRandomString();
	public static String ratePlanDescription = "Derived rate Plan Description" + Utility.generateRandomString();
	public static String Channels = "innCenter";
	public static String RoomClasses = "select all";	

	public static String RistrictionType = "Length of stay,Booking window,Promo code";
	public static String MinNights = "2"; 
	public static String MaxNights = "2";
	public static String MoreThanDaysCount = "2";
	public static String WithInDaysCount = "2"; 
	public static String PromoCode = "abc123"; 
	public static String currencyOptions = "USD,percent";
	public static String valueOptions = "greater than,lesser than";
	public static String USD = "USD"; 
	public static String percent = "percent";
	public static String percentValue = "78";
	public static String USDValue = "1989"; 
	public static String dateType = "Always available";
	...
	@Test
	public void createDerivedRatePlanWithAlwayAvailable()
			throws InterruptedException, IOException {

		Utility.DELIM = ",";

		test_name = "CreateDerivedRatePlanWithAlwayAvailable";
		...
		try {
			...
			ratePlanNames = ratesGrid.getActiveRatePlans(driver, "Nightly", "Interval", 140);
			existingRateName = ratePlanNames.get(0);
			testSteps.add("Get all Nightly and Interval rate plan " + ratePlanNames);
			app_logs.info("Get all Nightly and Interval rate plan " + ratePlanNames);
		...
		try {
			...
			derivedRate.selectRatePlan(driver, ratePlanNames.get(0), true, testSteps);
		...
		try {
			...
			if (getValue.equalsIgnoreCase(valueOptions.split(",")[0])) {
				...
				derivedRate.expandCurrencyValueDropdown(driver, 2);
				testSteps.add("Expand Value Comparison DropDown");
				app_logs.info("Expand Value Comparison DropDown");
				derivedRate.selectDropDownOptions(driver, valueOptions.split(",")[1], testSteps);
			} else {
			...
			derivedRate.takeRuleFromParentRatePlanCheckBox(driver, false, testSteps);
