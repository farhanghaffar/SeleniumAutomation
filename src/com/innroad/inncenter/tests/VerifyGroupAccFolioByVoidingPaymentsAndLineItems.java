...
public class VerifyGroupAccFolioByVoidingPaymentsAndLineItems extends TestCore {
	...
	public void verifyGroupAccFolioByVoidingPaymentsAndLineItems(String url, String clientcode, String username,
			...
			String adults, String children, String rateplan, String Salutation, String CardNumber, String NameOnCard) throws InterruptedException, IOException {
	...
	public Object[][] getData() {
		...
		return Utility.getData("VerifyGrpFolioByVoidPayLineItm", excel);
	}
