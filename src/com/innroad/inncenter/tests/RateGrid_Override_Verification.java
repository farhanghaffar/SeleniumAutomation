...
public class RateGrid_Override_Verification extends TestCore{
	...
	public void checkRunMode() {
		...
		public void rateGridOverrideVerification(String delim,String planType, String ratePlanName, String folioDisplayName,
				...
				String isSeasonRuleOnSunday, String newNight, String rate, String newAdult)
		{
			...
			try
			{
				...
				rateGrid.updateRuleForMinStay(driver, testSteps, extraRoomClassesInSeason, channelNames.get(0), ratesConfig.getProperty("minStay"));
