...
public class VerifyDocTemplateFunctionality extends TestCore {
    ...
    public void verifyDocTemplateFunctionality(String firstRatePlan, String secondRatePlan, String channels, String firstRoomClass,
                                               String secondRoomClass, String seasonName, String firstRoomRatePerNight, String secondRoomRatePerNight,
                                               String documentTemplateName, String templateDescription, String isDefaultTemplate, String propertyName,
                                               String confirmationEmailTriggers, String confirmationEmailEvents, String confirmationEmailAttachments,
                                               String otherFunctions, String contentFields, String salutation, String firstName, String lastName,
                                               String country, String address1, String address2, String address3, String city, String state, String stateShort,
                                               String poBox, String phoneNumber, String referral, String marketSegment, String emailAddress, String paymentType,
                                               String cardNumber, String cardName, String cardExpDate, String noteType, String noteSubject, String noteDescription,
                                               String manualEmailAttachment, String manualEmailContentFields, String manualEmailSpecialCharacters,
                                               String isMRBStr, String userFirstName, String userLastName, String clientName) {
        ...
        String corporateAccount = "CorporateAccount" + Utility.generateRandomString();
        ...
        documentTemplateName = documentTemplateName + Utility.generateRandomString();
        ...
        try {
            ...
            emailContentMap.put("Address", address1 + "|" + address2 + "|" + address3 + "|" + city + "|" + stateShort + "|" + poBox);
            ...
            emailContentMap.put("SystemDate", LocalDate.now().plusDays(0).format(DateTimeFormatter.ofPattern("EEE, MMM dd, yyyy")));
        ...
        try {
            ...
            if(!confirmationEmailTriggers.contains("None")) {
                String[] triggerArray = confirmationEmailTriggers.equals("") ? new String[]{} : confirmationEmailTriggers.split("\\|", -1);
                String[] eventArray = confirmationEmailEvents.equals("") ? new String[]{} : confirmationEmailEvents.split("\\|", -1);
                String[] attachmentArray = confirmationEmailAttachments.equals("") ? new String[]{""} : confirmationEmailAttachments.split("\\|", -1);
                ...
                for (int i = 0; i < triggerArray.length; i++) {
                    ...
                    if (scenariosToValidateMap.containsKey(key)) {
                        test_steps.add("Invalid test data provided - duplicate trigger for same event is provided in test data");
                        app_logs.info("Invalid test data provided - duplicate trigger for same event is provided in test data");
                        Assert.fail("Invalid test data provided - duplicate trigger for same event is provided in test data");
                    }
        ...
        try {
            if(contentFields.contains("Policies") || manualEmailContentFields.contains("Policies")) {
                ...
                HashMap<String, ArrayList<String>> foundCheckInPrintText = policies.createPolicies(driver, test_steps, "\\|", "\\*",
                        "Cancellation|Deposit|Check-in|No Show", cancellationPolicyName, depositPolicyName, checkInPolicyName, noShowPolicyName,
                        "flat fee|flat fee|% of balance on check-in|flat fee", "10|10|10|10",
                        "captured|captured|captured|captured", "0", "after the reservation was made", "false|false|false|false", "");
        ...
        try {
            if(contentFields.contains("travelAgentName") || manualEmailContentFields.contains("travelAgentName")) {
                ...
                account.createAccount(driver, test_steps, test, "Travel Agent", travelAgent, "Account First Name",
                        "Account First Name", "0987654321", "0987654321", "innroadguest@gmail.com",
                        marketSegment, referral, address1, address2, address3, city, state, poBox);
        ...
        try {
            if(contentFields.contains("accountName") || manualEmailContentFields.contains("accountName")) {
                ...
                navigation.navigateToAccounts(driver, test_steps);
                account.createAccount(driver, test_steps, test, "Corporate/Member Accounts", corporateAccount, "Account First Name",
                        "Account First Name", "0987654321", "0987654321",
                        "innroadguest@gmail.com", marketSegment, referral, address1, address2, address3, city, state, poBox);
        ...
        try {
            ...
            boolean attachPolicyToRatePlan = contentFields.contains("Policies") || manualEmailContentFields.contains("Policies");
            ...
            nightlyRate.createNightlyRatePlan(driver, test_steps, firstRatePlan, channels, roomClasses, seasonStartDate, seasonEndDate, seasonName,
                    firstRoomRatePerNight + "|" + secondRoomRatePerNight,
                    cancellationPolicyName, depositPolicyName, checkInPolicyName, noShowPolicyName, attachPolicyToRatePlan);
            ...
            if(scenariosToValidateMap.containsKey("ON_RATE_CHANGE") || scenariosToValidateMap.containsKey("NONE")) {
                ...
                ratesGrid.clickRateGridAddRatePlan(driver);
                ratesGrid.clickRateGridAddRatePlanOption(driver, "Nightly rate plan");
                nightlyRate.createNightlyRatePlan(driver, test_steps, secondRatePlan, channels, roomClasses, seasonStartDate, seasonEndDate, seasonName,
                        firstRoomRatePerNight + "|" + secondRoomRatePerNight,
                        cancellationPolicyName, depositPolicyName, checkInPolicyName, noShowPolicyName, attachPolicyToRatePlan);
            }
        ...
        try {
            ...
            for (String key : scenariosToValidateMap.keySet()) {
                ...
                documentTemplate.addOrAssociateConfirmationEmailFunction(driver, functionData.get(0), functionData.get(1), functionData.get(2).split("\\*"), test_steps);
            }
        ...
        try {
            ...
            emailContentMap.put("ArrivalDate", LocalDate.now().plusDays(0).format(DateTimeFormatter.ofPattern("EEE, MMM dd, yyyy")));
            emailContentMap.put("BookedOn", LocalDate.now().plusDays(0).format(DateTimeFormatter.ofPattern("EEE, MMM dd, yyyy")));
            emailContentMap.put("DepartureDate", LocalDate.now().plusDays(3).format(DateTimeFormatter.ofPattern("EEE, MMM dd, yyyy")));
            ...
            if(contentFields.contains("travelAgentName") || manualEmailContentFields.contains("travelAgentName")) {
                cpReservationPage.enter_MarketSegmentDetails(driver, test_steps, travelAgent, marketSegment, referral, false);
            } else {
            ...
            if (scenariosToValidateMap.containsKey("ON_QUOTE") || scenariosToValidateMap.containsKey("NONE")) {
                ...
                if(scenariosToValidateMap.containsKey("ON_QUOTE")) {
                    validateEmail(emailSubject, scenariosToValidateMap.get("ON_QUOTE"), contentFields, documentTemplateName, otherFunctions, 300);
                }
            ...
            emailContentMap.put("AdultsChildren", cpReservationPage.getNoOfAdults_ResDetail(driver) + "/" + cpReservationPage.getNoOfChilds_ResDetail(driver));
            ...
            if(otherFunctions.contains("Confirmation Message")) {
                ...
                if(emailUtils.newEmailReceived(emailSubject, emailCount, 300)) {
            ...
            if (scenariosToValidateMap.containsKey("ON_RESERVED") || scenariosToValidateMap.containsKey("NONE")) {
                ...
                if(scenariosToValidateMap.containsKey("ON_RESERVED")) {
                    validateEmail(emailSubject, scenariosToValidateMap.get("ON_RESERVED"), contentFields, documentTemplateName, otherFunctions,300);
                }
            ...
            if (scenariosToValidateMap.containsKey("ON_ARRIVAL_DATE") || scenariosToValidateMap.containsKey("NONE")) {
                ...
                if(scenariosToValidateMap.containsKey("ON_ARRIVAL_DATE")) {
                    validateEmail(emailSubject, scenariosToValidateMap.get("ON_ARRIVAL_DATE"), contentFields, documentTemplateName, otherFunctions,300);
                }
            ...
            if (scenariosToValidateMap.containsKey("ON_CONFIRMED") || scenariosToValidateMap.containsKey("NONE")) {
                ...
                if(scenariosToValidateMap.containsKey("ON_CONFIRMED")) {
                    validateEmail(emailSubject, scenariosToValidateMap.get("ON_CONFIRMED"), contentFields, documentTemplateName, otherFunctions,300);
                }
            ...
            if (scenariosToValidateMap.containsKey("ON_GUARANTEED") || scenariosToValidateMap.containsKey("NONE")) {
                ...
                if(scenariosToValidateMap.containsKey("ON_GUARANTEED")) {
                    validateEmail(emailSubject, scenariosToValidateMap.get("ON_GUARANTEED"),contentFields, documentTemplateName,  otherFunctions,300);
                }
            ...
            if (scenariosToValidateMap.containsKey("ON_ON_HOLD") || scenariosToValidateMap.containsKey("NONE")) {
                ...
                if(scenariosToValidateMap.containsKey("ON_ON_HOLD")) {
                    validateEmail(emailSubject, scenariosToValidateMap.get("ON_ON_HOLD"),contentFields, documentTemplateName,  otherFunctions,300);
                }
            ...
            if (scenariosToValidateMap.containsKey("ON_NO_SHOW") || scenariosToValidateMap.containsKey("NONE")) {
                ...
                if(scenariosToValidateMap.containsKey("ON_NO_SHOW")) {
                    validateEmail(emailSubject, scenariosToValidateMap.get("ON_NO_SHOW"), contentFields, documentTemplateName, otherFunctions,300);
                }
            ...
            if (scenariosToValidateMap.containsKey("ON_DATE_CHANGE") || scenariosToValidateMap.containsKey("NONE")) {
                ...
                if (isMRB) {
                    ...
                    test_steps.addAll(cpReservationPage.enterCheckInDate(driver, startDate.format(DateTimeFormatter.ofPattern("MM/dd/yyyy"))));
                    test_steps.addAll(cpReservationPage.enterCheckOutDate(driver, endDate.format(DateTimeFormatter.ofPattern("MM/dd/yyyy"))));
                    cpReservationPage.clickOnFindRooms(driver, test_steps);
                    emailCount = getEmailMessageCount(emailSubject);
                    ...
                    if(scenariosToValidateMap.containsKey("ON_DATE_CHANGE")) {
                        validateEmail(emailSubject, scenariosToValidateMap.get("ON_DATE_CHANGE"), contentFields, documentTemplateName, otherFunctions, 300);
                    }
            ...
            if (scenariosToValidateMap.containsKey("ON_RATE_CHANGE") || scenariosToValidateMap.containsKey("NONE")) {
                ...
                if (isMRB) {
                    ...
                    test_steps.addAll(cpReservationPage.selectRoomInStayInfoSectionUpdated(driver, firstRoomClass, "Yes"));
                    emailCount = getEmailMessageCount(emailSubject);
                    ...
                    if(scenariosToValidateMap.containsKey("ON_RATE_CHANGE")) {
                        validateEmail(emailSubject, scenariosToValidateMap.get("ON_RATE_CHANGE"), contentFields, documentTemplateName, otherFunctions, 300);
                    }
            ...
            if (scenariosToValidateMap.containsKey("ON_ROOM_CHANGE") || scenariosToValidateMap.containsKey("NONE")) {
                ...
                if (isMRB) {
                    cpReservationPage.editMRBReservationChangeStayDetails(driver, 1, 2);
                    test_steps.addAll(cpReservationPage.clickFindRooms(driver));
                    test_steps.addAll(cpReservationPage.selectRoomInStayInfoSectionUpdated(driver, secondRoomClass, "Yes"));
                    emailCount = getEmailMessageCount(emailSubject);
                    ...
                    if(scenariosToValidateMap.containsKey("ON_ROOM_CHANGE")) {
                        validateEmail(emailSubject, scenariosToValidateMap.get("ON_ROOM_CHANGE"), contentFields, documentTemplateName, otherFunctions, 300);
                    }
            ...
            if (scenariosToValidateMap.containsKey("ON_CANCELLED") || scenariosToValidateMap.containsKey("NONE")) {
                ...
                if(scenariosToValidateMap.containsKey("ON_CANCELLED")) {
                    validateEmail(emailSubject, scenariosToValidateMap.get("ON_CANCELLED"), contentFields, documentTemplateName, otherFunctions,300);
                }
            ...
            if (scenariosToValidateMap.containsKey("ON_IN-HOUSE") || scenariosToValidateMap.containsKey("NONE")) {
                ...
                if(scenariosToValidateMap.containsKey("ON_IN-HOUSE")) {
                    validateEmail(emailSubject, scenariosToValidateMap.get("ON_IN-HOUSE"), contentFields, documentTemplateName, otherFunctions, 300);
                }
            ...
            if (scenariosToValidateMap.containsKey("ON_DEPARTED") || scenariosToValidateMap.containsKey("NONE")) {
                ...
                if(scenariosToValidateMap.containsKey("ON_DEPARTED")) {
                    validateEmail(emailSubject, scenariosToValidateMap.get("ON_DEPARTED"), contentFields, documentTemplateName, otherFunctions, 300);
                }
            ...
            if (!manualEmailAttachment.equals("") || !manualEmailContentFields.equals("")) {
                ...
                cpReservationPage.manualEmail(driver, emailAddress, manualEmailSubject, manualEmailAttachment, "New Email", manualEmailContentFields, "");
            ...
            if (!manualEmailSpecialCharacters.equals("")) {
                ...
                cpReservationPage.manualEmail(driver, emailAddress, manualEmailSubject, "", "New Email", "", manualEmailSpecialCharacters);
            ...
            if (validateConfirmationLetter) {
                ...
                cpReservationPage.manualEmail(driver, emailAddress, manualEmailSubject, documentTemplateName, documentTemplateName, "", "");
                validateManualEmail(manualEmailSubject, documentTemplateName, "", "", 300);
            }

            if(validateConfirmationLetter) {
                app_logs.info("========= Validating if Confirmation Letter is attached to the Reservation Page ========");
                if(cpReservationPage.verifyIfDocumentIsAvailableOnReservationPage(driver, test_steps, documentTemplateName)) {
                    ...
                    app_logs.info("========= Assertion Confirmation Letter is not attached to the Reservation Page ========");
                    test_steps.add("========= Assertion Confirmation Letter is not attached to the Reservation Page ========");
                }
            }
            ...
            if (Utility.reTry.get(test_name) == Utility.count) {
                RetryFailedTestCases.count = Utility.reset_count;
                Utility.AddTest_IntoReport(test_name, test_description, test_catagory, test_steps);
                Utility.updateReport(e, "Failed to create reservation or validate triggers", test_name, "Login", driver);
            } else {
                Assert.fail();
            }
    ...
    private void validateNoEmailReceived(String emailSubject, String trigger, long timeOutInSeconds) {
        boolean emailReceived = emailUtils.newEmailReceived(emailSubject, emailCount, timeOutInSeconds);
        if (emailReceived) {
    ...
    private void validateEmail(String emailSubject, ArrayList<String> scenarioDataArray, String contentFields,
        ...
        if(!emailReceived && trigger.equalsIgnoreCase("ON_NO_SHOW")) {
            test_steps.add("Document Template existing issue email is not received on No Show <br>" + "<a href='https://innroad.atlassian.net/browse/NG-10281' target='_blank'>NG-10281</a>");
        }

        String[] attachments = scenarioDataArray.get(2).split("\\*");
        ArrayList<String> attachmentArrayList = new ArrayList<>();

        if(emailReceived && contentFields.contains("ReservationDetailsLink") && emailContentMap.get("ReservationDetailsLink").equals("")) {
            emailContentMap.put("ReservationDetailsLink", emailUtils.getReservationDetailLink(driver, emailSubject, reservationNumber));
        }
        ...
        if (emailReceived && contentFields != null && !contentFields.equals("")) {
            try {
                documentTemplate.verifyDocumentTemplate(driver, test_steps, emailUtils, contentFields, emailSubject, emailContentMap, "\\|", true);
            } catch (Exception e) {
    ...
    private void validateManualEmail(String emailSubject, String attachment, String contentFields,
        ...
        boolean emailReceived = emailUtils.newEmailReceived(emailSubject, 0, timeOutInSeconds);
    ...
    public Object[][] getData() {
        return Utility.getData("VerifyDocTemplateFunc", excel);
    }
