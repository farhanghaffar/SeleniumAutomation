...
public class ReportsV2LedgerBalancesNegativeTesting extends TestCore {
	...
	public void ValidateLedgerBalancesReport(String Scenario, String DateRange, String StartDate, String EndDate,
		...
		UnitExpenses="", UnitRevenues="", TravelAgentCommission="",
		DistributionMethod="", GiftCertificate="", GiftCertificateRedeemed="";
...
//			}
		...
		if (accountTypeOptions.isEmpty()) {
			//accountTypeOptions = "House Account,Group,Corporate/Member Accounts,Reservations,Unit Owners,Gift Certificate,Travel Agent";
			accountTypeOptions = "Group,House Account,Corporate/Member Accounts,Reservations,Unit Owners,Gift Certificate,Travel Agent";
		}
		...
		if (accountTypeOptions.split(",").length == 1) {
			...
			else if (accountTypeOptions.equals("Reservations")) {
...
//				TripSummaryBalance = report.getFolioAmountExcludingCurrency(driver, reservationPage.get_TripSummaryBalanceWithCurrency(driver, test_steps));
			...
			try {
				...
				try{
					...
					report.validateLedgerReportSummaryView(driver, beforeLedgerCategoryDetails, beforeDetailsOfAllLedgerCategories, afterLedgerCategoryDetails, afterDetailsOfAllLedgerCategories, 
							ledgerAccounts, ledgerAmounts, folioItemValues, numberOfRooms, test_steps);
...
//					}
			...
			try {
				...
				report.validateLedgerReportDetailedView(driver, ledgerAccounts, folioItemValues, numberOfRooms, reservationNumbers, guestNames, arrivalDates, itemDescription, roomChargeAmount, "$", test_steps);
...
//						}
	...
	public Object[][] getData() {
		...
		return Utility.getData("NegativeLedgerBalances", excel);
