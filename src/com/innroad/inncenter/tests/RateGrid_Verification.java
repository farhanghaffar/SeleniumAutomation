...
public class RateGrid_Verification extends TestCore{
	...
	String dayNum="";
	String weekDay="";
	String  roomClass2=null, oldRateIs=null, newRateIs=null, seasonStartDate=null, seasonEndDate=null ;
	...
	public void rateGridVerification(String activeRatePlanColor,String derivedRatePlanColor,String inactiveRatePlanColor,String delim,String planType,String ratePlanName,String folioDisplayName, String description, String channels, 
			...
			String isSeasonRuleOnThursday, String isSeasonRuleOnFriday, String isSeasonRuleOnSaturday, String isSeasonRuleOnSunday, String isSeasonPolicies, String seasonPolicyType, 
	...
	// Verify Edit icon Delete Icon and Get Default RatePlan and Total RatePlan
			...
			testSteps.add("Total Rate Plans: <b>"+size+ "</b>");	
				...
				Utility.catchException(driver, e, "Verify Edit Icon , Delete Icon, Get Default RatePlan and Total Rateplan", "RateGrid", "RateGrid", testName, test_description, test_catagory, testSteps);
			} catch (Error e) {
				Utility.catchError(driver, e, "Verify Edit Icon , Delete Icon, Get Default RatePlan and Total Rateplan", "RateGrid", "RateGrid", testName, test_description, test_catagory, testSteps);
		...
		try
		{
			...
			Utility.catchException(driver, e, "Inactive, Active, Derived RatePlan", "RateGrid", "RateGrid", testName, test_description, test_catagory, testSteps);
		} catch (Error e) {
			Utility.catchError(driver, e, "Inactive, Active, Derived RatePlan", "RateGrid", "RateGrid", testName, test_description, test_catagory, testSteps);
		...
		try
		{
		/*	getRatePlanNames=rateGrid.getRatePlanNames(driver);
			boolean isExist=rateGrid.verifyRatePlanExist(driver, testSteps, Utility.rateplanName, getRatePlanNames);
			if(!isExist)
			{
				Utility.logoutToRateV2(driver, testSteps);
				CreateNightlyRatePlanV2 createRatePlan= new CreateNightlyRatePlanV2();
			//	createRatePlan.createNightlyRatePlanV2(delim, ratePlanName, folioDisplayName, description, channels, roomClasses, isRatePlanRistrictionReq, ristrictionType, isMinStay, minNights, isMaxStay, maxNights, isMoreThanDaysReq, moreThanDaysCount, isWithInDaysReq, withInDaysCount, promoCode, isPolicesReq, policiesType, policiesName, seasonName, seasonStartDate, seasonEndDate, isMonDay, isTueDay, isWednesDay, isThursDay, isFriday, isSaturDay, isSunDay, isAdditionalChargesForChildrenAdults, ratePerNight, maxAdults, maxPersons, additionalAdultsPerNight, additionalChildPerNight, isAddRoomClassInSeason, extraRoomClassesInSeason, extraRoomClassRatePerNight, extraRoomClassMaxAdults, extraRoomClassMaxPersons, extraRoomClassAdditionalAdultsPerNight, extraRoomClassAdditionalChildPerNight, isAssignRulesByRoomClass, seasonRuleSpecificRoomClasses, seasonRuleType, seasonRuleMinStayValue, isSeasonRuleOnMonday, isSeasonRuleOnTuesday, isSeasonRuleOnWednesday, isSeasonRuleOnThursday, isSeasonRuleOnFriday, isSeasonRuleOnSaturday, isSeasonRuleOnSunday, isSeasonPolicies, seasonPolicyType, seasonPolicyValues);
				navigation.ratesGrid(driver,testSteps);	
			...
			Utility.catchException(driver, e, "Select RatePlan and Edit RatePlan", "RateGrid", "RateGrid", testName, test_description, test_catagory, testSteps);
		} catch (Error e) {
			Utility.catchError(driver, e, "Select RatePlan and Edit RatePlan", "RateGrid", "RateGrid", testName, test_description, test_catagory, testSteps);
		...
		try
		{
			...
			Utility.catchException(driver, e, "Description and Condition of RatePlan", "RateGrid", "RateGrid", testName, test_description, test_catagory, testSteps);
		} catch (Error e) {
			Utility.catchError(driver, e, "Description and Condition of RatePlan", "RateGrid", "RateGrid", testName, test_description, test_catagory, testSteps);
		...
		try
		{
			...
			Utility.catchException(driver, e, "Get Room Class size and All Room Classes Names and Verify Room Active Room Class and Availability Data", "RateGrid", "RateGrid", testName, test_description, test_catagory, testSteps);
		} catch (Error e) {
			Utility.catchError(driver, e, "Get Room Class size and All Room Classes Names and Verify Room Active Room Class and Availability Data", "RateGrid", "RateGrid", testName, test_description, test_catagory, testSteps);
		...
		try
		{
			...
			Utility.catchException(driver, e, "Get Room Class  and Channel Data", "RateGrid", "RateGrid", testName, test_description, test_catagory, testSteps);
		} catch (Error e) {
			Utility.catchError(driver, e, "Get Room Class  and Channel Data", "RateGrid", "RateGrid", testName, test_description, test_catagory, testSteps);
		...
		try
		{
			...
			Utility.catchException(driver, e, "Get Rule Applied on Which Room Classes  and get override and Non data of Room Class", "RateGrid", "RateGrid", testName, test_description, test_catagory, testSteps);
		} catch (Error e) {
			Utility.catchError(driver, e, "Get Rule Applied on Which Room Classes  and get override and Non data of Room Class", "RateGrid", "RateGrid", testName, test_description, test_catagory, testSteps);
		...
		try
		{
			...
			Utility.catchException(driver, e, "Get Color and Verify Room Class Color", "RateGrid", "RateGrid", testName, test_description, test_catagory, testSteps);
		} catch (Error e) {
			Utility.catchError(driver, e, "Get Color and Verify Room Class Color", "RateGrid", "RateGrid", testName, test_description, test_catagory, testSteps);
		...
		try
		{
			...
			Utility.catchException(driver, e, "Update Rate  and Verify Changed Information of Rate and verify color of Rate", "RateGrid", "RateGrid", testName, test_description, test_catagory, testSteps);
		} catch (Error e) {
			Utility.catchError(driver, e, "Update Rate  and Verify Changed Information of Rate and verify color of Rate", "RateGrid", "RateGrid", testName, test_description, test_catagory, testSteps);
		...
		try
		{
			...
			Utility.catchException(driver, e, "Removed OverRide, Delete RatePlan and Verify deleted ratePlan", "RatePlanName", "RatePlanName", testName, test_description, test_catagory, testSteps);
		} catch (Error e) {
			Utility.catchError(driver, e, "Removed OverRide, Delete RatePlan and Verify deleted ratePlan", "RatePlanName", "RatePlanName", testName, test_description, test_catagory, testSteps);
	...
	*/
	...
	public Object[][] getDataOne() {
		...
		return Utility.getData("RateGridOverrideVerification", excel);
