...
public class VerifyDerivedRatePlanInInnCenter extends TestCore {
...
//	Policies policy = new Policies();
	...
	ArrayList<String> noCheckInRuleMRB = new ArrayList<String>();
	ArrayList<String> noCheckOutRuleMRB = new ArrayList<String>();
	...
	public void verifyDerivedRatePlanInInnCenter(String delim, String ClientName, String parentRatePlanName,
			String derivedRatePlanName,
			String ReservationType, String CheckInDate, String CheckOutDate, String ReservationRoomClasses,
			String AccountFirstName, String AccountLastName, String adult, String children,
			String ModifyDeleteExistingChannel, String ModifyAddChannel,
			...
			String ModifyExtraRoomClassAdditionalChildPerNight, String ModifyisSerasonLevelRules,
			String ModifyisAssignRulesByRoomClass, String ModifySeasonRuleSpecificRoomClasses,
			String ModifySeasonRuleType, String ModifySeasonRuleMinStayValue, String ModifyisSeasonRuleOnMonday,
			String ModifyisSeasonRuleOnTuesday, String ModifyisSeasonRuleOnWednesday,
			String ModifyisSeasonRuleOnThursday, String ModifyisSeasonRuleOnFriday, String ModifyisSeasonRuleOnSaturday,
			String ModifyisSeasonRuleOnSunday,
			...
			String DrivedRulesUpdateType, String DrivedRulesUpdateStartDate, String DrivedRulesUpdateEndDate,
			String DrivedisSun_RulesUpdate, String DrivedisMon_RulesUpdate, String DrivedisTue_RulesUpdate,
			String DrivedisWed_RulesUpdate, String DrivedisThu_RulesUpdate, String DrivedisFri_RulesUpdate,
			String DrivedisSat_RulesUpdate, String DrivedType_RulesUpdate, String DrivedRuleMinStayValue_RulesUpdate,
			String DrivedRatesUpdateType, String DrivedcheckInDate_RatesUpdate, String DrivedcheckOutDate_RatesUpdate,
			String DrivedisSunday_RatesUpdate, String DrivedisMonday_RatesUpdate, String DrivedisTuesday_RatesUpdate,
			String DrivedisWednesday_RatesUpdate, String DrivedisThursday_RatesUpdate,
			String DrivedisFriday_RatesUpdate, String DrivedisSaturday_RatesUpdate, String DrivedupdateRatesType,
			String DrivedisUpdateRateByRoomClass, String DrivednightlyRate_RatesUpdate,
			String DrivedadditionalAdults_RatesUpdate, String DrivedadditionalChild_RatesUpdate,
			String ActionOnReservation, String isAccountPolicyApplicable, String ReservationChangeRoomClass,
			String ChangeResStartDate, String ChangeResEndDate, String ChangeAdult, String ChangeChildren) throws Exception {

		/**/
		Utility.DELIM = delim;

		test_name = "Derived Rate Plan Creation And Verify in Rate Grid";
		test_description = "Derived Rate Plan Creation And Verify in Rate Grid";
		test_catagory = "VerifyDerivedRatePlanInInnCenter";
		...
		String parentFolioDisplayName = ratePlanData.get("FolioDisplayName");
		String parentDescription = ratePlanData.get("Description");
		String parentChannels = ratePlanData.get("Channels");
		String parentRoomClasses = ratePlanData.get("RoomClasses");
		String parentisRatePlanRistrictionReq = ratePlanData.get("isRatePlanRistrictionReq");
		String parentRistrictionType = ratePlanData.get("RistrictionType");
		String parentisMinStay = ratePlanData.get("isMinStay");
		String parentMinNights = ratePlanData.get("MinNights");
		String parentisMaxStay = ratePlanData.get("isMaxStay");
		String parentMaxNights = ratePlanData.get("MaxNights");
		String parentisMoreThanDaysReq = ratePlanData.get("isMoreThanDaysReq");
		String parentMoreThanDaysCount = ratePlanData.get("MoreThanDaysCount");
		String parentisWithInDaysReq = ratePlanData.get("isWithInDaysReq");
		String parentWithInDaysCount = ratePlanData.get("WithInDaysCount");
		String parentPromoCode = ratePlanData.get("PromoCode");
		String parentisPolicesReq = ratePlanData.get("isPolicesReq");
		String parentPoliciesType = ratePlanData.get("PoliciesType");
		String parentPoliciesName = ratePlanData.get("PoliciesName");
		String parentSeasonName = ratePlanData.get("SeasonName");
		String parentSeasonStartDate = ratePlanData.get("SeasonStartDate");
		String parentSeasonEndDate = ratePlanData.get("SeasonEndDate");
		String parentisMonDay = ratePlanData.get("isMonDay");
		String parentisTueDay = ratePlanData.get("isTueDay");
		String parentisWednesDay = ratePlanData.get("isWednesDay");
		String parentisThursDay = ratePlanData.get("isThursDay");
		String parentisFriday = ratePlanData.get("isFriday");
		String parentisSaturDay = ratePlanData.get("isSaturDay");
		String parentisSunDay = ratePlanData.get("isSunDay");
		String parentisAdditionalChargesForChildrenAdults = ratePlanData.get("isAdditionalChargesForChildrenAdults");
		String parentRatePerNight = ratePlanData.get("RatePerNight");
		String parentMaxAdults = ratePlanData.get("MaxAdults");
		String parentMaxPersons = ratePlanData.get("MaxPersons");
		String parentAdditionalAdultsPerNight = ratePlanData.get("AdditionalAdultsPerNight");
		String parentAdditionalChildPerNight = ratePlanData.get("AdditionalChildPerNight");
		String parentisAddRoomClassInSeason = ratePlanData.get("isAddRoomClassInSeason");
		String parentExtraRoomClassesInSeason = ratePlanData.get("ExtraRoomClassesInSeason");
		String parentExtraRoomClassRatePerNight = ratePlanData.get("ExtraRoomClassRatePerNight");
		String parentExtraRoomClassMaxAdults = ratePlanData.get("ExtraRoomClassMaxAdults");
		String parentExtraRoomClassMaxPersons = ratePlanData.get("ExtraRoomClassMaxPersons");
		String parentExtraRoomClassAdditionalAdultsPerNight = ratePlanData
				.get("ExtraRoomClassAdditionalAdultsPerNight");
		String parentExtraRoomClassAdditionalChildPerNight = ratePlanData.get("ExtraRoomClassAdditionalChildPerNight");
		String parentisSerasonLevelRules = ratePlanData.get("isSerasonLevelRules");
		String parentisAssignRulesByRoomClass = ratePlanData.get("isAssignRulesByRoomClass");
		String parentSeasonRuleSpecificRoomClasses = ratePlanData.get("SeasonRuleSpecificRoomClasses");
		String parentSeasonRuleType = ratePlanData.get("SeasonRuleType");
		String parentSeasonRuleMinStayValue = ratePlanData.get("SeasonRuleMinStayValue");
		String parentisSeasonRuleOnMonday = ratePlanData.get("isSeasonRuleOnMonday");
		String parentisSeasonRuleOnTuesday = ratePlanData.get("isSeasonRuleOnTuesday");
		String parentisSeasonRuleOnWednesday = ratePlanData.get("isSeasonRuleOnWednesday");
		String parentisSeasonRuleOnThursday = ratePlanData.get("isSeasonRuleOnThursday");
		String parentisSeasonRuleOnFriday = ratePlanData.get("isSeasonRuleOnFriday");
		String parentisSeasonRuleOnSaturday = ratePlanData.get("isSeasonRuleOnSaturday");
		String parentisSeasonRuleOnSunday = ratePlanData.get("isSeasonRuleOnSunday");
		String parentisSeasonPolicies = ratePlanData.get("isSeasonPolicies");
		String parentSeasonPolicyType = ratePlanData.get("SeasonPolicyType");
		String parentSeasonPolicyValues = ratePlanData.get("SeasonPolicyValues");
		...
		String[] startDateArray = derivedCustomStartDate.split(Utility.DELIM);
		String[] endDateArray = derivedCustomEndDate.split(Utility.DELIM);
		String[] RoomClass = parentRoomClasses.split("\\|");
		...
		if (PercentORCurrency.equalsIgnoreCase("currency")) {
			try {
				...
				getTest_Steps.clear();
				getTest_Steps = admin.clickOnClient(driver, ClientName);
				test_steps.addAll(getTest_Steps);
		...
		if (!israteplanExist) {
			...
			try {
				...
				nightlyRate.enterRateFolioDisplayName(driver, parentFolioDisplayName, test_steps);
				nightlyRate.enterRatePlanDescription(driver, parentDescription, test_steps);
				...
				nightlyRate.selectChannels(driver, parentChannels, true, test_steps);
				...
				nightlyRate.selectRoomClasses(driver, parentRoomClasses, true, test_steps);
				...
				nightlyRate.selectRestrictions(driver, Boolean.parseBoolean(parentisRatePlanRistrictionReq),
						parentRistrictionType, Boolean.parseBoolean(parentisMinStay), parentMinNights,
						Boolean.parseBoolean(parentisMaxStay), parentMaxNights,
						Boolean.parseBoolean(parentisMoreThanDaysReq), parentMoreThanDaysCount,
						Boolean.parseBoolean(parentisWithInDaysReq), parentWithInDaysCount, parentPromoCode,
						test_steps);

				restrictionsSummary = nightlyRate.getRestrictionsToQualifyRate(driver, test_steps);
				nightlyRate.clickNextButton(driver, test_steps);

				nightlyRate.verifyTitleSummaryValue(driver, "Restrictions", restrictionsSummary, test_steps);

				nightlyRate.selectPolicy(driver, parentPoliciesType, parentPoliciesName,
						Boolean.parseBoolean(parentisPolicesReq), test_steps);

				HashMap<String, String> allPolicyDesc = nightlyRate.getAllPolicyDescriptions(driver, parentPoliciesName,
						Boolean.parseBoolean(parentisPolicesReq), test_steps);
				nightlyRate.clickNextButton(driver, test_steps);
				nightlyRate.verifyPolicyTitleSummaryValue(driver, parentPoliciesName, allPolicyDesc,
						Boolean.parseBoolean(parentisPolicesReq), test_steps);
			} catch (Exception e) {
				e.printStackTrace();
				if (Utility.reTry.get(testName) == Utility.count) {
			...
			try {
				...
				app_logs.info(parentRatePerNight);
				nightlyRate.createSeason(driver, test_steps, parentSeasonStartDate, parentSeasonEndDate,
						parentSeasonName, parentisMonDay, parentisTueDay, parentisWednesDay, parentisThursDay,
						parentisFriday, parentisSaturDay, parentisSunDay, parentisAdditionalChargesForChildrenAdults,
						parentRatePerNight, parentMaxAdults, parentMaxPersons, parentAdditionalAdultsPerNight,
						parentAdditionalChildPerNight, parentisAddRoomClassInSeason, parentExtraRoomClassesInSeason,
						parentExtraRoomClassRatePerNight, parentExtraRoomClassMaxAdults, parentExtraRoomClassMaxPersons,
						parentExtraRoomClassAdditionalAdultsPerNight, parentExtraRoomClassAdditionalChildPerNight,
						parentisAssignRulesByRoomClass, parentisSerasonLevelRules, parentSeasonRuleSpecificRoomClasses,
						parentSeasonRuleType, parentSeasonRuleMinStayValue, parentisSeasonRuleOnMonday,
						parentisSeasonRuleOnTuesday, parentisSeasonRuleOnWednesday, parentisSeasonRuleOnThursday,
						parentisSeasonRuleOnFriday, parentisSeasonRuleOnSaturday, parentisSeasonRuleOnSunday,
						parentSeasonPolicyType, parentSeasonPolicyValues, parentisSeasonPolicies);
		...
		try {
			...
			if (selectedSeasonType.equalsIgnoreCase("Always available")) {
				...
				if (Boolean.parseBoolean(parentRatePlanOffSetList.get(3))) {
					...
					nightlyRate.selectSeasonDates(driver, test_steps, allDatesBW.get(0));
				...
				for (String source : selectedChannels) {
					for (String date : allDatesBW) {
						RatesGridChannelRatesRules parentRateRule = roomClassWiseSourceRatesRule.get(roomClass)
								.get(source).get(date);
						RatesGridChannelRatesRules derivedRateRule = roomClassWiseSourceDerivedRatesRule.get(roomClass)
								.get(source).get(date);
						...
						if (parentRateRule != null || derivedRateRule != null) {
							if (!parentRateRule.getRooomRate().equals("--")) {
								...
								assertEquals(Utility.convertDecimalFormat(parentRateRule.getExtraAdultRate()),
										...
										"Failed To Verify Extra Adult Rate Where Date : " + date + " Source : " + source
												+ " Room Class : " + roomClass);
								assertEquals(Utility.convertDecimalFormat(parentRateRule.getExtraChildRate()),
										...
										"Failed To Verify Extra Child Rate Where Date : " + date + " Source : " + source
												+ " Room Class : " + roomClass);

								if (Boolean.parseBoolean(parentRatePlanOffSetList.get(3))&& selectedRulesTypes.size()>0) {
									if(isAssignRulesByRoomClass) {
										if(selectedRulesSpecificRoomClasses.contains(roomClass)) {
											...
											for(String type : selectedRulesTypes) {
												...
												if(type.equalsIgnoreCase("Min nights")) {
													try{
														assertEquals(Integer.parseInt(rulesTypeValues.get(type)), derivedRateRule.getMinRule(),
													...
													try{
														assertEquals(nightlyRate.isRuleApplied(date, rulesTypeValues.get(type)), derivedRateRule.isNoCheckIn(),
													...
													try{
														assertEquals(nightlyRate.isRuleApplied(date, rulesTypeValues.get(type)), derivedRateRule.isNoCheckOut(),
										...
										for(String type : selectedRulesTypes) {
											...
											if(type.equalsIgnoreCase("Min nights")) {
												try {
													assertEquals(Integer.parseInt(rulesTypeValues.get(type)), Integer.parseInt(derivedRateRule.getMinRule()),
														"Failed To Verify Min Rule Value Where Date : " + date + " Source : "
																+ source + " Room Class : " + roomClass);
												}catch (Exception e) {
													test_steps.add(e.toString());
...
//													+ source + " Room Class : " + roomClass);
									...
									try{assertNotEquals(parentRateRule.getMinRule(), derivedRateRule.getMinRule(),
											"Failed To Verify Min Rule Value Where Date : " + date + " Source : "
													+ source + " Room Class : " + roomClass);
									}catch (Exception e) {
//										test_steps.add(e.toString());
									}
									try{assertNotEquals(String.valueOf(parentRateRule.isNoCheckIn()),
...
//										test_steps.add(e.toString());
									...
									try{assertNotEquals(String.valueOf(parentRateRule.isNoCheckOut()),
...
//										test_steps.add(e.toString());
						...
						app_logs.info("Successfully Verified Rate & Rules for RoomClass : " + roomClass + " and Source : "+source+" where date : " + date);
						test_steps.add("Successfully Verified Rate & Rules for RoomClass : " + roomClass + " and Source : "+source+" where date : " + date);
					}
				}
			}

			app_logs.info("=================== SUCCESSFULLY VERIFIED RATES GRID RATES AND RULES OF DERIVED RATE PLAN : "
					+ derivedRatePlanName.toUpperCase() + " AS PER BASE RATE PLAN : " + parentRatePlanName.toUpperCase()
					+ " ===================");
			test_steps
					.add("=================== SUCCESSFULLY VERIFIED RATES GRID RATES AND RULES OF DERIVED RATE PLAN : "
							+ derivedRatePlanName.toUpperCase() + " AS PER BASE RATE PLAN : "
							+ parentRatePlanName.toUpperCase() + " ===================");
		...
		try {
			...
			if(!ModifyDeleteExistingChannel.isEmpty() || !ModifyAddChannel.isEmpty() || !ModifyDeleteExistingSeasonLevelRoomClasses.isEmpty() 
					|| !ModifyExistingSeasonLevelRoomClasses.isEmpty() || Boolean .parseBoolean(ModifyisAddRoomClassInSeason) || Boolean.parseBoolean(ModifyisSerasonLevelRules) ) {
			
				test_name = "Verify Modifications : Parent Level Channels Season RoomClass & Rules";
				test_description = "Verify Modifications : Modify Parent Level Channels Season RoomClass & Rules";
				test_steps.clear();
			...
			test_steps.add("=================== UN-SELECT DISTRIBUTED CHANNELS ======================");
			app_logs.info("=================== UN-SELECT DISTRIBUTED CHANNELS ======================");

			nightlyRate.selectChannels(driver, ModifyDeleteExistingChannel, false, test_steps);
		
		
			test_steps.add("=================== SELECT DISTRIBUTED CHANNELS ======================");
			app_logs.info("=================== SELECT DISTRIBUTED CHANNELS ======================");

			nightlyRate.selectChannels(driver, ModifyAddChannel, true, test_steps);
			...
			nightlyRate.enterRoomClassSeasonRate(driver, allDatesBW, ModifyExistingSeasonLevelRoomClasses,
					ModifyRatePerNight, ModifyisAdditionalChargesForChildrenAdults, ModifyMaxAdults, ModifyMaxPersons,
					ModifyAdditionalAdultsPerNight, ModifyAdditionalChildPerNight);
			...
			nightlyRate.enterSeasonLevelRules(driver, test_steps, ModifyisSerasonLevelRules,
					ModifyisAssignRulesByRoomClass, ModifySeasonRuleSpecificRoomClasses, ModifySeasonRuleType,
					ModifySeasonRuleMinStayValue, ModifyisSeasonRuleOnMonday, ModifyisSeasonRuleOnTuesday,
					ModifyisSeasonRuleOnWednesday, ModifyisSeasonRuleOnThursday, ModifyisSeasonRuleOnFriday,
					ModifyisSeasonRuleOnSaturday, ModifyisSeasonRuleOnSunday);
			...
			nightlyRate.verifyChannelsDisplayed(driver, ModifyDeleteExistingChannel, false, test_steps);
			nightlyRate.verifyChannelsDisplayed(driver, ModifyAddChannel, true, test_steps);
			nightlyRate.selectChannelsEditPage(driver, ModifyAddChannel, true, test_steps);
			nightlyRate.verifySelectedChannelsEditPage(driver, ModifyAddChannel, true, test_steps);

			nightlyRate.verifyRoomClassDisplayed(driver, ModifyExtraRoomClassesInSeason, true, test_steps);
			nightlyRate.selectRoomClassesEditPage(driver, ModifyExtraRoomClassesInSeason, true, test_steps);
			nightlyRate.verifySelectedRoomClassesEditPage(driver, ModifyExtraRoomClassesInSeason, true, test_steps);
...
//										test_steps.add(e.toString());
						...
						app_logs.info("Successfully Verified Rate & Rules for RoomClaa : " + roomClass + " and Source : "+source+" where date : " + date);
						test_steps.add("Successfully Verified Rate & Rules for RoomClaa : " + roomClass + " and Source : "+source+" where date : " + date);
					}
				}
			}
		...
		try {
			...
			test_name = "Checking Availability B/w Check In Check Out Dates";
			test_description = "Checking Availability B/w Check In Check Out Dates";
			test_steps.clear();
		...
		try {
			...
			if ((RulesUpdateType.equalsIgnoreCase("Overide") || RulesUpdateType.equalsIgnoreCase("BulkUpdate"))) {
				...
				for (String roomClass : reservationRoomClassesList) {
					...
					if (RulesUpdateType.equalsIgnoreCase("Overide")) {
						ArrayList<String> RulesUpdateStartDateList = Utility .convertTokenToArrayList(RulesUpdateStartDate, delim);
						int days = Utility.getNumberofDays(RulesUpdateStartDateList.get(0), RulesUpdateStartDateList.get(RulesUpdateStartDateList.size()-1));
						if(days==0) {
							days=1;
						}
						parentInitialMinStayRuleList = rateGrid.getRuleDataValuesForMinStay(driver, test_steps, roomClass,
								channelName, days);
						...
						parentInitialMinStayRuleList = rateGrid.getRuleDataValuesForMinStay(driver, test_steps, roomClass,
								channelName, Utility.getNumberofDays(RulesUpdateStartDate, RulesUpdateEndDate));
						parentInitialNoCheckInRuleList = rateGrid.getRuleDataValuesForNoCheckIn(driver, test_steps,
								roomClass, channelName, Utility.getNumberofDays(RulesUpdateStartDate, RulesUpdateEndDate));
						parentInitialNoCheckOutRuleList = rateGrid.getRuleDataValuesForNoCheckOut(driver, test_steps,
								roomClass, channelName, Utility.getNumberofDays(RulesUpdateStartDate, RulesUpdateEndDate));
				...
				for (String roomClass : reservationRoomClassesList) {
					...
					if (RulesUpdateType.equalsIgnoreCase("Overide")) {
						...
						derivedInitialMinStayRuleList = rateGrid.getRuleDataValuesForMinStay(driver, test_steps, roomClass,
								channelName, days);
			...
			if ((RulesUpdateType.equalsIgnoreCase("Overide") || RulesUpdateType.equalsIgnoreCase("BulkUpdate"))) {
				...
				for (String roomClass : reservationRoomClassesList) {
					...
					derivedAfterMinStayRuleList = rateGrid.getRuleDataValuesForMinStay(driver, test_steps, roomClass,
							channelName,days);
			...
			if ((RatesUpdateType.equalsIgnoreCase("Overide") || RatesUpdateType.equalsIgnoreCase("BulkUpdate"))) {
				...
				for (String roomClass : reservationRoomClassesList) {
					...
					if (RatesUpdateType.equalsIgnoreCase("Overide")) {
						ArrayList<String> RatesUpdateStartDateList = Utility .convertTokenToArrayList(checkInDate_RatesUpdate, delim);
						
						getParentInitialRatesPerNightChannelsTemp = rateGrid
								.getSourceWiseRatesRules(driver, test_steps, parentRatePlanName,
										derivedRatePlanName, false, delim,
										roomClass,
										channelName,
...
//						getData(getParentInitialRatesPerNightChannelsTemp);
						...
						allDatesBW = Utility.getAllDatesBetweenTwoDates(RatesUpdateStartDateList.get(0), RatesUpdateStartDateList.get(RatesUpdateStartDateList.size()-1));
...
//						getData(getParentInitialRatesPerNightChannelsTemp);
						...
						dates = Utility.getDateRangeBetweenfromAndToDate(fromDate, toDate);
						app_logs.info("Dates Are: " + dates);
						allDatesBW = Utility.getAllDatesBetweenTwoDates(checkInDate_RatesUpdate, checkOutDate_RatesUpdate);
					}
					for (String date : allDatesBW) {
						app_logs.info(date);
						app_logs.info("Found Room Rates : " + getParentInitialRatesPerNightChannelsTemp.get(roomClass).get(channelName).get(date));
						test_steps.add("Found Room Rates : " + getParentInitialRatesPerNightChannelsTemp.get(roomClass).get(channelName).get(date));
						RatesGridChannelRatesRules obj = getParentInitialRatesPerNightChannelsTemp.get(roomClass).get(channelName).get(date);
				...
				for (String roomClass : reservationRoomClassesList) {
					...
					if (RatesUpdateType.equalsIgnoreCase("Overide")) {
						...
						getDerivedInitialRatesPerNightChannelsTemp = rateGrid
								.getSourceWiseRatesRules(driver, test_steps, parentRatePlanName,
										derivedRatePlanName, true, delim,
										roomClass,
										channelName,
...
//					getData(getDerivedInitialRatesPerNightChannelsTemp);
					...
					for (String date : allDatesBW) {
						app_logs.info(date);
						app_logs.info("Found Room Rates : " + getDerivedInitialRatesPerNightChannelsTemp.get(roomClass).get(channelName).get(date));
						test_steps.add("Found Room Rates : " + getDerivedInitialRatesPerNightChannelsTemp.get(roomClass).get(channelName).get(date));
						RatesGridChannelRatesRules obj = getDerivedInitialRatesPerNightChannelsTemp.get(roomClass).get(channelName).get(date);
			...
			rateGrid.bulkUpdateOverideRates(driver, delim, RatesUpdateType, checkInDate_RatesUpdate,
					...
					parentRatePlanName, ReservationRoomClasses, channelName,updateRatesType, isUpdateRateByRoomClass,
			...
			if ((RatesUpdateType.equalsIgnoreCase("Overide") || RatesUpdateType.equalsIgnoreCase("BulkUpdate"))) {
				...
				//	HashMap<String, String> getDerivedAfterRatesPerNightChannelsTemp = new HashMap<String, String>();
					...
					if (RatesUpdateType.equalsIgnoreCase("Overide")) {
						...
						getDerivedAfterRatesPerNightChannelsTemp = rateGrid
								.getSourceWiseRatesRules(driver, test_steps, parentRatePlanName,
										derivedRatePlanName, true, delim,
										roomClass,
										channelName,
...
//						getData(getDerivedAfterRatesPerNightChannelsTemp);
					...
					for (String date : allDatesBW) {
						app_logs.info(date);
						app_logs.info("Found Room Rates : " + getDerivedAfterRatesPerNightChannelsTemp.get(roomClass).get(channelName).get(date));
						test_steps.add("Found Room Rates : " + getDerivedAfterRatesPerNightChannelsTemp.get(roomClass).get(channelName).get(date));
						RatesGridChannelRatesRules obj = getDerivedAfterRatesPerNightChannelsTemp.get(roomClass).get(channelName).get(date);
				...
				for (String roomClass : reservationRoomClassesList) {
					if (!parentRatePlanOffSetList.get(1).equalsIgnoreCase("percent")) {
						...
						app_logs.info("==========VERIFING DERIVED RATE PLAN RATES VALUES SHOULD CHANGED WHERE ROOM CLASS IS "
										+ roomClass + "==========");
						test_steps.add(
...
//								String expected = getDerivedInitialRates.get(roomClass).get(keyDate);
								String expected = derivedRate.calculateOffSet(
										...
										parentRatePlanOffSetList.get(0), parentRatePlanOffSetList.get(1),
										parentRatePlanOffSetList.get(2));
								assertEquals(Utility.formatDecimal(acctual), Utility.formatDecimal(expected), "Failed To Verify After Derived Base Rates");
								app_logs.info("Successfully Verified Base Rates : " + acctual + "  Changes for Date : "
										+ dates.get(i));
								test_steps.add("Successfully Verified Base Rates : " + acctual + "  Changes for Date : "
										+ dates.get(i));
...
//								String expected = getDerivedInitialExAdult.get(roomClass).get(keyDate);
								String expected = derivedRate.calculateOffSet(
										...
										parentRatePlanOffSetList.get(0), parentRatePlanOffSetList.get(1),
										parentRatePlanOffSetList.get(2));
								assertEquals(Utility.formatDecimal(acctual), Utility.formatDecimal(expected), "Failed To Verify After Derived Extra Adult Rates");
								app_logs.info("Successfully Verified Extra Adult Rates : " + acctual
...
//								String expected = getDerivedInitialExChild.get(roomClass).get(keyDate);
								String expected = derivedRate.calculateOffSet(
										...
										parentRatePlanOffSetList.get(0), parentRatePlanOffSetList.get(1),
										parentRatePlanOffSetList.get(2));
								assertEquals(Utility.formatDecimal(acctual), Utility.formatDecimal(expected), "Failed To Verify After Derived Extra Child Rates");
								app_logs.info("Successfully Verified Extra Child Rates : " + acctual
										+ "  Changes for Date : " + dates.get(i));
								test_steps.add("Successfully Verified Extra Child Rates : " + acctual
										+ "  Changes for Date : " + dates.get(i));
...
if(days==0) {
	days=1;
			...
			if ((DrivedRulesUpdateType.equalsIgnoreCase("Overide")
				...
				int rulesUpdateDiffDate = Utility.getNumberofDays(DrivedRulesUpdateStartDate, DrivedRulesUpdateEndDate) + 1;
			...
			if ((DrivedRatesUpdateType.equalsIgnoreCase("Overide")
				...
				for (String roomClass : reservationRoomClassesList) {
					...
					if (DrivedRatesUpdateType.equalsIgnoreCase("Overide")) {
						ArrayList<String> DrivedcheckInDate_RatesUpdateList = Utility.convertTokenToArrayList(DrivedcheckInDate_RatesUpdate, delim);
						getParentInitialRatesPerNightChannelsTemp = rateGrid.getRoomRatesExAdExChOfChannel(driver,
								DrivedcheckInDate_RatesUpdateList.get(0), DrivedcheckInDate_RatesUpdateList.get(DrivedcheckInDate_RatesUpdateList.size()-1), roomClass, channelName);
						app_logs.info(getParentInitialRatesPerNightChannelsTemp);
						getData(getParentInitialRatesPerNightChannelsTemp);
			...
			rateGrid.bulkUpdateOverideRates(driver, delim, DrivedRatesUpdateType, DrivedcheckInDate_RatesUpdate,
					...
					DrivedisFriday_RatesUpdate, DrivedisSaturday_RatesUpdate, derivedRatePlanName, ReservationRoomClasses,
					channelName,DrivedupdateRatesType, DrivedisUpdateRateByRoomClass, DrivednightlyRate_RatesUpdate,
					DrivedadditionalAdults_RatesUpdate, DrivedadditionalChild_RatesUpdate, test_steps);
				...
				HashMap<String, // Source
						HashMap<String, // date
								RatesGridChannelRatesRules>>> roomClassWiseSourceDerivedRatesRule = rateGrid
										.getSourceWiseRatesRules(driver, test_steps, parentRatePlanName,
												derivedRatePlanName, true, delim,
												ReservationRoomClasses, channelName,
...
//					rateGrid.clickForRateGridCalender(driver, test_steps);
				...
				for (String date : allDatesBW) {
					app_logs.info(date);
					app_logs.info("Found Room Rates : " + roomClassWiseSourceDerivedRatesRule.get(RoomClass[0]).get(channelName).get(date));
					test_steps.add("Found Room Rates : " + roomClassWiseSourceDerivedRatesRule.get(RoomClass[0]).get(channelName).get(date));
					RatesGridChannelRatesRules obj = roomClassWiseSourceDerivedRatesRule.get(RoomClass[0]).get(channelName).get(date);
...
//								CheckOutDate, RoomClass[0], channelName);
//						app_logs.info(getRatesPerNightChannels);
//						getData(getRatesPerNightChannels);
//
						Date fromDate = Utility.convertStringtoDateFormat(ratesConfig.getProperty("defaultDateFormat"),
...
driver.navigate().refresh();
					...
					if (isSeasonExistChange) {
						...
						test_steps.add(
								"Rate Plan Max. Adults: <b>" + maxAdultChange.get(ReservationChangeRoomClass) + "</b>");
						test_steps.add(
								"Rate Plan Max. Childs: <b>" + maxChildChange.get(ReservationChangeRoomClass) + "</b>");
		...
		if (ReservationType.equalsIgnoreCase("Single")) {
			...
			try {
				...
				if (derivedPromoCode.isEmpty()) {
					tapechart.searchInTapechart(driver, Utility.parseDate(CheckInDate, "dd/MM/yyyy", "MM/dd/yyyy"), Utility.parseDate(CheckOutDate, "dd/MM/yyyy", "MM/dd/yyyy"), adult, children, derivedRatePlanName,
							derivedPromoCode);
				} else {
					tapechart.searchInTapechart(driver, Utility.parseDate(CheckInDate, "dd/MM/yyyy", "MM/dd/yyyy"), Utility.parseDate(CheckOutDate, "dd/MM/yyyy", "MM/dd/yyyy"), adult, children, derivedRatePlanName,
							derivedPromoCode);
		...
		if (isReservationCreated) {
			...
			afterReservationDone(delim, ActionOnReservation, reservation, CheckInDate,
					CheckOutDate, GuestFirstName, isAccountPolicyApplicable, ReservationRoomClasses,
					test_name, ReservationType, adult, children, ChangeResStartDate, ChangeResEndDate,
					derivedRatePlanName, derivedPromoCode, ReservationChangeRoomClass, names, policyClauses,
					guestsWillIncurAFee, chargesType, cancelWithInType, noOfDays,ChangeAdult, ChangeChildren);
		}
	...
	public Object[][] getData() {
		...
		return Utility.getData("VerifyDerivedRatePlanInnCenter", excel);
	}
	...
	public void afterReservationDone(String delim, String ActionOnReservation, String reservation, String CheckInDate,
			String CheckOutDate, String GuestFirstName, String isAccountPolicyApplicable, String ReservationRoomClasses,
			String testName1, String ReservationType, String adult, String children, String ChangeResStartDate,
			String ChangeResEndDate, String derivedRatePlanName, String derivedPromoCode,
			...
			HashMap<String, String> cancelWithInType, HashMap<String, String> noOfDays, String ChangeAdult, String ChangeChildre) {
...
//				}
			...
			if (isAccountPolicyApplicable.equals("Yes")) {
				 ...
				 * depositAmount=reservation.calculationOfDepositAmountToBePaidForRateV2(
				 * roomChargesAre, policyAttr1Is[0], policyAttrValueIs[0]);} else
				 * if(isAccountPolicyCreate.equalsIgnoreCase("No") &&
				 * !(selectedpolicyNames.get(policyTypes.get(0)).equals(ratesConfig.getProperty(
				 * "noPolicyText")))) {
				 * depositAmount=reservation.calculationOfDepositAmountToBePaidForRateV2(
				 * roomChargesAre, getAccountPoliciesData.get(0).get("Type"),
...
//					}
			...
			if (isAccountPolicyApplicable.equals("Yes")) {
				/*
				 * if(isAccountPolicyCreate.equalsIgnoreCase("Yes")) {
				 * verificationDepositWithPolicy(PaymentType,policyNames.get(0),depositAmount,
				 * paymentTypeIs); } else if(isAccountPolicyCreate.equalsIgnoreCase("No") &&
				 * !(selectedpolicyNames.get(policyTypes.get(0)).equals(ratesConfig.getProperty(
				 * "noPolicyText")))) {
				 * verificationDepositWithPolicy(paymentType,selectedpolicyNames.get(policyTypes
				 * .get(0)),depositAmount,paymentTypeIs); }else {
				 * verificationDepoistWithoutPolicy(paymentType,checkInDates.get(0),ratesConfig.
				 * getProperty("noPolicyText")); }
				 */
			} else {
				if (!reervationDepositPolicy.equalsIgnoreCase("No Policy")) {
...
//				String seasonNoShowpolicy = getSessionLevelPolicy.get("No Show");
				...
				if (!seasonNoShowpolicy.equalsIgnoreCase("No Policy")) {
					...
					try {
						...
						if (Utility.reTry.get(testName) == Utility.count) {
							...
							Utility.updateReport(e, "Failed to capture no show policy attributes and values", testName,
					...
					try {
						...
						if (isAccountPolicyApplicable.equalsIgnoreCase("Yes")) {
							/*
							 * policyToValidate = policyName; policyAttrDisplayed = policyAttr1;
							 * policyAttrValueDisplayed = policyAttrValue; policyDesc =
							 * descWhileCreatePolicy.get(policyName).get(0); test_steps.
							 * add("Season level policy should be applied  for check-in date as <b>"
							 * +checkInDate+"</b>");
							 */
				...
				try {
					...
					if (Utility.reTry.get(testName) == Utility.count) {
						RetryFailedTestCases.count = Utility.reset_count;
						Utility.AddTest_IntoReport(testName, test_description, test_catagory, test_steps);
						Utility.updateReport(e, "Failed to make reservation as no show", testName, test_catagory,
								driver);
					} else {
						Assert.assertTrue(false);
					}
				...
				if (!ratePlanCheckInPolicy.equalsIgnoreCase("No Policy")) {
					...
					if (isAccountPolicyApplicable.equals("Yes")) {
						/*
						 * paymentAmt=Double.parseDouble(reservationPage.
						 * get_PaymentsForAccountReservation(driver, test_steps));
						 * app_logs.info(paymentAmt); if(isAccountPolicyCreate.equalsIgnoreCase("Yes"))
						 * { checkInAmount=reservationPage.calculationOfCheckInAmountToBePaidForRateV2(
						 * String.valueOf(balance), policyAttrValueIs[1]);} else
						 * if(isAccountPolicyCreate.equalsIgnoreCase("No") &&
						 * !(selectedpolicyNames.get(policyTypes.get(1)).equals(ratesConfig.getProperty(
						 * "noPolicyText")))) {
						 * checkInAmount=reservationPage.calculationOfCheckInAmountToBePaidForRateV2(
				...
				if (isAccountPolicyApplicable.equals("Yes")) {
					/*
					 * if(isAccountPolicyCreate.equalsIgnoreCase("Yes")) {
					 * completeCheckInIfPolicyExist(balance,checkInAmount); test_steps.
					 * add("==================Verify Check-In Policy On Reservation=================="
					 * );
					 * verificationCheckinWithPolicy(PaymentType,policyNames.get(1),checkInAmount,
					 * paymentAmount,checkInCardFormat); }else
					 * if(isAccountPolicyCreate.equalsIgnoreCase("No") &&
					 * !(selectedpolicyNames.get(policyTypes.get(1)).equals(ratesConfig.getProperty(
					 * "noPolicyText")))) { completeCheckInIfPolicyExist(balance,checkInAmount);
					 * verificationCheckinWithPolicy(PaymentType,selectedpolicyNames.get(policyTypes
					 * .get(1)),checkInAmount,paymentAmount,checkInCardFormat); } else {
					 * completeCheckInIfPolicyDoesntExist(balance); test_steps.
					 * add("==================Verify Check-In Policy On Reservation=================="
					 * ); verificationCheckinWithoutPolicy(ratesConfig.getProperty("noPolicyText"));
					 * }
					 */
				} else {
					if (!ratePlanCheckInPolicy.isEmpty()) {
				...
				roomChargesFolio = reservationPage.getRoomChargesFromFolioBasedOnDates(driver, test_steps, CheckInDate,
						CheckOutDate);
...
//				reservationPage.ClickStayInfo_ChangeDetails(driver, test_steps);
				...
				if (driver.findElements(By.xpath("(//span[text()='" + ReservationRoomClasses + "'])[2]")).size() > 0
					...
					String rateIs = reservationPage.calculateRatesAsPerAdultsAndChildCapacity(driver, getRatesChange,
							maxAdultChange.get(ReservationChangeRoomClass),
...
//
//	test_steps.add("=================== BASE RATE PLAN RULES BULKUPDATE ======================");
//	app_logs.info("=================== BASE RATE PLAN RULES BULKUPDATE ======================");
//
//	getTest_Steps.clear();
...
//
//	getTest_Steps.clear();
//	getTest_Steps = rateGrid.selectItemsFromDropDowns(driver, "Rate Plan", parentRatePlanName);
//	test_steps.addAll(getTest_Steps);
//
...
//
//	test_steps.add("=================== BASE RATE PLAN RULES OVERIDE ======================");
//	app_logs.info("=================== BASE RATE PLAN RULES OVERIDE ======================");
//
...
//	ArrayList<String> type_rulesUpdateList = Utility.convertTokenToArrayList(Type_RulesUpdate, delim);
//	ArrayList<String> RuleMinStayValue_RulesUpdateList = Utility.convertTokenToArrayList(RuleMinStayValue_RulesUpdate, delim);
//
...
//
//			if (!rateGrid.getRoomRateRoomClassLevel(driver, roomClassName).get(0).equalsIgnoreCase("--")) {
//
...
//				rateGrid.expandChannel(driver, test_steps, roomClassName, channelName);
//
//				ArrayList<String> rulesList = Utility.convertTokenToArrayList(type_rulesUpdateList.get(i),
//						",");
//
//				for (String type : rulesList) {
//
//					if (type.equalsIgnoreCase("min stay")) {
//						rateGrid.overrideMinStayValue(driver, test_steps, roomClassName, channelName,
//								RuleMinStayValue_RulesUpdateList.get(minStayIndex));
//						minStayIndex++;
//					} else if (type.equalsIgnoreCase("No Check In")) {
//						rateGrid.overrideRuleForNoCheckInAndOut(driver, test_steps, roomClassName,
//								channelName, ratesConfig.getProperty("checkinRule"), true);
//
//					} else if (type.equalsIgnoreCase("No Check out")) {
//						rateGrid.overrideRuleForNoCheckInAndOut(driver, test_steps, roomClassName,
//								channelName, ratesConfig.getProperty("checkoutRule"), true);
//					}
//				}
//			}
//		}
...
//
//	test_steps.add("=================== BASE RATE PLAN RATES BULKUPDATE ======================");
//	app_logs.info("=================== BASE RATE PLAN RATES BULKUPDATE ======================");
//
//	getTest_Steps.clear();
//	getTest_Steps = rateGrid.clickOnBulkUpdate(driver);
//	test_steps.addAll(getTest_Steps);
...
//
//	test_steps.add("=================== BASE RATE PLAN RATES OVERIDE ======================");
//	app_logs.info("=================== BASE RATE PLAN RATES OVERIDE ======================");
//
//	rateGrid.expandParentRateGrid(driver, "plus");
//	derivedRate.expandReduceDerivedratePlans(driver, false, test_steps);
//
...
//if (DrivedRulesUpdateType.equalsIgnoreCase("BulkUpdate")) {
//
//	test_steps.add("=================== DERIVED RATE PLAN RULES BLUK UPDATE ======================");
//	app_logs.info("=================== DERIVED RATE PLAN RULES BLUK UPDATE ======================");
//
//	getTest_Steps.clear();
//	getTest_Steps = rateGrid.clickOnBulkUpdate(driver);
//	test_steps.addAll(getTest_Steps);
...
//	getTest_Steps.clear();
//	getTest_Steps = rateGrid.selectStartDate(driver,
//			Utility.parseDate(DrivedRulesUpdateStartDate, "dd/MM/yyyy", "MM/dd/yyyy"));
//	test_steps.addAll(getTest_Steps);
//
//	test_steps.add("==========SELECT END DATE==========");
//	app_logs.info("==========SELECT END DATE==========");
...
//	getTest_Steps.clear();
//	getTest_Steps = rateGrid.selectEndDate(driver,
//			Utility.parseDate(DrivedRulesUpdateEndDate, "dd/MM/yyyy", "MM/dd/yyyy"));
//	test_steps.addAll(getTest_Steps);
//
//	app_logs.info("==========CHECKING/UNCHECKING DAYS==========");
//	test_steps.add("==========CHECKING/UNCHECKING DAYS==========");
//
//	getTest_Steps.clear();
//	getTest_Steps = rateGrid.checkDays(driver, "Sun", DrivedisSun_RulesUpdate);
//	test_steps.addAll(getTest_Steps);
//
//	getTest_Steps.clear();
//	getTest_Steps = rateGrid.checkDays(driver, "Mon", DrivedisMon_RulesUpdate);
//	test_steps.addAll(getTest_Steps);
//
//	getTest_Steps.clear();
//	getTest_Steps = rateGrid.checkDays(driver, "Tue", DrivedisTue_RulesUpdate);
//	test_steps.addAll(getTest_Steps);
//
//	getTest_Steps.clear();
//	getTest_Steps = rateGrid.checkDays(driver, "Wed", DrivedisWed_RulesUpdate);
//	test_steps.addAll(getTest_Steps);
//
//	getTest_Steps.clear();
//	getTest_Steps = rateGrid.checkDays(driver, "Thu", DrivedisThu_RulesUpdate);
//	test_steps.addAll(getTest_Steps);
//
//	getTest_Steps.clear();
//	getTest_Steps = rateGrid.checkDays(driver, "Fri", DrivedisFri_RulesUpdate);
//	test_steps.addAll(getTest_Steps);
//
//	getTest_Steps.clear();
//	getTest_Steps = rateGrid.checkDays(driver, "Sat", DrivedisSat_RulesUpdate);
//	test_steps.addAll(getTest_Steps);
//
//	app_logs.info("==========SELECTING RATE PLAN==========");
//	test_steps.add("==========SELECTING RATE PLAN==========");
//
//	getTest_Steps.clear();
//	getTest_Steps = rateGrid.selectItemsFromDropDowns(driver, "Rate Plan", derivedRatePlanName);
//	test_steps.addAll(getTest_Steps);
//
//	app_logs.info("==========SELECTING ROOM CLASS==========");
//	test_steps.add("==========SELECTING ROOM CLASS==========");
...
//	test_steps.addAll(getTest_Steps);
//
//	ArrayList<String> type_rulesUpdateList = Utility.convertTokenToArrayList(DrivedType_RulesUpdate, delim);
//
//	for (String type : type_rulesUpdateList) {
//
//		if (type.equalsIgnoreCase("min stay")) {
...
//
//			getTest_Steps.clear();
//			getTest_Steps = rateGrid.enterMinimumStayValue(driver, DrivedRuleMinStayValue_RulesUpdate);
//			test_steps.addAll(getTest_Steps);
//
//		} else if (type.equalsIgnoreCase("No Check In")) {
//
...
//	test_steps.add("==========VERIFYING TOTAL NUMBER OF DAYS==========");
//
//	int numberOfDays = Utility.getNumberofDays(DrivedRulesUpdateStartDate, DrivedRulesUpdateEndDate) + 1;
//	String expectedDays = "Rules will be updated for " + numberOfDays + " day(s) within this date range.";
//	test_steps.add("Expected total days : " + expectedDays);
//	app_logs.info("Expected total days : " + expectedDays);
//	String totalDays = rateGrid.getTotalDaysText(driver, "Rules");
...
//	getTest_Steps = rateGrid.clickOnYesUpdateButton(driver);
//	test_steps.addAll(getTest_Steps);
//} else if (DrivedRulesUpdateType.equalsIgnoreCase("Override")
//		|| DrivedRulesUpdateType.equalsIgnoreCase("Overide")) {
//
//	test_steps.add("=================== DERIVED RATE PLAN RULES OVERIDE ======================");
//	app_logs.info("=================== DERIVED RATE PLAN RULES OVERIDE ======================");
//
//	derivedRate.expandReduceDerivedratePlans(driver, true, test_steps);
//	rateGrid.expandParentRateGrid(driver, "minus");
//	getTest_Steps.clear();
...
//
//	ArrayList<String> roomClassesList = Utility.convertTokenToArrayList(ReservationRoomClasses, delim);
//	ArrayList<String> desiredOverideDate = Utility.convertTokenToArrayList(DrivedRulesUpdateStartDate, delim);
//	ArrayList<String> type_rulesUpdateList = Utility.convertTokenToArrayList(DrivedType_RulesUpdate, delim);
//	
//	for (String roomClassName : roomClassesList) {
//		for (int i = 0; i < desiredOverideDate.size(); i++) {
...
//				if (type.equalsIgnoreCase("min stay")) {
//					rateGrid.overrideMinStayValue(driver, test_steps, roomClassName, channelName,
//							DrivedRuleMinStayValue_RulesUpdate);
//				} else if (type.equalsIgnoreCase("No Check In")) {
//					rateGrid.overrideRuleForNoCheckInAndOut(driver, test_steps, roomClassName, channelName,
...
//if (DrivedRatesUpdateType.equalsIgnoreCase("BulkUpdate")) {
//
//	test_steps.add("=================== DERIVED RATE PLAN RATES BULK UPDATE ======================");
//	app_logs.info("=================== DERIVED RATE PLAN RATES BULK UPDATE ======================");
//
//	getTest_Steps.clear();
//	getTest_Steps = rateGrid.clickOnBulkUpdate(driver);
//	test_steps.addAll(getTest_Steps);
...
//	getTest_Steps.clear();
//	getTest_Steps = rateGrid.startDate(driver,
//			Utility.parseDate(DrivedcheckInDate_RatesUpdate, "dd/MM/yyyy", "MM/dd/yyyy"));
//	test_steps.addAll(getTest_Steps);
//
//	getTest_Steps.clear();
//	getTest_Steps = rateGrid.endDate(driver,
//			Utility.parseDate(DrivedcheckOutDate_RatesUpdate, "dd/MM/yyyy", "MM/dd/yyyy"));
//	test_steps.addAll(getTest_Steps);
//
//	app_logs.info("==========CHECKING/UNCHECKING DAYS==========");
//	test_steps.add("==========CHECKING/UNCHECKING DAYS==========");
//
//	getTest_Steps.clear();
//	getTest_Steps = rateGrid.bulkUpdatePoppupDayCheck(driver, "Sun", DrivedisSunday_RatesUpdate);
//	test_steps.addAll(getTest_Steps);
//
//	getTest_Steps.clear();
//	getTest_Steps = rateGrid.bulkUpdatePoppupDayCheck(driver, "Mon", DrivedisMonday_RatesUpdate);
//	test_steps.addAll(getTest_Steps);
//
//	getTest_Steps.clear();
//	getTest_Steps = rateGrid.bulkUpdatePoppupDayCheck(driver, "Tue", DrivedisTuesday_RatesUpdate);
//	test_steps.addAll(getTest_Steps);
//
//	getTest_Steps.clear();
//	getTest_Steps = rateGrid.bulkUpdatePoppupDayCheck(driver, "Wed", DrivedisWednesday_RatesUpdate);
//	test_steps.addAll(getTest_Steps);
//
//	getTest_Steps.clear();
//	getTest_Steps = rateGrid.bulkUpdatePoppupDayCheck(driver, "Thu", DrivedisThursday_RatesUpdate);
//	test_steps.addAll(getTest_Steps);
//
//	getTest_Steps.clear();
//	getTest_Steps = rateGrid.bulkUpdatePoppupDayCheck(driver, "Fri", DrivedisFriday_RatesUpdate);
//	test_steps.addAll(getTest_Steps);
//
//	getTest_Steps.clear();
//	getTest_Steps = rateGrid.bulkUpdatePoppupDayCheck(driver, "Sat", DrivedisSaturday_RatesUpdate);
//	test_steps.addAll(getTest_Steps);
//
//	getTest_Steps.clear();
//	getTest_Steps = rateGrid.selectItemsFromDropDowns(driver, "Rate Plan", derivedRatePlanName);
...
//
//	// Checks Rate Update Type
//	if (DrivedupdateRatesType.equalsIgnoreCase("EnterNewRate")) {
//		getTest_Steps.clear();
//		getTest_Steps = rateGrid.selectBulkUpdateRatesOption(driver, 0);
//		test_steps.addAll(getTest_Steps);
//
//		getTest_Steps.clear();
//		getTest_Steps = rateGrid.updateRoomsByRoomClassToggle(driver,
//				Boolean.parseBoolean(DrivedisUpdateRateByRoomClass));
//		test_steps.addAll(getTest_Steps);
//
//		//
//		// String[] roomClassArray = roomClassName.split("\\|");
...
//
//		// String[] nightlyRateArray = nightlyRate_RatesUpdate.split("\\|");
//		ArrayList<String> nightlyRateArray = Utility.convertTokenToArrayList(DrivednightlyRate_RatesUpdate,
//				delim);
//		int nightArrayLength = 1;
//		if (DrivedisUpdateRateByRoomClass.equalsIgnoreCase("True")) {
//			nightArrayLength = nightlyRateArray.size();
//		}
//		ArrayList<String> additionalAdultArray = Utility
//				.convertTokenToArrayList(DrivedadditionalAdults_RatesUpdate, delim);
//		ArrayList<String> additionalChildArray = Utility
//				.convertTokenToArrayList(DrivedadditionalAdults_RatesUpdate, delim);
//		// Check Length of NightlyRate List and Input Values
//		for (int i = 0; i < nightArrayLength; i++) {
...
//	getTest_Steps = rateGrid.clickYesUpdateButton(driver);
//	test_steps.addAll(getTest_Steps);
//} else if (DrivedRatesUpdateType.equalsIgnoreCase("Overide")
//		|| DrivedRatesUpdateType.equalsIgnoreCase("Override")) {
//
//	test_steps.add("=================== DERIVED RATE PLAN RATES OVERIDE ======================");
//	app_logs.info("=================== DERIVED RATE PLAN RATES OVERIDE ======================");
//
//	ArrayList<String> roomClassesList = Utility.convertTokenToArrayList(ReservationRoomClasses, delim);
//	ArrayList<String> desiredOverideDate = Utility.convertTokenToArrayList(DrivedcheckInDate_RatesUpdate, delim);
//	ArrayList<String> nightlyRate_RatesUpdateList = Utility.convertTokenToArrayList(DrivednightlyRate_RatesUpdate,
//			delim);
//	ArrayList<String> additionalAdults_RatesUpdateList = Utility
//			.convertTokenToArrayList(DrivedadditionalAdults_RatesUpdate, delim);
//	ArrayList<String> additionalChild_RatesUpdateList = Utility
//			.convertTokenToArrayList(DrivedadditionalChild_RatesUpdate, delim);
//
//
//	derivedRate.expandReduceDerivedratePlans(driver, true, test_steps);
//	rateGrid.expandParentRateGrid(driver, "minus");
