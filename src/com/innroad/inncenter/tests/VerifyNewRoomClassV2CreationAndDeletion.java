...
public class VerifyNewRoomClassV2CreationAndDeletion extends TestCore {
	...
	public void verifyNewRoomClassV2CreationAndDeletion( String roomClassName, 
		...
		try {
			...
			getTest_Steps.clear();
			getTest_Steps = roomClass.createRoomClassV2(driver_VRAP, roomClassName, roomClassAbbreviation, maxAdults, maxPersons, roomQuantity, test, getTest_Steps);
	...
	public Object[][] getData() {
		return Utility.getData("NewRoomClassV2CreationDelete", excel);
	}
