...
public class EditGroupBlockIncreaseDecreaseRoomBlocked extends TestCore {
	...
	public void editGroupBlockIncreaseDecreaseRoomBlocked(String url, String clientcode, String username,
		...
		try {
			...
			getTest_Steps.clear();
			getTest_Steps = group.increaseRoomBlockedCount(driver, RoomClassName, 1);
			test_steps.addAll(getTest_Steps);
...
//					"Failed to Verify Available Room in TapeChart");
		...
		try {
			...
			getTest_Steps.clear();
			getTest_Steps = group.decreaseRoomBlockedCount(driver, RoomClassName, 1);
			test_steps.addAll(getTest_Steps);
...
//					"Failed to Verify Available Room in TapeChart");
	...
	public Object[][] getData() {
		...
		return Utility.getData("EditIncreaseDecreaseRoomBlocked", excel);
	}
