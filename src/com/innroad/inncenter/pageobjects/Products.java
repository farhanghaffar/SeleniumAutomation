...
public class Products {
	...
	public ArrayList<String> selectProductCostPerTwo(WebDriver driver, String instance) throws InterruptedException {
		...
		String path = "//li[@label='" + instance + "']";
		Utility.ScrollToElement(element.productName, driver);
	...
	public void createProduct(WebDriver driver, String productName, String productCost, String productCategory,
