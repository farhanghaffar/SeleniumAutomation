...
//		}
	...
	public void expandChannel(WebDriver driver, ArrayList<String> testSteps, String roomClassName, String channelName)
			throws InterruptedException {
		String path = "//div[text()='" + roomClassName + "']/../../..//div[text()='" + channelName
				+ "']/following-sibling::span[contains(@class,'ir-plus')]";

		if (driver.findElements(By.xpath(path)).size() > 0) {
			path = "//div[text()='" + roomClassName + "']/../../..//div[text()='" + channelName
		...
		String minusPath = "//div[text()='" + roomClassName + "']/../../..//div[text()='" + channelName
	...
	public HashMap<String, String> getRoomRatesExAdExChOfChannel(WebDriver driver, String startDate, String endDate,
		...
		logger.info("Rate as per  Date  " + roomRatesExtraAdultsExtraChild);
		return roomRatesExtraAdultsExtraChild;
	...
	public ArrayList<String> selectItemsFromDropDowns(WebDriver driver, String dropDownName, String selectionElement)
		...
		if (selectionElement.contains(Utility.DELIM)) {
	...
	public void verifyRulesRemovedForClass(WebDriver driver, ArrayList<String> testSteps, String roomClass, int index) {
		String path = "(//div[contains(text(),'" + roomClass
				+ "')]/parent::div/following-sibling::div/div[@class='RuleIndication']/span)[" + index + "]";
		boolean isExist = Utility.isElementPresent(driver, By.xpath(path));
		assertEquals(isExist, false, "Failed to verify removed rule for room class");
	...
	public void verifyRulesRemovedForChannel(WebDriver driver, ArrayList<String> testSteps, String roomClass,
		...
		String path = "(//div[contains(text(),'" + roomClass
				...
				+ "']/parent::div/following-sibling::div/div[@class='RuleIndication']/span)[" + index + "]";
		boolean isExist = Utility.isElementPresent(driver, By.xpath(path));
		assertEquals(isExist, false, "Failed to verify removed rule for channel");
	...
	public void clickRateDropDown(WebDriver driver, ArrayList<String> test_steps) {
		Elements_RatesGrid elements = new Elements_RatesGrid(driver);
		Wait.waitUntilPresenceOfElementLocated(RateGridPage.OpenRateDropdown, driver);
...
//				+ "/ancestor::div//div[text()='Min Stay']/parent::div//input)[1]";
		String path = "(//div[contains(text(),'" + roomClass + "')]/../../../..//div[@title='" + channelName
				+ "']/../../..//div[text()='Min Stay']/parent::div//input)[1]";
		Wait.WaitForElement(driver, path);
		WebElement element = driver.findElement(By.xpath(path));
		Utility.ScrollToViewElementINMiddle(driver, element);
		element.click();
...
//				+ ruleAppliedOnCheckInOrCheckOut + "']" + "/following::div[1]//div[@class='rt-onHover  has-noValue enabled']";
		...
		String selectedPath = "(//div[contains(text(),'" + roomClass + "')]/../../../..//div[@title='" + channelName
				+ "']/../../..//div[contains(@class,'RuleHeader') and text()='"

				+ ruleAppliedOnCheckInOrCheckOut + "']" + "/following::div[1]//div[@class='rt-onHover  enabled'])[1]";

		String blankPath = "(//div[contains(text(),'" + roomClass + "')]/../../../..//div[@title='" + channelName
				+ "']/../../..//div[contains(@class,'RuleHeader') and text()='"
	...
	public void clickExpendRooClass(WebDriver driver, ArrayList<String> testSteps, String roomClass)
			throws InterruptedException {
		String roomClassName = "//div[contains(text(),'" + roomClass + "')]//following-sibling::span";

		String path = "//div[contains(text(),'" + roomClass
				+ "')]//following-sibling::span[contains(@class,'ir-plus')]";
		Wait.WaitForElement(driver, roomClassName);
		if (driver.findElements(By.xpath(path)).size() > 0) {
			path = "//div[contains(text(),'" + roomClass + "')]//following-sibling::span[contains(@class,'ir-plus')]";
			WebElement element = driver.findElement(By.xpath(path));
			Utility.ScrollToElement(element, driver);
			Wait.waitForElementToBeClickable(By.xpath(path), driver, 5);
			Wait.wait5Second();
...
//					JS.executeScript("arguments[0].value='"+endDate+"';", OR.EndDateInput);
	...
	public HashMap<String, RatesGridChannelRatesRules> getRatesAndRulesForDate(WebDriver driver,
		...
		for (String startDate : startDateList) {
			...
			String rule = "//div[contains(text(),'" + roomClassName + "')]/../../..//div[contains(text(),'"
					+ channelName + "')]/../../..//div[text()='Min Stay']/following-sibling::div//input";
			Wait.WaitForElement(driver, rule);
...
//				logger.info(noCheckOut);

						RatesGridChannelRatesRules ratesRules = new RatesGridChannelRatesRules(ruleValue, noCheckIn,
								noCheckOut, roomRate, extraAdultRate, extraChildRate);
						// logger.info(ratesRules);
...
//		}
	 ...
	 * ########################
	 * 
	 * ' Method Name: <createNightlyRatePlan> ' Description: <create Nightly
	 * Rate Plan > ' Input parameters: < WebDriver driver,String
	 * startDate,String endDate, String roomClass,String channelName> ' Return
	 * value: <NA> ' Created By: <Gangotri Sikheria> ' ' Created On:
	 * <MM/dd/yyyy> <07/21/2020>
	 * 
	 * #########################################################################
	 * #########################################################################
	 * ########################
	...
	public void createNightlyRatePlan(WebDriver driver, String planType, String ratePlanName, String folioDisplayName,
			...
			String isSeasonRuleOnSaturday, String isSeasonRuleOnSunday) throws InterruptedException, ParseException {
	...
	public void  removeRuleForMinStay(WebDriver driver,ArrayList<String> testSteps, String roomClass, String channelName,String ruleAppliedOn, int index) throws InterruptedException, ParseException
	{		 
		Elements_RatesGrid elements = new Elements_RatesGrid(driver);		
			String path="(//div[@class='DatesTable']//div[contains(@title,'"+roomClass+"')]"
					+ "/ancestor::div/..//following-sibling::div//div[@title='"+channelName+"']"
					+ "/ancestor::div/..//following-sibling::div//div[contains(@class,'RuleHeader') and text()='"+ruleAppliedOn+"']"
					+ "/parent::div//input[not(@value='')])["+index+"]";
	 ...
	 * ########################
	 * 
	 * ' Method Name: <updateExtraAdultsAndExtraChildBoth> ' Description:
	 * <Update Extra Adult and Extra Child at both at same time > ' Input
	 * parameters: <WebDriver driver, ArrayList<String> testSteps, String
	 * roomClass, String rate, String adults, String child> ' Return value: <NA>
	 * ' Created By: <Gangotri Sikheria> ' ' Created On: <MM/dd/yyyy>
	 * <07/31/2020>
	 * 
	 * #########################################################################
	 * #########################################################################
	...
	//extracting rate only from the HashMap(rate parameter) which having rate as value and date as Key
	public ArrayList<String> getRate(HashMap<String, String> rate, WebDriver driver, String checkin, String checkout, ArrayList<String>test_steps){
		ArrayList<String> rates = new ArrayList<String>();
		ArrayList<String> dates = new ArrayList<String>();
		String checkinDate = Utility.parseDate(checkin, "dd/MM/yyyy", "MM/dd/yyyy");
			String checkoutDate = Utility.parseDate(checkout, "dd/MM/yyyy", "MM/dd/yyyy");
	...
	public boolean selectRatePlan(WebDriver driver, String ratePlanName, ArrayList<String>test_steps) throws InterruptedException {
		boolean flag;
		Elements_RatesGrid elements = new Elements_RatesGrid(driver);
		...
		try {
			if(driver.findElements(By.xpath("//*[@id='ratePlans']//span[contains(@class,'ir-plus')]")).size()>0) {
				Utility.clickThroughJavaScript(driver, driver.findElement(By.xpath("//*[@id='ratePlans']//span[contains(@class,'ir-plus')]")));
			}
		}catch (Exception e) {
			// TODO: handle exception
		}
	...
	public boolean searchForRatePlanExistingOrNot(WebDriver driver, ArrayList<String> test_steps, 
			String ratePlanName) throws Exception {
		boolean ratePlanExists = false;
		ArrayList<String> allRatePlans = new ArrayList<>();
		try {
	...
	public void verifySelectedRatePlan(WebDriver driver, String ratePlan, ArrayList<String>test_steps) throws Exception {
	...
	public void verifyRatePlanSingleRoomClass(WebDriver driver, String roomClass,ArrayList<String> testSteps) throws InterruptedException {
		
		String path="//div[@class='DatesTable']//div[@class='roomClassName' and contains(text(),'"+roomClass+"')]";
		Wait.WaitForElement(driver, path);
		WebElement element = driver.findElement(By.xpath(path));
		Utility.ScrollToViewElementINMiddle(driver, element);
		assertEquals(element.getText().toLowerCase().trim(),roomClass.toLowerCase().trim(), "Failed to verify room Class");
		testSteps.add("Verified Room Class : <b> "+element.getText()+" Displayed</b>");
		logger.info("Verified Room Class : "+element.getText()+ "Displayed");
	...
	// Added By adhnan 8/04/2020
			public List<String>[] getActiveRatePlans(WebDriver driver, ArrayList<String> ratePlanTypes,int startIndex) throws InterruptedException {
				ArrayList<String> getNames = new ArrayList<String>();
				Elements_RatesGrid elements = new Elements_RatesGrid(driver);
				Wait.WaitForElement(driver, OR_RatesGrid.ratePlanNamesList);
				int size = elements.ratePlanNames.size();
...
//					}
			...
			public ArrayList<String> verifyDerivedRateDisplay(WebDriver driver, String rateName)
					throws InterruptedException {
				ArrayList<String> testSteps = new ArrayList<String>();
				String path = "//span[text()='"+ rateName +"']";
				Wait.WaitForElement(driver, path);
				...
				WebElement derivedRate = driver.findElement(By.xpath(path));
				Utility.ScrollToElement(derivedRate, driver);
				assertTrue(derivedRate.isDisplayed(), "Failed derived rate with name ( "+ rateName +") is not displaying in rate grid");
			...
			public ArrayList<String> clickDerivedRateExpandIcon(WebDriver driver, String rateName)
					throws InterruptedException {
				ArrayList<String> testSteps = new ArrayList<String>();
				String path = "//span[text()='"+ rateName +"']//preceding-sibling::span";
				Wait.WaitForElement(driver, path);
			...
			public String getDerivedRateCondition(WebDriver driver)
					throws InterruptedException {
				Elements_RatesGrid elements = new Elements_RatesGrid(driver);
				Wait.WaitForElement(driver, OR_RatesGrid.DerivedRateCondition);
				Wait.waitForElementToBeVisibile(By.xpath(OR_RatesGrid.DerivedRateCondition), driver);
			...
			public ArrayList<String> verifyDerivedRatePlanAmount(WebDriver driver, String ratePlan, String amount, String currencySymbol, String parentRatePlan)
					throws InterruptedException {
				ArrayList<String> testSteps = new ArrayList<String>();
				String path = "//span[text()='"+ ratePlan +"']//parent::h3//following-sibling::div//div[contains(text(),'Derived Rate Plan:')]";
				logger.info(path);
				WebElement derivedRate = driver.findElement(By.xpath(path));
				 ...
				 Utility.ScrollToElement(derivedRate, driver);
				 assertTrue(derivedRate.isDisplayed(),
				 "Failed to verify derived rate amount in rate grid");
...
public void verifyRoomClassAfterDelete(WebDriver driver, String roomClass,ArrayList<String> testSteps) throws InterruptedException {
...
public ArrayList<String> showroomavailability(WebDriver driver,boolean isToggleEnable) throws InterruptedException {
	ArrayList<String> test_steps = new ArrayList<String>();
	Elements_RatesGrid ratesGrid = new Elements_RatesGrid(driver);
	String toggleEnableColor = "rgba(62, 168, 244, 1)";
	String toggleDisableColor = "rgba(204, 204, 204, 1)";
	...
	if (isToggleEnable) {
		...
		if (ratesGrid.settingAvailabilityToggleButton.getCssValue("background-color")
				.equals(toggleDisableColor)) {
...
/*//extracting rate only from the HashMap(rate parameter) which having rate as value and date as Key
	...
	public void selectRatePlan(WebDriver driver, String ratePlanName, ArrayList<String>test_steps) {
		Elements_RatesGrid elements = new Elements_RatesGrid(driver);
	    clickRateDropDown(driver, test_steps);
	    Wait.waitUntilPresenceOfElementLocated(RateGridPage.SearchRatPlan, driver);	
		elements.searchRatPlan.sendKeys(ratePlanName);
	...
	public String getPerNightRate(WebDriver driver, String roomClassName)
			throws InterruptedException {
	 ...
	 * ########################
	 * 
	 * ' Method Name: <getRatePlanColorInRatePlanDropDownList> 
	 * ' Description: < return color of rate plan in the Rates grid Rate Plan drop down> 
	 ...
	 * 
	 * ' Method Name:
	 * <getRatePlanColorInverifyDerivedRateLabelRatePlanDropDownList> '
	 * Description: < Validations on Derived Rates Label > ' Input parameters: <
	 * WebDriver, String, ArrayList,String>> ' Return value:ArrayList<String> '
	 * Created By: <Adhnan Ghaffar> ' Created On: <08/21/2020>
	 *
...
public void expandRoomClass(WebDriver driver,String roomClass) throws InterruptedException{
 ...
 public String getRate(WebDriver driver,String channel,int index) throws InterruptedException{
		...
		String getRate = "(//div[text()='"+channel+"']//..//following-sibling::div)["+index+"]//div[@class=' RegularRate']";
		Wait.WaitForElement(driver, getRate);
		Wait.waitForElementToBeVisibile(By.xpath(getRate), driver);
		Wait.waitForElementToBeClickable(By.xpath(getRate), driver);
		WebElement element = driver.findElement(By.xpath(getRate));
 ...
 public String getRule(WebDriver driver,String ruleName,int index) throws InterruptedException{
		...
		String getRule = "(//div[text()='"+ruleName+"']//following-sibling::div)["+index+"]//input[@name='rulevalue']";
		Wait.WaitForElement(driver, getRule);
		Wait.waitForElementToBeVisibile(By.xpath(getRule), driver);
		Wait.waitForElementToBeClickable(By.xpath(getRule), driver);
		WebElement element = driver.findElement(By.xpath(getRule));
 ...
 public String getNoCheckInCheckOut(WebDriver driver,String ruleName,int index) throws InterruptedException{
		...
		String getCheckinCheckout = "(//div[text()='"+ruleName+"']//following-sibling::div)["+index+"]//div//child::div[contains(@class, 'rt-onHover')]";
		Wait.WaitForElement(driver, getCheckinCheckout);
		Wait.waitForElementToBeVisibile(By.xpath(getCheckinCheckout), driver);
		Wait.waitForElementToBeClickable(By.xpath(getCheckinCheckout), driver);
		WebElement element = driver.findElement(By.xpath(getCheckinCheckout));
	...
	public List<String>[] getRateMinStayRule(WebDriver driver, String checkIn, String checkout, String ratePlan,
			String roomClass, String timeZone,ArrayList<String> testSteps) throws InterruptedException, ParseException {
	...
	public HashMap<String, List[]> getRateMinStayRule(WebDriver driver, String checkIn, String checkout, String ratePlan,
			String roomClass, String timeZone, String channels, ArrayList<String> testSteps) throws InterruptedException, ParseException {
					...
					for(String classes : splittedClasses) {
						for(String channel : splittedChannels) {
							...
							for (int j = 1; j <=loopCount; j++) {
								...
								if(getNoCheckIn.contains(expectedClassesForEnabled)) {
									getNoCheckInValue.add(true);
									logger.info("get no check in value for "+ channel +" in " + classes +" : "+getNoCheckIn + " : " + true);
									
								}else {
									getNoCheckInValue.add(false);
									logger.info("get no check in value for "+ channel +" in " + classes +" : "+getNoCheckIn + " : " + false);
								...
								if(getNoCheckOut.contains(expectedClassesForEnabled)) {
									getNoCheckOutValue.add(true);
									logger.info("get no check out value for "+ channel +" in " + classes +" : "+getNoCheckOut + " : " + true);
								}else {
									getNoCheckOutValue.add(false);
									logger.info("get no check out value for "+ channel +" in " + classes +" : "+getNoCheckOut + " : " + false);
								}
								count = count + 1;
	 ...
	 * 
	 * ' Method Name:
	 * <verifyNumberOfDerivedRatePlanInLabel> '
	 * Description: < Verify Number of rate Plans in Derived Rates Label > 
	 * ' Input parameters: <WebDriver, String, ArrayList,String>> ' Return value:ArrayList<String> '
	 * Created By: <Adhnan Ghaffar> ' Created On: <08/21/2020>
	 *
	 * #########################################################################
	 * #########################################################################
	 * ########################
	 */
	public ArrayList<String> verifyNumberOfDerivedRatePlanInLabel(WebDriver driver, String numberOfRatePlans, ArrayList<String> testSteps)
			throws InterruptedException {
		Elements_DerivedRate elements = new Elements_DerivedRate(driver);
		Wait.WaitForElement(driver, DerivedRatePage.DERIVED_RATE_PLAN_LABEL);
		Wait.explicit_wait_visibilityof_webelement(elements.DERIVED_RATE_PLAN_LABEL, driver);
		...
		testSteps.add("Found Derived Rates Label text : " + text);
		assertTrue(text.contains("(" + numberOfRatePlans + ")"), "Failed number of derived rate Plans missmatched");
		testSteps.add("Successfully verified Total number of Derived Rates count is Displayed next to the Derived Rate text in brackets");
		logger.info("Successfully verified Total number of Derived Rates count is Displayed next to the Derived Rate text in brackets");
	...
	// Added By adhnan 8/04/2020
		public ArrayList<String> getActiveRatePlans(WebDriver driver, String ratePlanType,
				int requiredNumberOfRatePlans) throws InterruptedException {
			ArrayList<String> getNames = new ArrayList<String>();
			Elements_RatesGrid elements = new Elements_RatesGrid(driver);
			Wait.WaitForElement(driver, OR_RatesGrid.ratePlanNamesList);
			int size = elements.ratePlanNames.size();
...
//				nightlyRate.enterRateFolioDisplayName(driver, ratePlanName, test_steps);
	...
	public void searchAndEditRatePlan(WebDriver driver, ArrayList<String> test_steps, String ratePlanName) throws Exception {
		Navigation navigation = new Navigation();
		navigation.Inventory(driver, test_steps);
		navigation.RatesGrid(driver);
		if (searchForRatePlanExistingOrNot(driver, test_steps, ratePlanName)) {
	...
	public HashMap<String, String> getBookingWindowRestrictions(WebDriver driver, ArrayList<String> test_steps, 
		...
		boolean bookingWindowCheckBoxSelected = driver.findElement(By.xpath(bookingWindowCheckBox)).isSelected();
		if (bookingWindowCheckBoxSelected) {
			String moreThanValue = driver.findElement(By.
					xpath("//span[contains(text(),'More than')]/../../..//input[@class='ant-input-number-input']")).getAttribute("value");
			String withInValue = driver.findElement(By.

				xpath("//span[contains(text(),'Within')]/../../..//input[@class='ant-input-number-input']")).getAttribute("value");

			bookingWindowRestrictions.put("More than", moreThanValue);
			bookingWindowRestrictions.put("Within", withInValue);			
			if (Utility.validateString(moreThanValue)) {
				test_steps.add("Captured <b>More than --- days in advance of check-in date</b> value as <b>"+moreThanValue+"</b>");				
			} else {
				test_steps.add("<b>More than --- days in advance of check-in date</b> check box is disabled");
			}
			if (Utility.validateString(withInValue)) {
	...
	//Added By Adhnan 08/29/2020
	public ArrayList<String> bulkUpdate(WebDriver driver, String bulkUpdateType,String startDate, String endDate, String dateFormat,
			String sunday, String monday, String tuesday, String wednesday, String thursday,
			String friday, String saturday, String isTotalOccupancyOn, String totalOccupancyType,
			String totalOccupancyValue, String ratePlansName, String roomClassName, String channel,
			String updateRatesType, String updateRateByRoomClass, String nightlyRate, String additionalAdults,
			String additionalChild, String rateChangeValue, String rateCurrencyType,ArrayList<String> activeRatePlanNames,
			ArrayList<String> inactiveRatePlanNames, ArrayList<String> activeRoomClassesNames, 
			ArrayList<String> activeChannelsList,  String isMinimumStayOn, String minimumStayValue, String isCheckInOn, String isNoCheckInChecked, String isCheckOutOn, String isNoCheckOutChecked) throws InterruptedException {
		ArrayList<String> getTestSteps = new ArrayList<>();
		ArrayList<String> testSteps = new ArrayList<>();
...
//		testSteps.addAll(getTestSteps);
		...
		if (updateRatesType.equalsIgnoreCase("EnterNewRate")) {
			...
			getTestSteps.clear();
			getTestSteps = updateRoomsByRoomClassToggle(driver,
	...
	//Added By Adhnan 09/01/2020
	public ArrayList<String> expandReduceDerivedRateRoomClass(WebDriver driver,String ratePlan, String roomClass, String buttonName) throws InterruptedException{
		
		ArrayList<String>  steps = new ArrayList<String>(); 
		String expandRoomClass = "(//span[text()='"+ratePlan+"']//ancestor::div[@class='DerivedPlan']//following-sibling::div[contains(@class,'RateplanDetails')]//div[@class='roomClassName' and text()='"+roomClass+"']//following-sibling::span)[1]";
		Wait.WaitForElement(driver, expandRoomClass);
		Wait.waitForElementToBeVisibile(By.xpath(expandRoomClass), driver);
		Wait.waitForElementToBeClickable(By.xpath(expandRoomClass), driver);
		WebElement expandButton = driver.findElement(By.xpath(expandRoomClass));
	...
	//Added By Adhnan 09/01/2020
		public ArrayList<String> expandReduceBaseRateRoomClass(WebDriver driver,String ratePlan, String roomClass, String buttonName) throws InterruptedException{
			
			ArrayList<String>  steps = new ArrayList<String>(); 
			String expandRoomClass = "(//span[text()='"+ratePlan+"']//ancestor::div[@id='ratePlans']//following-sibling::div[contains(@class,'RateplanDetails')]//div[@class='roomClassName' and text()='"+roomClass+"']//following-sibling::span)[1]";
			Wait.WaitForElement(driver, expandRoomClass);
			Wait.waitForElementToBeVisibile(By.xpath(expandRoomClass), driver);
			Wait.waitForElementToBeClickable(By.xpath(expandRoomClass), driver);
			WebElement expandButton = driver.findElement(By.xpath(expandRoomClass));
	 ...
	 * ########################
	 * 
	 * ' Method Name: <clickOnRateTab> ' Description: <This method will
	 * click on rates tab in rate grid > ' Input parameters: <WebDriver
	 * driver> ' Return value : <ArrayList<String> > ' Created By: <Farhan
	 * Ghaffar> ' Created On: <08/27/2020>
	 * 
	 * #########################################################################
	 * #########################################################################
	 * ########################
	...
	public boolean verifyLenthOfStayCheckBox(WebDriver driver,ArrayList test_steps,String nameOfComponent) throws InterruptedException {
		String path = "//span[text()='"+nameOfComponent+"']//parent::label";
		Wait.WaitForElement(driver,path);
		Wait.waitForElementToBeVisibile(By.xpath(path), driver);
		Wait.waitForElementToBeClickable(By.xpath(path), driver);
	...
	public ArrayList<String> getRuleDataValuesForMinStay(WebDriver driver, ArrayList<String> test_steps,String roomClassName, String channelName,int days) throws InterruptedException {
		ArrayList<String> data = new ArrayList<String>();
		String rule = "//div[contains(text(),'"+roomClassName+"')]/../../..//div[contains(text(),'"+channelName+"')]/../../..//div[text()='Min Stay']/following-sibling::div//input";
		System.out.println("rulePath: "+rule);
		Wait.WaitForElement(driver, rule);
		String ruleValue="";
		for(int i=0;i<days;i++) {
			rule = "(//div[contains(text(),'"+roomClassName+"')]/../../..//div[contains(text(),'"+channelName+"')]/../../..//div[text()='Min Stay']/following-sibling::div//input)["+(i+1)+"]";
			ruleValue=driver.findElement(By.xpath(rule)).getAttribute("value");
			if(ruleValue.isEmpty()||ruleValue.equals("")) {
				ruleValue="0";
			}
	...
	public ArrayList<String> getRuleDataValuesForNoCheckIn(WebDriver driver, ArrayList<String> test_steps,String roomClassName, String channelName,int days) throws InterruptedException {
		ArrayList<String> data = new ArrayList<String>();
		String rule = "//div[contains(text(),'"+roomClassName+"')]/../../..//div[contains(text(),'"+channelName+"')]/../../..//div[text()='No Check In']/following-sibling::div/div/div";
		Wait.WaitForElement(driver, rule);
		String ruleValue="";
		for(int i=0;i<days;i++) {
			rule = "(//div[contains(text(),'"+roomClassName+"')]/../../..//div[contains(text(),'"+channelName+"')]/../../..//div[text()='No Check In']/following-sibling::div/div/div)["+(i+1)+"]";
			ruleValue=driver.findElement(By.xpath(rule)).getAttribute("class");
			if(ruleValue.contains("noValue")) {
				ruleValue="No";
			}else {
	...
	public ArrayList<String> getRuleDataValuesForNoCheckOut(WebDriver driver, ArrayList<String> test_steps,String roomClassName, String channelName,int days) throws InterruptedException {
		ArrayList<String> data = new ArrayList<String>();
		String rule = "//div[contains(text(),'"+roomClassName+"')]/../../..//div[contains(text(),'"+channelName+"')]/../../..//div[text()='No Check Out']/following-sibling::div/div/div";
		Wait.WaitForElement(driver, rule);
		String ruleValue="";
		for(int i=0;i<days;i++) {
			rule = "(//div[contains(text(),'"+roomClassName+"')]/../../..//div[contains(text(),'"+channelName+"')]/../../..//div[text()='No Check Out']/following-sibling::div/div/div)["+(i+1)+"]";
			ruleValue=driver.findElement(By.xpath(rule)).getAttribute("class");
			if(ruleValue.contains("noValue")) {
				ruleValue="No";
			}else {
	...
	public void overrideMinStayValue(WebDriver driver, ArrayList<String> testSteps, String roomClass, String channelName, String newNight) throws InterruptedException {
//String path = "(//div[contains(text(),'" + roomClass + "')]/ancestor::div//div[@title='" + channelName + "']"
//				+ "/ancestor::div//div[text()='Min Stay']/parent::div//input)[1]";
		String path = "(//div[contains(text(),'" + roomClass + "')]/../../../..//div[@title='" + channelName + "']/../../..//div[text()='Min Stay']/parent::div//input)[1]";
		Wait.WaitForElement(driver, path);
		WebElement element = driver.findElement(By.xpath(path));
		Utility.ScrollToViewElementINMiddle(driver, element);
		element.click();
...
//				+ ruleAppliedOnCheckInOrCheckOut + "']" + "/following::div[1]//div[@class='rt-onHover  has-noValue enabled']";
		...
		String selectedPath = "(//div[contains(text(),'" + roomClass + "')]/../../../..//div[@title='" + channelName + "']/../../..//div[contains(@class,'RuleHeader') and text()='"
																					
																								 
				+ ruleAppliedOnCheckInOrCheckOut + "']" + "/following::div[1]//div[@class='rt-onHover  enabled'])[1]";
		
		String blankPath = "(//div[contains(text(),'" + roomClass + "')]/../../../..//div[@title='" + channelName + "']/../../..//div[contains(@class,'RuleHeader') and text()='"
																					
																								 
				+ ruleAppliedOnCheckInOrCheckOut + "']" + "/following::div[1]//div[@class='rt-onHover  has-noValue enabled'])[1]";
		...
		testSteps.add("Update Rule for <b>" + ruleAppliedOnCheckInOrCheckOut + " </b> Message : <b> Rule saved successfully </b>");
		logger.info("Update Rule for " + ruleAppliedOnCheckInOrCheckOut + " Message :  Rule saved successfully");
		

	}
	
	public void overrideNightExtraAdultChildRate(WebDriver driver, ArrayList<String> testSteps, String roomClass, String channel, String nightRate, String extAdult, String extChild)
			throws InterruptedException {
		

		Elements_RatesGrid elements = new Elements_RatesGrid(driver);
		String path = "//div[@class='DatesTable']//div[contains(@title,'"+roomClass+"')]/ancestor::div/..//following-sibling::div//div[@title='"+channel+"']//parent::div/following::div[1]/div[1][text()!='--']";
		Wait.explicit_wait_elementToBeClickable(driver.findElement(By.xpath(path)), driver);
		Utility.ScrollToElement(driver.findElement(By.xpath(path)), driver);
		try{
			driver.findElement(By.xpath(path)).click();
	...
	public void clickExpendRooClass(WebDriver driver, ArrayList<String> testSteps, String roomClass) throws InterruptedException {
		String roomClassName="//div[contains(text(),'"+roomClass+"')]//following-sibling::span";	
		
		String path = "//div[contains(text(),'"+roomClass+"')]//following-sibling::span[contains(@class,'ir-plus')]";
		Wait.WaitForElement(driver, roomClassName);
		if(driver.findElements(By.xpath(path)).size()>0) {
			path = "//div[contains(text(),'"+roomClass+"')]//following-sibling::span[contains(@class,'ir-plus')]";
			WebElement element = driver.findElement(By.xpath(path));
	...
	public ArrayList getAvailability(WebDriver driver, ArrayList<String> testSteps, String roomClass,int days,String CheckInDate) throws Exception {
		String availability="//div[contains(text(),'"+roomClass+"')]/../../..//div[text()='Available']/../following-sibling::div/div";
		ArrayList avail = new ArrayList<>();
		DateTimeFormatter dtf = DateTimeFormatter.ofPattern("dd/MM/yyyy");  
		LocalDateTime now = LocalDateTime.now();  
		String today=dtf.format(now);  
		...
		for(int i=1;i<=days;i++) {
			...
			availability="(//div[contains(text(),'"+roomClass+"')]/../../..//div[text()='Available']/../following-sibling::div/div)["+(i)+"]";
			logger.info(availability);
			Wait.WaitForElement(driver, availability);
			Utility.ScrollToElement(driver.findElement(By.xpath(availability)), driver);
			avail.add(driver.findElement(By.xpath(availability)).getText());
			testSteps.add("Getting availability count of  the room class : "+roomClass +" for the date : "+date+" as "+driver.findElement(By.xpath(availability)).getText());
			logger.info("Getting availability count of  the room class : "+roomClass +" for the date : "+date+" as "+driver.findElement(By.xpath(availability)).getText());
		}
		return avail;
	}
		 ...
		 public void overrideNoCheckInCheckOut(WebDriver driver,String ruleName,int index, boolean isClick) throws InterruptedException{
			...
			public ArrayList<String> overrideMinStayRule(WebDriver driver, String checkIn, String checkout, String ratePlan,
					String roomClass, String timeZone, String channels, String ruleValue, Boolean noCheckIn, Boolean noCheckOut) throws InterruptedException, ParseException {
							...
							for(String classes : splittedClasses) {
								for(String channel : splittedChannels) {
									...
									for (int j = 1; j <=loopCount; j++) {
										...
										overrideRule(driver, "Min Stay", j,ruleValue);
										logger.info("Set Value for source ("+ channel +") in roomclass (" + classes + ")");
										testSteps.add("Set rule value("+ ruleValue +") for source ("+ channel +") in roomclass (" + classes + ")");
										overrideNoCheckInCheckOut(driver, "No Check In", j, noCheckIn);
										if(noCheckIn) {
											logger.info("Checked no check in for source ("+ channel +") in roomclass (" + classes + ")");
											testSteps.add("Checked no check in for  source ("+ channel +") in roomclass (" + classes + ")");
											
										}else {
											logger.info("Unchecked no check in for source ("+ channel +") in roomclass (" + classes + ")");
											testSteps.add("Unchecked no check in for source ("+ channel +") in roomclass (" + classes + ")");
											
										}
										overrideNoCheckInCheckOut(driver, "No Check Out", j, noCheckOut);
										if(noCheckOut) {
											logger.info("Checked no check out for source ("+ channel +") in roomclass (" + classes + ")");
											testSteps.add("Checked no check out for source ("+ channel +") in roomclass (" + classes + ")");
											
										}else {
											logger.info("Unchecked no check out for source ("+ channel +") in roomclass (" + classes + ")");
											testSteps.add("Unchecked no check out for source ("+ channel +") in roomclass (" + classes + ")");
	...
	// Added By Adhnan 09/02/2020
			...
			public ArrayList<String> verifyRulesValue(WebDriver driver,String ratePlanType, String channels, String startDate, String endDate,
					String dateFormat, String timeZone, String overrideMinStayValue, String overrideNoCheckInValue,
					String overrideNoCheckOutValue, HashMap<String, Boolean> dayMap)
					throws InterruptedException, ParseException {
				ArrayList<String> testSteps = new ArrayList<>();
				...
				while (token.hasMoreTokens()) {
					...
					for (int i = 0; i <= days; i++) {
						...
						if (dayMap.get(day)) {
							...
							String getRule = getRule(driver, "Min Stay", i + 1);
							//testSteps.add("Expected "+ratePlanType+" Rate Plan Rule Value : '" + overrideMinStayValue + "'");
							logger.info("Expected "+ratePlanType+" Rate Plan Rule Value : '" + overrideMinStayValue + "'");
						//	testSteps.add("Found "+ratePlanType+" Rate Plan Rule Value : '" + getRule + "'");

							logger.info("Found "+ratePlanType+" Rate Plan Rule Value : '" + getRule + "'");
							testSteps.add("Successfully Verified  "+ratePlanType+" Rate Plan Rule Value : '" + getRule + "'");
							logger.info("Successfully Verified  "+ratePlanType+" Rate Plan Rule Value : '" + getRule + "'");
							if(!getRule.equals(overrideMinStayValue)) {
								Wait.wait5Second();
							}
							Assert.assertTrue(getRule.equals(overrideMinStayValue),
									"Failed "+ratePlanType+" Rate MinStay Value Missmatched");
							String getNoCheckIn = getNoCheckInCheckOut(driver, "No Check In", i + 1);
							//testSteps.add("Expected "+ratePlanType+" Rate Plan No Check In Rule Value : '" + overrideNoCheckInValue + "'");
							logger.info("Expected "+ratePlanType+" Rate Plan No Check In Rule Value : '" + overrideNoCheckInValue + "'");
							//testSteps.add("Found "+ratePlanType+" Rate Plan No Check In Rule Value : '" + getNoCheckIn + "'");
							logger.info("Found "+ratePlanType+" Rate Plan No Check In Rule Value : '" + getNoCheckIn + "'");
							testSteps.add("Successfully Verified  "+ratePlanType+" Rate Plan No Check In Rule Value : '" + getNoCheckIn + "'");
							logger.info("Successfully Verified  "+ratePlanType+" Rate Plan No Check In Rule Value : '" + getNoCheckIn + "'");
							Assert.assertTrue(getNoCheckIn.contains(overrideNoCheckInValue),
									"Failed "+ratePlanType+" Rate No CheckIn Value Missmatched");
							String getNoCheckOut = getNoCheckInCheckOut(driver, "No Check Out", i + 1);
							//testSteps.add("Expected "+ratePlanType+" Rate Plan No Check Out Rule Value : '" + overrideNoCheckOutValue + "'");
							logger.info("Expected "+ratePlanType+" Rate Plan No Check Out Rule Value : '" + overrideNoCheckOutValue + "'");

						//	testSteps.add("Found "+ratePlanType+" Rate Plan No Check Out Rule Value : '" + getNoCheckOut + "'");

							logger.info("Found "+ratePlanType+" Rate Plan No Check Out Rule Value : '" + getNoCheckOut + "'");
							testSteps.add("Successfully Verified "+ratePlanType+" Rate Plan No Check Out Rule Value : '" + getNoCheckOut + "'");
							logger.info("Successfully Verified "+ratePlanType+" Rate Plan No Check Out Rule Value : '" + getNoCheckOut + "'");
							Assert.assertTrue(getNoCheckOut.contains(overrideNoCheckOutValue),
									"Failed "+ratePlanType+" Rate No CheckOut Value Missmatched");
						}
					}
	...
	public ArrayList<String> overrideMinStayRules(WebDriver driver, String startDate, String endDate,String dateFormat, String ratePlan,
			String classes, String timeZone, String channels, String ruleValue, Boolean noCheckIn, Boolean noCheckOut,HashMap<String, Boolean> dayMap) throws InterruptedException, ParseException {
	...
	public ArrayList<String> expandParentRateGrid(WebDriver driver,String className) throws InterruptedException{
		ArrayList<String> testSteps = new ArrayList<>();
		String expandParentRateGrid = "//div[@id='ratePlans']//following-sibling::div[@class='RateplanOverview']//span[@class='ir-acrd-bnt ir-"+ className +" pr-5']";
		List<WebElement> expand = driver.findElements(By.xpath(expandParentRateGrid));
		if(expand.size() > 0) {
			Wait.WaitForElement(driver, expandParentRateGrid);
			Wait.waitForElementToBeVisibile(By.xpath(expandParentRateGrid), driver);
	...
	public ArrayList getBlockOutRoomClass(WebDriver driver,ArrayList<String> testSteps,String RoomClass,int days,String Source,String CheckInDate) throws Exception {
		ArrayList<Boolean> al = new ArrayList<Boolean>();
		String blockout="";
		...
		for(int i=0;i<days;i++) {
			...
			String date=dateFormat2.format(currentDatePlusOne2);
				...
				blockout="//div[contains(text(),'"+RoomClass+"')]/../../..//div[contains(text(),'"+Source+"')]/../following-sibling::div["+(i+1)+"]";
				String classAtt=driver.findElement(By.xpath(blockout)).getAttribute("class");
				if(classAtt.contains("NoBlackedStatus")) {
					al.add(true);
					testSteps.add("Getting the room class : "+RoomClass +" for the date : "+date+" as not Blocked out");
					logger.info("Getting the room class : "+RoomClass +" for the date : "+date+" as not Blocked out");
				}else {
					testSteps.add("Getting the room class : "+RoomClass +" for the date : "+date+" as Blocked out");
					logger.info("Getting the room class : "+RoomClass +" for the date : "+date+" as Blocked out");
					al.add(false);
...
public HashMap<String, String> getLengthOfStayMinAndMaxValue(WebDriver driver, String componentName, String minName, String maxName,HashMap<String, Boolean> isLengthOfStay) throws InterruptedException{
		HashMap<String, String> minMax= new HashMap<String, String>();
		boolean isLengthOfStayCheck=verifyLenthOfStayCheckBox(driver, componentName);
		isLengthOfStay.put("Length of stay", isLengthOfStayCheck);
		logger.info("isLengthOfStayCheck "+isLengthOfStayCheck);
	...
	public HashMap<String, String> getBookingWindowValue(WebDriver driver, String componentName, String moreThan, String withIn,ArrayList<String> test_steps,HashMap<String, Boolean> bookingWindow) throws InterruptedException{
		HashMap<String, String> moreThanWithIn= new HashMap<String, String>();
     	boolean isBookingWindowChecked=isBookingWindowChecked(driver, test_steps);
     	bookingWindow.put("Booking window", isBookingWindowChecked);
		if(isBookingWindowChecked) {
	...
	public String getPromocodeValue(WebDriver driver, String componentName, ArrayList<String> test_steps, HashMap<String, Boolean> promoCode) throws InterruptedException{
		String minMax= null;
     	boolean isPromoCodeChecked=isPromoCodeChecked(driver, test_steps);
     	promoCode.put("PromoCode", isPromoCodeChecked);
		if(isPromoCodeChecked) {
	...
	public void clickRateOfRoomClass(WebDriver driver, String roomClassName, String checkInDate, String checkOutDate)throws InterruptedException, ParseException {
		Elements_RatesGrid elements = new Elements_RatesGrid(driver);
		ArrayList<String> dayList = new ArrayList<String>();
		ArrayList<String> dateList = new ArrayList<String>();
		ArrayList<String> datesList = new ArrayList<String>();
	...
	public void clickRateOfChannel(WebDriver driver, String roomClassName, String channelName,String checkInDate, String checkOutDate)throws InterruptedException, ParseException {
		Elements_RatesGrid elements = new Elements_RatesGrid(driver);
		ArrayList<String> dayList = new ArrayList<String>();
		ArrayList<String> dateList = new ArrayList<String>();
		ArrayList<String> datesList = new ArrayList<String>();
	...
	public void verifyRateExAdExChDisabledOrEnabled(WebDriver driver, ArrayList<String> testSteps, boolean isExist) {
			assertEquals(Utility.isElementPresent(driver, By.xpath(OR_RatesGrid.rateExAdExChPopup)),isExist, "Failed to verify Rate field disabled");
				if(isExist==false) {
					testSteps.add("Verified Rates Extra Adult and Extra Child Disabled");
					logger.info("Verified Rates Extra Adult and Extra Child Disabled");}
			else if(isExist==true) {
	...
	public void verifyRoomClass(WebDriver driver, ArrayList<String> roomClassesList, ArrayList<String> testSteps) throws InterruptedException {
		ArrayList<String>roomClass = new ArrayList<String>();
		roomClass=getrateGridRoomClass(driver);
		Collections.sort(roomClass);
		Collections.sort(roomClassesList);
	...
	public HashMap<String, String> getTotalOccupancy(WebDriver driver, String startDate, String endDate) throws ParseException, InterruptedException {
		Elements_RatesGrid elements = new Elements_RatesGrid(driver);
		ArrayList<String> totalOccupancy = new ArrayList<String>();
		ArrayList<String> datesList = new ArrayList<String>();
		HashMap<String, String> totalOccupancyList = new HashMap<String, String>();
	...
	public HashMap<String, String> verifyBulkUpdateRuleForMinStay(WebDriver driver, String startDate, String endDate, String roomClass, String channelName, String ruleAppliedOn,String minValue) throws ParseException, InterruptedException {
		Elements_RatesGrid elements = new Elements_RatesGrid(driver);
		ArrayList<String> datesList = new ArrayList<String>();
		HashMap<String, String> totalOccupancyList = new HashMap<String, String>();
		ArrayList<String> dayList = new ArrayList<String>();
		...
		dateFromtotalOccupiency.clear();
		for (Map.Entry<String, String> entry : totalOccupancy.entrySet()) {
			dateFromtotalOccupiency.add(Utility.getDateOnlyFromCompleteDate(Utility.convertStringtoDateFormat("dd/MM/yyyy", entry.getKey())));
		}
		logger.info("Total Occupancy are: " + totalOccupancy);
		String pathOne = "//div[@class='DatesTable']//div[contains(@title,'" + roomClass + "')]"
				+ "/ancestor::div/..//following-sibling::div//div[@title='" + channelName + "']"
		...
		for (int i = 0; i < datesList.size(); i++) {
			for (int j = 0; j < dateFromtotalOccupiency.size(); j++){
				if (datesList.get(i).equals(dateFromtotalOccupiency.get(j))){
					Utility.ScrollToElement(elementOne.get(i), driver);
					assertEquals(elementOne.get(i).getAttribute("value"), minValue, "Failed to Verify Updated Min Stay");
					logger.info("Verified Updated Min Stay is :" + minValue);
					totalOccupancyList.put(dateList.get(j), elementOne.get(i).getAttribute("value"));	}
			}
	...
	public HashMap<String, String> verifyBulkUpdateRuleForCheckInCheckout(WebDriver driver, String startDate, String endDate, String roomClass, String channelName, String ruleAppliedOn) throws ParseException, InterruptedException {
		Elements_RatesGrid elements = new Elements_RatesGrid(driver);
		ArrayList<String> datesList = new ArrayList<String>();
		HashMap<String, String> totalOccupancyList = new HashMap<String, String>();
		ArrayList<String> dayList = new ArrayList<String>();
  ...
  //Created By Gangotri- Bulk Update- Date -17 Sep 2020
	public void selectBulkUpdateRatePlan(WebDriver driver,String selectionElement,ArrayList<String> testSteps)
		...
		String valueArray[]= selectionElement.split("\\|");
			for(int j=0;j<valueArray.length;j++) {
				...
				String selectionElementsPath=null;
				if(valueArray[j].contains("All Active") || valueArray[j].contains("All Inactive")) {
					 selectionElementsPath = "(//div[@class='Select-menu-outer'])[1]//div[contains(@class,'Select-option')]/span[contains(text(),'"+valueArray[j]+"')]";
				}else {
				selectionElementsPath = "(//div[@class='Select-menu-outer'])[1]//div[contains(@class,'Select-option')]/span[text()='"+valueArray[j]+"']";
				}
				WebElement selectionElementsList = driver.findElement(By.xpath(selectionElementsPath));
				selectionElementsList.click();
				testSteps.add("Entered : " + valueArray[j]);
	...
	public void selectBulkUpdateRoomClass(WebDriver driver,String roomClass,ArrayList<String> testSteps)
		...
		String valueArray[]= roomClass.split("\\|");
			for(int j=0;j<valueArray.length;j++) {
				...
				String selectionElementsPath=null;
				if(valueArray[j].contains("All")) {
					 selectionElementsPath = "(//div[@class='Select-menu-outer'])[1]//div[contains(@class,'Select-option')and contains(text(),'"+valueArray[j]+"')]";
				}else {
				selectionElementsPath = "(//div[@class='Select-menu-outer'])[1]//div[contains(@class,'Select-option')and text()='"+valueArray[j]+"']";
				}
				WebElement selectionElementsList = driver.findElement(By.xpath(selectionElementsPath));
				selectionElementsList.click();
				testSteps.add("Entered : " + valueArray[j]);
	...
	public boolean searchAndVerifyRatePlanExist(WebDriver driver, String ratePlanName, boolean click, ArrayList<String> testSteps) throws InterruptedException {
	...
	public HashMap<String, String> bulkUpdateAvailabilityChange(WebDriver driver,ArrayList test_steps, String startDate, String endDate, String roomClass, String toggleOccupancy, String totalOccupancyType, String totalOccupancyValue,String  source, String action,
			String monDay, String tuesDay, String wednesDay, String thursDay, String friDay, String saturDay, String sunDay) throws ParseException, InterruptedException {
		ArrayList<String> testSteps = new ArrayList<>();
		ArrayList<String> sourcetype = new ArrayList<String>();
		ArrayList<String> actiontype = new ArrayList<String>();
		Elements_RatesGrid element = new Elements_RatesGrid(driver);
...
//					JS.executeScript("arguments[0].value='"+endDate+"';", OR.EndDateInput);
		...
		actiontype=Utility.splitInputData(action);
			for(int i=0;i<=sourcetype.size()-1;i++)
					{
						String xpath="//div[contains(text(),'"+sourcetype.get(i)+"')]//parent::div/div[2]//span[text()='"+actiontype.get(i)+"']";
						Wait.waitForElementToBeVisibile(By.xpath(xpath), driver);
						driver.findElement(By.xpath(xpath)).click();
						logger.info("For the "+roomClass+ "room class(es) ,source "+sourcetype.get(i)+ "action selected is "+actiontype.get(i));
						test_steps.add("For the "+roomClass+ "room class(es) ,source "+sourcetype.get(i)+ " action selected is "+actiontype.get(i));
						availabilityChange.put(roomClass+"_"+sourcetype.get(i),actiontype.get(i));
						//logger.info(availabilityChange);
					}
		Wait.waitForElementToBeVisibile(By.xpath(OR.upadteButton), driver);
	...
	public ArrayList<String> selectDaysBulkUpdate(WebDriver driver,String monDay, String tuesDay, String wednesDay, String thursDay, String friDay, String saturDay, String sunDay) throws ParseException, InterruptedException {
		ArrayList<String> testSteps = new ArrayList<>();
		Elements_RatesGrid element = new Elements_RatesGrid(driver);
		if(monDay.equalsIgnoreCase("no"))
		{
	...
	public ArrayList<String> getCheckedDays(WebDriver driver,String monDay, String tuesDay, String wednesDay, String thursDay, String friDay, String saturDay, String sunDay) throws ParseException, InterruptedException {
		ArrayList<String> checkedDays = new ArrayList<>();
		Elements_RatesGrid element = new Elements_RatesGrid(driver);
		if(monDay.equalsIgnoreCase("yes"))
		{
	...
	public ArrayList<String> bulkUpdateMulPoppupRoomClass(WebDriver driver, String roomClass) throws InterruptedException, ParseException {
		...
		//String roomClassesPath = "(//div[contains(text(),'Select room class(es)')]//parent::div//following::div[@class='Select-menu-outer'])[1]//div[contains(@class,'Select-option')]";
		//String roomClassesPath = "//label[text()='Room class']//following-sibling::div//div[2]/input";
		String roomClassesPath = "(//div[@class='Select-placeholder']//parent::div//following::div[@class='Select-menu-outer'])[1]//div[contains(@class,'Select-option')]";
		List<WebElement> roomClassesElement = driver.findElements(By.xpath(roomClassesPath));
		logger.info("Room Class Before for" + roomclasstype.get(j));
		logger.info("Room Class Size " + roomClassesElement.size());
	...
	public ArrayList<String> bulkUpdateEnterRoomClass(WebDriver driver, String roomClass) throws InterruptedException, ParseException {
		...
		for(int i=0;i<=roomClasses.size()-1;i++)
		{
			JavascriptExecutor js = (JavascriptExecutor) driver;
			ratesGrid.bulkUpdatePopupRoomClass.click();
			js.executeScript("arguments[0].setAttribute('value', '" + roomClasses.get(i+1) +"')", ratesGrid.bulkUpdatePopupRoomClass);
			//ratesGrid.bulkUpdatePopupRoomClass.sendKeys(roomClasses.get(i+1));
			ratesGrid.bulkUpdatePopupRoomClass.sendKeys(Keys.TAB);
			testSteps.add("room class(es) are selected");
	...
	public HashMap<String, String> getAvailableBlockoutOfRoomClasses(WebDriver driver, ArrayList test_steps, String startDate, String endDate,
			String roomClass, String source) throws ParseException, InterruptedException {
		Elements_RatesGrid elements = new Elements_RatesGrid(driver);
		ArrayList<String> sourceNames = new ArrayList<String>();
		ArrayList<String> datesList = new ArrayList<String>();
		HashMap<String, String> availabilityStatus = new HashMap<String, String>();
					...
					for (String mulsources : sources)
						...
						try {
								...
								for(int i=0;i<=dateList.size();i++)
									{
										int n=i+1;
										String xpathAvailableCount = "//div[contains(text(),'Available')]//parent::div//following-sibling::div["+n+"]";
										String availableCount=driver.findElement(By.xpath(xpathAvailableCount)).getText();
										logger.info("For "+mulroomclasses+ " room class the respective day  " + dateList.get(i)+ " available room count is "+availableCount );
										//test_steps.add("For "+mulroomclasses+ " room class the respective day  " + dateList.get(i)+ " available room count is "+availableCount );

										String xpath = "//div[contains(text(),'"+mulsources+"')]//parent::div//following-sibling::div["+n+"]";
										String availability=driver.findElement(By.xpath(xpath)).getAttribute("class");
										if(availability.contains("NoBlackedStatus"))
											{
												logger.info("For the "+mulsources+ " source, " +mulroomclasses+ " room class the respective day  " + dateList.get(i)+ " is available");
												availabilityStatus.put(mulroomclasses+"_"+mulsources+"_"+dateList.get(i), "available");
												test_steps.add(" "+availabilityStatus);
											}
										else
											{
												logger.info("For the "+mulsources+ " source, " +mulroomclasses+ " room class the respective day  " + dateList.get(i)+ " is blocked");
												availabilityStatus.put(mulroomclasses+"_"+mulsources+"_"+dateList.get(i), "blocked");
												//logger.info(availabilityStatus);
												test_steps.add(" "+availabilityStatus);
											}
	...
	public ArrayList<String> selectMulRoomClass(WebDriver driver, String roomClass) throws InterruptedException, ParseException {
	...
	public ArrayList<String> verifyGivenRoomClasses(WebDriver driver, String RoomClasses,
			ArrayList<String> testSteps) throws InterruptedException {
		Elements_RatesGrid ratesGrid = new Elements_RatesGrid(driver);
		Wait.WaitForElement(driver, OR_RatesGrid.ROOM_CLASSES_NAMES);
		Wait.waitForElementToBeClickable(By.xpath(OR_RatesGrid.ROOM_CLASSES_NAMES), driver);
	...
	public HashMap<String, RatesGridChannelRatesRules> getRatesAndRulesForDate(WebDriver driver,ArrayList<String> test_steps, 
			String parentRatePlanName,String derivedRatePlanName,boolean isDerivedLevel,
			String roomClassName, String channelName,String StartDate, String EndDate) throws Exception {
		...
		ArrayList<String> allDatesBW = Utility.getAllDatesBetweenCheckInOutDates(startDate, endDateList.get(startDateList.indexOf(startDate)));
		...
		String roomClassLevelRateXpath = "//div[@class='roomClassName'and contains(@title,'"+roomClassName+"')]//parent::div/parent::div//following-sibling::div//div[@class=' RegularRate']";
		
		String xpath = "//div[@class='roomClassName'and contains(@title,'"
				+ roomClassName + "')]"
				+ "//parent::div/parent::div//following-sibling::div//div[contains(@class,'d-flex')]" + "//div[@title='"
				+ channelName + "']//parent::div//following-sibling::div/div[1]";
...
//				logger.info(extraChildRate);
//				logger.info(extraAdultRate);
				String rule1 = "(//div[contains(text(),'"+roomClassName+"')]/../../..//div[contains(text(),'"+channelName+"')]/../../..//div[text()='Min Stay']/following-sibling::div//input)["+(index+1)+"]";
//				logger.info(rule1);
				String ruleValue=driver.findElement(By.xpath(rule1)).getAttribute("value");
				if(ruleValue.isEmpty()||ruleValue.equals("")) {
					ruleValue="0";
...
//				logger.info(ruleValue);
				...
				String rule2 = "(//div[contains(text(),'"+roomClassName+"')]/../../..//div[contains(text(),'"+channelName+"')]/../../..//div[text()='No Check In']/following-sibling::div/div/div)["+(index+1)+"]";
//				logger.info(rule2);
				String noCheckInValue=driver.findElement(By.xpath(rule2)).getAttribute("class");
				if(noCheckInValue.contains("noValue")) {
					noCheckIn=false;
...
//				logger.info(noCheckIn);
				...
				String rule3 = "(//div[contains(text(),'"+roomClassName+"')]/../../..//div[contains(text(),'"+channelName+"')]/../../..//div[text()='No Check Out']/following-sibling::div/div/div)["+(index+1)+"]";
//				logger.info(rule3);
				String noCheckOutValue=driver.findElement(By.xpath(rule3)).getAttribute("class");
				if(noCheckOutValue.contains("noValue")) {
					noCheckOut = false;
...
//				logger.info(noCheckOut);
				...
				RatesGridChannelRatesRules ratesRules = new RatesGridChannelRatesRules(ruleValue, noCheckIn, noCheckOut, roomRate, extraAdultRate, extraChildRate);
				//logger.info(ratesRules);
				dateWiseRateGridValues.put(allDatesBW.get(i), ratesRules);
//				logger.info(dateWiseRateGridValues.get(allDatesBW.get(index)));
//				logger.info(dateWiseRateGridValues.size());
...
//		}
	...
	public HashMap<String, //RoomClass
				HashMap<String, //Source
					HashMap<String, //date
						RatesGridChannelRatesRules>>>  getSourceWiseRatesRules (WebDriver driver,ArrayList<String> test_steps,
								String parentRatePlanName,String derivedRatePlanName,boolean isDerivedLevel,
								String delim, String roomClassName, String channelName,String startDate, String endDate) throws Exception {
		...
		for(String roomClass : roomClassList) {
			...
			for(String source : channelNameList) {
				...
				getRatesAndRulesForDate(driver, test_steps,  parentRatePlanName, derivedRatePlanName, isDerivedLevel,roomClass, source, startDate, endDate);
	...
	public void expandReduceDerivedratePlans(WebDriver driver, boolean expand)
			throws InterruptedException {
		ArrayList<String> testSteps = new ArrayList<String>();
		Elements_DerivedRate elements = new Elements_DerivedRate(driver);
		Wait.WaitForElement(driver, DerivedRatePage.DERIVED_RATE_PLAN_ARROW);
	...
	public ArrayList<String> getRoomRateRoomClassLevel(WebDriver driver, String roomClassName){
		...
		ArrayList<String> list = new ArrayList<String>();
		String xpath = "//div[@class='roomClassName'and contains(@title,'"+roomClassName+"')]/../..//div[@class=' RegularRate']";
		List<WebElement> eleList = driver.findElements(By.xpath(xpath));
		for(WebElement ele : eleList) {
			list.add(ele.getText());
		}
	...
	//Added By Adhnan  
		public String getOrVerifyIntervalValue(WebDriver driver, String interval,boolean verify,ArrayList<String> testSteps) throws InterruptedException {
			Elements_RatesGrid ratesGrid = new Elements_RatesGrid(driver);
			Wait.WaitForElement(driver, RateGridPage.EnterInterval);
			Wait.waitForElementToBeVisibile(By.xpath(RateGridPage.EnterInterval), driver);
			Wait.waitForElementToBeClickable(By.xpath(RateGridPage.EnterInterval), driver);
		...
		public ArrayList<String> verifybyDefaultProrateCheckbox(WebDriver driver, boolean isChecked) throws InterruptedException {
			Elements_RatesGrid ratesGrid = new Elements_RatesGrid(driver);
			ArrayList<String> testSteps = new ArrayList<>();
			Wait.WaitForElement(driver, RateGridPage.CheckboxProrateForEachSeasonbyDefault);
			Wait.waitForElementToBeVisibile(By.xpath(RateGridPage.CheckboxProrateForEachSeasonbyDefault), driver);
			Wait.waitForElementToBeClickable(By.xpath(RateGridPage.CheckboxProrateForEachSeasonbyDefault), driver);
			if (isChecked) {
				assertTrue(ratesGrid.ProRateCheckbox.getAttribute("class").contains("ant-checkbox-checked"),"Failed CheckBox is not checked");
				ratesGridLogger.info("Successfully verified Pro-rate each season checkbox is checked.");
				testSteps.add("Successfully verified Pro-rate each season checkbox is checked.");
			} else {
				assertTrue(!ratesGrid.ProRateCheckbox.getAttribute("class").contains("ant-checkbox-checked"),"Failed CheckBox is checked");
				ratesGridLogger.info("Successfully verified Pro-rate each season checkbox is Unchecked.");
				testSteps.add("Successfully verified Pro-rate each season checkbox is Unchecked.");
			}
			return testSteps;
		...
		public ArrayList<String> verifybyDefaultProrateCheckboxMessageDisplayed(WebDriver driver) throws InterruptedException {
			Elements_RatesGrid ratesGrid = new Elements_RatesGrid(driver);
			ArrayList<String> testSteps = new ArrayList<>();
			Wait.WaitForElement(driver, RateGridPage.CheckboxProrateForEachSeasonbyDefault);
			Wait.waitForElementToBeVisibile(By.xpath(RateGridPage.CheckboxProrateForEachSeasonbyDefault), driver);
		...
		public ArrayList<String> enterProRateValues(WebDriver driver,String isAdditionalAdultChild, boolean isProRateChecked,
				 String ProRateRoomClassName,
		...
		public ArrayList<String> verifyRoomClassProRateCheckBoxChecked(WebDriver driver,
				boolean checked, String roomClassName, 
				ArrayList<String> testSteps) throws InterruptedException {
		...
		public ArrayList<String> updateProRateAtClassLevel(WebDriver driver, String RoomClasses,
				boolean isAdditionalAdultChild, boolean isProRateChecked,
				String customRatePerNight, String adultRate, String childRate,
				ArrayList<String> testSteps) throws InterruptedException {
			...
			if (isProRateChecked) {
				...
				String childpath = "(//li[@class='IntervalRatePlan line']//span[text()='"+RoomClasses+"']//parent::label//..//following-sibling::div[contains(@class,'RoomStayList')]//label//span)[1]"; 
		...
		public ArrayList<String> selectDate(WebDriver driver, String selecDate, boolean isStartDate) throws ParseException {
			...
			String expectedMonth = ESTTimeZone.getDateBaseOnDate(selecDate, "MM/dd/yyyy", "MMMM yyyy");
			String getStartDate = ESTTimeZone.getDateBaseOnDate(selecDate, "MM/dd/yyyy", "EEE MMM dd yyyy");
		...
		public ArrayList<String> getRoomClassRateWithAdditionalAdultAndChild(WebDriver driver, String roomClassName,
			...
			String pathOfRates = "//li[@class='IntervalRatePlan line']//span[text()='" + getRoomClass
					+ "']//parent::label//following-sibling::span[@class='additionalInfo sm-input']//input[@class='ant-input-number-input']";
	...
	public HashMap<String, ArrayList<String>> getRateDetailsFromGrid(WebDriver driver, ArrayList<String> test_steps, String ratePlan, String roomClassName, String channel,
																		String startDateStr, String endDateStr, String dateFormat) throws InterruptedException {
		...
		for(int i = 1; i <= dateDifference; i++) {
			...
			String rate = getRate(driver, channel, i).replace("-", "").trim();
