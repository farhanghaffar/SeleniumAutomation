...
public class Groups {
	...
	public HashMap<String,String> searchAccount(WebDriver driver) throws InterruptedException {
	...
	public ArrayList<String> createNewBlock1(WebDriver driver, String blockName, String roomPerNight, String RoomClass)
			throws InterruptedException {
		ArrayList<String> test_steps = new ArrayList<>();
		Elements_AdvanceGroups group = new Elements_AdvanceGroups(driver);
		Wait.explicit_wait_xpath(OR.Click_New_Block_button, driver);
		...
		String select_date = "//td[@class='today day']//following-sibling::td[2]";
	...
	public ArrayList<String> selectCancellationPolicy(WebDriver driver, String policyName) throws InterruptedException {
		...
		groupLogger.info("Click cancel drop down box");
		...
		groupLogger.info("Select policy");
		...
		groupLogger.info("click pickup button");
		...
		groupLogger.info("click done button");
	...
	public void verifyStartCheckInButton(WebDriver driver) throws InterruptedException {
		...
		assertEquals(groups.StartCheckInButtonInReservationDetails.isDisplayed(), true,
...
<<<<<<< HEAD
	 ...
	 * ########################
	 * 
	 * ' Method Name: <clickGroupNewReservationButton> ' Description: <This
	 * method will click on new reservation button in group> ' Input parameters:
	 * <WebDriver driver> ' Return value: <ArrayList<String>> ' Created By:
	 * <Farhan Ghaffar> ' Created On: <07/21/2020>
	 * 
	 * #########################################################################
	 * #########################################################################
	 * ########################
=======
	 ...
	 * ################
	 * 
	 * ' Method Name: <clickGroupNewReservationButton> ' Description: <This method
	 * will click on new reservation button in group> ' Input parameters: <WebDriver
	 * driver> ' Return value: <ArrayList<String>> ' Created By: <Farhan Ghaffar> '
...
>>>>>>> 8dcd42b23bb7b43aad5eafc97a642112bf3d50d0
	...
	public ArrayList<String> addLineItems(WebDriver driver, String LineCategory, String LineAmount)
		...
		JavascriptExecutor jse = (JavascriptExecutor) driver;
		jse.executeScript("arguments[0].scrollIntoView();",
				driver.findElement(By.id("MainContent_Folio1_dgLineItems_drpLedgeraccountname_0")));

		Select cat = new Select(driver.findElement(By.id("MainContent_Folio1_dgLineItems_drpLedgeraccountname_0")));
		cat.selectByVisibleText(LineCategory);
		...
		// Enter Amount
		Wait.explicit_wait_visibilityof_webelement_120(
				driver.findElement(By.id("MainContent_Folio1_dgLineItems_txtAmount_0")), driver);
		Wait.explicit_wait_elementToBeClickable(driver.findElement(By.id("MainContent_Folio1_dgLineItems_txtAmount_0")),
				driver);
		driver.findElement(By.id("MainContent_Folio1_dgLineItems_txtAmount_0")).sendKeys(LineAmount);
	...
	private void selectDate(WebDriver driver, String dateSelected, ArrayList<String>test_steps) throws InterruptedException {
