...
//		*/
	...
	public ArrayList<String> verifyTapeChartBrokenRulesPopupUpdate(WebDriver driver,String isMinimumStayOn, String minimumStayValue, String isNoCheckInChecked, String isNoCheckOutChecked)
			throws InterruptedException {
	 ...
	 * ########################
	 */
	public ArrayList<String> clickAvailableSlotWithOutRulePopupHandling(WebDriver driver, String RoomClass) throws InterruptedException {
		...
		testSteps.add("Click available room of Room Class '" + RoomClass + "'");
		tapechartLogger.info("Click available room of Room Class '" + RoomClass + "'");

		return testSteps;
	}

	public ArrayList<String> clickAvailableSlotWithOutRulePopupHandlingForRoomNumber(WebDriver driver, ArrayList<String> test_steps, String roomClassAbbreviation, String roomNumber) throws InterruptedException {
		ArrayList<String> testSteps = new ArrayList<>();
	...
	public ArrayList<String> clickConfirm_RaservationUpdate(WebDriver driver) throws InterruptedException {
		...
		System.out.println(TapeChart.Toaster_Message);
	...
	public void clickSearchButton(WebDriver driver, ArrayList<String> test_steps) {
		Elements_TapeChart TapeChart = new Elements_TapeChart(driver);
		JavascriptExecutor jse = (JavascriptExecutor) driver;
		jse.executeScript("arguments[0].click();", TapeChart.Click_Search_TapeChart);
		tapechartLogger.info("Search Button Clicked");
	...
	public void enterAdult(WebDriver driver, String TapeChartAdults, ArrayList<String> test_steps)
			throws InterruptedException {
		Wait.wait5Second();
		Elements_TapeChart TapeChart = new Elements_TapeChart(driver);
		...
		TapeChart.Enter_Adults_Tapehchart.clear();
		TapeChart.Enter_Adults_Tapehchart.sendKeys(TapeChartAdults);
		test_steps.add("Enter adults number count in tape chart: " + TapeChartAdults);
															...
															ArrayList<String> testSteps, String message,String roomClass, String checkInDate, String checkOutDate, String format,String abbreviation) throws InterruptedException, ParseException
	{
		...
		String rate=null; Float floatRate = null; int intRateIs=0;
	...
	public boolean isRoomClassAvailableInTapeChart(WebDriver driver, String roomClassName) {
		...
		String CellPath = "//div[contains(text(),'" + roomClassName
				+ "')  and contains(@class,'roomclassname')]//parent::*//following-sibling::"
				+ "div//following-sibling::div[contains(@class,'DatesContainer')]//ancestor::"
				+ "div[contains(@class,'tapechartdatecell Available')]";
		try {
	 ...
	 * ########################
	 */
	public void clickAvailableSlot(WebDriver driver, String RoomClass,ArrayList<String> testSteps) throws InterruptedException {
	...
	public void enterChildren(WebDriver driver, ArrayList<String> test_steps, String child) throws InterruptedException {
		Elements_TapeChart TapeChart = new Elements_TapeChart(driver);
		Wait.waitForElementToBeVisibile(By.xpath(OR.Enter_Children_Tapechart), driver);
		TapeChart.Enter_Children_Tapechart.clear();
		TapeChart.Enter_Children_Tapechart.sendKeys(child);
		test_steps.add("Entering children number count in tape chart as : <b>"+child+"</b>");
	}
	...
	public void selectRatePlan(WebDriver driver, String RatePlan, ArrayList<String> test_steps)
		...
		test_steps.add("Selecting rate plan in tape chart as : <b>" + RatePlan+"</b>");
	}
	...
	public ArrayList<String> searchInTapechart(WebDriver driver, String checkin, String checkout, String adult,
	...
	public boolean verifyMinStayLength(WebDriver driver,boolean verifyLenthOfStayChecked,
		...
		if (verifyLenthOfStayChecked && verifyMinStayCondidtion) {
			...
			if (isSeasonApplied && MinCondition <= days) {
				...
				testSteps.addAll(searchInTapechart(driver, checkIn, checkout, adult, child, ratePlan, ""));
	...
	public boolean verifyMinCondition(WebDriver driver,boolean verifyLenthOfStayChecked,
		...
		if (verifyLenthOfStayChecked && verifyMinStayCondidtion) {
			...
			if (isSeasonApplied && MinCondition <= days) {
				...
				System.out.println("getDateForNumberOfNight" + getDateForNumberOfNight);

				testSteps.addAll(searchInTapechart(driver, checkIn, getDateForNumberOfNight, adult, child, ratePlan, ""));
...
//					+ groupName + "')])[last()]";
	...
	public void updateCheckOutDate(WebDriver driver, ArrayList<String> test_steps, String roomClassAbbreviation, String roomNumber, String reservationName,
		...
		String reservationLocator = String.format("//div[text() ='%s' and contains(@class,'roomclassname')]//parent::*//following-sibling::div//div[@title='%s']/parent::div/div[2]" +
