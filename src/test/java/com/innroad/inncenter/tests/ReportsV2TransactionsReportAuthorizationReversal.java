...
public class ReportsV2TransactionsReportAuthorizationReversal extends TestCore {
...
//	CPReservationPage reservationPage = new CPReservationPage();
	...
	public void validateLedgerBalancesReport(String TestCaseID, String Scenario, String dateRange, String dateEffective, 
		...
		try {
			...
			test_steps.add("beforeCreditCardTransactionTypeTotal2: "+beforeCreditCardTransactionTypeTotal2);
			if((count<=5))
			{
			allTabs = new ArrayList<>(driver.getWindowHandles());
			reportsTab = allTabs.get(1);
...
//					reservationPage.rollBackReservation(driver, test_steps, guestFullName, "RESERVED");
		...
		try {
			...
			//report.validateCreditCardTransactionTypeDetailInTransectionReport_RV2(driver, transactionType, beforeCreditCardTransactionTypeTotal2, afterCreditCardTransactionTypeTotal2, paymentTransactionTypeAndAmount, test_steps);
