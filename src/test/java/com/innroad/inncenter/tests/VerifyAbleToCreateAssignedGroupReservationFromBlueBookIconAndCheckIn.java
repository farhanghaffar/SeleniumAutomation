...
*/
			roomClass.createRoomClassV2(driver, testSteps, roomClassName, roomClassAbbreviation, maxAdults, maxPersons, roomQuantity);
...
*/
			...
			roomClass.deleteRoomClassIfExist(driver, testSteps, tempraryRoomClassName);
	...
	public Object[][] getData() {
		...
		return Utility.getData("CreateAssignedResFromBlueIcon", envLoginExcel);
	}
