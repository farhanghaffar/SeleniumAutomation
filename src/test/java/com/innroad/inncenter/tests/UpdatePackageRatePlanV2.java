...
public class UpdatePackageRatePlanV2 extends TestCore {
	...
	public void verifyPackageRatePlanExist(String delim, String packageRatePlanName, String folioDisplayName, String description,
...
//		app_logs.info(" product : " + productArray.length + productArray[0]);
		...
		try {
			...
			getTestSteps.clear();
			getTestSteps = ratePackage.createPackage(driver, packageRatePlanName, folioDisplayName, description, rateType, productName, productAmount, productFirstCalculationMethod, productSecondCalculationMethod,
	...
	public void updatePackageRatePlanV2(String delim, String updatedRatePlanName, String updatedFolioDisplayName, String updatedDescription,
			String isExisingProductRemove,String productName,
			String isAddMoreProduct, String newProductName, String newProductAmount, String calculationMethodOne, String calculationMethodTwo,
			String seasonName, String seasonDuration, String seasonStartDate,
			String seasonEndDate, String isMonDay, String isTueDay, String isWednesDay, String isThursDay,
			String isFriday, String isSaturDay, String isSunDay, String isAdditionalChargesForChildrenAdults,
			String ratePerNight, String maxAdults, String maxPersons, String additionalAdultsPerNight,
			String additionalChildPerNight,String isAddRoomClassInSeason, String extraRoomClassesInSeason, String extraRoomClassRatePerNight,
			...
			String isSeasonRuleOnWednesday, String isSeasonRuleOnThursday, String isSeasonRuleOnFriday,
			String isSeasonRuleOnSaturday, String isSeasonRuleOnSunday, String isSeasonPolicies,
			String seasonPolicyType, String seasonPolicyValues) throws InterruptedException, IOException, ParseException {

		Utility.DELIM = "\\" + delim;

		test_name = "UpdatePackageRatePlanV2";
		testDescription = "Rates V2 - Create/Update/Delete Package Rate Plan of Nightly Rate <br>";
		testCategory = "UpdatePackageRatePlanV2";
		testName = test_name;
		...
		try {
			...
			if(Boolean.parseBoolean(isAddMoreProduct)) {
				...
				getTestSteps.clear();
				getTestSteps = ratePackage.addProducts(driver, newProductName, newProductAmount, calculationMethodOne, calculationMethodTwo);
				testSteps.addAll(getTestSteps);
	...
	public Object[][] getData() {
		...
		return Utility.getData("CreatePackageRatePlan", envLoginExcel);
	}
	
	@DataProvider
	public Object[][] getUpdateData(){
		return Utility.getData("UpdatePackageRatePlanV2", envLoginExcel);
