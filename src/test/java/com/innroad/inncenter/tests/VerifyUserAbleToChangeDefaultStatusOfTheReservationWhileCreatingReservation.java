...
public class VerifyUserAbleToChangeDefaultStatusOfTheReservationWhileCreatingReservation extends TestCore {
	...
	public void verifyUserAbleToChangeDefaultStatusOfTheReservationWhileCreatingReservation(String TestCaseID, String CheckInDate,
			String CheckOutDate, String RatePlanName, String ReservationRoomClass, String status)
			throws ParseException {
		test_name = "VerifyUserAbleToChangeDefaultStatusOfTheReservationWhileCreatingReservation";
		test_description = "Verify user able to change default status of the reservation while creating reservation<br>"
				+ "<a href='https://innroad.testrail.io/index.php?/cases/view/824767'>"
				+ "Click here to open TestRail: C824767</a>" + "<br>";
...
String markSegStatus="InActive";
		try {
			...
			listManagement.SaveButtonClick(driver, test_steps);
			listManagement.SelectRatePlan_ChangeStatus(driver, NewItemNameInActive, markSegStatus, getTest_Steps);
			listManagement.NewItemCreation(driver, NewItemNameObsolete, Description, test_steps);
			listManagement.SaveButtonClick(driver, test_steps);
			markSegStatus = "Obsolete";
			getTest_Steps.clear();
			getTest_Steps = listManagement.SelectRatePlan_ChangeStatus(driver, NewItemNameObsolete, markSegStatus,
					getTest_Steps);
		...
		try {
			...
			reservationPage.selectReservationStatus(driver, status, test_steps);
			...
			reservationPage.verifyMarketSegmentDropDown(driver, test_steps, NewItemNameActive, true);
			reservationPage.verifyMarketSegmentDropDown(driver, test_steps, NewItemNameInActive, false);
			reservationPage.verifyMarketSegmentDropDown(driver, test_steps, NewItemNameObsolete, false);
			...
			Utility.customAssert(statusAfterRes.toUpperCase(), status.toUpperCase(), true, true,
			...
			reservationPage.verify_BannerDetails(driver, test_steps, Salutation, GuestFirstName, GuestLastName, PhoneNumber, Email, FilioTripTotal, FilioBalance, reservationNo, statusAfterRes, CheckInDate, CheckOutDate, Country);
		...
		try {
			...
			test_steps.add("Navigate to ListManagement");
			listManagement.SelectFilter(driver, "Market Segment", test_steps);
			markSegStatus = "InActive";
			listManagement.SelectRatePlan_ChangeStatus(driver, NewItemNameActive, markSegStatus, getTest_Steps);
			listManagement.SaveButtonClick(driver, test_steps);
			listManagement.SelectStatus(driver, markSegStatus, test_steps);
...
ArrayList<String> list =  Utility.convertTokenToArrayList(TestCaseID, "\\|");
	...
	public Object[][] getData() {
		...
		return Utility.getData("VerifyStatusChangeWhileRes", HS_EXCEL);
	}
