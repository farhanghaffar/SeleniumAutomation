...
//	String caseId="785603";
	...
	public void verifyIncidentalOrderInStayInfoHistoryAndFolio(String TestCaseID, String Amount, String Referral,
		...
		try {
			...
			// 
			test_steps.addAll(cpReservationPage.clickonPaymentMetod(driver));
			test_steps.addAll(cpReservationPage.selectPaymentMethod(driver,"Cash"));
		...
		try {
			...
			comments = " Created new reservation. Verified incidentals order in incidental section. Verified incidentals order in folio section. Verified deleted incidentals is showing in void state in folio section.";
			statusCode.add(0, "1");
			RetryFailedTestCases.count = Utility.reset_count;
			Utility.AddTest_IntoReport(test_name, test_description, test_catagory, test_steps);
	...
	public Object[][] getData() {
		...
		return Utility.getData("VerifyIncidental_ResFolio", envLoginExcel);
	}
