...
public class VerifyRateplanInInncenter extends TestCore {
	...
	public void verifyRateplanInInncenter(String delim, String ReservationType, String CheckInDate, String CheckOutDate,
			String adult, String children, String ReservationRoomClasses, String ActionOnReservation,
			String ReservationChangeRoomClass, String ChangeResStartDate, String ChangeResEndDate, String RatePlanName,
			...
			String RulesUpdateEndDate, String isSun_RulesUpdate, String isMon_RulesUpdate, String isTue_RulesUpdate,
			String isWed_RulesUpdate, String isThu_RulesUpdate, String isFri_RulesUpdate, String isSat_RulesUpdate,
			String Type_RulesUpdate, String RuleMinStayValue_RulesUpdate, String RatesUpdateType,
			...
			String updateRatesType, String isUpdateRateByRoomClass, String nightlyRate_RatesUpdate,
			String additionalAdults_RatesUpdate, String additionalChild_RatesUpdate,

			String ModifyDeleteExistingSeasonLevelRoomClasses, String ModifyExistingSeasonLevelRoomClasses,
			String ModifyisAdditionalChargesForChildrenAdults, String ModifyRatePerNight, String ModifyMaxAdults,
			String ModifyMaxPersons, String ModifyAdditionalAdultsPerNight, String ModifyAdditionalChildPerNight,
			String ModifyisAddRoomClassInSeason, String ModifyExtraRoomClassesInSeason,
			String ModifyExtraRoomClassRatePerNight, String ModifyExtraRoomClassMaxAdults,
			String ModifyExtraRoomClassMaxPersons, String ModifyExtraRoomClassAdditionalAdultsPerNight,
			String ModifyExtraRoomClassAdditionalChildPerNight) throws Exception {
		/**/
		Utility.DELIM = delim;
...
//		ArrayList<String> ModifyisSeasonRuleOnDaysList = Utility.convertTokenToArrayList(ModifyisSeasonRuleOnDays,
//				delim);
//
//		String ModifyisSeasonRuleOnMonday = ModifyisSeasonRuleOnDaysList.get(0);
//		String ModifyisSeasonRuleOnTuesday = ModifyisSeasonRuleOnDaysList.get(1);
//		String ModifyisSeasonRuleOnWednesday = ModifyisSeasonRuleOnDaysList.get(2);
//		String ModifyisSeasonRuleOnThursday = ModifyisSeasonRuleOnDaysList.get(3);
//		String ModifyisSeasonRuleOnFriday = ModifyisSeasonRuleOnDaysList.get(4);
//		String ModifyisSeasonRuleOnSaturday = ModifyisSeasonRuleOnDaysList.get(5);
//		String ModifyisSeasonRuleOnSunday = ModifyisSeasonRuleOnDaysList.get(6);
...
//		verifyDefaultActiveInActiveDeletedRatePlan(driver);
//		verifyModificationOfRules(driver);	
//		verifySeasonBlackOutAndDelete(driver);
...
//				nightlyRate.verifyTitleSummaryValue(driver, "Channel", summaryChannels, test_steps);
		...
		try {
			...
			if (RulesUpdateType.equalsIgnoreCase("BulkUpdate")) {
				...
				// Utility.convertTokenToArrayList(ReservationRoomClasses, delim);
			...
			try {
				...
				HashMap<String, // RoomClass
						HashMap<String, // Source
								HashMap<String, // date
										RatesGridChannelRatesRules>>> initialRoomClassWiseSourceRatesRule = rateGrid
												.getSourceWiseRatesRules(driver, test_steps, RatePlanName, RatePlanName,
														false, delim,
				...
				for (String date : allDatesBW) {
					app_logs.info(date);
					app_logs.info(initialRoomClassWiseSourceRatesRule.get(selectedRoomClasses.get(0))
				...
				test_steps.add("=================== UN-SELECT SEASON LEVEL ROOM CLASS ======================");
				app_logs.info("=================== UN-SELECT SEASON LEVEL ROOM CLASS ======================");
				nightlyRate.switchCalendarTab(driver, test_steps);
				allSeasonsDates = nightlyRate.getAllSeasonsDates(driver);
				Utility.app_logs.info("All Season Dates : " + allSeasonsDates);
				test_steps.add("All Season Dates : " + allSeasonsDates);
				...
				nightlyRate.unSelectSeasonLevelExistingRoomClass(driver, ModifyDeleteExistingSeasonLevelRoomClasses,
						test_steps);

				test_steps.add("=================== MODIFY SEASON LEVEL ROOM CLASS ======================");
				app_logs.info("=================== MODIFY SEASON LEVEL ROOM CLASS ======================");

				nightlyRate.selectAdditionalChargesForChildrenAdults(driver, test_steps,
						ModifyisAdditionalChargesForChildrenAdults);

				nightlyRate.enterRoomClassSeasonRate(driver, allDatesBW, ModifyExistingSeasonLevelRoomClasses,
						ModifyRatePerNight, ModifyisAdditionalChargesForChildrenAdults, ModifyMaxAdults,
						ModifyMaxPersons, ModifyAdditionalAdultsPerNight, ModifyAdditionalChildPerNight);

				test_steps.add("=================== SELECT SEASON LEVEL ROOM CLASS ======================");
				app_logs.info("=================== SELECT SEASON LEVEL ROOM CLASS ======================");

				nightlyRate.addExtraRoomClassInSeason(driver, test_steps, ModifyisAddRoomClassInSeason,
						ModifyExtraRoomClassesInSeason, ModifyisAdditionalChargesForChildrenAdults,
						ModifyExtraRoomClassRatePerNight, ModifyExtraRoomClassMaxAdults, ModifyExtraRoomClassMaxPersons,
						ModifyExtraRoomClassAdditionalAdultsPerNight, ModifyExtraRoomClassAdditionalChildPerNight);
				...
				nightlyRate.switchOverviewTab(driver, test_steps);

				ArrayList<String> selectedChannelsAfterModify = nightlyRate.getSelectedChannels(driver);
				ArrayList<String> selectedRoomClassesAfterModify = nightlyRate.getSelectedRoomClass(driver);
				Utility.app_logs.info("Selected Channels : " + selectedChannelsAfterModify);
				test_steps.add("Selected Channels : " + selectedChannelsAfterModify);
				Utility.app_logs.info("Selected Room Classes : " + selectedRoomClassesAfterModify);
				test_steps.add("Selected Room Classes : " + selectedRoomClassesAfterModify);

				nightlyRate.switchCalendarTab(driver, test_steps);

				ArrayList<String> allSeasonsDatesAfterModify = nightlyRate.getAllSeasonsDates(driver);
				Utility.app_logs.info("All Season Dates : " + allSeasonsDatesAfterModify);
				test_steps.add("All Season Dates : " + allSeasonsDatesAfterModify);

				String startSeasonDateAfterModify = allSeasonsDatesAfterModify.get(0);
				String endSeasonDateAfterModify = allSeasonsDatesAfterModify.get(allSeasonsDatesAfterModify.size() - 1);
				ArrayList<String> allDatesBWAfterModify = Utility
						.getAllDatesBetweenCheckInOutDates(startSeasonDateAfterModify, endSeasonDateAfterModify);
				...
				HashMap<String, // RoomClass
						HashMap<String, // Source
								HashMap<String, // date
										RatesGridChannelRatesRules>>> afterModifiyRoomClassWiseSourceRatesRule = rateGrid
												.getSourceWiseRatesRules(driver, test_steps, RatePlanName, RatePlanName,
														false, delim,
														Utility.convertArrayListToToken(selectedRoomClassesAfterModify,
																delim),
														Utility.convertArrayListToToken(selectedChannelsAfterModify,
																delim),
														startSeasonDateAfterModify, endSeasonDateAfterModify);

				for (String date : allDatesBWAfterModify) {
					app_logs.info(date);
					app_logs.info(afterModifiyRoomClassWiseSourceRatesRule.get(selectedRoomClassesAfterModify.get(0))
							.get(selectedChannelsAfterModify.get(0)).get(date));
				}

				ArrayList<String> modifyExistingSeasonLevelRoomClassesList = Utility
						.convertTokenToArrayList(ModifyExistingSeasonLevelRoomClasses, delim);
				ArrayList<String> ModifyRatePerNightList = Utility.convertTokenToArrayList(ModifyRatePerNight, delim);
				ArrayList<String> ModifyAdditionalAdultsPerNightList = Utility
						.convertTokenToArrayList(ModifyAdditionalAdultsPerNight, delim);
				ArrayList<String> ModifyAdditionalChildPerNightList = Utility
						.convertTokenToArrayList(ModifyAdditionalChildPerNight, delim);

				ArrayList<String> ModifyExtraRoomClassesInSeasonList = Utility
						.convertTokenToArrayList(ModifyExtraRoomClassesInSeason, delim);
				ArrayList<String> ModifyExtraRoomClassRatePerNightList = Utility
						.convertTokenToArrayList(ModifyExtraRoomClassRatePerNight, delim);
				ArrayList<String> ModifyExtraRoomClassAdditionalAdultsPerNightList = Utility
						.convertTokenToArrayList(ModifyExtraRoomClassAdditionalAdultsPerNight, delim);
				ArrayList<String> ModifyExtraRoomClassAdditionalChildPerNightList = Utility
						.convertTokenToArrayList(ModifyExtraRoomClassAdditionalChildPerNight, delim);

				for (String roomClass : selectedRoomClasses) {

					app_logs.info("==================== VERIFYING RATES OF ROOM CLASS : " + roomClass.toUpperCase()
							+ " ====================");
					test_steps.add("==================== VERIFYING RATES OF ROOM CLASS : <b>" + roomClass.toUpperCase()
							+ "</b> ====================");

					for (String source : selectedChannels) {

						app_logs.info("==================== VERIFYING RATES OF SOURCE : " + source.toUpperCase()
								+ " ====================");
						test_steps.add("==================== VERIFYING RATES OF SOURCE : <b>" + source.toUpperCase()
								+ "</b> ====================");

						for (String date : allDatesBW) {

							app_logs.info("==================== VERIFYING RATES WHERE DATE IS : " + date
									+ " ====================");
							test_steps.add("==================== VERIFYING RATES WHERE DATE IS : " + date
									+ " ====================");

							RatesGridChannelRatesRules initialRateRule = initialRoomClassWiseSourceRatesRule
									.get(roomClass).get(source).get(date);
							RatesGridChannelRatesRules afterModifiyRateRule = afterModifiyRoomClassWiseSourceRatesRule
									.get(roomClass).get(source).get(date);
							if (initialRateRule != null || afterModifiyRateRule != null) {
								if (!initialRateRule.getRooomRate().equals("--")) {
									if (!afterModifiyRateRule.isRatesOveriden()) {
										if (modifyExistingSeasonLevelRoomClassesList.contains(roomClass)) {
											int index = modifyExistingSeasonLevelRoomClassesList.indexOf(roomClass);

											assertEquals(
													Utility.convertDecimalFormat(ModifyRatePerNightList.get(index)),
													Utility.convertDecimalFormat(afterModifiyRateRule.getRooomRate()),
													"Failed To Verify Room Rate Where Date : " + date + " Source : "
															+ source + " Room Class : " + roomClass);

											app_logs.info("Successfully Verified Room Rate : "
													+ afterModifiyRateRule.getRooomRate());
											test_steps.add("Successfully Verified Room Rate : "
													+ afterModifiyRateRule.getRooomRate());

											assertEquals(
													Utility.convertDecimalFormat(
															ModifyAdditionalAdultsPerNightList.get(index)),
													Utility.convertDecimalFormat(
															afterModifiyRateRule.getExtraAdultRate()),
													"Failed To Verify Extra Adult Rate Where Date : " + date
															+ " Source : " + source + " Room Class : " + roomClass);

											app_logs.info("Successfully Verified Extra Adult Rate : "
													+ afterModifiyRateRule.getExtraAdultRate());
											test_steps.add("Successfully Verified Extra Adult Rate : "
													+ afterModifiyRateRule.getExtraAdultRate());

											assertEquals(
													Utility.convertDecimalFormat(
															ModifyAdditionalChildPerNightList.get(index)),
													Utility.convertDecimalFormat(
															afterModifiyRateRule.getExtraChildRate()),
													"Failed To Verify Extra Child Rate Where Date : " + date
															+ " Source : " + source + " Room Class : " + roomClass);

											app_logs.info("Successfully Verified Extra Child Rate : "
													+ afterModifiyRateRule.getExtraChildRate());
											test_steps.add("Successfully Verified Extra Child Rate : "
													+ afterModifiyRateRule.getExtraChildRate());
										} else {

											assertEquals(Utility.convertDecimalFormat(initialRateRule.getRooomRate()),
													Utility.convertDecimalFormat(afterModifiyRateRule.getRooomRate()),
													"Failed To Verify Room Rate Where Date : " + date + " Source : "
															+ source + " Room Class : " + roomClass);
											...
											assertEquals(
													Utility.convertDecimalFormat(initialRateRule.getExtraAdultRate()),
													Utility.convertDecimalFormat(
															afterModifiyRateRule.getExtraAdultRate()),
													"Failed To Verify Extra Adult Rate Where Date : " + date
															+ " Source : " + source + " Room Class : " + roomClass);
											...
											assertEquals(
													Utility.convertDecimalFormat(initialRateRule.getExtraChildRate()),
													Utility.convertDecimalFormat(
															afterModifiyRateRule.getExtraChildRate()),
													"Failed To Verify Extra Child Rate Where Date : " + date
															+ " Source : " + source + " Room Class : " + roomClass);
										...
										app_logs.info("Rate is overriden for date : " + date);
										test_steps.add("Rate is overriden for date : " + date);
									}
								}
							}
						}
				...
				app_logs.info(
						"=================== SUCCESSFULLY VERIFIED RATES GRID RATES AFTER MODIFY ===================");
				test_steps.add(
						"=================== SUCCESSFULLY VERIFIED RATES GRID RATES AFTER MODIFY ===================");
			...
			if (ReservationType.equalsIgnoreCase("MRB")) {
				...
				if (isVerifyPolicies) {
					...
					if (CheckInDate.split("\\|").length > 1) {
						...
						deposit.add(nightlyRate.getSeasonLevelPolicyByRoomClass(driver,
								ratesConfig.getProperty("depositPolicyText"), ReservationRoomClasses, test_steps));
						checkin.add(nightlyRate.getSeasonLevelPolicyByRoomClass(driver,
								ratesConfig.getProperty("checkInPolicyText"), ReservationRoomClasses, test_steps));
					}
				...
				for (int k = 0; k < rm.length; k++) {
					...
					if (ActionOnReservation.equalsIgnoreCase("Recalculate")
						...
						minStayRuleChnage = rateGrid.getRuleDataValuesForMinStay(driver, test_steps,
						...
						noCheckInRuleChnage = rateGrid.getRuleDataValuesForNoCheckIn(driver, test_steps,
								ReservationChangeRoomClass, channelName, daysChnage);
						...
						verifyLenthOfStayCheckedChange = rateGrid.verifyLenthOfStayCheckBox(driver, test_steps,
								"Length of stay");
						app_logs.info("Verified length of saty is checked: " + verifyLenthOfStayCheckedChange);
						if (verifyLenthOfStayCheckedChange) {

							verifyMinStayCondidtionChange = rateGrid.verifyLenthOfStayCheckBox(driver, test_steps,
									"Min");
							verifyMaxStayConditionChange = rateGrid.verifyLenthOfStayCheckBox(driver, test_steps,
									"Max");
						...
						restricrionsLengthOfStayChange = reservationPage.verifylenthOfStayRestrictions(driver,
								test_steps, verifyLenthOfStayCheckedChange, verifyMinStayCondidtionChange,
								verifyMaxStayConditionChange, addStayofLengthChange, daysChnage);

						Utility.app_logs.info(addStayofLengthChange);
						Utility.app_logs.info(restricrionsLengthOfStayChange);

						restricrionsBookingWindowChange = reservationPage.verifyBookingWindowRestrictions(driver,
								test_steps, isBookinWindowChange, ChangeResStartDate, ChangeResEndDate,
								bookingWindowRestrictionsChange);
						...
						if (ReservationType.equalsIgnoreCase("MRB")) {
							isSeasonExistChange = nightlyRate.verifySeasonExistInbetweencheckinAndCheckout(driver,
									test_steps, ChangeResStartDate, ChangeResEndDate);
						} else {
							ArrayList<String> checkInListChnage = Utility.convertTokenToArrayList(ChangeResStartDate,
									delim);

							ArrayList<String> checkOutListChange = Utility.convertTokenToArrayList(ChangeResStartDate,
									delim);

							ArrayList<Boolean> isSeasonChange = new ArrayList<Boolean>();
							int index = 0;
							for (String checkIn : checkInListChnage) {
								isSeasonChange.add(nightlyRate.verifySeasonExistInbetweencheckinAndCheckout(driver,
										test_steps, ChangeResStartDate, checkOutListChange.get(index++)));
							}
						...
						if (isSeasonExistChange) {
							...
							maxAdultChange.put(ReservationChangeRoomClass,
									nightlyRate.getMaxAdult(driver, ReservationChangeRoomClass));
							...
							test_steps.add("Rate Plan Max. Adults: <b>" + maxAdultChange.get(ReservationChangeRoomClass)
									+ "</b>");
							test_steps.add("Rate Plan Max. Childs: <b>" + maxChildChange.get(ReservationChangeRoomClass)
									+ "</b>");
							...
							if (isVerifyPolicies) {
								...
								if (CheckInDate.split("\\|").length > 1) {
									for (int i = 0; i < RoomClass.length; i++) {
										deposit.add(nightlyRate.getSeasonLevelPolicyByRoomClass(driver,
												ratesConfig.getProperty("depositPolicyText"), RoomClass[i],
												test_steps));
										checkin.add(nightlyRate.getSeasonLevelPolicyByRoomClass(driver,
												ratesConfig.getProperty("checkInPolicyText"), RoomClass[i],
												test_steps));
									}
								} else {
									deposit.add(nightlyRate.getSeasonLevelPolicyByRoomClass(driver,
							...
							if (ReservationType.equalsIgnoreCase("MRB")) {
								...
								rateGrid.selectDateFromDatePicker(driver, ChangeResStartDate,
								...
								test_steps.add("===Get Data From Rate Plan===");
								getRatesPerNightChannelsChange = rateGrid.getRoomRatesExAdExChOfChannel(driver,
								...
								fromDate = Utility.convertStringtoDateFormat(
										ratesConfig.getProperty("defaultDateFormat"), ChangeResStartDate);
								app_logs.info("Start Date: " + fromDate);
								...
								for (int i = 0; i < dates.size(); i++) {
									...
									app_logs.info(ad);
									getRatesChange.put(
											Utility.convertDateFormattoString(
													ratesConfig.getProperty("defaultDateFormat"), datesChnage.get(i)),
											rateIs);
									getExAdultChange.put(
											Utility.convertDateFormattoString(
													ratesConfig.getProperty("defaultDateFormat"), datesChnage.get(i)),
											ad);
									getExChildChange.put(
											Utility.convertDateFormattoString(
													ratesConfig.getProperty("defaultDateFormat"), datesChnage.get(i)),
											ch);
								}
				...
				rateGrid.expandChannel(driver, test_steps, ReservationRoomClasses, channelName);
				...
				if (isSeasonExist) {
					if (!ReservationType.equalsIgnoreCase("MRB")) {
						...
						capacityAdult.put(ReservationRoomClasses,
								nightlyRate.getAdultCapacity(driver, ReservationRoomClasses));
						capacityChild.put(ReservationRoomClasses,
								nightlyRate.getChildCapacity(driver, ReservationRoomClasses));
						...
						for (int i = 0; i < dates.size(); i++) {
							...
							String ad = StringUtils
									.substringAfter(
											...
											"ExAd:");
							app_logs.info(ad);
							getRates.put(Utility.convertDateFormattoString(ratesConfig.getProperty("defaultDateFormat"),
									dates.get(i)), rateIs);
							getExAdult.put(Utility.convertDateFormattoString(
									ratesConfig.getProperty("defaultDateFormat"), dates.get(i)), ad);
							getExChild.put(Utility.convertDateFormattoString(
				...
				if (ActionOnReservation.equalsIgnoreCase("Recalculate")
					...
					if (isSeasonExistChange) {
						...
						if (!ReservationType.equalsIgnoreCase("MRB")) {
							...
							Date fromDate = Utility.convertStringtoDateFormat(
									ratesConfig.getProperty("defaultDateFormat"), ChangeResStartDate);
							app_logs.info("Start Date: " + fromDate);
							Date toDate = Utility.convertStringtoDateFormat(
									ratesConfig.getProperty("defaultDateFormat"), ChangeResEndDate);
							app_logs.info("End Date: " + toDate);
							datesChnage = Utility.getDateRangeBetweenfromAndToDate(fromDate, toDate);
							app_logs.info("Dates Are: " + dates);
							...
							for (int i = 0; i < dates.size(); i++) {
								...
								String ad = StringUtils.substringAfter(
										...
										"ExAd:");
								app_logs.info(ad);
								getRatesChange.put(Utility.convertDateFormattoString(
										ratesConfig.getProperty("defaultDateFormat"), datesChnage.get(i)), rateIs);
...
app_logs.info(isRoomClassAvailable);
				if (driver.findElements(By.xpath("(//span[text()='" + ReservationRoomClasses + "'])[2]")).size() > 0
					...
					app_logs.info(restricrionsBookingWindow);
					app_logs.info(isSeasonExist);
					
					String minStayColor = "";
					if (restricrionsLengthOfStay && restricrionsBookingWindow && isSeasonExist) {

						app_logs.info("Get Rates : " + getRates);
						app_logs.info("Max Adult : " + maxAdult.get(ReservationRoomClasses));
						app_logs.info("Max Child : " + maxChild.get(ReservationRoomClasses));
						app_logs.info("Get Ext Adult : " + getExAdult);
						app_logs.info("Get Ext Child : " + getExChild);
						app_logs.info("Capacity Child : " + capacityChild.get(ReservationRoomClasses));
						app_logs.info("Capacity Adult : " + capacityAdult.get(ReservationRoomClasses));
						app_logs.info("Reservation Adult : " + adult);
						app_logs.info("Reservation Children : " + children);
						app_logs.info("Reservation RoomClass : " + ReservationRoomClasses);
						app_logs.info("Dates : " + dates);
			...
			try {
				...
				if (Utility.reTry.get(test_name) == Utility.count) {
					RetryFailedTestCases.count = Utility.reset_count;
					Utility.AddTest_IntoReport(test_name, test_description, test_catagory, test_steps);
					Utility.updateReport(e, "Failed to Navigate " + "s", test_name, "NavigateAccounts", driver);
				} else {
			...
			try {
				...
				if (Utility.reTry.get(test_name) == Utility.count) {
					RetryFailedTestCases.count = Utility.reset_count;
					Utility.AddTest_IntoReport(test_name, test_description, test_catagory, test_steps);
					Utility.updateReport(e, "Failed to click New Reservation", test_name, "CorporateAccount", driver);
				} else {
					Assert.assertTrue(false);
				}
			} catch (Error e) {
				...
				if (restricrionsLengthOfStay && restricrionsBookingWindow && isSeasonExist) {
					...
					try {
						rateIs = tapechart.calculateRatesAsPerAdultsAndChildCapacity(driver, getRates,
								...
								getExChild, capacityChild.get(ReservationRoomClasses),
								capacityAdult.get(ReservationRoomClasses), adult, children, test_steps,
								ratesConfig.getProperty("tapeChartMsg"), ReservationRoomClasses, CheckInDate,
				...
				if (ActionOnReservation.equalsIgnoreCase("No Show")) {
					...
					if (!seasonNoShowpolicy.equalsIgnoreCase("No Policy")) {
						...
						try {
							...
							if (isAccountPolicyApplicable.equalsIgnoreCase("Yes")) {
								...
								reservationPage.click_Folio(driver, test_steps);
								highestAmountOfPolicyDetails = reservationPage.getHighestAmountOfPolicy(driver,
										test_steps, allPoliciesDetails, checkInDates, checkOutDates);
					...
					if (driver.findElements(By.xpath("(//span[text()='" + ReservationRoomClasses + "'])[2]")).size() > 0
						...
						if (restricrionsLengthOfStayChange && restricrionsBookingWindowChange && isSeasonExistChange
							...
							HashMap<String, String> roomChargesFolio1 = reservationPage
									.getRoomChargesFromFolioBasedOnDates(driver, test_steps, ChangeResStartDate,
											ChangeResEndDate);
					...
					HashMap<String, String> roomChargesFolio = reservationPage
							.getRoomChargesFromFolioBasedOnDates(driver, test_steps, CheckInDate, CheckOutDate);
					Utility.app_logs.info(roomChargesFolio);
					String RoomChagres = reservationPage.get_RoomCharge(driver, test_steps);
					reservationPage.click_DeatilsTab(driver, test_steps);
					if (!ReservationType.equalsIgnoreCase("MRB")) {
...
//					reservationPage.ClickStayInfo_ChangeDetails(driver, test_steps);
					...
					if (driver.findElements(By.xpath("(//span[text()='" + ReservationRoomClasses + "'])[2]")).size() > 0
							&& isRoomClassAvailableChange) {
						String rateIs = reservationPage.calculateRatesAsPerAdultsAndChildCapacity(driver,
								getRatesChange, maxAdultChange.get(ReservationChangeRoomClass),
								maxChildChange.get(ReservationChangeRoomClass), getExAdultChange, getExChildChange,
								capacityChildChange.get(ReservationChangeRoomClass),
								capacityAdultChange.get(ReservationChangeRoomClass), adult, children, test_steps,
...
//				String statydiff = Utility.differenceBetweenDates(CheckInDate, CheckOutDate);
					...
					boolean isCancellationPolicyApplicable = policy.isCancellationPolicyApplicable(
					...
					if (isCancellationPolicyApplicable) {
						reservationPage.verifyReservationPopWindowPolicyName(driver, test_steps,
								names.get("Cancellation"), "Cancellation");
						reservationPage.addCancelationReson(driver, test_steps, "Cancellation",
						...
						if (!calCancelPolicy[0].equalsIgnoreCase("alreadyPaid")) {
							reservationPage.verifyCancellationSuccessuful(driver, test_steps, "0.00",
									calCancelPolicy[1], calCancelPolicy[0], "Processed");
							reservationPage.clickCloseButtonOfSuccessModelPopup(driver, test_steps);
						}
						...
						assertEquals(tripTotal, foundBestPolicyAmount.getCalculatedAmount(),
	...
	public void verifyDefaultActiveInActiveDeletedRatePlan(WebDriver driver) {

		String delim = "|";
		String RatePlanName1 = "TestRateAAD";
		String FolioDisplayName = "TestRateFolioAAD";
		String Description = "TestRateDescAAD";
		String Channels = "InnCenter";
		String RoomClasses = "N Room1";
		String isRatePlanRistrictionReq = "false";
		String RistrictionType = "";
		String isMinStay = "";
		String MinNights = "";
		String isMaxStay = "";
		String MaxNights = "";
		String isMoreThanDaysReq = "";
		String MoreThanDaysCount = "";
		String isWithInDaysReq = "";
		String WithInDaysCount = "";
		String PromoCode = "";
		String isPolicesReq = "false";
		String PoliciesType = "";
		String PoliciesName = "";
		String SeasonName = "TestSeason";
		String isMonDay = "yes";
		String isTueDay = "yes";
		...
		String isSunDay = "yes";
		String isAdditionalChargesForChildrenAdults = "false";
		String RatePerNight = "300";
		String MaxAdults = "";
		String MaxPersons = "";
		String AdditionalAdultsPerNight = "";
		String AdditionalChildPerNight = "";
		String isAddRoomClassInSeason = "no";
		String ExtraRoomClassesInSeason = "";
		String ExtraRoomClassRatePerNight = "";
		String ExtraRoomClassMaxAdults = "";
		String ExtraRoomClassMaxPersons = "";
		String ExtraRoomClassAdditionalAdultsPerNight = "";
		String ExtraRoomClassAdditionalChildPerNight = "";
		String isSerasonLevelRules = "no";
		String isAssignRulesByRoomClass = "no";
		String SeasonRuleSpecificRoomClasses = "";
		String SeasonRuleType = "";
		String SeasonRuleMinStayValue = "";
		String isSeasonRuleOnMonday = "";
		String isSeasonRuleOnTuesday = "";
		String isSeasonRuleOnWednesday = "";
		String isSeasonRuleOnThursday = "";
		String isSeasonRuleOnFriday = "";
		String isSeasonRuleOnSaturday = "";
		String isSeasonRuleOnSunday = "";
		String isSeasonPolicies = "no";
		String SeasonPolicyType = "";
		String SeasonPolicyValues = "";

		Utility.AddTest_IntoReport(test_name, test_description, test_catagory, test_steps);
		test_name = "Create Rate Plan For Active, InActive & Default Rate Plan Verification";
		test_description = "Create Rate Plan For Active, InActive & Default Rate Plan Verification";
		test_steps.clear();
		try {
			// After login
			test_steps.add("=================== NAVIGATE TO RATE GRID ======================");
		...
		test_steps.add("=================== Creating the Rate Plan ======================");
		app_logs.info("=================== Creating the Rate Plan ======================");
		String RatePlanNamelocal = RatePlanName1 + Utility.generateRandomString();
		try {
			...
			nightlyRate.enterRatePlanName(driver, RatePlanNamelocal, test_steps);
			nightlyRate.enterRateFolioDisplayName(driver, FolioDisplayName, test_steps);
			nightlyRate.enterRatePlanDescription(driver, Description, test_steps);

			nightlyRate.clickNextButton(driver, test_steps);

			nightlyRate.verifyTitleSummaryValue(driver, "Rate plan name", RatePlanNamelocal, test_steps);
		...
		try {
			...
			nightlyRate.createSeason(driver, test_steps, seasonStartDate, seasonEndDate, SeasonName, isMonDay, isTueDay,
		...
		Utility.AddTest_IntoReport(test_name, test_description, test_catagory, test_steps);
		test_name = "Verify RatePlan Active & Default EveryWhere";
		test_description = "Verify RatePlan Active & Default EveryWhere";
		test_steps.clear();
		try {
			// After login
			test_steps.add("=================== NAVIGATE TO RATE GRID ======================");
			...
			test_steps.add("=================== Verify RatePlan Active & Default in Rates Grid ======================");
			app_logs.info("=================== Verify RatePlan Active & Default in Rates Grid ======================");

			String foundSelectedRate = rateGrid.selectedRatePlan(driver);
			assertEquals(foundSelectedRate.toUpperCase(), RatePlanNamelocal.toUpperCase(),
					"Failed To Verify Rates Grid Selected Default RatePlan");
			test_steps.add(
					"Successfully Verified RatePlan Selected By Deafult in RatesGrid DropDown : " + foundSelectedRate);
			app_logs.info(
					"Successfully Verified RatePlan Selected By Deafult in RatesGrid DropDown : " + foundSelectedRate);
			ArrayList<String> activeRateList = rateGrid.getActiveAndInactiveRatePlanNames(driver, "active");
			assertTrue(activeRateList.contains(RatePlanNamelocal), "Failed To Verify Active RatesPlan in ratesGrid ");
			test_steps.add("Successfully Verified Active RatePlan in RatesGrid DropDown : " + foundSelectedRate);
			app_logs.info("Successfully Verified Active RatePlan in RatesGrid DropDown : " + foundSelectedRate);
			try {
				navigation.cpReservation_Backward(driver);
			} catch (Exception e) {
				Actions actions = new Actions(driver);
			...
			test_steps.add("=================== Verify RatePlan Active & Default in Tape Chart ======================");
			app_logs.info("=================== Verify RatePlan Active & Default in Tape Chart ======================");
			navigation.navigateTapeChart(driver, test);
			test_steps.add("Navigate TapeChart");
			app_logs.info("Navigate TapeChart");

			foundSelectedRate = tapechart.getSelectedRatePlan(driver);
			assertEquals(foundSelectedRate.toUpperCase(), RatePlanNamelocal.toUpperCase(),
					"Failed To Verify TapeChart Selected Default RatePlan");
			test_steps.add(
					"Successfully Verified RatePlan Selected By Deafult in TapeChart DropDown : " + foundSelectedRate);
			app_logs.info(
					"Successfully Verified RatePlan Selected By Deafult in TapeChart DropDown : " + foundSelectedRate);
			test_steps.add("Successfully Verified Active RatePlan Selected By Deafult in TapeChart DropDown : "
					+ foundSelectedRate);
			String TravelAgent = "";
			String MarketSegment = "GDS";
			String State = "New York";
			...
			test_steps
					.add("=================== Verify RatePlan Active & Default in Group Block ======================");
			app_logs.info("=================== Verify RatePlan Active & Default in Group Block ======================");

			String AccountName = "AccountName_" + Utility.GenerateRandomString15Digit();
			navigation.Groups(driver);
			getTest_Steps.clear();
			group.type_GroupName(driver, test, AccountName, getTest_Steps);
			test_steps.addAll(getTest_Steps);

			String AccountNo = Utility.GenerateRandomString15Digit();
			getTest_Steps.clear();
			getTest_Steps = group.enterAccountNo(driver, AccountNo);
			test_steps.addAll(getTest_Steps);
			...
			foundSelectedRate = group.getSelectedRatePlan(driver);
			assertEquals(foundSelectedRate.toUpperCase(), RatePlanNamelocal.toUpperCase(),
					"Failed To Verify Group Block Selected Default RatePlan");
			test_steps.add("Successfully Verified RatePlan Selected By Deafult in Group Block DropDown : "
					+ foundSelectedRate);
			app_logs.info("Successfully Verified RatePlan Selected By Deafult in Group Block DropDown : "
					+ foundSelectedRate);
			test_steps.add("Successfully Verified RatePlan Active Selected By Deafult in Group Block DropDown : "
					+ foundSelectedRate);

			test_steps.add("=================== Verify RatePlan Active in New Reservation ======================");
			app_logs.info("=================== Verify RatePlan Active in New Reservation ======================");

			navigation.Reservation_Backward(driver);

			reservationPage.click_NewReservation(driver, test_steps);
			boolean isPresent = reservationPage.isRatePlanPresent(driver, RatePlanNamelocal);
			assertEquals(isPresent, true, "Failed To Verify New Reservation RatePlan Not Active");
			test_steps.add("Successfully Verified Active RatePlan Selected in New Reservation DropDown : "
					+ RatePlanNamelocal);
			app_logs.info("Successfully Verified Active RatePlan Selected in New Reservation DropDown : "
					+ RatePlanNamelocal);

			reservationPage.close_FirstOpenedReservation(driver, test_steps);

			Utility.AddTest_IntoReport(test_name, test_description, test_catagory, test_steps);
			test_name = "Make RatePalan InActive and Verify EveryWhere";
			test_description = "Make RatePalan InActive and Verify EveryWhere";
			test_steps.clear();

			test_steps.add("=================== Make InActive RatePlan ======================");
			app_logs.info("=================== Make InActive RatePlan ======================");

			navigation.Inventory(driver, test_steps);
			navigation.ratesGrid(driver);
			rateGrid.selectRatePlan(driver, RatePlanNamelocal, test_steps);
			rateGrid.clickOnEditRatePlan(driver);
			...
			navigation.ratesGrid(driver);
			test_steps
					.add("=================== Verify RatePlan InActive & Default in Rates Grid ======================");
			app_logs.info(
					"=================== Verify RatePlan InActive & Default in Rates Grid ======================");

			foundSelectedRate = rateGrid.selectedRatePlan(driver);
			assertNotEquals(foundSelectedRate.toUpperCase(), RatePlanNamelocal.toUpperCase(),
					"Failed To Verify Rates Grid Selected is Default RatePlan");
			test_steps.add("Successfully Verified RatePlan is not Selected By Deafult in RatesGrid DropDown : "
					+ foundSelectedRate);
			app_logs.info("Successfully Verified RatePlan is not Selected By Deafult in RatesGrid DropDown : "
					+ foundSelectedRate);
			ArrayList<String> inActiveRateList = rateGrid.getActiveAndInactiveRatePlanNames(driver, "inactive");
			assertTrue(inActiveRateList.contains(RatePlanNamelocal + " [Inactive]"),
					"Failed To Verify InActive RatesPlan in ratesGrid ");
			test_steps.add("Successfully Verified InActive RatePlan in RatesGrid DropDown : " + foundSelectedRate);
			app_logs.info("Successfully Verified InActive RatePlan in RatesGrid DropDown : " + foundSelectedRate);
			try {
				navigation.cpReservation_Backward(driver);
			} catch (Exception e) {
				Actions actions = new Actions(driver);
			...
			test_steps
					.add("=================== Verify RatePlan InActive & Default in Tape Chart ======================");
			app_logs.info(
					"=================== Verify RatePlan InActive & Default in Tape Chart ======================");
			navigation.navigateTapeChart(driver, test);
			test_steps.add("Navigate TapeChart");
			app_logs.info("Navigate TapeChart");
			...
			assertNotEquals(foundSelectedRate.toUpperCase(), RatePlanNamelocal.toUpperCase(),
					"Failed To Verify TapeChart Selected Default RatePlan");
			test_steps.add("Successfully Verified RatePlan is not Selected By Deafult in TapeChart DropDown : "
					+ foundSelectedRate);
			app_logs.info("Successfully Verified RatePlan is not Selected By Deafult in TapeChart DropDown : "
					+ foundSelectedRate);

			isPresent = tapechart.isRatePlanPresent(driver, RatePlanNamelocal);
			assertEquals(isPresent, false, "Failed To Verify New Reservation RatePlan Not Active");
			test_steps.add(
					"Successfully Verified InActive RatePlan Selected in TapeChart DropDown : " + RatePlanNamelocal);
			app_logs.info(
					"Successfully Verified InActive RatePlan Selected in TapeChart DropDown : " + RatePlanNamelocal);

			test_steps.add(
					"=================== Verify RatePlan InActive & Default in Group Block ======================");
			app_logs.info(
					"=================== Verify RatePlan InActive & Default in Group Block ======================");

			navigation.Groups(driver);
			group.Search_Account(driver, AccountName, AccountNo, true, true);
			...
			assertNotEquals(foundSelectedRate.toUpperCase(), RatePlanNamelocal.toUpperCase(),
					"Failed To Verify Group Block Selected Default RatePlan");
			test_steps.add("Successfully Verified RatePlan is not Selected By Deafult in Group Block DropDown : "
					+ foundSelectedRate);
			app_logs.info("Successfully Verified RatePlan is not Selected By Deafult in Group Block DropDown : "
					+ foundSelectedRate);

			isPresent = group.isRatePlanPresent(driver, RatePlanNamelocal);
			assertEquals(isPresent, false, "Failed To Verify New Reservation RatePlan Not Active");
			test_steps.add("Successfully Verified RatePlan InActive Selected By Deafult in Group Block DropDown : "
					+ foundSelectedRate);
			app_logs.info("Successfully Verified RatePlan InActive Selected By Deafult in Group Block DropDown : "
					+ foundSelectedRate);

			test_steps.add("=================== Verify RatePlan InActive in New Reservation ======================");
			app_logs.info("=================== Verify RatePlan InActive in New Reservation ======================");

			navigation.Reservation_Backward(driver);

			reservationPage.click_NewReservation(driver, test_steps);
			isPresent = reservationPage.isRatePlanPresent(driver, RatePlanNamelocal);
			assertEquals(isPresent, false, "Failed To Verify New Reservation RatePlan Not Active");
			test_steps.add("Successfully Verified InActive RatePlan Selected in New Reservation DropDown : "
					+ RatePlanNamelocal);
			app_logs.info("Successfully Verified InActive RatePlan Selected in New Reservation DropDown : "
					+ RatePlanNamelocal);

			reservationPage.close_FirstOpenedReservation(driver, test_steps);

			Utility.AddTest_IntoReport(test_name, test_description, test_catagory, test_steps);
			test_name = "Delete RatePalan and Verify EveryWhere";
			test_description = "Delete RatePalan and Verify EveryWhere";
			test_steps.clear();

			test_steps.add("=================== Delete RatePlan ======================");
			...
			test_steps.add("=================== Verify Deleted RatePlan in Rates Grid ======================");
			app_logs.info("=================== Verify Deleted RatePlan in Rates Grid ======================");

			ArrayList<String> allRateList = rateGrid.getActiveAndInactiveRatePlanNames(driver, "all");
			assertTrue(!allRateList.contains(RatePlanNamelocal),
					"Failed To Verify Deleted RatesPlan in ratesGrid " + allRateList);
			test_steps.add("Successfully Verified Deleted RatePlan in RatesGrid DropDown : " + foundSelectedRate);
			app_logs.info("Successfully Verified Deleted RatePlan in RatesGrid DropDown : " + foundSelectedRate);
			try {
				navigation.cpReservation_Backward(driver);
			} catch (Exception e) {
				Actions actions = new Actions(driver);
			...
			test_steps.add("=================== Verify Deleted RatePlan in Tape Chart ======================");
			app_logs.info("=================== Verify Deleted RatePlan in Tape Chart ======================");
			navigation.navigateTapeChart(driver, test);
			test_steps.add("Navigate TapeChart");
			app_logs.info("Navigate TapeChart");

			isPresent = tapechart.isRatePlanPresent(driver, RatePlanNamelocal);
			assertEquals(isPresent, false, "Failed To Verify New Reservation RatePlan Not Deleted");
			test_steps.add(
					"Successfully Verified Deleted RatePlan Selected in TapeChart DropDown : " + RatePlanNamelocal);
			app_logs.info(
					"Successfully Verified Deleted RatePlan Selected in TapeChart DropDown : " + RatePlanNamelocal);

			test_steps.add("=================== Verify Deleted RatePlan in Group Block ======================");
			app_logs.info("=================== Verify Deleted RatePlan in Group Block ======================");
			...
			isPresent = group.isRatePlanPresent(driver, RatePlanNamelocal);
			assertEquals(isPresent, false, "Failed To Verify New Reservation RatePlan Not Deleted");
			test_steps.add("Successfully Verified RatePlan Deleted Selected By Deafult in Group Block DropDown : "
					+ foundSelectedRate);
			app_logs.info("Successfully Verified RatePlan Deleted Selected By Deafult in Group Block DropDown : "
					+ foundSelectedRate);

			test_steps.add("=================== Verify Deleted RatePlan in New Reservation ======================");
			app_logs.info("=================== Verify Deleted RatePlan in New Reservation ======================");
			...
			isPresent = reservationPage.isRatePlanPresent(driver, RatePlanNamelocal);
			assertEquals(isPresent, false, "Failed To Verify New Reservation RatePlan Not Deleted");
			test_steps.add("Successfully Verified Deleted RatePlan Selected in New Reservation DropDown : "
					+ RatePlanNamelocal);
			app_logs.info("Successfully Verified Deleted RatePlan Selected in New Reservation DropDown : "
					+ RatePlanNamelocal);
	...
	public void verifyModificationOfRules(WebDriver driver) throws Exception {

		String delim = "|";
		String RatePlanName1 = "TestRateMOR";
		String FolioDisplayName = "TestRateFolioMOR";
		String Description = "TestRateDescMOR";
		String Channels = "InnCenter";
		String RoomClasses = "N Room1";
		String isRatePlanRistrictionReq = "false";
		String RistrictionType = "";
		...
		Utility.AddTest_IntoReport(test_name, test_description, test_catagory, test_steps);
		test_name = "Create Rate Plan For Rules Verification";
		test_description = "Create Rate Plan For Rules Verification";
		test_steps.clear();
		try {
			// After login
			test_steps.add("=================== NAVIGATE TO RATE GRID ======================");
		...
		Utility.AddTest_IntoReport(test_name, test_description, test_catagory, test_steps);
		test_name = "Get initial Rates Grid Values Before Modify";
		test_description = "Get initial Rates Grid Values Before Modify";
		test_steps.clear();

		navigation.ratesGrid(driver);
		ArrayList<String> allDatesBW = Utility.getAllDatesBetweenCheckInOutDates(seasonStartDate, seasonEndDate);
		ArrayList<String> selectedRoomClasses = Utility.convertTokenToArrayList(RoomClasses, delim);
		ArrayList<String> selectedChannels = Utility.convertTokenToArrayList(Channels, delim);
		HashMap<String, // RoomClass
				HashMap<String, // Source
						HashMap<String, // date
								RatesGridChannelRatesRules>>> initialRoomClassWiseSourceRatesRule = rateGrid
										.getSourceWiseRatesRules(driver, test_steps, RatePlanNamelocal,
												RatePlanNamelocal, false, delim, RoomClasses, Channels, seasonStartDate,
												seasonEndDate);
		...
		Utility.AddTest_IntoReport(test_name, test_description, test_catagory, test_steps);
		test_name = "Modify Season Level Rules";
		test_description = "Modify Season Level Rules";
		test_steps.clear();

		navigation.ratesGrid(driver);
		driver.navigate().refresh();
		rateGrid.clickRatePlanArrow(driver, test_steps);
		rateGrid.selectAndReturnSpecificRatePlan(driver, test_steps, RatePlanNamelocal);
		Wait.waitUntilPageLoadNotCompleted(driver, 40);
...
//		test_steps.add("All Season Dates : " + allSeasonsDates);
		...
		test_steps.add("=================== MODIFY SEASON LEVEL RULES ======================");
		app_logs.info("=================== MODIFY SEASON LEVEL RULES ======================");

		nightlyRate.clickRulesRestrictionOnSeason(driver, test_steps);

		String ModifyisSerasonLevelRules = "Yes";
		String ModifyisAssignRulesByRoomClass = "no";
		String ModifySeasonRuleSpecificRoomClasses = "N Room1";
		String ModifySeasonRuleType = "Min nights|No check-in|No check-out";
		String ModifySeasonRuleMinStayValue = "3";
		String ModifyisSeasonRuleOnMonday = "yes|yes";
		String ModifyisSeasonRuleOnTuesday = "yes|yes";
		String ModifyisSeasonRuleOnWednesday = "yes|yes";
		String ModifyisSeasonRuleOnThursday = "yes|yes";
		String ModifyisSeasonRuleOnFriday = "yes|yes";
		String ModifyisSeasonRuleOnSaturday = "yes|yes";
		String ModifyisSeasonRuleOnSunday = "yes|yes";

		nightlyRate.clickAssignRulesByRoomClass(driver, test_steps, ModifyisAssignRulesByRoomClass);
		nightlyRate.enterSeasonLevelRules(driver, test_steps, ModifyisSerasonLevelRules, ModifyisAssignRulesByRoomClass,
				ModifySeasonRuleSpecificRoomClasses, ModifySeasonRuleType, ModifySeasonRuleMinStayValue,
				ModifyisSeasonRuleOnMonday, ModifyisSeasonRuleOnTuesday, ModifyisSeasonRuleOnWednesday,
				ModifyisSeasonRuleOnThursday, ModifyisSeasonRuleOnFriday, ModifyisSeasonRuleOnSaturday,
				ModifyisSeasonRuleOnSunday);

		ArrayList<String> ModifySeasonRuleSpecificRoomClassesList = Utility
				.convertTokenToArrayList(ModifySeasonRuleSpecificRoomClasses, Utility.DELIM);

		ArrayList<String> ModifySeasonRuleTypeList = Utility.convertTokenToArrayList(ModifySeasonRuleType,
				Utility.DELIM);

		ArrayList<String> monList = Utility.convertTokenToArrayList(ModifyisSeasonRuleOnMonday, Utility.DELIM);
		ArrayList<String> tueList = Utility.convertTokenToArrayList(ModifyisSeasonRuleOnTuesday, Utility.DELIM);
		ArrayList<String> wedList = Utility.convertTokenToArrayList(ModifyisSeasonRuleOnWednesday, Utility.DELIM);
		ArrayList<String> thuList = Utility.convertTokenToArrayList(ModifyisSeasonRuleOnThursday, Utility.DELIM);
		ArrayList<String> friList = Utility.convertTokenToArrayList(ModifyisSeasonRuleOnFriday, Utility.DELIM);
		ArrayList<String> satList = Utility.convertTokenToArrayList(ModifyisSeasonRuleOnSaturday, Utility.DELIM);
		ArrayList<String> sunList = Utility.convertTokenToArrayList(ModifyisSeasonRuleOnSunday, Utility.DELIM);
		...
		Utility.AddTest_IntoReport(test_name, test_description, test_catagory, test_steps);
		test_name = "Get Rates Grid Values After Modification";
		test_description = "Get Rates Grid Values After Modification";
		test_steps.clear();
		...
		rateGrid.clickRatePlanArrow(driver, test_steps);
		rateGrid.selectAndReturnSpecificRatePlan(driver, test_steps, RatePlanNamelocal);
		if (ModifyisSerasonLevelRules.equalsIgnoreCase("Yes")) {
			HashMap<String, // RoomClass
					HashMap<String, // Source
							HashMap<String, // date
									RatesGridChannelRatesRules>>> afterModifiyRoomClassWiseSourceRatesRule = rateGrid
											.getSourceWiseRatesRules(driver, test_steps, RatePlanNamelocal,
													RatePlanNamelocal, false, delim, RoomClasses, Channels,
													seasonStartDate, seasonEndDate);

			for (String date : allDatesBW) {
				app_logs.info(date);
				app_logs.info(afterModifiyRoomClassWiseSourceRatesRule.get(selectedRoomClasses.get(0))
						.get(selectedChannels.get(0)).get(date));
			}

			Utility.AddTest_IntoReport(test_name, test_description, test_catagory, test_steps);
			test_name = "Verify Season Level Rules Modification In Rates Grid";
			test_description = "Verify Season Level Rules Modification In Rates Grid";
			test_steps.clear();
			...
			for (String roomClass : selectedRoomClasses) {
				...
				for (String source : selectedChannels) {
					...
					for (String date : allDatesBW) {
						...
						test_steps.add("==================== VERIFYING RATES WHERE DATE IS : " + date
								+ " ====================");
						RatesGridChannelRatesRules afterModifyVal = afterModifiyRoomClassWiseSourceRatesRule
								.get(roomClass).get(source).get(date);

						if (ModifyisAssignRulesByRoomClass.equalsIgnoreCase("Yes")) {
							if (ModifySeasonRuleSpecificRoomClassesList.contains(roomClass)) {
								if (ModifySeasonRuleTypeList.size() > 0 && ModifySeasonRuleTypeList != null) {
									int checkInDayIndex = 0;
									int checkOutDayIndex = 0;
									int j = 0;
									for (String type : ModifySeasonRuleTypeList) {

										if (type.equalsIgnoreCase("No check-out")) {
											if (j == 0) {
												checkInDayIndex = 1;
												checkOutDayIndex = 0;
											} else if (j > 0) {
									...
									for (int i = 0; i < ModifySeasonRuleTypeList.size(); i++) {
										try {
											if (ModifySeasonRuleTypeList.get(i).equalsIgnoreCase("Min Nights")) {
												assertEquals(Integer.parseInt(afterModifyVal.getMinRule()),
														Integer.parseInt(ModifySeasonRuleMinStayValue),
														"Failed to verify Min Stay Rule Not Mached for date : " + date
																+ " Source : " + source + " RoomClass : " + roomClass);
												app_logs.info("Successfully verify Min Stay Rule Value : "
														+ ModifySeasonRuleMinStayValue
														+ " After Modify Season Rule for date : " + date + " Source : "
														+ source + " RoomClass : " + roomClass);
												test_steps.add("Successfully verify Min Stay Rule Value : "
														+ ModifySeasonRuleMinStayValue
														+ " After Modify Season Rule for date : " + date + " Source : "
														+ source + " RoomClass : " + roomClass);
											} else if (ModifySeasonRuleTypeList.get(i)
													.equalsIgnoreCase("No check-in")) {

												String day = Utility.parseDate(date, "dd/MM/yyyy", "E");

												if (day.equalsIgnoreCase("Mon")) {
													assertEquals(monList.get(checkInDayIndex).toUpperCase(),
															Utility.convertBooleanToString(afterModifyVal.isNoCheckIn())
																	.toUpperCase(),
															"Failed to verify Check In Rule Not Mached for date : "
																	+ date + " Source : " + source + " RoomClass : "
																	+ roomClass);
													app_logs.info("Successfully verify Check In Rule Value : "
															+ afterModifyVal.isNoCheckIn()
															+ " After Modify Season Rule for date : " + date
															+ " Source : " + source + " RoomClass : " + roomClass);
													test_steps.add("Successfully verify Check In Rule Value : "
															+ afterModifyVal.isNoCheckIn()
															+ " After Modify Season Rule for date : " + date
															+ " Source : " + source + " RoomClass : " + roomClass);
												} else if (day.equalsIgnoreCase("Tue")) {
													assertEquals(tueList.get(checkInDayIndex).toUpperCase(),
															Utility.convertBooleanToString(afterModifyVal.isNoCheckIn())
																	.toUpperCase(),
															"Failed to verify Check In Rule Not Mached for date : "
																	+ date + " Source : " + source + " RoomClass : "
													...
													assertEquals(wedList.get(checkInDayIndex).toUpperCase(),
															Utility.convertBooleanToString(afterModifyVal.isNoCheckIn())
																	.toUpperCase(),
															"Failed to verify Check In Rule Not Mached for date : "
																	+ date + " Source : " + source + " RoomClass : "
													...
													assertEquals(thuList.get(checkInDayIndex).toUpperCase(),
															Utility.convertBooleanToString(afterModifyVal.isNoCheckIn())
																	.toUpperCase(),
															"Failed to verify Check In Rule Not Mached for date : "
																	+ date + " Source : " + source + " RoomClass : "
													...
													assertEquals(friList.get(checkInDayIndex).toUpperCase(),
															Utility.convertBooleanToString(afterModifyVal.isNoCheckIn())
																	.toUpperCase(),
															"Failed to verify Check In Rule Not Mached for date : "
																	+ date + " Source : " + source + " RoomClass : "
													...
													assertEquals(satList.get(checkInDayIndex).toUpperCase(),
															Utility.convertBooleanToString(afterModifyVal.isNoCheckIn())
																	.toUpperCase(),
															"Failed to verify Check In Rule Not Mached for date : "
																	+ date + " Source : " + source + " RoomClass : "
													...
													assertEquals(sunList.get(checkInDayIndex).toUpperCase(),
															Utility.convertBooleanToString(afterModifyVal.isNoCheckIn())
																	.toUpperCase(),
															"Failed to verify Check In Rule Not Mached for date : "
																	+ date + " Source : " + source + " RoomClass : "
													...
													.equalsIgnoreCase("No check-out")) {
												String day = Utility.parseDate(date, "dd/MM/yyyy", "E");

												if (day.equalsIgnoreCase("Mon")) {
													assertEquals(monList.get(checkOutDayIndex).toUpperCase(),
															Utility.convertBooleanToString(afterModifyVal.isNoCheckIn())
																	.toUpperCase(),
															"Failed to verify Check Out Rule Not Mached for date : "
																	+ date + " Source : " + source + " RoomClass : "
																	+ roomClass);
													app_logs.info("Successfully verify Check Out Rule Value : "
															+ afterModifyVal.isNoCheckIn()
															+ " After Modify Season Rule for date : " + date
															+ " Source : " + source + " RoomClass : " + roomClass);
													test_steps.add("Successfully verify Check Out Rule Value : "
															+ afterModifyVal.isNoCheckIn()
															+ " After Modify Season Rule for date : " + date
															+ " Source : " + source + " RoomClass : " + roomClass);
												} else if (day.equalsIgnoreCase("Tue")) {
													assertEquals(tueList.get(checkOutDayIndex).toUpperCase(),
															Utility.convertBooleanToString(afterModifyVal.isNoCheckIn())
																	.toUpperCase(),
															"Failed to verify Check In Rule Not Mached for date : "
																	+ date + " Source : " + source + " RoomClass : "
													...
													assertEquals(wedList.get(checkOutDayIndex).toUpperCase(),
															Utility.convertBooleanToString(afterModifyVal.isNoCheckIn())
																	.toUpperCase(),
															"Failed to verify Check In Rule Not Mached for date : "
																	+ date + " Source : " + source + " RoomClass : "
													...
													assertEquals(thuList.get(checkOutDayIndex).toUpperCase(),
															Utility.convertBooleanToString(afterModifyVal.isNoCheckIn())
																	.toUpperCase(),
															"Failed to verify Check In Rule Not Mached for date : "
																	+ date + " Source : " + source + " RoomClass : "
													...
													assertEquals(friList.get(checkOutDayIndex).toUpperCase(),
															Utility.convertBooleanToString(afterModifyVal.isNoCheckIn())
																	.toUpperCase(),
															"Failed to verify Check In Rule Not Mached for date : "
																	+ date + " Source : " + source + " RoomClass : "
													...
													assertEquals(satList.get(checkOutDayIndex).toUpperCase(),
															Utility.convertBooleanToString(afterModifyVal.isNoCheckIn())
																	.toUpperCase(),
															"Failed to verify Check In Rule Not Mached for date : "
																	+ date + " Source : " + source + " RoomClass : "
													...
													assertEquals(sunList.get(checkOutDayIndex).toUpperCase(),
															Utility.convertBooleanToString(afterModifyVal.isNoCheckIn())
																	.toUpperCase(),
															"Failed to verify Check In Rule Not Mached for date : "
																	+ date + " Source : " + source + " RoomClass : "
									...
									try {
										if (ModifySeasonRuleTypeList.get(i).equalsIgnoreCase("Min Nights")) {
											...
											test_steps.add("Successfully verify Min Stay Rule Value : "
													...
													+ " After Modify Season Rule for date : " + date + " Source : "
													+ source + " RoomClass : " + roomClass);
										} else if (ModifySeasonRuleTypeList.get(i).equalsIgnoreCase("No check-in")) {
											...
											if (day.equalsIgnoreCase("Mon")) {
												assertEquals(monList.get(checkInDayIndex).toUpperCase(),
														Utility.convertBooleanToString(afterModifyVal.isNoCheckIn())
																.toUpperCase(),
														"Failed to verify Check In Rule Not Mached for date : " + date
																+ " Source : " + source + " RoomClass : " + roomClass);
												app_logs.info("Successfully verify Check In Rule Value : "
														+ afterModifyVal.isNoCheckIn()
														+ " After Modify Season Rule for date : " + date + " Source : "
										...
										} else if (ModifySeasonRuleTypeList.get(i).equalsIgnoreCase("No check-out")) {
											String day = Utility.parseDate(date, "dd/MM/yyyy", "E");
											...
											if (day.equalsIgnoreCase("Mon")) {
												assertEquals(monList.get(checkOutDayIndex).toUpperCase(),
														Utility.convertBooleanToString(afterModifyVal.isNoCheckIn())
																.toUpperCase(),
														"Failed to verify Check Out Rule Not Mached for date : " + date
																+ " Source : " + source + " RoomClass : " + roomClass);
												app_logs.info("Successfully verify Check Out Rule Value : "
														+ afterModifyVal.isNoCheckIn()
														+ " After Modify Season Rule for date : " + date + " Source : "
			...
			app_logs.info(
					"=================== SUCCESSFULLY VERIFIED RATES GRID RULES AFTER MODIFY ===================");
			test_steps
					.add("=================== SUCCESSFULLY VERIFIED RATES GRID RULES AFTER MODIFY ===================");
		}

		Utility.AddTest_IntoReport(test_name, test_description, test_catagory, test_steps);
		test_name = "BulkUpdate/Override Rules ";
		test_description = "BulkUpdate/Override Rules ";
		test_steps.clear();

		String RulesUpdateType = "Override";
		String RulesUpdateStartDate = seasonStartDate;
		String RulesUpdateEndDate = seasonStartDate;
		String isSun_RulesUpdate = "yes";
		String isMon_RulesUpdate = "yes";
		String isTue_RulesUpdate = "yes";
		String isWed_RulesUpdate = "yes";
		String isThu_RulesUpdate = "yes";
		String isFri_RulesUpdate = "yes";
		String isSat_RulesUpdate = "yes";
		String parentRatePlanName = RatePlanNamelocal;
		String ReservationRoomClasses = RoomClasses;
		String channelName = Channels;
		String Type_RulesUpdate = "Min stay";
		String RuleMinStayValue_RulesUpdate = "2";
		...
		rateGrid.bulkUpdateOverideRules(driver, delim, RulesUpdateType, RulesUpdateStartDate, RulesUpdateEndDate,
				...
				isFri_RulesUpdate, isSat_RulesUpdate, parentRatePlanName, ReservationRoomClasses, channelName,
				Type_RulesUpdate, RuleMinStayValue_RulesUpdate, test_steps);

		Utility.AddTest_IntoReport(test_name, test_description, test_catagory, test_steps);
		test_name = "Modify Season Level Rules After BulkUpdate/Override When AssignRulesByRoomClass is Checked";
		test_description = "Modify Season Level Rules After BulkUpdate/Override When AssignRulesByRoomClass is Checked";
		test_steps.clear();
...
//		test_steps.add("All Season Dates : " + allSeasonsDates);
		...
		String ModifyisSerasonLevelRulesafterbulkUpdate = "Yes";
		String ModifyisAssignRulesByRoomClassafterbulkUpdate = "Yes";
		String ModifySeasonRuleSpecificRoomClassesafterbulkUpdate = "N Room1";
		String ModifySeasonRuleTypeafterbulkUpdate = "Min nights|No check-out";
		String ModifySeasonRuleMinStayValueafterbulkUpdate = "5";
		String ModifyisSeasonRuleOnMondayafterbulkUpdate = "yes";
		String ModifyisSeasonRuleOnTuesdayafterbulkUpdate = "yes";
		String ModifyisSeasonRuleOnWednesdayafterbulkUpdate = "yes";
		String ModifyisSeasonRuleOnThursdayafterbulkUpdate = "yes";
		String ModifyisSeasonRuleOnFridayafterbulkUpdate = "yes";
		String ModifyisSeasonRuleOnSaturdayafterbulkUpdate = "yes";
		String ModifyisSeasonRuleOnSundayafterbulkUpdate = "yes";

		nightlyRate.clickAssignRulesByRoomClass(driver, test_steps, ModifyisAssignRulesByRoomClassafterbulkUpdate);
		nightlyRate.enterSeasonLevelRules(driver, test_steps, ModifyisSerasonLevelRulesafterbulkUpdate,
				ModifyisAssignRulesByRoomClassafterbulkUpdate, ModifySeasonRuleSpecificRoomClassesafterbulkUpdate,
				ModifySeasonRuleTypeafterbulkUpdate, ModifySeasonRuleMinStayValueafterbulkUpdate,
				ModifyisSeasonRuleOnMondayafterbulkUpdate, ModifyisSeasonRuleOnTuesdayafterbulkUpdate,
				ModifyisSeasonRuleOnWednesdayafterbulkUpdate, ModifyisSeasonRuleOnThursdayafterbulkUpdate,
				ModifyisSeasonRuleOnFridayafterbulkUpdate, ModifyisSeasonRuleOnSaturdayafterbulkUpdate,
				ModifyisSeasonRuleOnSundayafterbulkUpdate);

		ArrayList<String> ModifySeasonRuleSpecificRoomClassesListafterbulkUpdate = Utility
				.convertTokenToArrayList(ModifySeasonRuleSpecificRoomClassesafterbulkUpdate, Utility.DELIM);

		ArrayList<String> ModifySeasonRuleTypeListafterbulkUpdate = Utility
				.convertTokenToArrayList(ModifySeasonRuleTypeafterbulkUpdate, Utility.DELIM);

		ArrayList<String> monListafterbulkUpdate = Utility
				.convertTokenToArrayList(ModifyisSeasonRuleOnMondayafterbulkUpdate, Utility.DELIM);
		ArrayList<String> tueListafterbulkUpdate = Utility
				.convertTokenToArrayList(ModifyisSeasonRuleOnTuesdayafterbulkUpdate, Utility.DELIM);
		ArrayList<String> wedListafterbulkUpdate = Utility
				.convertTokenToArrayList(ModifyisSeasonRuleOnWednesdayafterbulkUpdate, Utility.DELIM);
		ArrayList<String> thuListafterbulkUpdate = Utility
				.convertTokenToArrayList(ModifyisSeasonRuleOnThursdayafterbulkUpdate, Utility.DELIM);
		ArrayList<String> friListafterbulkUpdate = Utility
				.convertTokenToArrayList(ModifyisSeasonRuleOnFridayafterbulkUpdate, Utility.DELIM);
		ArrayList<String> satListafterbulkUpdate = Utility
				.convertTokenToArrayList(ModifyisSeasonRuleOnSaturdayafterbulkUpdate, Utility.DELIM);
		ArrayList<String> sunListafterbulkUpdate = Utility
				.convertTokenToArrayList(ModifyisSeasonRuleOnSundayafterbulkUpdate, Utility.DELIM);
		...
		Utility.AddTest_IntoReport(test_name, test_description, test_catagory, test_steps);
		test_name = "Get Rates Grid Values After Modifications ";
		test_description = "Get Rates Grid Values After Modifications ";
		test_steps.clear();
		...
		rateGrid.clickRatePlanArrow(driver, test_steps);
		rateGrid.selectAndReturnSpecificRatePlan(driver, test_steps, RatePlanNamelocal);
		if (ModifyisSerasonLevelRulesafterbulkUpdate.equalsIgnoreCase("Yes")) {
			HashMap<String, // RoomClass
					HashMap<String, // Source
							HashMap<String, // date
									RatesGridChannelRatesRules>>> afterbulkUpdateRoomClassWiseSourceRatesRule = rateGrid
											.getSourceWiseRatesRules(driver, test_steps, RatePlanNamelocal,
													RatePlanNamelocal, false, delim, RoomClasses, Channels,
													seasonStartDate, seasonEndDate);
			...
			for (String date : allDatesBW) {
				app_logs.info(date);
				app_logs.info(afterbulkUpdateRoomClassWiseSourceRatesRule.get(selectedRoomClasses.get(0))
						.get(selectedChannels.get(0)).get(date));
			}

			ArrayList<String> Type_RulesUpdateafterbulkUpdate = Utility.convertTokenToArrayList(Type_RulesUpdate,
					Utility.DELIM);
			ArrayList<String> monListafterRulesUpdate = Utility.convertTokenToArrayList(isMon_RulesUpdate,
					Utility.DELIM);
			ArrayList<String> tueListafterRulesUpdate = Utility.convertTokenToArrayList(isTue_RulesUpdate,
					Utility.DELIM);
			ArrayList<String> wedListafterRulesUpdate = Utility.convertTokenToArrayList(isWed_RulesUpdate,
					Utility.DELIM);
			ArrayList<String> thuListafterRulesUpdate = Utility.convertTokenToArrayList(isThu_RulesUpdate,
					Utility.DELIM);
			ArrayList<String> friListafterRulesUpdate = Utility.convertTokenToArrayList(isFri_RulesUpdate,
					Utility.DELIM);
			ArrayList<String> satListafterRulesUpdate = Utility.convertTokenToArrayList(isSat_RulesUpdate,
					Utility.DELIM);
			ArrayList<String> sunListafterRulesUpdate = Utility.convertTokenToArrayList(isSun_RulesUpdate,
					Utility.DELIM);

			Utility.AddTest_IntoReport(test_name, test_description, test_catagory, test_steps);
			test_name = "Verify Rules After BulkUpdate/Override for known Dates and Season Level Modification";
			test_description = "Verify Rules After BulkUpdate/Override for known Dates and Season Level Modification";
			test_steps.clear();
			...
			for (String roomClass : selectedRoomClasses) {
				...
				for (String source : selectedChannels) {
					...
					for (String date : allDatesBW) {
						...
						test_steps.add("==================== VERIFYING RATES WHERE DATE IS : " + date
								+ " ====================");
						RatesGridChannelRatesRules afterModifyVal = afterbulkUpdateRoomClassWiseSourceRatesRule
								.get(roomClass).get(source).get(date);

						if (ModifyisAssignRulesByRoomClassafterbulkUpdate.equalsIgnoreCase("Yes")) {
							if (ModifySeasonRuleSpecificRoomClassesListafterbulkUpdate.contains(roomClass)) {
								if (date.equals(seasonStartDate)) {
									for (int i = 0; i < Type_RulesUpdateafterbulkUpdate.size(); i++) {
										int checkInDayIndex = 0;
										int checkOutDayIndex = 0;
										int j = 0;
										for (String type : Type_RulesUpdateafterbulkUpdate) {
										...
										try {
											if (Type_RulesUpdateafterbulkUpdate.get(i).equalsIgnoreCase("Min Nights")) {
												assertEquals(Integer.parseInt(afterModifyVal.getMinRule()),
														Integer.parseInt(RuleMinStayValue_RulesUpdate),
														"Failed to verify Min Stay Rule Not Mached for date : " + date
																+ " Source : " + source + " RoomClass : " + roomClass);
												app_logs.info("Successfully verify Min Stay Rule Value : "
														+ RuleMinStayValue_RulesUpdate + " Same as " + RulesUpdateType
														+ " After Modify Season Rule for date : " + date + " Source : "
														+ source + " RoomClass : " + roomClass);
												test_steps.add("Successfully verify Min Stay Rule Value : "
														+ RuleMinStayValue_RulesUpdate + " Same as " + RulesUpdateType
														+ " After Modify Season Rule for date : " + date + " Source : "
														+ source + " RoomClass : " + roomClass);
											} else if (Type_RulesUpdateafterbulkUpdate.get(i)
													.equalsIgnoreCase("No check-in")) {
												...
												if (day.equalsIgnoreCase("Mon")) {
													assertEquals(
															Utility.convertBooleanToString(afterModifyVal.isNoCheckIn())
																	.toUpperCase(),
															monListafterRulesUpdate.get(checkInDayIndex).toUpperCase(),

															"Failed to verify Check In Rule Not Mached for date : "
																	+ date + " Source : " + source + " RoomClass : "
																	+ roomClass);
													app_logs.info("Successfully verify Check In Rule Value : "
															+ afterModifyVal.isNoCheckIn() + " Same as "
															+ RulesUpdateType + " After Modify Season Rule for date : "
															+ date + " Source : " + source + " RoomClass : "
															+ roomClass);
													test_steps.add("Successfully verify Check In Rule Value : "
															+ afterModifyVal.isNoCheckIn() + " Same as "
													...
													assertEquals(
															Utility.convertBooleanToString(afterModifyVal.isNoCheckIn())
																	.toUpperCase(),
															tueListafterRulesUpdate.get(checkInDayIndex).toUpperCase(),
													...
													assertEquals(
															Utility.convertBooleanToString(afterModifyVal.isNoCheckIn())
																	.toUpperCase(),
															wedListafterRulesUpdate.get(checkInDayIndex).toUpperCase(),
													...
													assertEquals(
															Utility.convertBooleanToString(afterModifyVal.isNoCheckIn())
																	.toUpperCase(),
															thuListafterRulesUpdate.get(checkInDayIndex).toUpperCase(),
													...
													assertEquals(
															Utility.convertBooleanToString(afterModifyVal.isNoCheckIn())
																	.toUpperCase(),
															friListafterRulesUpdate.get(checkInDayIndex).toUpperCase(),
													...
													assertEquals(
															Utility.convertBooleanToString(afterModifyVal.isNoCheckIn())
																	.toUpperCase(),
															satListafterRulesUpdate.get(checkInDayIndex).toUpperCase(),
													...
													assertEquals(
															Utility.convertBooleanToString(afterModifyVal.isNoCheckIn())
																	.toUpperCase(),
															sunListafterRulesUpdate.get(checkInDayIndex).toUpperCase(),
												...
												if (day.equalsIgnoreCase("Mon")) {
													assertEquals(
															Utility.convertBooleanToString(
																	afterModifyVal.isNoCheckOut()).toUpperCase(),
															monListafterRulesUpdate.get(checkOutDayIndex).toUpperCase(),

															"Failed to verify Check Out Rule Not Mached for date : "
																	+ date + " Source : " + source + " RoomClass : "
																	+ roomClass);
													app_logs.info("Successfully verify Check Out Rule Value : "
															+ afterModifyVal.isNoCheckOut() + " Same as "
															+ RulesUpdateType + " After Modify Season Rule for date : "
															+ date + " Source : " + source + " RoomClass : "
															+ roomClass);
													test_steps.add("Successfully verify Check Out Rule Value : "
													...
													assertEquals(
															Utility.convertBooleanToString(
																	afterModifyVal.isNoCheckOut()).toUpperCase(),
															tueListafterRulesUpdate.get(checkOutDayIndex).toUpperCase(),
													...
													assertEquals(
															Utility.convertBooleanToString(
																	afterModifyVal.isNoCheckOut()).toUpperCase(),
															wedListafterRulesUpdate.get(checkOutDayIndex).toUpperCase(),
													...
													assertEquals(
															Utility.convertBooleanToString(
																	afterModifyVal.isNoCheckOut()).toUpperCase(),
															thuListafterRulesUpdate.get(checkOutDayIndex).toUpperCase(),
													...
													assertEquals(
															Utility.convertBooleanToString(
																	afterModifyVal.isNoCheckOut()).toUpperCase(),
															friListafterRulesUpdate.get(checkOutDayIndex).toUpperCase(),
													...
													assertEquals(
															Utility.convertBooleanToString(
																	afterModifyVal.isNoCheckOut()).toUpperCase(),
															satListafterRulesUpdate.get(checkOutDayIndex).toUpperCase(),
													...
													assertEquals(
															Utility.convertBooleanToString(
																	afterModifyVal.isNoCheckOut()).toUpperCase(),
															sunListafterRulesUpdate.get(checkOutDayIndex).toUpperCase(),
									...
									if (ModifySeasonRuleTypeListafterbulkUpdate.size() > 0
											&& ModifySeasonRuleTypeListafterbulkUpdate != null) {
										int checkInDayIndex = 0;
										int checkOutDayIndex = 0;
										int j = 0;
										for (String type : ModifySeasonRuleTypeListafterbulkUpdate) {
										...
										for (int i = 0; i < ModifySeasonRuleTypeListafterbulkUpdate.size(); i++) {
											try {
												if (ModifySeasonRuleTypeListafterbulkUpdate.get(i)
														.equalsIgnoreCase("Min Nights")) {
													assertEquals(Integer.parseInt(afterModifyVal.getMinRule()),
															Integer.parseInt(
																	ModifySeasonRuleMinStayValueafterbulkUpdate),
															"Failed to verify Min Stay Rule Not Mached for date : "
																	+ date + " Source : " + source + " RoomClass : "
																	+ roomClass);
													app_logs.info("Successfully verify Min Stay Rule Value : "
															+ ModifySeasonRuleMinStayValueafterbulkUpdate
													...
													test_steps.add("Successfully verify Min Stay Rule Value : "
															...
															+ " After Modify Season Rule for date : " + date
															+ " Source : " + source + " RoomClass : " + roomClass);
												} else if (ModifySeasonRuleTypeListafterbulkUpdate.get(i)
														.equalsIgnoreCase("No check-in")) {
													...
													if (day.equalsIgnoreCase("Mon")) {
														assertEquals(
																Utility.convertBooleanToString(
																		afterModifyVal.isNoCheckIn()).toUpperCase(),
																monListafterbulkUpdate.get(checkInDayIndex)
																		.toUpperCase(),
														...
														assertEquals(
																Utility.convertBooleanToString(
																		afterModifyVal.isNoCheckIn()).toUpperCase(),
																tueListafterbulkUpdate.get(checkInDayIndex)
																		.toUpperCase(),
														...
														assertEquals(
																Utility.convertBooleanToString(
																		afterModifyVal.isNoCheckIn()).toUpperCase(),
																wedListafterbulkUpdate.get(checkInDayIndex)
																		.toUpperCase(),
														...
														assertEquals(
																Utility.convertBooleanToString(
																		afterModifyVal.isNoCheckIn()).toUpperCase(),
																thuListafterbulkUpdate.get(checkInDayIndex)
																		.toUpperCase(),
														...
														assertEquals(
																Utility.convertBooleanToString(
																		afterModifyVal.isNoCheckIn()).toUpperCase(),
																friListafterbulkUpdate.get(checkInDayIndex)
																		.toUpperCase(),
														...
														assertEquals(
																Utility.convertBooleanToString(
																		afterModifyVal.isNoCheckIn()).toUpperCase(),
																satListafterbulkUpdate.get(checkInDayIndex)
																		.toUpperCase(),
														...
														assertEquals(
																Utility.convertBooleanToString(
																		afterModifyVal.isNoCheckIn()).toUpperCase(),
																sunListafterbulkUpdate.get(checkInDayIndex)
																		.toUpperCase(),
													...
													if (day.equalsIgnoreCase("Mon")) {
														assertEquals(
																Utility.convertBooleanToString(
																		afterModifyVal.isNoCheckOut()).toUpperCase(),
																monListafterbulkUpdate.get(checkOutDayIndex)
																		.toUpperCase(),
														...
														assertEquals(
																Utility.convertBooleanToString(
																		afterModifyVal.isNoCheckOut()).toUpperCase(),
																tueListafterbulkUpdate.get(checkOutDayIndex)
																		.toUpperCase(),
														...
														assertEquals(
																Utility.convertBooleanToString(
																		afterModifyVal.isNoCheckOut()).toUpperCase(),
																wedListafterbulkUpdate.get(checkOutDayIndex)
																		.toUpperCase(),
														...
														assertEquals(
																Utility.convertBooleanToString(
																		afterModifyVal.isNoCheckOut()).toUpperCase(),
																thuListafterbulkUpdate.get(checkOutDayIndex)
																		.toUpperCase(),
														...
														assertEquals(
																Utility.convertBooleanToString(
																		afterModifyVal.isNoCheckOut()).toUpperCase(),
																friListafterbulkUpdate.get(checkOutDayIndex)
																		.toUpperCase(),
														...
														assertEquals(
																Utility.convertBooleanToString(
																		afterModifyVal.isNoCheckOut()).toUpperCase(),
																satListafterbulkUpdate.get(checkOutDayIndex)
																		.toUpperCase(),
														...
														assertEquals(
																Utility.convertBooleanToString(
																		afterModifyVal.isNoCheckOut()).toUpperCase(),
																sunListafterbulkUpdate.get(checkOutDayIndex)
																		.toUpperCase(),
								...
								for (int i = 0; i < ModifySeasonRuleTypeListafterbulkUpdate.size(); i++) {
									try {
										if (ModifySeasonRuleTypeListafterbulkUpdate.get(i)
												.equalsIgnoreCase("Min Nights")) {
											assertEquals(Integer.parseInt(afterModifyVal.getMinRule()),
													Integer.parseInt(ModifySeasonRuleMinStayValueafterbulkUpdate),
													"Failed to verify Min Stay Rule Not Mached for date : " + date
															+ " Source : " + source + " RoomClass : " + roomClass);
											app_logs.info("Successfully verify Min Stay Rule Value : "
													+ ModifySeasonRuleMinStayValueafterbulkUpdate
											...
											if (day.equalsIgnoreCase("Mon")) {
												assertEquals(monListafterbulkUpdate.get(checkInDayIndex).toUpperCase(),
														Utility.convertBooleanToString(afterModifyVal.isNoCheckIn())
																.toUpperCase(),
														"Failed to verify Check In Rule Not Mached for date : " + date
																+ " Source : " + source + " RoomClass : " + roomClass);
												...
												assertEquals(tueListafterbulkUpdate.get(checkInDayIndex).toUpperCase(),
														Utility.convertBooleanToString(afterModifyVal.isNoCheckIn())
																.toUpperCase(),
														"Failed to verify Check In Rule Not Mached for date : " + date
																+ " Source : " + source + " RoomClass : " + roomClass);
												...
												assertEquals(wedListafterbulkUpdate.get(checkInDayIndex).toUpperCase(),
														Utility.convertBooleanToString(afterModifyVal.isNoCheckIn())
																.toUpperCase(),
														"Failed to verify Check In Rule Not Mached for date : " + date
																+ " Source : " + source + " RoomClass : " + roomClass);
												...
												assertEquals(thuListafterbulkUpdate.get(checkInDayIndex).toUpperCase(),
														Utility.convertBooleanToString(afterModifyVal.isNoCheckIn())
																.toUpperCase(),
														"Failed to verify Check In Rule Not Mached for date : " + date
																+ " Source : " + source + " RoomClass : " + roomClass);
												...
												assertEquals(friListafterbulkUpdate.get(checkInDayIndex).toUpperCase(),
														Utility.convertBooleanToString(afterModifyVal.isNoCheckIn())
																.toUpperCase(),
														"Failed to verify Check In Rule Not Mached for date : " + date
																+ " Source : " + source + " RoomClass : " + roomClass);
												...
												assertEquals(satListafterbulkUpdate.get(checkInDayIndex).toUpperCase(),
														Utility.convertBooleanToString(afterModifyVal.isNoCheckIn())
																.toUpperCase(),
														"Failed to verify Check In Rule Not Mached for date : " + date
																+ " Source : " + source + " RoomClass : " + roomClass);
												...
												assertEquals(sunListafterbulkUpdate.get(checkInDayIndex).toUpperCase(),
														Utility.convertBooleanToString(afterModifyVal.isNoCheckIn())
																.toUpperCase(),
														"Failed to verify Check In Rule Not Mached for date : " + date
																+ " Source : " + source + " RoomClass : " + roomClass);
											...
											if (day.equalsIgnoreCase("Mon")) {
												assertEquals(
														Utility.convertBooleanToString(afterModifyVal.isNoCheckOut())
																.toUpperCase(),
														monListafterbulkUpdate.get(checkOutDayIndex).toUpperCase(),
												...
												assertEquals(
														Utility.convertBooleanToString(afterModifyVal.isNoCheckOut())
																.toUpperCase(),
														tueListafterbulkUpdate.get(checkOutDayIndex).toUpperCase(),
												...
												assertEquals(
														Utility.convertBooleanToString(afterModifyVal.isNoCheckOut())
																.toUpperCase(),
														wedListafterbulkUpdate.get(checkOutDayIndex).toUpperCase(),
												...
												assertEquals(
														Utility.convertBooleanToString(afterModifyVal.isNoCheckOut())
																.toUpperCase(),
														thuListafterbulkUpdate.get(checkOutDayIndex).toUpperCase(),
												...
												assertEquals(
														Utility.convertBooleanToString(afterModifyVal.isNoCheckOut())
																.toUpperCase(),
														friListafterbulkUpdate.get(checkOutDayIndex).toUpperCase(),
												...
												assertEquals(
														Utility.convertBooleanToString(afterModifyVal.isNoCheckOut())
																.toUpperCase(),
														satListafterbulkUpdate.get(checkOutDayIndex).toUpperCase(),
												...
												assertEquals(
														Utility.convertBooleanToString(afterModifyVal.isNoCheckOut())
																.toUpperCase(),
														sunListafterbulkUpdate.get(checkOutDayIndex).toUpperCase(),
			...
			app_logs.info(
					"=================== SUCCESSFULLY VERIFIED RATES GRID RULES AFTER BULKUPDATE & MODIFY ===================");
			test_steps.add(
					"=================== SUCCESSFULLY VERIFIED RATES GRID RULES AFTER BULKUPDATE & MODIFY ===================");
		}
		Utility.AddTest_IntoReport(test_name, test_description, test_catagory, test_steps);
	...
	public void verifySeasonBlackOutAndDelete(WebDriver driver) throws Exception {
		...
		Utility.AddTest_IntoReport(test_name, test_description, test_catagory, test_steps);
		test_name = "Create Rate Plan For Season BlackOut/Delete Verification";
		test_description = "Create Rate Plan For Season BlackOut/Delete Verification";
		test_steps.clear();
		try {
			// After login
			test_steps.add("=================== NAVIGATE TO RATE GRID ======================");
		...
		Utility.AddTest_IntoReport(test_name, test_description, test_catagory, test_steps);
		test_name = "DO SEASON BLACKOUT AND VERIFY NO RATE COMBINATION MESSAGE IN RESERVATION";
		test_description = "DO SEASON BLACKOUT AND VERIFY NO RATE COMBINATION MESSAGE IN RESERVATION";
		test_steps.clear();
		try {
			navigation.ratesGrid(driver);
			driver.navigate().refresh();
			...
			rateGrid.clickOnEditRatePlan(driver);
			nightlyRate.switchCalendarTab(driver, test_steps);
			nightlyRate.blockoutSeason(driver, getTest_Steps, seasonStartDate, seasonEndDate);
			nightlyRate.clickSaveRatePlanButton(driver, test_steps);
			try {
				navigation.cpReservation_Backward(driver);
			} catch (Exception e) {
			...
			reservationPage.click_NewReservation(driver, test_steps);
			test_steps.add("=================== VERIFY NO RATE COMBINATION MESSAGE IN RESERVATION ======================");
			app_logs.info("=================== VERIFY NO RATE COMBINATION MESSAGE IN RESERVATION ======================");
			reservationPage.select_CheckInDate(driver, test_steps, seasonStartDate);
			reservationPage.select_CheckoutDate(driver, test_steps, seasonEndDate);
			reservationPage.enter_Adults(driver, test_steps, "1");
			reservationPage.enter_Children(driver, test_steps, "0");
			if (PromoCode.isEmpty()) {
				reservationPage.select_Rateplan(driver, test_steps, RatePlanNamelocal, PromoCode);
			} else {
				String rateplan = "Promo Code";
				reservationPage.select_Rateplan(driver, test_steps, rateplan, PromoCode);
			}
			...
			Utility.AddTest_IntoReport(test_name, test_description, test_catagory, test_steps);
			test_name = "MAKE SEASON AVAILABLE AND VERIFY SEASON EXIST IN RESERVATION";
			test_description = "MAKE SEASON AVAILABLE AND SEASON EXIST IN RESERVATION";
			test_steps.clear();
			...
			reservationPage.click_NewReservation(driver, test_steps);
			test_steps.add("=================== VERIFY SEASON EXIST IN RESERVATION ======================");
			app_logs.info("=================== VERIFY SEASON EXIST IN RESERVATION ======================");
			reservationPage.select_CheckInDate(driver, test_steps, seasonStartDate);
			reservationPage.select_CheckoutDate(driver, test_steps, seasonEndDate);
			reservationPage.enter_Adults(driver, test_steps, "1");
			reservationPage.enter_Children(driver, test_steps, "0");
			...
			if (driver.findElements(By.xpath("(//span[text()='" + RoomClasses + "'])[2]")).size() > 0
					) {
				
				test_steps.add("Successfully Verified Season Exist in Reservation");
				app_logs.info("Successfully Verified Season Exist in Reservation");
			}

			reservationPage.close_FirstOpenedReservation(driver, test_steps);
			Utility.AddTest_IntoReport(test_name, test_description, test_catagory, test_steps);
			test_name = "DELETE SEASON AND VERIFY NO RATE COMBINATION MESSAGE IN RESERVATION";
			test_description = "DELETE SEASON AND VERIFY NO RATE COMBINATION MESSAGE IN RESERVATION";
			test_steps.clear();
			...
			nightlyRate.clickDeleteSeasonButton(driver, test_steps);
