...
//	Policies policy = new Policies();
	...
	// HashMap<String, String> getRatesPerNightChannels = new HashMap<String,
	// String>();
	...
	public void verifyDerivedRatePlanInInnCenter(String delim, String ClientName, String parentRatePlanName,
			String derivedRatePlanName, String ReservationType, String CheckInDate, String CheckOutDate, String adult,
			String children, String ReservationRoomClasses, String ActionOnReservation,
			...
			String PercentOfFee, String FeeChargesType,
			...
			String ModifySeasonRuleType, String ModifySeasonRuleMinStayValue, String ModifyisSeasonRuleOnDays,
			String RulesUpdateType, String RulesUpdateStartDate, String RulesUpdateEndDate, String Type_RulesUpdate,
			String RuleMinStayValue_RulesUpdate, String Days_RulesUpdate, String RatesUpdateType,
			String checkInDate_RatesUpdate, String checkOutDate_RatesUpdate, String Days_RatesUpdate,
			String updateRatesType, String isUpdateRateByRoomClass, String nightlyRate_RatesUpdate,
			String additionalAdults_RatesUpdate, String additionalChild_RatesUpdate, String DrivedRulesUpdateType,
						...
						for (String date : allDatesBW) {
							...
							if (parentRateRule != null || derivedRateRule != null) {
								if (!parentRateRule.getRooomRate().equals("--")) {
									...
									if(!derivedRateRule.isRatesOveriden()) {
...
//										test_steps.add(e.toString());
		...
		// Channel Modify and verify in derived level
		...
		// modify roomClass season level and verify in dervied level
		...
		try {
			...
			if (!ModifyDeleteExistingChannel.isEmpty() || !ModifyAddChannel.isEmpty()
					|| !ModifyDeleteExistingSeasonLevelRoomClasses.isEmpty()
					|| !ModifyExistingSeasonLevelRoomClasses.isEmpty()
					|| Boolean.parseBoolean(ModifyisAddRoomClassInSeason)
					|| Boolean.parseBoolean(ModifyisSerasonLevelRules)) {
...
//			}
							...
							if (parentRateRule != null || derivedRateRule != null) {
								if (!parentRateRule.getRooomRate().equals("--")) {
									if(!derivedRateRule.isRatesOveriden()) {
										...
										app_logs.info(
												"Successfully Verified Room Rate : " + derivedRateRule.getRooomRate());
										test_steps
												.add("Successfully Verified Room Rate : " + derivedRateRule.getRooomRate());
										...
										app_logs.info("Successfully Verified Extra Adult Rate : "
												+ derivedRateRule.getExtraAdultRate());
										...
										app_logs.info("Successfully Verified Extra Child Rate : "
												+ derivedRateRule.getExtraChildRate());
				...
				app_logs.info("=================== SUCCESSFULLY VERIFIED RATES GRID RATES OF DERIVED RATE PLAN : "
						+ derivedRatePlanName.toUpperCase() + " AS PER BASE RATE PLAN : "
						+ parentRatePlanName.toUpperCase() + " ===================");
				test_steps.add("=================== SUCCESSFULLY VERIFIED RATES GRID RATES OF DERIVED RATE PLAN : "
						+ derivedRatePlanName.toUpperCase() + " AS PER BASE RATE PLAN : "
						+ parentRatePlanName.toUpperCase() + " ===================");
				...
				for (String roomClass : selectedRoomClasses) {
					...
					app_logs.info("==================== VERIFYING RULES OF ROOM CLASS : " + roomClass.toUpperCase()
							+ " ====================");
					test_steps.add("==================== VERIFYING RULES OF ROOM CLASS : <b>" + roomClass.toUpperCase()
							+ "</b> ====================");

					for (String source : selectedChannels) {

						app_logs.info("==================== VERIFYING RULES OF SOURCE : " + source.toUpperCase()
								+ " ====================");
						test_steps.add("==================== VERIFYING RULES OF SOURCE : <b>" + source.toUpperCase()
								+ "</b> ====================");

						for (String date : allDatesBW) {

							app_logs.info("==================== VERIFYING RULES WHERE DATE IS : " + date
									+ " ====================");
							test_steps.add("==================== VERIFYING RULES WHERE DATE IS : " + date
									+ " ====================");
												...
												for (String type : selectedRulesTypes) {
													...
													if (type.equalsIgnoreCase("Min nights")) {
														try {
															...
															app_logs.info("Successfully Verified Min stay Rule : "
																	+ derivedRateRule.getMinRule());
															test_steps.add("Successfully Verified Min stay Rule : "
																	+ derivedRateRule.getMinRule());
														...
														try {
															assertEquals(
																	...
																	"Failed To Verify No CheckIn Rule Where Date : "
																			+ date + " Source : " + source
																			+ " Room Class : " + roomClass);
															app_logs.info("Successfully Verified No CheckIn Rule : "
																	+ derivedRateRule.isNoCheckIn());
															test_steps.add("Successfully Verified No CheckIn Rule : "
																	+ derivedRateRule.isNoCheckIn());
														} catch (Exception e) {
															test_steps.add(e.toString());
														}
														...
														try {
															assertEquals(
																	...
																	"Failed To Verify No Checkout Rule Where Date : "
																			+ date + " Source : " + source
																			+ " Room Class : " + roomClass);
															app_logs.info("Successfully Verified No Checkout Rule : "
																	+ derivedRateRule.isNoCheckOut());
															test_steps.add("Successfully Verified No Checkout Rule : "
																	+ derivedRateRule.isNoCheckOut());
														} catch (Exception e) {
															test_steps.add(e.toString());
														}
...
//										test_steps.add(e.toString());
				...
				app_logs.info("=================== SUCCESSFULLY VERIFIED RATES GRID RULES OF DERIVED RATE PLAN : "
						+ derivedRatePlanName.toUpperCase() + " AS PER BASE RATE PLAN : "
						+ parentRatePlanName.toUpperCase() + " ===================");
				test_steps.add("=================== SUCCESSFULLY VERIFIED RATES GRID RULES OF DERIVED RATE PLAN : "
						+ derivedRatePlanName.toUpperCase() + " AS PER BASE RATE PLAN : "
						+ parentRatePlanName.toUpperCase() + " ===================");
				// assertEquals(roomClassWiseSourceDerivedRatesRule,
				// roomClassWiseSourceRatesRule);
				...
				for (String roomClass : reservationRoomClassesList) {
					...
					if (RatesUpdateType.equalsIgnoreCase("Overide")) {
						...
						getParentInitialRatesPerNightChannelsTemp = rateGrid.getSourceWiseRatesRules(driver, test_steps,
								parentRatePlanName, derivedRatePlanName, false, delim, roomClass, channelName,
				...
				for (String roomClass : reservationRoomClassesList) {
					...
					if (RatesUpdateType.equalsIgnoreCase("Overide")) {
						...
						getDerivedInitialRatesPerNightChannelsTemp = rateGrid.getSourceWiseRatesRules(driver,
								test_steps, parentRatePlanName, derivedRatePlanName, true, delim, roomClass,
				...
				for (String roomClass : reservationRoomClassesList) {
					...
					if (RatesUpdateType.equalsIgnoreCase("Overide")) {
						...
						getDerivedAfterRatesPerNightChannelsTemp = rateGrid.getSourceWiseRatesRules(driver, test_steps,
								parentRatePlanName, derivedRatePlanName, true, delim, roomClass, channelName,
								RatesUpdateStartDateList.get(0),
								RatesUpdateStartDateList.get(RatesUpdateStartDateList.size() - 1));
...
//								minStayRuleValue);
		...
		if (isReservationCreated) {
			...
			afterReservationDone(delim, ActionOnReservation, reservation, CheckInDate, CheckOutDate, GuestFirstName,
					...
					ChangeResEndDate, parentRatePlanName, derivedRatePlanName, derivedPromoCode,
	...
	public Object[][] getData() {
		...
		return Utility.getData("VerifyDerivedRatePlanInnCenter", envLoginExcel);
	}
...
//	testSteps.addAll(getTestSteps);
	...
	public void changeStaydetails(String delim, String parentRatePlanName, String derivedRatePlanName,
		...
		//Utility.AddTest_IntoReport(testName, test_description, test_catagory, test_steps);
		test_steps.clear();
		testName = "Modify Rates And Rules For Change stay details Verification in Reservation";
...
//				app_logs.info(ad);
			...
			Utility.AddTest_IntoReport(testName, test_description, test_catagory, test_steps);
			test_steps.clear();
			testName = "Change stay details-Recalculate Rate,  verify in reservation";
...
//			reservationPage.ClickStayInfo_ChangeDetails(driver, test_steps);
			...
			Utility.AddTest_IntoReport(testName, test_description, test_catagory, test_steps);
			test_steps.clear();
			testName = "Change stay details-No Rate Change,  verify in reservation";
			...
			Utility.AddTest_IntoReport(testName, test_description, test_catagory, test_steps);
			test_steps.clear();
			testName = "Change stay details-Change only for added/removed dates,  verify in reservation";
