...
public class DailyFlashReportPaymentMethodTypeAsOthers extends TestCore{
...
//			try {
				...
				if (isPayment.equalsIgnoreCase("Yes")) {
					...
					reservationV2Page.takePayment_RV2(driver, test_steps, false, null, "Test",paymentMethod,cardNumber);
...
//			}
	...
	public Object[][] getData() {
		...
		return Utility.getData("DailyFlashReportPaymentOthers", excelReservationV2);
	}
