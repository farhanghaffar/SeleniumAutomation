...
public class VerifyGuestInfoSpecialCharReservationV2 extends TestCore {
...
//	ArrayList<String> getTest_Steps = new ArrayList<>();
	...
	public void verifyGuestInfoSpecialCharReservationV2(String TestCaseId, String TestCaseName,
			String RatePlanName, String GuestFirstName, String GuestLastName)
			throws Exception {
...
//				getTest_Steps.clear();
				obj1.createRoomClassWithDescriptionV2(driver, test_steps, roomClassName, roomClassAB,
...
//		String guestLastName = "Wick_" + Utility.generateRandomNumberWithGivenNumberOfDigits(4);
	...
	public Object[][] getData() {
		...
		return Utility.getData("VerifyGuestInfoSpecialCharResV2", HS_EXCEL);
	}
