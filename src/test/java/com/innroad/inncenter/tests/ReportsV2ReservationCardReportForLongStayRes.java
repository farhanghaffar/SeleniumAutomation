...
public class ReportsV2ReservationCardReportForLongStayRes extends TestCore {
	...
	cardExpDate = Utility.getFutureMonthAndYearForMasterCard(driver,test_steps), roomCharge , guestFullName,guestFullName2,reservation_Status, stayInfo = null;
	...
	public Object[][] getData() {
		...
		return Utility.getData("ReportForLongStayRes", excelReservationV2);
	}
