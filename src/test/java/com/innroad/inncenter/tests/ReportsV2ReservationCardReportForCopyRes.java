...
public class ReportsV2ReservationCardReportForCopyRes extends TestCore {
	...
	//	{
		...
		try {
			...
			copiedReservationDetails=reservationV2Page.copyReservation(driver, test_steps, guestFirstNameCopied, guestLastNameCopied);
			res.closeFirstReservation(driver, test_steps);
		...
		try {
     	...
     	String roomNumber_CopiedRes=stayinfo.getSI_ROOM_NUMBER();
		...
		app_logs.info("TripSummary details: "+ledgerAmounts);
			...
			report.verifyCardViewDetails( driver, reservationNumber_CopiedRes,reservation_Status_copied,guestFullNameCopied ,adults,children, roomClass, roomNumber_CopiedRes, ratePlan,
...
//	}
	...
	public Object[][] getData() {		
		return Utility.getData("ReportForCopyRes", excelReservationV2);
	}
