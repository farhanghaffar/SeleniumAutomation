...
public class ReportsV2TransactionsReportRefundTotal  extends TestCore {
	...
	public void validateLedgerBalancesReport(String TestCaseID, String Scenario, String dateRange, String dateEffective, 
		...
		try {
			if (resType.equalsIgnoreCase("Single") || resType.equalsIgnoreCase("TapeChart")) {	
			    ...
			    guestFolio.refundPaymentFromGuestDetailsTab(driver, test_steps, "10");
...
//			try {
				...
				paymentData = guestFolio.refundPaymentFromGuestDetailsTab(driver, test_steps, "10.00");
...
//					reservationPage.rollBackReservation(driver, test_steps, guestFullName, "RESERVED");
	...
	public Object[][] getData() {
		...
		return Utility.getData("V2TransactionsRefundTotal", excelReservationV2);
	}
