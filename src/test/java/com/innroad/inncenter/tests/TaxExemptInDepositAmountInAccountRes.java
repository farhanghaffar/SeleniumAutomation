...
public class TaxExemptInDepositAmountInAccountRes extends TestCore {
	...
	public void taxExemptInDepositAmountInRes(String TestCaseID,
		...
		test_name = "TaxExcemptInDepositAmountGroupRes";
		...
		try {
			...
			tax.createNewTax(driver, taxName, taxName, taxName, value, category, taxLedgerAccount, excludeTaxExempt, Percentage, Vat, false, "", "", "");
		...
		try {
			...
			String accountName="Auto Acc"+Utility.generateRandomString();
			act.createNewAccountWithTaxExempt(driver, test_steps, accountType, accountName, marketSegment, referral, "N Acco Fname", "N Acc LName", "9807654321", "9087654312", address1, address2, address3, email, city, state, "23456","1234");
			act.clickOnNewReservationButton(driver, test_steps);
			...
			res.selectRoom(driver, test_steps, roomClassName, isAssign, accountName);
		...
		/*	boolean isTaxExist = res.isTaxPresentAfterTaxExemptForAccount(driver, test_steps, taxLedgerAccount, taxName);
	...
	public Object[][] getData() {
		return Utility.getData("TaxExemptInDepositAmountInRes", SNExcel);
