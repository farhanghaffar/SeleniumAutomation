...
public class ReportsV2ReservationCardReportForPrevStay  extends TestCore  {
	...
	public void reportsV2ReservationCardReportForLongStayRes(String TestCaseID, String Scenario, String dateRange, 
		...
		try {
			...
			reservationDetails=reservationV2Page.createReservation_WithDetails(driver, test_steps, sourceOfRes, checkInDate2, checkOutDate2, adults, 
					...
					"", "", "", "", "", "", "", "", 
					"", "", "", "", "", "", false, "1235","",true,false);			
			reservationV2Page.closeAllOpenedReservations(driver);
			copiedReservationDetails=reservationV2Page.createReservation_WithGuestProfile(driver, test_steps, checkInDate, checkOutDate, adults, children, ratePlan, 
		...
		try {
			...
			String reservationNumber_CopiedRes="";
			reservationNumber_CopiedRes=copiedReservationDetails.get("ReservationNumber");
			String reservation_Status_copied=null;
			reservation_Status_copied=copiedReservationDetails.get("ReservationStatus");	
			app_logs.info("reservationNumber_CopiedRes: "+reservationNumber_CopiedRes);
			app_logs.info("reservation_Status_copied: "+reservation_Status_copied);			
			String roomNumber_CopiedRes=copiedReservationDetails.get("RoomNumber");
			app_logs.info("roomNumber_CopiedRes: "+roomNumber_CopiedRes);		
			...
			roomChargesTotal=Double.parseDouble(roomChargePerNight)*Integer.parseInt(noOfNight);
			...
			categoryTaxs.add(taxType);			
			 ...
			 double expectedFee=Double.parseDouble(feeValue)*Integer.parseInt(noOfNight);
		...
		app_logs.info("TripSummary details: "+ledgerAmounts);
			...
			reservation_Status_copied="In-House";		
			...
			report.verifyCardViewDetails( driver, reservationNumber_CopiedRes,reservation_Status_copied,guestFullName2 ,adults,children, roomClass, roomNumber_CopiedRes, ratePlan,
				 ...
				 referral, "MC",cardLastFourNumber,cardExpDate, test_steps,checkInDate,checkOutDate,accountName,accountType,"1",true);
	...
	public Object[][] getData() {	
		return Utility.getData("ReportForPrevStay", excelReservationV2);
	}
