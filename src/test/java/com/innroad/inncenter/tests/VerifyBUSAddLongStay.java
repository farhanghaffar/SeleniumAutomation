...
public class VerifyBUSAddLongStay extends TestCore{
	...
	public void verifyBUSChangeStayDetails(String version, String roomClassName, String channel, String message,
		...
		String testName = "Verify BUS Add Long Stay";
		String startDate = null, endDate = null,  confirmationNo = null, expiryDate = null,
				startDate1 = null, endDate1 = null, advertiserId = null, classId = null, currency = null,propertyId = null,
						phoneCode = null, phoneNumberVrbo = null, totalAmount=null, roomCharges=null,
								getAddress1 = null, getAddress2 = null, getAddress3 = null, getAaddress4 = null,countryName=null, property=null;
		int nightsDays=3;
		...
		try {
			...
			testSteps.add("<b>===== Enable Longer Stay Option =====</b>");
			app_logs.info("===== Enable Longer Stay Option =====");
			...
			if (!Utility.validateString(noOfNights)) {
				properties.LongStay(driver,  String.valueOf(nightsDays-1), testSteps,true, true, false);
		
			}else {			
			properties.LongStay(driver, String.valueOf(Integer.parseInt(noOfNights)-1), testSteps,true, true, false);
			}			
		...
		try {
			testSteps.add("====================UPDATE LONG STAY======================");
			...
			reservation.longStayCheckbox(driver, testSteps, true);
			reservation.clickSaveButtonAfterEditPaymentMethods(driver, testSteps);
			reservation.clicksetExemptanyWay(driver, testSteps);
			
		}catch (Exception e) {
			e.printStackTrace();
			Utility.catchException(driver,e, test_description, test_catagory, "Update long stay in reservation", testName, test_description,
					test_catagory, testSteps);

		} catch (Error e) {
			e.printStackTrace();
			Utility.catchError(driver,e, test_description, test_catagory, "Update long stay in reservation", testName, test_description,
					test_catagory, testSteps);
		}
		...
		try {
			...
			vrboObject.validateBookingUpdateXML(response, advertiserId, classId, classId, confirmationNo, "en_US",
					...
					getAddress2, getAddress3, countryName, getAaddress4, postalCode, adult, child, SDate, EDate,SDate,
					 resStatus, tripTotal, true,dueDates,testSteps);
		}catch (Exception e) {
			e.printStackTrace();
		...
		try {
			...
			testSteps.add("<b>===== Disable Longer Stay Option =====</b>");
			app_logs.info("===== Disable Longer Stay Option =====");
			navigation.properties(driver);
			navigation.openProperty(driver, testSteps, property);
			navigation.clickPropertyOptions(driver, testSteps);
			properties.LongStay(driver,"", testSteps,false, false, false);
			properties.PublishButton(driver);
	...
	public Object[][] getDataOne() {
		...
		return Utility.getData("BUSAddLongStay", otaexcel);
