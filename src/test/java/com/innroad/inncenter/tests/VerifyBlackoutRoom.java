...
public class VerifyBlackoutRoom extends TestCore {
	...
	public void verifyBlackoutRoom(String Url, String ClientCode, String UserName, String Password, String Blackout,
		...
		try {
			...
			roomClass.deleteRoomClassIfExist(driver, test_steps, "BlockOutRoom");
			...
			*/
			...
			roomClass.createRoomClassV2(driver, test_steps, RoomClassName, RoomClassAbbreviation, maxAdults, maxPersopns, roomQuantity);
...
//			navigation.Reservation_Backward_1(driver);
	...
	public Object[][] getData() {
		...
		return Utility.getData("VerifyBlackoutRoom", envLoginExcel);
	}
