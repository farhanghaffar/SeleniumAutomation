...
public class VerifyTaxesInCPReservation extends TestCore {
	...
	public void verifyCpReservationWithTaxes(String TestCaseID,
            ...
            String ratename, String baseAmount, String additionalAdult, String additionalChild) throws Exception {
...
/*			res.select_CheckInDate(driver, test_steps, CheckInDate);
	...
	public Object[][] getData() {
		...
		return Utility.getData("VerifyTaxesInCPReservation", envLoginExcel);
	}
