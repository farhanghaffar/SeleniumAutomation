...
public class Verify_AddPostRollBackVoid_FolioLineItems extends TestCore{
	...
	public void verify_AddPostRollBackCoid_FolioLineItems(String TestCaseID ,String url, String ClientCode, String Username, String Password,String PropertyName,String CheckInDate,String CheckOutDate,String Adults,String Children,String Rateplan,String PromoCode,String IsSplitRes,
			...
			String LineItemCategory,String LineItemCategoryAmount) throws ParseException, Exception {
		
		boolean isExecutable=Utility.getResultForCase(driver, TestCaseID);
		if(isExecutable) {

		test_name = "Verify_AddPostRollBackVoid_FolioLineItems";
		test_description = "Verify_AddPostRollBackVoid_FolioLineItems <br>"
				+ "<a href='https://innroad.testrail.io/index.php?/cases/view/682410' target='_blank'>"
				+ "Click here to open TestRail: 682410</a>";
		test_catagory = "Verify_AddPostRollBackVoid_FolioLineItems";
		...
		//String TestCaseID="848164|848750";	
		...
		try {
			...
			res.selectFolioOptionByIndex(driver, "2");
	...
	public Object[][] getData() {
		...
		return Utility.getData("Verify_AddPostRollBackVoid", SanityExcel);
	}
