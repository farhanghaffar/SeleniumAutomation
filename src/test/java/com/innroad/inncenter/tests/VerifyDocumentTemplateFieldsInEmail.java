...
public class VerifyDocumentTemplateFieldsInEmail extends TestCore {
	...
	public void verifyDocumentTemplateFieldsInEmail(String url, String ClientCode, String Username, String Password,
			...
			String IsSplitRes, String RoomClass,String RoomClassAbbrivations, String IsAssign, String IsDepositOverride,
...
//			boolean isRoomClassAvailable = rc.searchRoomClassV2(driver, RoomClass);
//			RoomAbbri = rc.getAbbrivation(driver, "\\|", RoomClass, test_steps);
...
//			System.out.println(RoomAbbri);
	...
	public Object[][] getData() {
		...
		return Utility.getData("DocumentTemplateFieldsInEmail", HS_EXCEL);
	}
