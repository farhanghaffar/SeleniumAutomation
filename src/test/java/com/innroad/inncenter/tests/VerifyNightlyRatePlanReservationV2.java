...
public class VerifyNightlyRatePlanReservationV2 extends TestCore {
...
//			res.click_NewReservation(driver, test_steps);
			...
			if (ReservationType.contains("single")) {
				...
				HashMap<String, ReservationRatesDetail> obj = res.getFullRatesDetail_Creation(driver, test_steps,
						ReservationRoomClasses, CheckInDate, CheckOutDate, adult, children, RatePlanName, "");
				app_logs.info(obj);
...
//				app_logs.info("test : " + rateIs.get("15/04/2021"));
	...
	public Object[][] getData() {
		...
		return Utility.getData("VerifyNightlyRatePlanResV2", envLoginExcel);
	}
