...
public class VerifyAbleToCreateGroupReservationWithBlueBookIcon extends TestCore {
	...
	public void verifyAbleToCreateGroupReservationWithBlueBookIcon(String TestCaseID, String rateName, String baseAmount,
			...
			String blueBookClass) throws Exception {
		...
		try {
			...
			comments = " Created reservation from blue book icon with number (" + reservationNumber + ")";
			statusCode.add(0, "1");
	...
	public Object[][] getData() {
		...
		return Utility.getData("CreateResFromBlueIcon", envLoginExcel);
	}
