...
public class VerifyGroupAccountFolioByMakingPayments extends TestCore {
	...
	//		getTest_Steps = res.verifyAccountAttached(driver, AccountName);
		...
		try {
			...
			getTest_Steps = folio.verifyFolioItemsAmount(driver, Total, afterAccAdd, PayAmount, groupNameAndAccount.get("GroupName"));
			test_steps.addAll(getTest_Steps);
	...
	public Object[][] getData() {
		...
		return Utility.getData("VerifyGrpAccFolioByMakingPay", envLoginExcel);
	}
