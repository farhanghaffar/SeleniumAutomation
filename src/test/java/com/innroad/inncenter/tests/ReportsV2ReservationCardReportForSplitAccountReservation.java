...
public class ReportsV2ReservationCardReportForSplitAccountReservation extends TestCore{
	...
	public void reportsV2ReservationCardReportForLongStayRes(String TestCaseID, String Scenario, String dateRange, 
		...
		String accountName="TEST_XXX_UnitOwnerAcc";
		String accountType="Unit Owners";
		//tax
	...
	public Object[][] getData() {
		...
		return Utility.getData("Split_Account_Res", excelReservationV2);
	}
