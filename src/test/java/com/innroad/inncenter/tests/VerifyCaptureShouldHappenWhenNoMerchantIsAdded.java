...
public class VerifyCaptureShouldHappenWhenNoMerchantIsAdded extends TestCore {
	...
	public void verifyCaptureShouldHappenWhenNoMerchantIsAdded( String TestCaseId, String TestCaseName,String checkInDate,
			String checkOutDate, String adults, String children, String rateplan, String roomClass, String rate,
			String salutation, String guestFirstName, String guestLastName,String paymentMethod, String cardNumber,
			String nameOnCard, String marketSegment, String referral, String amount) throws Exception {
		...
		try {
			...
			data = res.createReservation(driver, test_steps, "From Reservations page", checkInDate, checkOutDate,
					...
					"", "", "", "", "", "", "", "", false, marketSegment, referral, "", "", nameOnCard,
					yearDate, 0, "", false, "", "", "", "", "", "", "", "", "", "", "", "", "", "", false, "");
			reservationNo = data.get("ReservationNumber");
			reservationPage.closeReservationTab(driver);
			 res.createReservation(driver, test_steps, "From Reservations page", checkInDate, checkOutDate,
					adults, children, rateplan, "", roomClass, "", salutation, guestFirstName, guestLastName, "", "",
					"", "", "", "", "", "", "", "", false, marketSegment, referral, "", "", nameOnCard,
					yearDate, 0, "", false, "", "", "", "", "", "", "", "", "", "", "", "", "", "", false, "");
		...
		try{
			...
			for(int i=0;i<3;i++) 
			{
				...
				folioNew.makePayment(driver, test_steps, amount,paymentMethods[i], reservationNo, "", "", "", "", "");
	...
	public Object[][] getData() {
		return Utility.getData("VerifyCaptureWithoutGateway", SNExcel);
	}
