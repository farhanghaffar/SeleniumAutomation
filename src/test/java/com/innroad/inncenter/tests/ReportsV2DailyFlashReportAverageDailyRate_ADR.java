...
public class ReportsV2DailyFlashReportAverageDailyRate_ADR  extends TestCore {
...
//			}
		...
		try {
			if(!TestCaseID.equalsIgnoreCase("849333"))
			{
	...
	public Object[][] getData() {
		...
		return Utility.getData("DailyFlashAverageDailyRate_ADR", excelReservationV2);
	}
