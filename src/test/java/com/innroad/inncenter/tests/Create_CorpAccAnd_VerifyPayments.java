...
public class Create_CorpAccAnd_VerifyPayments extends TestCore{
	...
	public void create_CorpAccAnd_VerifyPayments(String TestCaseID,String url, String ClientCode, String Username, String Password,String PropertyName,String CheckInDate,String CheckOutDate,String Adults,String Children,String Rateplan,String PromoCode,String IsSplitRes,
			...
			String AccountName,String Accounttype,String TakePaymentType,String LineItemCategory,String LineItemCategoryAmount) throws ParseException, Exception {
		...
		app_logs.info("##################################################################################");
		//String TestCaseID="848107|848112|848122|848183|848296|848118";
		...
		try {
			...
			app_logs.info("****************** verifying payment in account *********************");
				...
				comments="created corporate account and verified payment of a reservation with corp account and that payment verified in account folio";
	...
	public Object[][] getData() {
		...
		return Utility.getData("Create_CorpAccAnd_VerifyPayment", SNExcel);
	}
