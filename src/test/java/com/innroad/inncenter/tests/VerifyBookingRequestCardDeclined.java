...
public class VerifyBookingRequestCardDeclined extends TestCore{
	...
	public void bookingRequestRejection(String beginDate, String noOfNights, String originationDate,
		...
		try {
			...
			testName = "Verify Booking Request Card declined ";
			app_logs.info("##################################################################################");
			...
			Utility.catchException(driver, e, test_description, test_catagory, "Get Data", testName,
		...
		if(!response.get("BODY").contains("SERVER_ERROR") && response.get("StatusCode").equals("200")) {
			...
			String errorType="BILLING_ERROR_CC_DECLINED";
		...
		Utility.AddTest_IntoReport(testName, test_description, test_catagory, testSteps);
			...
			Utility.catchException(driver, e, test_description, test_catagory, "Get Request", testName,
					test_description, test_catagory, testSteps);

		} catch (Error e) {
			Utility.catchError(driver, e, test_description, test_catagory, "Get Request", testName,
					test_description, test_catagory, testSteps);
		}
	...
	public Object[][] getData() {
		...
		return Utility.getData("Carddeclined", otaexcel);
	}
