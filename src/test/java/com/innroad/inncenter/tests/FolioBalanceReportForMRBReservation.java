...
public class FolioBalanceReportForMRBReservation extends TestCore {
	...
	public void folioBalanceReportForSplitReservation(String TestCaseID, String Scenario, String effectiveDate, 
		...
		app_logs.info("==========Verify Testcase id:849126==========");	
		test_steps.add("==========Verify Testcase id:849126==========");		
		...
		report.validateFoliobalanceReportSummaryView(driver, beforeRecivableBalance, afterRecivableBalance, beforePayableBalance, afterPayableBalance,
				reservationType,  String.format("%.2f",folioBalance*2),beforeNetTotal,afterNetTotal,false,true, test_steps);		
       Wait.wait10Second();		
	...
	public Object[][] getData() {
		...
		return Utility.getData("FolioBalanceReportForMRBRes", excelReservationV2);
	}
