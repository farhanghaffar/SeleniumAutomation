...
public class ReportsV2TransactionsReportCancelRefundAuthRev_NegativeAmount  extends TestCore   {
	...
	public void validateLedgerBalancesReport(String TestCaseID, String Scenario, String dateRange, 
		...
		try {
				...
				test_steps.add("**************<b>DO TRANSACTION TYPE REFUND FROM FOLIO TAB </b>**************");
				...
				test_steps.add("**************<b>DO TRANSACTION TYPE AUTH  FROM FOLIO TAB </b>**************");
				...
				test_steps.add("**************<b>DO TRANSACTION TYPE AUTH REVERSAL FROM FOLIO TAB </b>**************");
					guestFolio.cancelPaymentPopUp(driver, test_steps,PaymentTransactionType);
					Wait.wait5Second();
					
				test_steps.add("**************<b>DO TRANSACTION TYPE CAPTURE FROM FOLIO TAB </b>**************");
				...
				test_steps.add("**************<b>DO CANCELLATION OF CAPTURED TRANSACTION FROM FOLIO TAB </b>**************");
				...
				test_steps.add("**************<b> VERIFYING NEGATIVE VALUE FOR TRANSACTION TYPE REFUND,CANCEL AND AUTHREVERSAL  </b>**************");
				report.validateReservationAddedToDetailedViewForTransactionReport_ColorCode(driver, test_steps, checkInDate, guestFullName, reservationNumber, paymentMethod);
	...
	public Object[][] getData() {
		...
		return Utility.getData("CancelRefundAuthRev", excelReservationV2);
	}
