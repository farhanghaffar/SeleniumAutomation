...
public class ReservationCardReportOrderbyArrivalDate extends TestCore {
	...
	public void reservationCardReportOrderbyArrivalDate(String TestCaseID, String Scenario, String dateRange, 
		...
		try {
		  ...
		  Wait.wait5Second();
			ReservationStatusBar resBar=reservationV2Page.getStatusBarDetail(driver);
			reservation_Status=resBar.getSB_RESERVATION_STATUS();
			app_logs.info("reservation_Status: "+reservation_Status);
			...
			includeReservationTypes="In-House";
			onlyIncludeReservationsWith="None";
			sortReservationsBy="Arrival Date and Time";
			...
			app_logs.info("==========Verify Reservationcard report for status of reservation==========");				
			report.verifyReservationCardReport_ReservationType(driver, test_steps, reservation_Status,includeReservationTypes);
