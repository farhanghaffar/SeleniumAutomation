...
public class VerifyRatesCombinationMessageInReservationV2 extends TestCore {
	...
	public void verifyRatesCombinationMessageInReservationV2(String TestCaseId, String TestCaseName, String RatePlanName,
...
//		}
		...
		try {
			...
			nightlyRate.blockoutSeason(driver, getTest_Steps, startSeasonDate, endSeasonDate);
...
//			reservationPage.select_CheckInDate(driver, test_steps, startSeasonDate);
//			reservationPage.select_CheckoutDate(driver, test_steps, endSeasonDate);
...
//					accountFirstName, accountLastName, isTaxExempt, taxExemptID);
		...
		try {
			...
			rateGrid.clickOnEditRatePlan(driver);
			nightlyRate.switchCalendarTab(driver, test_steps);
			nightlyRate.createSeason(driver, test_steps, CheckInDate+","+CheckOutDate, CheckOutDate, SeasonName, isMonDay, isTueDay,
...
FindRoomDetail findRoomDetail = res.getFindRooDetail(driver, RatePlanName, roomClassName, test_steps);
			...
			res.verifyRoomClassDetail(findRoomDetail, roomClassName, true, true, RatePlanName, true, true, "rooms", false, false, "", false, false, test_steps);
	...
	public Object[][] getData() {
		...
		return Utility.getData("VerifyRatesCombinationMsgIResV2", HS_EXCEL);
	}
