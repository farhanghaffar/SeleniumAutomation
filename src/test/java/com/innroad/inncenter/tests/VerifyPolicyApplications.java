...
public class VerifyPolicyApplications extends TestCore {
	...
	public void verifyFolioActions(String TestCaseID,String caseName, String displayName, String Policy_T,String ratePlan,
			
			String source,String firstName,String lastName,String roomChargePercentage , String roomCharge,
			
			 String IsAssign, String isChecked, String checkInPolicType,String checkInPolicyName,String cancelationPolicyName,
			 
			 String paymentType, String cardNumber, String nameOnCard,String cardExpDate, String policyAttr2,
			 
			 String policyAttrValue2,String Action,String PolicyApplicable, String mRBReservation,String CheckInDate,
			 
			 String CheckOutDate,String Adults,String Children,String Rateplan,String PromoCode,
			 
			 String IsSplitRes,String RoomClass,String IsDepositOverride,String DepositOverrideAmount,String IsAddMoreGuestInfo,
			 
			 String Salutation,String GuestFirstName,String GuestLastName,String PhoneNumber,String AltenativePhone,
			 
			 String Email,String Account,String AccountType,String Address1,String Address2,
			 
			 String Address3,String City,String Country,String State,String PostalCode,
			 
			 String IsGuesProfile,String TravelAgent,String MarketSegment,String Referral,String Description,
...
//		comments = "Verified policies through bulk actions";
	...
	public Object[][] getData() {
		...
		return Utility.getData("folioaction", envLoginExcel);
	}
