...
public class ReportsV2DailyFlashReportRevenueType extends TestCore {
...
//					reservationPage.rollBackReservation(driver, test_steps, guestFullName, "RESERVED");
		...
		try {
			...
			if (!ledgerAccount.isEmpty()) {
				...
				report.validateDailyFlashReportRevenueTypes_RV2(driver, beforeRevenueDetails, afterRevenueDetails, ledgerAccounts, ledgerAmounts, folioItemValues, noOfRooms, test_steps);
	...
	public Object[][] getData() {
		...
		return Utility.getData("ReportsV2DailyFlashReportRevenu", excelReservationV2);
	}
