...
public class ReportsV2TransactionsReportCreditCardTotal extends TestCore {
...
//					reservationPage.rollBackReservation(driver, test_steps, guestFullName, "RESERVED");
		...
		try {
			...
			test_steps.add("After Summary view: "+summaryViewReportAfterAction);
	...
	public Object[][] getData() {
		...
		return Utility.getData("TransactionsRepCreditCardTotal", excelReservationV2);
	}
