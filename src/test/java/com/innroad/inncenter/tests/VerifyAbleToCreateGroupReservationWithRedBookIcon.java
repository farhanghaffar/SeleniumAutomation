...
public class VerifyAbleToCreateGroupReservationWithRedBookIcon extends TestCore {
	...
	public void verifyAbleToCreateGroupReservationWithRedBookIcon(String TestCaseID, String rateName, String baseAmount,
		...
		try {
			...
			testSteps.addAll(getTestSteps);
			comments = " Created reservation from red book icon with number (" + reservationNumber + ")";
			statusCode.add(0, "1");
			RetryFailedTestCases.count = Utility.reset_count;
			Utility.AddTest_IntoReport(ScriptName, TestDescription, TestCategory, testSteps);
		} catch (Exception e) {
	...
	public Object[][] getData() {
		...
		return Utility.getData("CreateResFromRedIcon", envLoginExcel);
	}
