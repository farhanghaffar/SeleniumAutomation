...
public class VerifyReportsGeneratedIncludeFolioOptions extends TestCore{
	...
	public void verifyReportsGeneratedIncludeFolioOptions(String TestCaseID, String adults,String children,String ratePlan,String promoCode,
		...
		try{			
			...
			comments = " Created reservation with number (" + reservationNumber + "). Verified that reports inlcude folio options";
			statusCode.add(0, "1");
			RetryFailedTestCases.count = Utility.reset_count;
			Utility.AddTest_IntoReport(testName, testDescription, testCategory, test_steps);
	...
	public Object[][] getData() {
		...
		return Utility.getData("ReportsGeneratedIncludeFolio", envLoginExcel);
	}
