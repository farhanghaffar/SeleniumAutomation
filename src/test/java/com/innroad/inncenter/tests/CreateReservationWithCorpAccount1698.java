...
public class CreateReservationWithCorpAccount1698 extends TestCore{
	...
	public void createReservationWithCorpAccount1698(String url, String clientCode, String username, String password,String propertyName,String adult,String children,String rateplan,String promoCode,String isSplitRes,
		...
		String testName = "CreateReservationWithCorpAccount1698";
		...
		try {
			...
			getTestSteps.clear();
			getTestSteps = reservationPage.clickBookNow(driver, testSteps);
			testSteps.addAll(getTestSteps);
	...
	public Object[][] getData() {
		...
		return Utility.getData("CreateResWithCorpAcc1698", envLoginExcel);
	}
