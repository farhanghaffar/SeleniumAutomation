...
public class ReportsV2DailyFlashReportNetChangeInGuestLedger extends TestCore {
...
//			}
		...
		try {
				...
				report.validateDailyFlashReportNetChangess_RV2(driver, beforeNetChangesDetails, afterNetChangesDetails, "Net Change In Guest Ledger", ledgerAmounts, noOfRooms, outBoundAmount, test_steps);
	...
	public Object[][] getData() {
		...
		return Utility.getData("ReportNetChangeInGuestLedger", excelReservationV2);
	}
