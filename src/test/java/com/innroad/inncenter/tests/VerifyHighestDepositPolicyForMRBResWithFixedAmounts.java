...
public class VerifyHighestDepositPolicyForMRBResWithFixedAmounts extends TestCore{
	...
	public void verifyHighestDepositPolicyForMRBResWithFixedAmounts(String roomClassName, String roomClassAbb, String maxAdults, 
		...
		try {
			...
			roomClass.createRoomClassV2(driver, test_steps, roomClassName1, roomClassAbb1, maxAdults, maxPersons, roomQuantity);
			roomNumberAssigned.add(Utility.RoomNo);
			roomClass.closeRoomClassTabV2(driver, roomClassName1);
			...
			roomClass.createRoomClassV2(driver, test_steps, roomClassName2, roomClassAbb2, maxAdults, maxPersons, roomQuantity);
			roomNumberAssigned.add(Utility.RoomNo);
			roomClass.closeRoomClassTabV2(driver, roomClassName2);
...
//			depositAmount=reservationPage.deposit(driver, test_steps, "", "");		
		...
		try {
			...
			folio.verifyLineItemIcon(driver, test_steps, paymentMethod,
	...
	public Object[][] getData() {
		return Utility.getData("verifyFADepositPolicyMRB", envLoginExcel);
	}
