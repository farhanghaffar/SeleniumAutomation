...
public class VerifyReservationInAdvanceGroup extends TestCore {
	...
	public void verifyReservationInAdvanceGroup(String url, String clientcode, String username, String password,
			...
			String RoomClassName, String PayAmount,String checkInDate, String checkOutDate,String adults, String children, String rateplan, String Salutation, String CardNumber, String NameOnCard, String PaymentType, String PayType,
			String isGroupPolicyApplicable, String reservationType) throws InterruptedException, IOException {
		...
		try {
			...
			String expiryDate=Utility.getFutureMonthAndYearForMasterCard();
			  ...
			  reservationPage.selectRoom1(driver, test_steps, RoomClassName, "Yes",AccountName);
			  
			  
			  reservationPage.clickNext(driver, test_steps);
			  
			  reservationPage.enter_MailingAddress_OnUnchecked_CreateGuestProfile(driver,
			  test_steps, Salutation, AccountFirstName, AccountLastName,
			...
			//reservationPage.createGroupReservation(driver, test_steps, RoomClassName, config.getProperty("flagOn"),"",Salutation, AccountFirstName, AccountLastName, config.getProperty("flagOff"),PaymentType, CardNumber, NameOnCard, expiryDate, isGroupPolicyApplicable,  reservationType, rooms, resNo);
		...
		try {
			test_steps.add("============Verifying Folio balance and make paymnet advance============");
			app_logs.info("=============Verifying Folio balance and make paymnet advance=============");
			double Total = 0;
			try {
		...
		try {
			test_steps.add("============Navigate to Groups Folio============");
			app_logs.info("=============Navigate to Groups Folio=============");
			getTest_Steps.clear();
			...
			getTest_Steps.clear();
			test_steps.add("============Verifying line items from Groups Folio============");
			app_logs.info("=============Verifying line items from Groups Folio=============");
	...
	public Object[][] getData() {
		...
		return Utility.getData("VerifyReservationInAdvanceGroup", envLoginExcel);
	}
