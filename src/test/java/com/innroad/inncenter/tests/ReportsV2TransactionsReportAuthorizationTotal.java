...
public class ReportsV2TransactionsReportAuthorizationTotal  extends TestCore  {
...
//	CPReservationPage reservationPage = new CPReservationPage();
	...
	public void validateLedgerBalancesReport(String TestCaseID, String Scenario, String dateRange, String dateEffective, 
		...
		try {
			...
			app_logs.info("beforeCreditCardTransactionTypeTotal: "+beforeCreditCardTransactionTypeTotal);
			test_steps.add("beforeCreditCardTransactionTypeTotal: "+beforeCreditCardTransactionTypeTotal);
...
//					reservationPage.rollBackReservation(driver, test_steps, guestFullName, "RESERVED");
		...
		try {
			...
			app_logs.info("afterCreditCardTransactionTypeTotal: "+afterCreditCardTransactionTypeTotal);
			test_steps.add("afterCreditCardTransactionTypeTotal: "+afterCreditCardTransactionTypeTotal);
	...
	public Object[][] getData() {
		...
		return Utility.getData("TransactionsAuthorizationTotal", excelReservationV2);
	}
