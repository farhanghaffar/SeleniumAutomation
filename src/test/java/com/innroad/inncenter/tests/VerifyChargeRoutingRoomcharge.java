...
public class VerifyChargeRoutingRoomcharge extends TestCore{
	...
	public void verifyChargeRoutingRoomcharge(String TestCaseID,String url, String ClientCode, String Username, String Password,
		...
		try{
			...
			test_steps.add("Select charge routing as"+chargeRoutingType);
			account.Save(driver);
		...
		try {
			...
			roomCost=cpReservation.select_MRBRooms(driver, test_steps, RoomClass, IsAssign,Accounttype);
	...
	public Object[][] getData() {
		...
		return Utility.getData("VerifyChargeRoutingRoomcharge", SNExcel);
	}
