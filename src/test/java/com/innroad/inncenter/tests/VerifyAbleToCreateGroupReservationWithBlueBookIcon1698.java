...
public class VerifyAbleToCreateGroupReservationWithBlueBookIcon1698 extends TestCore {
	...
	public void verifyAbleToCreateGroupReservationWithBlueBookIcon1698(String ratePlanName, String baseAmount,
		...
		String testName = "VerifyAbleToCreateGroupReservationWithBlueBookIcon1698";
		testDescription = "Desktop : Advanced group : Verify able to create group reservation with Blue Book icon.<br>";
		testCategory = "Groups";
	...
	public Object[][] getData() {
		...
		return Utility.getData("CreateResFromBlueIcon1698", envLoginExcel);
	}
