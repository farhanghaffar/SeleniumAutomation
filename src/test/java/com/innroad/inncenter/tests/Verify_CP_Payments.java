...
public class Verify_CP_Payments extends TestCore{
	...
	public void Verify_CP_Payments(String TestCaseID,String url, String ClientCode, String Username, String Password,String PropertyName,String CheckInDate,String CheckOutDate,String Adults,String Children,String Rateplan,String PromoCode,
	...
	@AfterMethod
	public void updateTestRail() {
		/*if(flag) {
			statusCode.set(0, "1");
			statusCode.set(1, "1");
		}*/
		
		Utility.updateTestCase(driver, caseId, statusCode, comments,TestCore.TestRail_AssignToID);
	}
	...
	public Object[][] getData() {
		...
		return Utility.getData("CP_Reservation_Payments", SanityExcel);
	}
