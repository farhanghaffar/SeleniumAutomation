...
public class VerifyCopyOfGroupNotesToSplitedCopiedReservation  extends TestCore {
	...
	public void verifyCopyOfGroupNotesToSplitedCopiedReservation(String TestCaseID, String rateName, String baseAmount,
		...
		String testcaseId="848626";
		
	    Utility.initializeTestCase(testcaseId, caseId, statusCode, comments, "825287");
	
	    test_description = testName + "<br>"
			+ "<a href='https://innroad.testrail.io/index.php?/cases/view/825287' target='_blank'>"
			+ "Click here to open TestRail: C825287</a><br>";
		...
		try {
			...
			String checkInDate_ = Utility.getCurrentDate("MM/dd/yyyy");
			String checkoutDate_ = Utility.GetNextDate(1, "MM/dd/yyyy");
			reservationPage.enterDate(driver, "start", checkInDate_, "1");
			testSteps.add("Select First Room CheckIn Date : " + checkInDate_);
			app_logs.info("Select First Room CheckIn Date : " + checkInDate_);
			reservationPage.enterDate(driver, "end", checkoutDate_, "1");
			testSteps.add("Select First Room CheckOut Date : " + checkoutDate_);
			app_logs.info("Select First Room CheckOut Date : " + checkoutDate_);

			checkInDate_ = Utility.GetNextDate(1, "MM/dd/yyyy");
			checkoutDate_ = Utility.GetNextDate(2, "MM/dd/yyyy");
			reservationPage.enterDate(driver, "start", checkInDate_, "2");
			testSteps.add("Select Second Room CheckIn Date : " + checkInDate_);
			app_logs.info("Select Second Room CheckIn Date : " + checkInDate_);
			reservationPage.enterDate(driver, "end", checkoutDate_, "2");
			testSteps.add("Select Second Room CheckOut Date : " + checkoutDate_);
			app_logs.info("Select Second Room CheckOut Date : " + checkoutDate_);
			...
			getTestSteps.clear();
			getTestSteps = reservationPage.enter_Children(driver, getTestSteps, child);
			testSteps.addAll(getTestSteps);
			...
			reservationPage.enter_PaymentDetails(driver, getTestSteps, paymentMethod, cardNumber,guestFirstName, cardExpDate);
			...
			getTestSteps=reservationPage.verifyNotesCopiedOrNot(driver,getTestSteps,NoteType, Subject, Description,true);
		...
		try {
			...
			statusCode.set(0, "1");
			comments.add(0, "Group account notes details are showing in copied reservation");
	...
	public Object[][] getData() {
		...
		return Utility.getData("CopyOfGRPNotesToSplitedRes", excel_Swarna);
	}
