...
public class CreateReservationWithTravelAgentAccount1698 extends TestCore{
	...
	public void createReservationWithTravelAgentAccount1698(String url, String clientCode, String username, String password,String propertyName,String adults,String children,String rateplan,String promoCode,String isSplitRes,
		...
		String testName = "CreateReservationWithTravelAgentAccount1698";
		testDescription = "Create Reservation From Travel Agent Account <br>";
		...
		try {
			...
			if (Utility.reTry.get(ScriptName) == Utility.count) {
				RetryFailedTestCases.count = Utility.reset_count;
				Utility.AddTest_IntoReport(ScriptName, TestDescription, TestCategory, testSteps);
				Utility.updateReport(e, "Failed to create travel agent account", testName, "TravelAccount", driver);
			} else {
				Assert.assertTrue(false);
			}
	...
	public Object[][] getData() {
		...
		return Utility.getData("CreateResWithTravelAgentAcc1698", envLoginExcel);
	}
