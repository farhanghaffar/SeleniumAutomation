...
public class ReportsV2DailyFlashReportValidationReservationV2 extends TestCore {
...
//			try {
				...
				if (!Incidentals.isEmpty()) {
					...
					folioNew.addFolioLineItem(driver, test_steps, Incidentals, "10");
...
//			}
		...
		try {
			...
			if (!ledgerAccount.isEmpty()) {
				...
				report.validateDailyFlashReportRevenueTypes(driver, beforeRevenueDetails, afterRevenueDetails, ledgerAccounts, ledgerAmounts, folioItemValues, noOfRooms, test_steps);
		...
		try {
			...
			if (isPayment.equalsIgnoreCase("Yes")) {
				...
				report.validateDailyFlashReportPaymentsMethodTypes(driver, paymentMethod, beforePaymentDetails, afterPaymentDetails, ledgerAccounts, ledgerAmounts, folioItemValues, noOfRooms, test_steps);
		...
		try {
			...
			if (guestStatus.isEmpty()) {
				...
				if (resType.isEmpty()) {
					report.validateDailyFlashReportNetChangess(driver, beforeNetChangesDetails, afterNetChangesDetails, "Net Change In City Ledger", folioBalances, noOfRooms, outBoundAmount, test_steps);

				}else {
					report.validateDailyFlashReportNetChangess(driver, beforeNetChangesDetails, afterNetChangesDetails, "Net Change In Guest Ledger", ledgerAmounts, noOfRooms, outBoundAmount, test_steps);

				}
				report.validateDailyFlashReportNetChangess(driver, beforeNetChangesDetails, afterNetChangesDetails, "Net Change In Advanced Deposits", folioBalances, noOfRooms, outBoundAmount, test_steps);
		...
		try {
			...
			report.validateDailyFlashReportGuestCount(driver, beforeGuestCountDetails, afterGuestCountDetails, roomCounts.get("Current In-House"), guestCounts.get("Current In-House"), adultCounts.get("Current In-House"), childCounts.get("Current In-House"), "Current In-House", test_steps);
			report.validateDailyFlashReportGuestCount(driver, beforeGuestCountDetails, afterGuestCountDetails, roomCounts.get("Expected Total Arrivals"), guestCounts.get("Expected Total Arrivals"), adultCounts.get("Expected Total Arrivals"), childCounts.get("Expected Total Arrivals"), "Expected Total Arrivals", test_steps);
			report.validateDailyFlashReportGuestCount(driver, beforeGuestCountDetails, afterGuestCountDetails, roomCounts.get("Pending Arrivals (To Be Checked In)"), guestCounts.get("Pending Arrivals (To Be Checked In)"), adultCounts.get("Pending Arrivals (To Be Checked In)"), childCounts.get("Pending Arrivals (To Be Checked In)"), "Pending Arrivals (To Be Checked In)", test_steps);
			report.validateDailyFlashReportGuestCount(driver, beforeGuestCountDetails, afterGuestCountDetails, roomCounts.get("Expected Total Departures"), guestCounts.get("Expected Total Departures"), adultCounts.get("Expected Total Departures"), childCounts.get("Expected Total Departures"), "Expected Total Departures", test_steps);
			report.validateDailyFlashReportGuestCount(driver, beforeGuestCountDetails, afterGuestCountDetails, roomCounts.get("Pending Departures (To Be Checked Out)"), guestCounts.get("Pending Departures (To Be Checked Out)"), adultCounts.get("Pending Departures (To Be Checked Out)"), childCounts.get("Pending Departures (To Be Checked Out)"), "Pending Departures (To Be Checked Out)", test_steps);
			report.validateDailyFlashReportGuestCount(driver, beforeGuestCountDetails, afterGuestCountDetails, roomCounts.get("Current Staying OverNight"), guestCounts.get("Current Staying OverNight"), adultCounts.get("Current Staying OverNight"), childCounts.get("Current Staying OverNight"), "Current Staying OverNight", test_steps);
			...
			report.validateDailyFlashReportPropertyStatistics(driver, beforePropertyStatisticsDetails, afterPropertyStatisticsDetails, "Total Room Nights", totalRooms, test_steps);
			report.validateDailyFlashReportPropertyStatistics(driver, beforePropertyStatisticsDetails, afterPropertyStatisticsDetails, "Out of Order Room Nights", oooRooms, test_steps);
			report.validateDailyFlashReportPropertyStatistics(driver, beforePropertyStatisticsDetails, afterPropertyStatisticsDetails, "Sold Room Nights", soldRooms, test_steps);
	...
	public Object[][] getData() {
		...
		return Utility.getData("DailyFlashReport", excelReservationV2);
	}
