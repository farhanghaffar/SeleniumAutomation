...
public class VerifyBilingInfoInRoomingListAndReservation extends TestCore {
	...
	public void verifyBilingInfoInRoomingListAndReservation(String TestCaseID,String AccountName, String MargetSegment, String Referral, String AccountFirstName,
...
//			test_steps.addAll(getTest_Steps);
	...
	public Object[][] getData() {
		...
		return Utility.getData("VerifyBillInfoRoomingListAndRes", envLoginExcel);
	} //
