...
public class ReportsV2DailyFlashReportPaymentMethodType extends TestCore {
...
//			}
		...
		try {
			...
			if (isPayment.equalsIgnoreCase("Yes")) {
				...
				report.validateDailyFlashReportPaymentsMethodTypes(driver, paymentMethod, beforePaymentDetails, afterPaymentDetails, ledgerAccounts, ledgerAmounts, folioPaymentItemValues, noOfRooms, test_steps);
	...
	public Object[][] getData() {
		...
		return Utility.getData("DailyFlashReportPaymentType", excelReservationV2);
	}
