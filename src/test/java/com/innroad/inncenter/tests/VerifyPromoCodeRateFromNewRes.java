...
public class VerifyPromoCodeRateFromNewRes extends TestCore{
	...
	public void verifyPromoCodeRateFromNewRes(String TestCaseID, String checkinDate, String checkoutdate, String roomClassName,
            ...
            String adult, String children, String actionPerformed) throws ParseException {
		...
		Utility.DELIM = delim;
		test_name = "VerifyPromoCodeRateFromNewRes" + actionPerformed;
		...
		try {
			...
			test_steps.add("=================== NAVIGATE TO NEW RESERVATION PAGE ======================");
			app_logs.info("=================== NAVIGATE TO NEW RESERVATION PAGE ======================");
			nav.Reservation_Backward_3(driver);
			cpRes.click_NewReservation(driver, test_steps);
			test_steps.add("Click at New Reservation Button: ");
			test_steps.add(
		...
		try {
			...
			statusCode.set(0, "1");
			comments.set(0,"Verify the search in new Reservation " + actionPerformed);
			RetryFailedTestCases.count = Utility.reset_count;
			Utility.AddTest_IntoReport(test_name, test_description, test_catagory, test_steps);
		} catch (Exception e) {
			e.printStackTrace();
	...
	public Object[][] getData() {
		...
		return Utility.getData("VerifyPromoCodeRateFromNewRes", envLoginExcel);
