...
public class ReportsV2TransactionsReportVisacardTotal  extends TestCore  {
...
//	CPReservationPage reservationPage = new CPReservationPage();
	...
	paymentMethod = "Masterrr", cardNumber = "5454545454545454", currency = null, clientTimeZone, dFormat, sourceOfRes="From Reservations page", propertyName, 
	...
	HashMap<String, ArrayList<String>> beforeCreditCardTransactionTypeTotal=new HashMap<>();
	HashMap<String, ArrayList<String>> afterCreditCardTransactionTypeTotal = new HashMap<>();
...
//					reservationPage.rollBackReservation(driver, test_steps, guestFullName, "RESERVED");
		...
		try {
			...
			app_logs.info("afterCreditCardTypeTotal: "+afterCreditCardTypeTotal);
			test_steps.add("afterCreditCardTypeTotal: "+afterCreditCardTypeTotal);
