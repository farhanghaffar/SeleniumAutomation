...
public class RatePlan_RoomClassVerification extends TestCore{
	...
	public void rateGridRoomClassVerification(String roomClassName, String roomClassAbb,String maxAdults, String maxPersons, String roomQuantity)
	{
		...
		// Login
				...
				try
				{
					...
					newRoomClass.createRoomClassV2(driver, testSteps, roomClassNameIs, roomClassAbbIs, maxAdults, maxPersons, roomQuantity);
				...
				try
				{
					...
					navigation.roomClass(driver);
					newRoomClass.searchRoomClassV2(driver, roomClassNameIs);
					testSteps.add("Click on Search Button");
					app_logs.info("Click on Search Button");
					newRoomClass.deleteRoomClassV2(driver, roomClassNameIs);
	...
	public Object[][] getData() {
		...
		return Utility.getData("RatePlanVerifyRoomClass", envLoginExcel);
