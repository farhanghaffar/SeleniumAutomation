...
public class CP_CreateReservationWithBestAvailableRateplan extends TestCore{
	...
	public void CP_CreateReservation(String TestCaseID,String url, String ClientCode, String Username, String Password,String CheckInDate,String CheckOutDate,String Adults,String Children,String Rateplan,String PromoCode,
		...
		if(isExecutable) {
		//TestCaseID="848262";
		Utility.initializeTestCase(TestCaseID, caseId, statusCode, statusCode,"848262");


		test_name = "CP Reservation Creation with Best available rate";
	...
	public Object[][] getData() {
		...
		return Utility.getData("CreateReservation_BestRatePlan",SanityExcel);
	}
