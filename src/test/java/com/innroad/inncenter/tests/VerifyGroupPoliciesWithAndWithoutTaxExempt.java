...
public class VerifyGroupPoliciesWithAndWithoutTaxExempt  extends TestCore{
	...
	public void verifyDepositCheckInAndCancellationPolicies(String TestCaseID,String policyType,String policyName,
		...
		//Login
				...
				try {
					...
					comments="Verified check in functionality when reservation is picked from group block and having multiple policies. ";
					app_logs.info("Verified check in functionality when reservation is picked from group block and having multiple policies.");	
					testSteps.add("Verified check in functionality when reservation is picked from group block and having multiple policies.");
					}catch (Exception e) {
				...
				try {
					...
					app_logs.info(cancelAmount);
						...
						comments=comments+"Verified  cancellation policy functionality for groupreservation";
						app_logs.info("Verified cancellation policy functionality for groupreservation");	
						testSteps.add("Verified cancellation policy functionality for groupreservation");
				...
				try {
					...
					/*comments= "Verified checkin policy view in group reservation"
							  +"Verified cancellation policy view in group reservation";
	...
	public Object[][] getData() {
		...
		return Utility.getData("VerifyPoliciesInGroup", BEExcel);
	}
