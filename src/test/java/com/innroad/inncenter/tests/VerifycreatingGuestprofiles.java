...
public class VerifycreatingGuestprofiles extends TestCore {
...
//	@BeforeTest(alwaysRun = true)
	...
	public void verifycreatingGuestprofiles(String testCaseID, String ratePlan, String roomClassName,
			String swipeCardString, String swipedCardNumber, String swipedCardName, String swipedCardExpiry)
			throws ParseException {
		test_name = "VerifycreatingGuestprofiles";
		test_description = "VerifycreatingGuestprofiles"
				+ "<a href='https://innroad.testrail.io/index.php?/cases/view/848375' target='_blank'>"
				+ "Click here to open TestRail: C848375</a><br>";
		...
		Wait.waitUntilPageIsLoaded(driver);
			...
			testSteps.add("===== <a href='https://innroad.testrail.io/index.php?/cases/view/824888' target='_blank'>"
					+ "<b>Verify creating Guest profiles while creating reservation with invalid payment initially.</b></a> =====");
			...
			guestHistory.searchWithFirstName(driver, guestProfileFirstName, testSteps);
			guestHistory.searchWithLastName(driver, guestProfileLastName, testSteps);

			homePage.getGuestProfile(driver, testSteps, guestProfileFirstName + " " + guestProfileLastName);
...
/////////////////////////////
		...
		paymentTypeMethod = "Swipe";

		try {

			Utility.refreshPage(driver);
			Wait.waitUntilPageIsLoaded(driver);
			testSteps.add("===== <a href='https://innroad.testrail.io/index.php?/cases/view/824631' target='_blank'>"
					+ "<b>Use swipe across.</b></a> =====");
			...
			reservationPage.enter_PaymentDetails(driver, testSteps, paymentTypeMethod, swipeCardString, nameOnCard,
					cardExpDate);
	...
	public Object[][] getData() {
		...
		return Utility.getData("VerifycreatingGuestprofiles", excel_Swarna);
