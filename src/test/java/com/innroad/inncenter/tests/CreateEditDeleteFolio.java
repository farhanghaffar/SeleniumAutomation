...
public class CreateEditDeleteFolio extends TestCore{
	...
	public void Verify_Notes_Tasks_CP_Reservation(String TestCaseID ,String url, String ClientCode, String Username, String Password,String PropertyName,String CheckInDate,String CheckOutDate,String Adults,String Children,String Rateplan,String PromoCode,
		...
		if(isExecutable) {
		test_name = "CreateEditDeleteFolio";
		...
		//String TestCaseID="848149|848494";
		...
		try {
			...
			String FolioName="NTestFolio";
			String FolioDescription="This is NTestFolio";
			String UpdatedFolioName="NTestFolioUpdated";
			String UpdatedFolioDescription="This is NTestFolio updated";
			
			
			res.createNewFolio(driver, test_steps,FolioName , FolioDescription);
			res.verifyCreatedFolio(driver, test_steps, FolioName);
			
			res.updateCustomFolio(driver, test_steps, FolioName, UpdatedFolioName, UpdatedFolioDescription);
			res.verifyCreatedFolio(driver, test_steps, UpdatedFolioName);
			
			res.deleteFolio(driver, test_steps, UpdatedFolioName);
			
			String[] testcase1 = TestCaseID.split(Utility.DELIM);
			for (int i = 0; i < testcase1.length; i++) {
				statusCode.add(i, "1");
			}
			comments="Successfully verified new created folio in reservation and edited and deleted also";
			RetryFailedTestCases.count = Utility.reset_count;
			Utility.AddTest_IntoReport(testName, test_description, test_catagory, test_steps);
		} catch (Exception e) {
			e.printStackTrace();
	...
	public Object[][] getData() {
		...
		return Utility.getData("Verify_Note_Task_CP_Reservation", SanityExcel);
	}
