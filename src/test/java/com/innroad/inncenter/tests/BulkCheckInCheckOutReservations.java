...
public class BulkCheckInCheckOutReservations extends TestCore {
	...
	public void bulkCheckInCheckOutReservations(String TestCaseID, String referral, String firstName1, String lastName1, String account,
...
//			testSteps.add("Successfully click Book Now");
		...
		try {
			...
			String getDate = ESTTimeZone.DateFormateForLineItemWithFormate(0,"MM/dd/yy");
		...
		try {
			...
			comments = " Bulk checked in reservations. Verified bulk checked in reservation status. Bulk checked out reservation. Verifed bulk checked out reservations status";
...
for (int i = 0; i < testcase.length; i++) {
	...
	public Object[][] getData() {
		...
		return Utility.getData("BulkCheckInCheckOutReservations", HS_EXCEL);
	}
