...
public class VerifyCancellationPolicyForSplitRoomResNewPolicies extends TestCore {
	...
	public void verifyCancellationPolicy(String TestCaseID, String ClientCode, String Username, String Password,
...
//			rateGrid.clickOnGivenPolicy(driver, "No Show", true);
		...
		try {
			...
			reservationPage.select_Dates(driver, test_steps, checkInDate+"|"+checkOutDate, checkOutDate+"|"+Utility.parseDate(Utility.getDatePast_FutureDate(2, "US/Eastern"), "MM/dd/yyyy", "dd/MM/yyyy"), adults+"|"+adults, children+"|"+children, ratePlan+"|"+ratePlan, "", "Yes");
			reservationPage.select_Rateplan(driver, test_steps, ratePlan, "");
			reservationPage.clickOnFindRooms(driver, test_steps);
			ArrayList<String> rooms = reservationPage.getAllRoomNumbersFromRoomClassDropDown(driver, test_steps, roomClass1);
		...
		try {			 
			...
			reservationPage.verifyPostCancellationFeeCheckbox(driver, test_steps);
			comments = "Verified Cancellation Policy Post Cancellattion Fee checkbox for Split reservation";
			statusCode.add(0, "1");
...
//					"", "Capture", policyName, policyType, roomBaseAmount, totalNights, tripTaxes, policyAttr1, policyAttrValue1);
			...
			comments = comments+ ". Verified Cancellation Policy for Split reservation";
			statusCode.add(1, "1");
	...
	public Object[][] getData() {
		return Utility.getData("CancellationPolicySplitRoom", HS_EXCEL);
	}
