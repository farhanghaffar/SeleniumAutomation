...
public class VerifyLedgerBalanceReport extends TestCore {
	...
	public void verifyLedgerBalanceReport(String adults,String children,String ratePlan,String promoCode,String isSplitRes,
		...
		String firstRoomNumber = null, secondRoomNumber = null, updatedRoomNumber = null, roomClassAbb = null,
		reservation=null, status=null, checkInDate = null, checkOutDate = null, ledgerReportFromDate = null, ledgerReportToDate = null;
...
//			System.out.println("roomClassAbb :  " + roomClassAbb);
			...
			roomDetails = roomClass.openRoomClassAndGetDataFromRoomTab(driver, test_steps, roomClassName.split("\\|")[0]);
			
			roomClassAbb = roomDetails.get("Abbreviation");
		...
		try {
			...
			app_logs.info(Rooms);
			reservationPage.enter_PaymentDetails(driver, test_steps, "MC", "5454545454545454", guestFirstName+" "+guestLastName, 
					Utility.getFutureMonthAndYearForMasterCard());
	...
	public Object[][] getData() {
		return Utility.getData("VerifyLedgerBalanceReport", envLoginExcel);
	}
