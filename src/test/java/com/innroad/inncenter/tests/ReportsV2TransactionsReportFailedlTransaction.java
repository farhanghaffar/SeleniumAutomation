...
public class ReportsV2TransactionsReportFailedlTransaction extends TestCore {
	...
	public void validateLedgerBalancesReport(String TestCaseID, String Scenario, String dateRange, 
		...
		//	test_steps.add("beforeCreditCardTransactionTypeTotal2: "+beforeCreditCardTransactionTypeTotal2);
				...
				guestFolio.clickOnFolioTab(driver, test_steps);
				includePayment="Capture";
				paymentData = guestFolio.takePaymentFromGuestFolio_Failed(driver, test_steps, includePayment);
	...
	public Object[][] getData() {
		...
		return Utility.getData("FailedlTransaction", excelReservationV2);
	}
