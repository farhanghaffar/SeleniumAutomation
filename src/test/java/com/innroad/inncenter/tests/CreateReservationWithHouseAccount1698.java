...
public class CreateReservationWithHouseAccount1698 extends TestCore{
	...
	public void createReservatinWithHouseAccount1698(String url, String clientCode, String username, String password,String PropertyName,String adult,String children,String rateplan,String promoCode,String isSplitRes,
			...
			String bedsCount, String maxAdults, String maxPersons, String roomQuantity, String startRoomNumber) throws InterruptedException, IOException {

		String testName = "CreateReservatinWithHouseAccount1698";
		testDescription = "CP Reservation Creation With House Account<br>";
		testCatagory = "Create House Account";
		...
		try {
			...
			getTestSteps.clear();
			calendarTodayDate = ratesGrid.getCalendarDate(driver, calendarTodayDay, dateFormat, getTestSteps);
			testSteps.addAll(getTestSteps);		
		...
		try {
			...
			getTestSteps.clear();
			reservationPage.select_HouseAccoutAsPayment(driver, getTestSteps, accountName);
			testSteps.addAll(getTestSteps);
			
			getTestSteps.clear();
			reservationPage.enter_TravelAgentMarketSegmentDetails(driver, getTestSteps, travelAgent, marketSegment, referral,accountType);
			testSteps.addAll(getTestSteps);
	...
	public Object[][] getData() {
		...
		return Utility.getData("CreateResWithHouseAcc1698", envLoginExcel);
	}
