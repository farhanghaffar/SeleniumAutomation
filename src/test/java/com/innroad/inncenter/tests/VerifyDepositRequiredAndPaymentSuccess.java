...
String testName = this.getClass().getSimpleName().trim();
	...
	public void verifyDepositRequiredAndPaymentSuccess(String roomClassName, String roomClassAbbrivation, String maxAdults,
		...
		try {
			...
			//newRoomclass.createRoomClassV2(driver, roomClassNames, roomClassAbbs, maxAdults, maxPersons, roomQuantity, test, test_steps);
			newRoomclass.createRoomClassV2(driver, test_steps,roomClassNames, roomClassAbbs, maxAdults, maxPersons, roomQuantity);
	...
	public Object[][] getData() {
		...
		return Utility.getData("VerifyDepositRequiredAndPayment", envLoginExcel);
