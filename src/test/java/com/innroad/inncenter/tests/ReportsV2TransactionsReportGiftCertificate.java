...
public class ReportsV2TransactionsReportGiftCertificate  extends TestCore {
	...
	public void validateLedgerBalancesReport(String TestCaseID, String Scenario, String dateRange, String dateEffective, 
		...
		if (paymentMethod.equals("Gift Certificate")) {
			try {
				...
				Gift_Certificate=Gift_Certificate+Utility.generateRandomNumber();
				nav.Accounts(driver);
				...
				accountPage.ClickNewAccountbutton(driver, "Gift Certificate");
				accountPage.AccountDetails(driver, "Gift Certificate", accountName);
...
//			try {
				...
				paymentData = guestFolio.takePaymentFromGuestFolio_RV2(driver, test_steps, includePayment,"","Gift Certificate",cardNumber, "");
...
//					reservationPage.rollBackReservation(driver, test_steps, guestFullName, "RESERVED");
		...
		if (paymentData.get("Payment Type").equalsIgnoreCase("MC")) {
			...
			expChanges2.put("Cash", Double.parseDouble("0.00"));	
			expChanges2.put("Check", Double.parseDouble("0.00"));	
			expChanges2.put("Gift Certificate", Double.parseDouble("0.00"));	
		} else if (paymentData.get("Payment Type").equalsIgnoreCase("Cash")) {
			expChanges2.put("Cash", Double.parseDouble(amount));
			expChanges2.put("Check", Double.parseDouble("0.00"));
			expChanges2.put("Credit Card", Double.parseDouble("0.00"));
			expChanges2.put("Gift Certificate", Double.parseDouble("0.00"));
		...
		else if (paymentData.get("Payment Type").equalsIgnoreCase("Gift Certificate")) {
			expChanges2.put("Check", Double.parseDouble("0.00"));
			expChanges2.put("Credit Card", Double.parseDouble("0.00"));	
			expChanges2.put("Cash", Double.parseDouble("0.00"));
			expChanges2.put("Gift Certificate", Double.parseDouble(amount));
		}
		...
		test_steps.add("========== Validating Reports after 4 minutes at "+java.time.LocalTime.now()+"==========");
		app_logs.info("========== Validating Reports after 4 minutes at "+java.time.LocalTime.now()+"==========");
	...
	public Object[][] getData() {
		...
		return Utility.getData("TransactionsReportGiftCertifica", excelReservationV2);
	}
