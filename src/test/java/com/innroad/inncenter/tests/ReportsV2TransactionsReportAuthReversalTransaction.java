...
public class ReportsV2TransactionsReportAuthReversalTransaction extends TestCore {
	...
	String sourceOfRes="From Reservations page", reservationNumber = null, guestFirstName = null, guestLastName, guestSalutation = "Mr.",	
	 referral = "Walk In", currency = null, reportsTab, applicationTab,
	cardExpDate = Utility.getFutureMonthAndYearForMasterCard(driver,test_steps), roomCharge , guestFullName;
	...
	public Object[][] getData() {
		...
		return Utility.getData("CancelTransactionType", excelReservationV2);
	}
