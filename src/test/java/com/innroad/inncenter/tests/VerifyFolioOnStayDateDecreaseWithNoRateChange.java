...
public class VerifyFolioOnStayDateDecreaseWithNoRateChange extends TestCore {
...
//	NewRoomClassesV2 obj1 = new NewRoomClassesV2();
	...
	public void verifyFolioOnStayDateDecreaseWithNoRateChange(String TestCaseId, String TestCaseName,String RatePlanName,String roomClassName,String changeOption) throws Exception {
...
//			nightlyRate.verifyTitleSummaryValue(driver, "Channel", summaryChannels, test_steps);
		...
		String CheckOutDate = Utility.getCustomDate(SeasonStartDate, "dd/MM/yyyy", "dd/MM/yyyy", 5);
		...
		String CheckInDateModify = Utility.getCustomDate(SeasonStartDate, "dd/MM/yyyy", "dd/MM/yyyy", 2);
		String CheckOutDateModify = Utility.getCustomDate(SeasonStartDate, "dd/MM/yyyy", "dd/MM/yyyy", 3);
		...
		try {
			...
			res.verifyFolioLineItem(folioLineItemsAfterModify.get(0), "Pending", true, true, Utility.getCustomDate(CheckInDateModify,"dd/MM/yyyy","MMM d, yyyy",0), true, true,
					"Room Charge", true, true, RatePlanName, true, true, "1", true, true, roomClassWiseSourceRatesRule.get(roomClassName).get(channelName).get(CheckInDateModify).getRooomRate(), true,
					true, "0", false, false, "0", false, false, test_steps);
			
			res.verifyFolioLineItem(folioLineItemsAfterModify.get(1), "Pending", true, true, Utility.getCustomDate(CheckInDateModify,"dd/MM/yyyy","MMM d, yyyy",0), true, true,
					"Room Charge", true, true, RatePlanName, true, true, "1", true, true, roomClassWiseSourceRatesRule.get(roomClassName).get(channelName).get(CheckInDateModify).getRooomRate(), true,
					true, "0", false, false, "0", false, false, test_steps);
			res.verifyFolioLineItem(folioLineItemsAfterModify.get(2), "Pending", true, true, Utility.getCustomDate(CheckInDateModify,"dd/MM/yyyy","MMM d, yyyy",0), true, true,
					"Room Charge", true, true,  RatePlanName, true, true, "1", true, true, roomClassWiseSourceRatesRule.get(roomClassName).get(channelName).get(CheckInDateModify).getRooomRate(), true,
					true, "0", false, false, "0", false, false, test_steps);
			res.verifyFolioLineItem(folioLineItemsAfterModify.get(3), "Pending", true, true, Utility.getCustomDate(CheckInDateModify,"dd/MM/yyyy","MMM d, yyyy",0), true, true,
					"Room Charge", true, true, RatePlanName, true, true, "1", true, true,roomClassWiseSourceRatesRule.get(roomClassName).get(channelName).get(CheckInDateModify).getRooomRate(), true,
					true, "0", false, false, "0", false, false, test_steps);
			res.verifyFolioLineItem(folioLineItemsAfterModify.get(4), "Pending", true, true, Utility.getCustomDate(CheckInDateModify,"dd/MM/yyyy","MMM d, yyyy",0), true, true,
					"Room Charge", true, true,  RatePlanName, true, true, "1", true, true, roomClassWiseSourceRatesRule.get(roomClassName).get(channelName).get(CheckInDateModify).getRooomRate(), true,
					true, "0", false, false, "0", false, false, test_steps);
		} catch (Exception e) {
			e.printStackTrace();
...
//					TestCore.TestRail_AssignToID);
	...
	public Object[][] getData() {
		...
		return Utility.getData("VerifyFolioOnStayDateDecrease", HS_EXCEL);
	}
